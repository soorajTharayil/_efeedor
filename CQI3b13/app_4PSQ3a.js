  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter the no of pathology samples, such as biopsy or other tissue specimens related safety events or errors reported in the month"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter total No of patient safety event reported in the month"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "The no. of pathology samples, such as biopsy or other tissue specimens related safety events or errors reported in the month be less than the no.of patient safety event reported in the month."
        );
        return;
      }
