                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top:-16px;">
                        <div class="form-group">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.patient_file}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.verified}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.indication}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.medicine}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.alert}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.dilution}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.administering}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.privacy}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.vials}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.cannula}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.flush}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.medications}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.reassess}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.oral}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.discarded}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.handwashing}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left: -7px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.procedures}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
