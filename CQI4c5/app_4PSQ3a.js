  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of ICU equipment utilised days less than ICU equipment days available"
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "Number of ICU equipment utilised days less than ICU equipment days availabl"
        );
        return false;
      }
