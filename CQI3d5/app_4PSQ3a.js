  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Total number of safe and rational prescriptions than total number of prescription audited "
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "Total number of safe and rational prescriptions less than  total number of prescription audited"
        );
        return false;
      }
