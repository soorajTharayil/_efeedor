							...
							<form id="msform">
										...
										<div class="row">
											<div class="col-xs-12 col-sm-12 col-md-12">
												...
												<div class="form-group">
													...
													<span class="has-float-label">
														<input class="form-control" placeholder="{{lang.patient_name_placeholder}}" name="name" oninput="restrictToAlphabets(event)" maxlength="25" type="text" id="emailid" ng-model="feedback.name" onblur="this.value = this.value.toUpperCase();" autocomplete="off" style=" padding-top:0px;" />
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													...
													<span class="has-float-label">
														<input class="form-control" placeholder="{{lang.enter_placeholder}}" type="text" id="contactnumber" maxlength="20" ng-required="true" ng-model="feedback.patientid" autocomplete="off" placeholder="Numerical digits only" style="padding-top:0px;" />
											...
											<div class="col-xs-12 col-sm-12 col-md-12	">
												<div class="form-group">
													<span class="" style="font-size:16px;">{{lang.department}} <sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<select class="form-control" ng-model="feedback.ward" ng-disabled="isWardPreselected" ng-change="reloadQuestionsForDepartment(feedback.ward)">
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													<span class="addon" style="    font-size: 16px;">{{lang.doctorname}}<sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<input class="form-control" placeholder="{{lang.doctorname}}" type="text" id="doctorname" maxlength="20" ng-required="true" ng-model="feedback.doctorname" autocomplete="off"  style="padding-top:0px;" />
														<label for="contactnumber"></label>
													</span>
												</div>
											</div>
											<!-- <div class="col-xs-12 col-sm-12 col-md-12	">
												...
												<div class="form-group">
													...
													<span class="has-float-label">
														...
														<select class="form-control" ng-model="feedback.ward" ng-change="change_ward2()" ng-required="true">
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													...
													<span class="has-float-label">
														<input class="form-control" oninput="restrictToNumerals(event)" type="tel" minlength="7" maxlength="10" id="contactnumber" ng-model="feedback.contactnumber" style="padding-top:0px;" autocomplete="off" placeholder="{{lang.mobile_placeholder}}" step="1" />
														<label for="contactnumber"></label>
													</span>
												</div>
											</div>
								...
								<fieldset ng-show="step2 == true">
									...
									<div class="form-card">
										...
										<h3 class="sectiondivision" style="font-weight:bold;" ng-show="feedback.section == 'OP'">
											{{ feedback.ward === 'EMERGENCY' ? 'EMERGENCY FEEDBACK FORM' : feedback.ward === 'HEALTH CHECKUP' ? 'HEALTH CHECKUP FEEDBACK FORM' : 'OUTPATIENT FEEDBACK FORM' }}
										</h3>
								...
								<fieldset ng-show="step3 == true">
									<div class="form-card">
										...
										<h3 class="sectiondivision" style="text-align: center;margin-top:0px; font-size:18px; padding-top:36px;"><b> {{lang.yourreason}} </b></h3>
										<div class="col-xs-12 col-sm-12 col-md-12" style=" margin-top:3%;   margin-bottom: 4%;">
											...
											<div class="col-xs-12 col-md-12 col-sm-6">
												...
												<span style="font-size:18px;margin-left:2%;" for="spec_service">{{lang.specificservices}} </span>
											</div>
											<!-- Referred by doctor -->
											<div class="col-xs-12 col-md-12 col-sm-6">
									...
									<input type="button" name="previous" class="previous action-button-previous" ng-click="prev2()" style="font-size:small;" value="{{lang.previous}}" />
									...
									<div class="form-card">
										...
										<div class="row justify-content-center" ng-show="positivefeedback == false || feedback.recommend1Score < recommend1Score || feedback.overallScore < overallScore">
											<div class="col-12 text-center">
												...
												<p style="text-align:center; margin-top: 45px; font-weight: 300;" class="lead">{{lang.unhappythankyoumessage}}</p>
											</div>
										</div>
