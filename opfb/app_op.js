...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $timeout) {
	...
	$scope.setupapplication = function () {
		...
		// Extract location parameter using native JavaScript
		...
		$http.get($rootScope.baseurl_main + '/department.php?patientid=' + id, { timeout: 20000 }).then(function (responsedata) {
			...
			$scope.questioset = []; // Initialize empty for selected department

			if (locationValue) {
				console.log("Location from URL:", locationValue);

				// Find matching ward from the fetched list
				var matchingWard = $scope.wardlist.ward.find(function (ward) {
					return ward.title === locationValue;
				});

				if (matchingWard) {
					// Set ward and populate bed numbers
					$scope.feedback.ward = matchingWard.title;
					$scope.bed_no = matchingWard.bedno;
					$scope.bed_nok = matchingWard.bednok;
					$scope.bed_nom = matchingWard.bednom;

					//Other option should be disable
					$scope.isWardPreselected = true;
				} else {
					console.error('No matching ward found for location:', locationValue);
					$scope.isWardPreselected = false;
				}

				// Now that allQuestions is populated, reload questions for the department
				$scope.reloadQuestionsForDepartment(locationValue);
			} else {
				console.log('No location parameter found in the URL');
			}
	...
	$scope.reloadQuestionsForDepartment = function (selectedDepartment) {
		...
		var departmentQuestionMapping = {
			"CARDIOLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"ENT": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"GASTROENTEROLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"GENERAL MEDICINE": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"GENERAL SURGERY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"NEUROLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"ONCOLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"ORTHOPAEDICS": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"PEDIATRICS": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"PHYSIOTHERAPY & REHABILITATION": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"PLASTIC SURGERY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"UROLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"VASCULAR SURGERY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Dialysis", "Nursing", "Endoscopy", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Physiotherapy", "Emergency/ Casualty", "Health Checkup Experience", "Security and Parking"],
			"EMERGENCY": ["Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Laboratory", "Pharmacy", "Emergency/ Casualty", "Security and Parking"],
			"HEALTH CHECKUP": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Laboratory", "Pharmacy", "Health Checkup Experience", "Security and Parking"],
			"DIALYSIS": ["Appointment Booking", "Registration & Reception", "Billing", "Dialysis", "Nursing", "Laboratory", "Security and Parking"],
			"CHEMOTHERAPY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Laboratory", "Pharmacy", "Chemotherapy", "Security and Parking"],
			"ENDOSCOPY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Endoscopy", "Nursing", "Pharmacy", "Security and Parking"],
			"RADIOLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Security and Parking"],
			"LABORATORY": ["Appointment Booking", "Registration & Reception", "Billing", "Laboratory", "Security and Parking"],
			"PHARMACY": ["Billing", "Pharmacy", "Security and Parking"],
			"PHYSIOTHERAPY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Physiotherapy", "Security and Parking"]
		...
		relevantCategories.forEach(function (category) {
			var matchedQuestions = $scope.allQuestions.filter(function (q) {
				return q.category === category;
			});
			$scope.questioset = $scope.questioset.concat(matchedQuestions);
		});
	...
	$scope.savefeedback = function () {
		...
		$http.post($rootScope.baseurl_main + '/saveoutpatientfeedback.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
