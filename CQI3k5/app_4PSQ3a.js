  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of surgical site infections among laparoscopic cholecystectomy in a given period"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter number of laparoscopic cholecystectomies performed in that period "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Please enter number of surgical site infections among laparoscopic cholecystectomy in a given period  be less than number of laparoscopic cholecystectomies performed in that period"
        );
        return;
      }
