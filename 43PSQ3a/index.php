                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateICUSMR()" style="margin-left:20px;">
                        Calculate COPD action plan at discharge
                      </button>
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>The percentage of neurorehabilitation patients who show improvement in physical quality and activity (per 100 patients) is: <span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
