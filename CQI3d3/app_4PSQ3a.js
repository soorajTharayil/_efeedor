  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of patients who developed adverse anaesthesia events following anaesthesia"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          " number of patients who developed adverse anaesthesia events following anaesthesia less than number of patients who underwent anaesthesia "
        );
        return;
      }
