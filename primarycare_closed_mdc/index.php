        ...
        <div class="card px-0 pt-2 pb-0 mt-2 mb-3">
          ...
          <div class="row">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 30px; margin-left:5px;">
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 5px;">
                        <input type="text" class="form-cont" ng-model="feedback.ensure_text" placeholder="Remarks" style="margin-left:-2px;margin-top:5px;"/>
                      </span>
                    </div>
            ...
            <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
              ...
              <span class="has-float-label" style="margin-top: 5px;">
                <input type="text" class="form-cont" ng-model="feedback.char_text" placeholder="Remarks" style="margin-left:-2px;margin-top:5px;"/>
              </span>
            </div>
