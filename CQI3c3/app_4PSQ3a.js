  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "the total number of dispensing errors less than the total number of in-patient days for the month."
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "The no. the total number of dispensing errors less than the no.of total number of in-patient days for the month"
        );
        return false;
      }
