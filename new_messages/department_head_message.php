...
$feedback_query = 'SELECT * FROM  bf_feedback_adf  WHERE departmenthead_messagestatus = 0';
...
while ($feedback_object = mysqli_fetch_object($feedback_result)) {
    ...
    while ($tickets_object = mysqli_fetch_object($tickets_result)) {
        ...
        $meta_data['link'] = $config_set['BASE_URL'] . 'admission/track/' . $TID;
    ...
    $update_query = 'Update bf_feedback_adf set departmenthead_messagestatus = 1 WHERE id=' . $feedback_object->id;
...
//adf departmenthead(adf) message when ticket is REOPEN ......................................................................................................................................................

$feedback_query = "SELECT * FROM  tickets_adf  WHERE status = 'Reopen'";
...
while ($feedback_object = mysqli_fetch_object($feedback_result)) {
    ...
    $tickets_query = 'SELECT * FROM  tickets_adf  inner JOIN department ON department.dprt_id = tickets_adf.departmentid   WHERE  feedbackid = ' . $feedback_object->id . ' AND tickets_adf.reopen_ticket_alert = 0 GROUP BY  department.description';
    ...
    while ($tickets_object = mysqli_fetch_object($tickets_result)) {
        ...
        $department_query = 'SELECT * FROM  tickets_adf  inner JOIN department ON department.dprt_id = tickets_adf.departmentid   WHERE  feedbackid = ' . $feedback_object->id . ' AND tickets_adf.reopen_ticket_alert = 0 AND department.description="' . $tickets_object->description . '"';
    ...
    $update_query = 'Update tickets_adf set reopen_ticket_alert = 1 WHERE id=' . $feedback_object->id;
...
//adf departmenthead(adf) message when ticket is TRANSFER...................................................................................................................



$feedback_query = "SELECT * FROM  tickets_adf  WHERE status = 'Transfered'";
...
while ($feedback_object = mysqli_fetch_object($feedback_result)) {
    ...
    $tickets_query = 'SELECT * FROM  tickets_adf  inner JOIN department ON department.dprt_id = tickets_adf.departmentid_trasfered   WHERE  feedbackid = ' . $feedback_object->id . ' AND tickets_adf.transfer_ticket_alert = 0 GROUP BY  department.description';
    ...
    while ($tickets_object = mysqli_fetch_object($tickets_result)) {
        ...
        $department_query = 'SELECT * FROM  tickets_adf  inner JOIN department ON department.dprt_id = tickets_adf.departmentid_trasfered   WHERE  feedbackid = ' . $feedback_object->id . ' AND tickets_adf.transfer_ticket_alert = 0 AND department.description="' . $tickets_object->description . '"';
    ...
    $update_query = 'Update tickets_adf set transfer_ticket_alert = 1 WHERE id=' . $feedback_object->id;
