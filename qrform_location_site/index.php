          ...
          <fieldset ng-show="step2 == true">
            ...
            <div class="box box-primary profilepage" style=" background: transparent;">
              <div class="box-body box-profile" style="display: inline-block;margin-left: 25px; margin-right: 25px;">
                <a ng-href="../pcrf_location_site?src=QR&location={{urlLocation}}&site={{urlSite}}" class="btn btn-danger btn-block" style="padding: 15px;border-radius: 45px; font-size: 16px; box-shadow: 0px 1px 1px rgba(0,0,0,0.5);background-color:#DB6B97; border:none;">
                  {{lang.button1}}</a>
                <br>
                ...
                <p>&nbsp;</p>
                <a href="../ipfb_location_site?src=QR&location={{urlLocation}}&site={{urlSite}}" class="btn btn-primary btn-block" style=" background: #4285F4 ; padding: 15px;border-radius: 45px; font-size: 16px; box-shadow: 0px 1px 1px rgba(0,0,0,0.5); border:none;">
                  {{lang.button2}}</a>
                <p>&nbsp;</p>
              </div>
              <!-- <p>&nbsp;</p>  -->
