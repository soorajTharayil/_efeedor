  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter No of Environmental cleaning & disinfection (terminal cleaning) completed in the month"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter No of Environmental cleaning & disinfection (terminal cleaning) Scheduled in the month"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Please enter No of Environmental cleaning & disinfection (terminal cleaning) completed in the month less than No of Environmental cleaning & disinfection (terminal cleaning) Scheduled in the month"
        );
        return;
      }
