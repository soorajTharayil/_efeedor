            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step0 == true">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <span class="addon" style="font-size: 16px;"> {{lang.reg_mobile_message}} <sup
                              style="color:red;font-size:15px;">*</sup></span>

                          <span class="has-float-label">

                            <br><br>
                            <!-- oninput="restrictToNumerals(event)" -->
                            <input class="form-control" placeholder="{{lang.reg_mobile_message_placeholder}}"
                              oninput="restrictToNumerals(event)" maxlength="10" name="contactnumber" type="tel"
                              id="contactnumber" ng-model="feedback.contactnumber" autocomplete="on"
                              style=" padding-top:0px;" step="1" />
                  ...
                  <input type="button" name="next" style="background: #4285F4 ; font-size:small; " ng-click="next0()"
                    class="next action-button" value="{{lang.next}}" />
                ...
                <fieldset ng-show="step1 == true">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <span class="addon" style="    font-size: 16px;"> {{lang.patientname}}<sup
                              style="color:red">*</sup></span>

                          <span class="has-float-label">

                            <input class="form-control" placeholder="{{lang.patient_name_placeholder}}" name="name"
                              maxlength="25" type="text" oninput="restrictToAlphabets(event)" id="emailid"
                              ng-model="feedback.name" onblur="this.value = this.value.toUpperCase();"
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <span class="addon" style="    font-size: 16px;">{{lang.patientid}}<sup
                              style="color:red">*</sup></span>

                          <span class="has-float-label">

                            <input class="form-control" placeholder="{{lang.enter_placeholder}}" maxlength="20"
                              type="text" id="contactnumber" ng-required="true" ng-model="feedback.patientid"
                              autocomplete="off" placeholder="Numerical digits only" style="padding-top:0px;" />
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          <span class="" style="font-size:16px;">{{lang.wardtitle}} <sup
                              style="color:red">*</sup></span>
                          <span class="has-float-label">
                            <select class="form-control" ng-model="feedback.ward"
                              ng-disabled="isWardPreselected_location" ng-change="change_ward()" ng-required="true"
                            ...
                            <select class="form-control" ng-model="feedback.ward"
                              ng-disabled="isWardPreselected_location" ng-change="change_wardk()" ng-required="true"
                              ng-show="typel == 'lang2'">
                              <option value="">{{lang.wardtitle}}</option>
                              <option ng-repeat="x in wardlist.ward" ng-show="x.title != 'ALL'" value="{{x.title}}">
                                {{x.titlek}}
                            ...
                            <select class="form-control" ng-model="feedback.ward"
                              ng-disabled="isWardPreselected_location" ng-change="change_wardm()" ng-required="true"
                              ng-show="typel == 'lang3'">
                              <option value="">{{lang.wardtitle}}</option>
                              <option ng-repeat="x in wardlist.ward" ng-show="x.title != 'ALL'" value="{{x.title}}">
                                {{x.titlem}}
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12	">
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" ng-model="feedback.bedno" ng-disabled="isWardPreselected_site"
                              ng-required="true" ng-show="typel == 'english'">
                            ...
                            <select class="form-control" ng-model="feedback.bedno" ng-disabled="isWardPreselected_site"
                              ng-required="true" ng-show="typel == 'lang2'">
                            ...
                            <select class="form-control" ng-model="feedback.bedno" ng-disabled="isWardPreselected_site"
                              ng-required="true" ng-show="typel == 'lang3'">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="display: none;">
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            ...
                            <input class="form-control" type="tel" maxlength="10" id="contactnumber"
                              ng-model="feedback.contactnumber" style="padding-top:0px;" autocomplete="off"
                  ...
                  <!-- next button -->
                  <input type="button" name="previous" class="previous action-button-previous" style=" font-size:small;"
                    ng-click="prev0()" value="{{lang.previous}}" />

                  <input type="button" name="next" ng-click="next1()" style="background: #4285F4 ; font-size:small; ;"
                    class="next action-button" value="{{lang.next}}" />
                ...
                <fieldset ng-show="step2 == true">
                  ...
                  <div class="location-banner" ng-show="urlLocation && urlSite" style="width: 95%; background: lightgrey; ">
                    <span class="location-icon" style="margin-left: -4px;"><i class="fa fa-map-marker" aria-hidden="true"></i></span>
                    <span class="location-text" style="text-align: left;">
                      Room/ Bed No.: {{urlSite}}<br>
                      Floor: {{urlLocation}}
                    </span>
                  </div>
                  ...
                  <div class="form-card">
                    ...
                    <div ng-repeat="x in questioset">
                      ...
                      <div class="setsection">
                        ...
                        <h3 class="sectiondivision" ng-show="typel != 'lang2' && typel != 'lang3'"
                          style="text-align: center;     margin-top: 10px;font-weight:bold;">{{x.category}}</h3>

                        <h3 class="sectiondivision" ng-show="typel == 'lang2'"
                          style="text-align: center;     margin-top: 10px;font-weight:bold;">{{x.categoryk}}</h3>

                        <h3 class="sectiondivision" ng-show="typel == 'lang3'"
                          style="text-align: center;     margin-top: 10px;font-weight:bold;">{{x.categorym}}</h3>
                          ...
                          <div class="col-xs-12 col-sm-12  col-md-12" style="padding-right:0px;padding-left:0px;">
                            ...
                            <ul class="modulelist">
                              ...
                              <li ng-click="questionvalueset(1,q.shortkey,q)"
                                ng-show="q.valuetext == 0  || q.valuetext != 1" class="text-center"
                              ...
                              <li ng-click="questionvalueset(0,q.shortkey,q)" ng-show="q.valuetext == 1"
                              ...
                              <li ng-click="questionvalueset(2,q.shortkey,q)"
                                ng-show="q.valuetext == 0  || q.valuetext != 2" class="text-center"
                                style="width:20%;font-size: 14px;">
                              ...
                              <li ng-click="questionvalueset(0,q.shortkey,q)" ng-show="q.valuetext == 2"
                              ...
                              <li ng-click="questionvalueset(3,q.shortkey,q)"
                                ng-show="q.valuetext == 0  || q.valuetext != 3" class="text-center"
                                style="width:20%;font-size: 14px;">
                              ...
                              <li ng-click="questionvalueset(0,q.shortkey,q)" ng-show="q.valuetext == 3"
                                ng-show="prompt_neutral_grey == true" class="text-center"
                                style="width:20%;font-size: 14px;">
                              ...
                              <li ng-click="questionvalueset(4,q.shortkey,q)"
                                ng-show="q.valuetext == 0 || q.valuetext != 4" class="text-center"
                                style="width:20%;font-size: 14px;">
                              ...
                              <li ng-click="questionvalueset(0,q.shortkey,q)" ng-show="q.valuetext == 4"
                                ng-show="prompt_excellent_grey == true" class="text-center"
                                style="width:20%;font-size: 14px;">
                              ...
                              <li ng-click="questionvalueset(5,q.shortkey,q)"
                                ng-show="q.valuetext == 0 || q.valuetext != 5" class="text-center"
                                style="width:20%;font-size: 14px;">
                              ...
                              <li ng-click="questionvalueset(0,q.shortkey,q)" ng-show="q.valuetext == 5"
                                ng-show="prompt_definite_grey == true" class="text-center"
                                style="width:20%;font-size: 14px;">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12 errorsection text-left">
                            ...
                            <span class="has-float-label" ng-show="x.errortitle == true">
                              ...
                              <div class="form-check" ng-repeat="z in q.negative">
                                ...
                                <input class="form-check-input" style="width:20px; height:20px; margin: 0px -17px 0"
                                  type="checkbox" ng-model="feedback.reasonSet[q.type][z.shortkey]">

                                <label class="form-check-label" for="flexCheckChecked{{z.id}}"
                              ...
                              <input class="form-control " placeholder="{{lang.optional}}" id="diagnosticComment"
                  ...
                  <input type="button" name="previous" class="previous action-button-previous" style=" font-size:small;"
                    ng-click="prev1()" ng-if="!urlLocation || !urlSite" value="{{lang.previous}}" />
                ...
                <fieldset ng-show="step3 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                        ...
                        <div class="rating">
                          ...
                          <input type="radio" id="star10" name="rating" ng-model="recommend1_definite_grey"
                            value="10" />
                    ...
                    <div>
                      <input type="text" id="npsdtractor" ng-model="feedback.detractorcomment" style="display:none;"
                        placeholder="{{lang.detractor}}">
                      <input type="text" id="npspassive" ng-model="feedback.passivecomment" style="display:none;"
                        placeholder="Passive feedback...">
                      <input type="text" id="npspromoter" ng-model="feedback.promotercomment" style="display:none;"
                        placeholder="Promoter feedback...">
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12" style=" margin-top:3%;   margin-bottom: 4%;">
                      ...
                      <h3 class="sectiondivision"
                        style="text-align: left;margin-top:0px; font-size:18px; padding-top:36px;"><b>
                      ...
                      <div class="col-xs-12 col-md-12 col-sm-6" style="margin-left: -10px;">
                        ...
                        <input ng-model="feedback.specificservice" id="spec_service" type="checkbox"
                          style="width: 18px;height: 18px;" />
                      ...
                      <h3 class="sectiondivision"
                        style="text-align: left;margin-top:0px; padding-top:0px; font-size:18px; margin-bottom:5px; font-weight:bolder;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          ...
                          <div class="form-group input-group">
                            ...
                            <span class="has-float-label">
                              ...
                              <input class="form-control" type="text" ng-model="feedback.staffname"
                                style=" height: 22px; margin-left:5px ; margin-top:5px;" />
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="padding-right:0px;padding-left:0px;">
                        ...
                        <div class="col-xs-12 col-sm-12  col-md-12" style="padding-right:0px;padding-left:0px;">
                          ...
                          <textarea style="border: 2px solid #ccc;" class="form-control"
                            ng-model="feedback.suggestionText" rows="5" id="comment"></textarea>
                  ...
                  <input type="button" name="previous" class="previous action-button-previous" style="font-size:small;"
                    ng-click="prev2()" value="{{lang.previous}}" />

                  <input type="button" ng-show="loader == false" style="background: #4285F4 ; font-size:small;"
                    name="make_payment" class="next action-button" ng-click="savefeedback()" value="{{lang.submit}}" />
