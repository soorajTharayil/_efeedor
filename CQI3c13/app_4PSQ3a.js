  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter No of restricted antibiotics prescribed As per hospital policy with proper indications"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter total no of restricted antibiotics prescribed in the month"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          " No of restricted antibiotics prescribed As per hospital policy with proper indications less than Total no of restricted antibiotics prescribed in the month ."
        );
        return;
      }
