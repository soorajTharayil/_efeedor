            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <h4 style="font-size:18px"><strong>{{lang.kpi_info}} {{selectedMonths}} {{selectedYears}}
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Avg. time taken for initial assessment of indoor patients: <span ng-style="{ color: getTextColor() }">{{calculatedResult}}</span></strong><br><br>
