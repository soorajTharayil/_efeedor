            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top: opx;">
                    <div class="form-group">
                      <h6 style="font-size: 16px;margin-left:-6px;margin-top:13px;"><b></b></h6>
                      <div style="margin-top: 30px; text-align: left;margin-left:-6px;">
                        <p style="font-size: 16px; margin-bottom: 2px;">{{lang.identification_details}}</p>
                        <span class="has-float-label">
                          <input class="form-control" type="text" ng-model="feedback.identification_details"
                            placeholder="Enter your input" ng-required="true" style="margin-top: 0px;" />
                        </span>
                      </div>
                      <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                        ...
                        <!-- Input -->
                        <div style="position: relative; width: 100%;">
                          <input class="form-control" ng-model="feedback.vital_signs" type="datetime-local"
                            id="formula_para1_hr15" ng-required="true" autocomplete="off" max="{{todayDateTime}}"
                            onclick="this.showPicker && this.showPicker()"
                            onfocus="this.showPicker && this.showPicker()"
                            style="padding: 6px 8px; border: 1px solid #ced4da; border-radius: 4px; margin-top: 0px; width: 100%;" />
                        </div>
                      </div>
                      <div style="margin-top: 10px; text-align: left;margin-left:-6px;">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12"
                    style="padding-right: 0px; padding-left: 12px; margin-left: 5px; margin-top: 25px;">
