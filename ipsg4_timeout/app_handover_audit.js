...
$scope.user_id = ehandor.userid;
	...
	$scope.savefeedback = function () {
		...
		$scope.feedback.vital_signs = formatDateToLocalString($scope.feedback.vital_signs);
		...
		$http.post($rootScope.baseurl_main + '/save_ma_ipsg4_timeout.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
