...
$scope.user_id = ehandor.userid;
	...
	$scope.calculateMedicationErrorRate = function () {
		...
		if (isNaN(medicationErrors) || medicationErrors < 0) {
			alert("Please enter total No. of damaged line identified in the month");
			return;
		}

		if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
			alert("Please enter total No of laundry sent for washing in the month  ");
			return;
		}

		if (medicationErrors > opportunitiesForErrors) {
			alert("Please enter total No. of damaged line identified in the month be less than total No of laundry sent for washing in the month ");
			return;
		}
