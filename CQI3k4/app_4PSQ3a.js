  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of surgical site infections among coronary artery bypass grafting CABG in a given period "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Please enter  number of surgical site infections among coronary artery bypass grafting CABG in a given period  be less than total number of CABG cases in the month"
        );
        return;
      }
