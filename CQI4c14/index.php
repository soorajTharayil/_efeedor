                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div style="margin-top: 5px;text-align:left;"><br>
                    ...
                    <!-- <div style="margin-left:15px;">
                      <strong>turnaround time for blood donation(Blood Center): <span ng-style="{ color: getTextColor() }">{{calculatedResult}}</span></strong><br><br>
                      <strong>Bench Mark Time: {{ feedback.benchmark }}</strong>
                    </div> -->

                    <div class="col-xs-12 col-sm-12 col-md-12"
                      style="padding-right: 0px; padding-left: 12px; margin-left: 5px; margin-top: 5px;">
