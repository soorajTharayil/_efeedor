          ...
          <div class=" px-0 pt-2 pb-0 ">
            ...
            <div class="box box-primary profilepage" style="background: transparent;">
              <div class="box-body box-profile" style="display: inline-block; margin-left: 25px; margin-right: 25px;">
                ...
                <div ng-if="profilen['OP-MODULE'] == true">
                  <a href="../opfb?location=EMERGENCY" class="btn btn-success btn-block" style="background: #4285F4; padding: 15px; border-radius: 45px; font-size: 16px; box-shadow: 0px 1px 1px rgba(0,0,0,0.5); border:none;">EMERGENCY FEEDBACK</a>
                  <br>
                </div>

                <div ng-if="profilen['OP-MODULE'] == true">
                  <a href="../opfb?location=HEALTH CHECKUP" class="btn btn-success btn-block" style="padding: 15px; border-radius: 45px; font-size: 16px; box-shadow: 0px 1px 1px rgba(0,0,0,0.5); border:none;">HEALTH CHECKUP FEEDBACK</a>
                  <br>
                </div>
                ...
                <div ng-if="profilen['INCIDENT-MODULE'] == true">
                  <a href="../imf?src=Link&userid={{ adminId }} " class="btn btn-primary btn-block" style="padding: 15px; border-radius: 45px; font-size: 16px; box-shadow: 0px 1px 1px rgba(0,0,0,0.5); background-color:#DB6B97; border:none;">{{lang.button5}}</a>
                  <br>
                </div>
                ...
                <div ng-if="profilen['QUALITY-MODULE'] == true" style="margin-top: 0px;">
