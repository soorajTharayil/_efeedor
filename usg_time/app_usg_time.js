...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $window) {
	...
	$scope.savefeedback = function () {
		...
		if (!$scope.feedback.initial_assessment_hr2 || isNaN(assessmentDate.getTime())) {
			alert("Please enter patient entry time.");
			return;
		}
		...
		$http.post($rootScope.baseurl_main + '/savepatientfeedback_usg_time.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
