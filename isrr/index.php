								...
								<fieldset ng-show="step4 == true">
									<div class="text-left details-section" style="background: white;">
										...
										<div class="form-group" style="margin-left: 13px; margin-right:13px;margin-top:30px;">
											...
											<input style="border-bottom: 0px; " type="file" accept="*" onchange="angular.element(this).scope().encodeFile(this)" />

											<br>
											<p ng-show="feedback.file">{{feedback.fileName}}</p> <!-- Display file name after upload -->
										</div>
										<br><br>
