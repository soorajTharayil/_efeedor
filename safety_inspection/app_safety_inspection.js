...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $window) {
	...
	$scope.savefeedback = function () {
		...
		$http.post($rootScope.baseurl_main + '/savepatientfeedback_safety_inspection.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
