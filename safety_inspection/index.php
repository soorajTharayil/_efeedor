                    ...
                    <div class="row">
                      ...
                      <div class="form-group" style="margin-left: 19px;margin-top:-12px;" ng-show="feedback.dep === 'Pharmacy'">
                        ...
                        <div class="form-group" style="margin-top:-12px;">
                          ...
                          <input type="hidden" ng-model="feedback.location" ng-init="feedback.location = 'REFRIGERATOR'" />
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.temperature_chart}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                                <input type="radio" ng-model="feedback['temperature_chart' + feedback.dep + '_' + feedback.location]" value="yes" />
                                <span style="margin-left: 5px;">Yes</span>
                        ...
                        <div class="form-group" style="margin-top:-12px;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.medicine_stored}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.over_dated}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.near_expiry}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.credit_note}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                      ...
                      <div class="form-group" style="margin-left: 19px;margin-top:-12px;" ng-show="feedback.dep === 'Terrace'">
                        ...
                        <div class="form-group" style="margin-top:-12px;">
                          ...
                          <input type="hidden" ng-model="feedback.location" ng-init="feedback.location = 'GENERAL CONDITION OF THE DEPARTMENT'" />
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.terrace_neat}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.terrace_restrict}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                      ...
                      <div class="form-group" style="margin-left: 19px;margin-top:-12px;" ng-show="feedback.dep === 'Laundry'">
                        ...
                        <div class="form-group" style="margin-top:-12px;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.space_linen}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                        ...
                        <div class="form-group" style="margin-top:-12px;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.staff_record}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
                        ...
                        <div class="form-group" style="margin-top:-12px;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.hypochlorite}}</p>
                            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                              <label style="display: flex; align-items: center;">
