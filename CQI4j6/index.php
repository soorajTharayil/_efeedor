                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Door to IV thrombolytic bolus (≥75% compliance) ≤60 min [Achieving Door to needle times (time of bolus administration) within 60 minutes in 75% or more of acute ischemic stroke(Stroke Unit):</strong><span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
