            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step0 == true">
                  ...
                  <h4><strong>SAFETY ADHERENCE AUDIT FORM</strong></h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <span class="addon" style="font-size: 16px;">{{lang.staff_name}}<sup style="color:red">*</sup></span>
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" id="department" ng-required="true" ng-model="feedback.department" autocomplete="off" style="padding-top:0px;margin-top: 5px;">
                              ...
                              <option ng-repeat="x in safety_adherence.safety_adherence" ng-show="x.title != 'ALL'" value="{{x.title}}">{{x.title}}</option>
                            </select>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.department === 'Lab'" style="margin-left:7px;">
                        <div class="form-group">
                          <!-- <span class="addon" style="font-size: 16px;">PPE Audit - Lab</span> -->

                          <div style="margin-top: 0; margin-left:0;">
                            <p style="font-size: 16px; margin-bottom: 6px;margin-left: -6px;">{{lang.action}}</p>
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.apron}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.department === 'X-Ray'" style="margin-left:7px;">
                        <div class="form-group">
                          <!-- <span class="addon" style="font-size: 16px;">PPE Audit - Lab</span> -->

                          <div style="margin-top: 0; margin-left:0;">
                            <p style="font-size: 16px; margin-bottom: 6px;margin-left: -6px;">{{lang.action}}</p>
                            <input style="border: 1px ridge #ccc; margin-left: -5px; width: 100%; padding-top:5px;padding-left: 7px;" class="form-control" id="textarea1" placeholder="Enter the activity here" ng-model="feedback.comment_r" rows="5">
                          </div>
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.lead_apron}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.use_xray_barrior}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div style="margin-top: 8px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.use_tld_badge}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.department === 'USG'" style="margin-left:7px;">
                        <div class="form-group">
                          <!-- <span class="addon" style="font-size: 16px;">PPE Audit - Lab</span> -->

                          <div style="margin-top: 0; margin-left:0;">
                            <p style="font-size: 16px; margin-bottom: 6px;margin-left: -6px;">{{lang.action}}</p>
                            <input style="border: 1px ridge #ccc; margin-left: -5px; width: 100%; padding-top:5px;padding-left: 7px;" class="form-control" id="textarea1" placeholder="Enter the activity here" ng-model="feedback.comment_u" rows="5">
                          </div>
