...
// Select Department
	...
	$scope.savefeedback = function () {
		...
		$http.post($rootScope.baseurl_main + '/save_ma_surgeons_closed_mdc.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId , $scope.feedback).then(function (responsedata) {
