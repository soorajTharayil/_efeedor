  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateErrorRate = function () {
      ...
      if (isNaN(reportingErrors) || reportingErrors < 0) {
        alert(
          "Please enter Number of patients who develop new / worsening of pressure ulcer."
        );
        return;
      }
      ...
      if (reportingErrors > testsPerformed) {
        alert(
          "Number of patients who develop new / worsening of pressure ulcer less than Total number of patient days for the month"
        );
        return;
      }
