  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "please enter Number of deaths  less than Number of discharges and deaths in that month"
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "Please enter Number of deaths month less than Number of discharges and deaths in that month"
        );
        return false;
      }
