  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of cases where the planned surgery was changed intraoperatively"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "number of cases where the planned surgery was changed intraoperatively less than  number of surgeries performed in that month "
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "umber of cases where the planned surgery was changed intraoperatively less than  number of surgeries performed in that month"
        );
        return false;
      }
