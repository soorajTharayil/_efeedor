  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of missed hand hygiene opportunities-(Infection Control - Nursing)"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of missed hand hygiene opportunities-(Infection Control - Nursing) less than Number of hand hygiene opportunities"
        );
        return;
      }
