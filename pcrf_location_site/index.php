						...
						<div class="col-md-12 mx-0">
							...
							<form id="msform">
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													...
													<span class="has-float-label"><br><br>
														<input class="form-control" placeholder="{{lang.reg_mobile_message_placeholder}}" name="contactnumber" type="tel" pattern="\d*" maxlength="10" oninput="restrictToNumerals(event)" id="emailid" ng-model="feedback.contactnumber" oninput="restrictToNumerals(event)" autocomplete="on" style=" padding-top:0px;" step-1 />
								...
								<fieldset ng-show="step2 == true">
									...
									<div class="location-banner" ng-show="urlLocation" style="width: 95%; background: lightgrey;">
										<span class="location-icon" style="margin-left: -4px;">
											<i class="fa fa-map-marker" aria-hidden="true"></i>
										</span>
										<span class="location-text" style="text-align: left;">
											<span ng-if="urlSite">Room/ Bed No.: {{urlSite}}<br></span>
											Floor: {{urlLocation}}
										</span>
									</div>
									...
									<div class="" style="width: 92%; margin: 0px auto;">
										...
										<div>
											<input type="button" name="previous" style="font-size:small;" class="previous action-button-previous" ng-click="activeStep('step1')" ng-if="!urlLocation || !urlSite" value="{{lang.previous}}" />
										</div>
									</div>
								</fieldset>
								...
								<fieldset ng-show="step4 == true">
									<div class="text-left details-section" style="background: white;">
										...
										<table class="details-content" style="border-spacing: 10px; border-collapse: collapse; width: 100%; margin-bottom: 0px; border: 1px solid #dddddd;">
											...
											<tr ng-show="submit_as_concern == true">
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%;">{{lang.SelectedCategory}}</td>
												<td ng-show="selectedParameterObject.title && selectedParameterObject.title != 'Other'" style="width: 65%; border: 1px solid #dddddd; padding: 10px;">
											...
											<tr ng-show="submit_as_concern == true">
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%;">{{lang.concern_request}}</td>
												<td ng-show="selectedParameterObject.title && selectedParameterObject.title != 'Other'" style=" width: 65%; border: 1px solid #dddddd; padding: 10px;">
											...
											<tr>
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%;">{{lang.showwardtitle}}</td>
												<td style="border: 1px solid #dddddd; padding: 10px; width: 65%; ">
													<!-- WARD DROPDOWN -->
													<select class="form-control" ng-model="feedback.ward" ng-change="change_ward()" ng-required="true" ng-show="typel == 'english'">
														<option value="">{{lang.wardtitle}}</option>
														<option ng-repeat="x in wardlist.ward" ng-show="x.title != 'ALL'" value="{{x.title}}">
											...
											<tr>
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%;">{{lang.bedno}}</td>
												<td style="border: 1px solid #dddddd; padding: 10px;width: 65%;">
													...
													<div class="form-group" style="margin-bottom:10px;">
														<select class="form-control" ng-model="feedback.bedno" ng-required="true" ng-show="typel == 'english'">
															<option value="">{{lang.bedno}}</option>
															<!-- <option ng-repeat="(key, value) in bed_no" value="{{key}}">{{value}}</option> -->
															<option ng-repeat="(key, value) in bed_no" value="{{value.trim()}}">{{value}}</option>

														</select>

														<select class="form-control" ng-model="feedback.bedno" ng-required="true" ng-show="typel == 'lang2'">
															<option value="">{{lang.bedno}}</option>
															<option ng-repeat="(key, value) in bed_nok" value="{{value.trim()}}">{{value}}</option>
														</select>

														<select class="form-control" ng-model="feedback.bedno" ng-required="true" ng-show="typel == 'lang3'">
															<option value="">{{lang.bedno}}</option>
															<option ng-repeat="(key, value) in bed_nom" value="{{value.trim()}}">{{value}}</option>
														</select>
													</div>

													<!-- Textbox for bedno-->
													<!-- <div class="form-group">
														<input class="form-control" placeholder="{{lang.bedno}}" type="text" id="bednumber" ng-required="true" ng-model="feedback.bedno" autocomplete="off" />
													</div> -->
											...
											<tr>
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%; ">{{lang.patientname}}</td>
												<td style="border: 1px solid #dddddd; padding: 10px; width: 65%;">
													<input type="text" class="form-control" ng-model="feedback.name" placeholder="Enter your name" />
												</td>
											</tr>

											<tr>
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%;">{{lang.patientid}}</td>
												<td style="border: 1px solid #dddddd; padding: 10px; width: 65%;">
													<input type="text" class="form-control" ng-model="feedback.patientid" placeholder="Enter UHID" />
												</td>
											</tr>

											<tr>
												<td class="details-label" style="border: 1px solid #dddddd; padding: 10px; width: 35%; ">{{lang.mobileno}}</td>
												<td style="border: 1px solid #dddddd; padding: 10px; width: 65%; ">
													<input type="tel" class="form-control" pattern="\d*" maxlength="10" oninput="restrictToNumerals(event)" ng-model="feedback.contactnumber" placeholder="Enter mobile no." />
												</td>
											</tr>
