  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of Fall prevention compliances in Physiotherapy OP "
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter Total Number of Fall prevention opportunities in Physiotherapy OP"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of Fall prevention compliances in Physiotherapy OP less than Total Number of Fall prevention opportunities in Physiotherapy OP "
        );
        return;
      }
