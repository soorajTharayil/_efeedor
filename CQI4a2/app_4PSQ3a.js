  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of drugs and consumables procured outside the formulary "
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter Number of drugs and consumables procured from inside the formulary and outside from local purchases "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of drugs and consumables procured outside the formulary less than Number of drugs and consumables procured from inside the formulary and outside from local purchases "
        );
        return;
      }
