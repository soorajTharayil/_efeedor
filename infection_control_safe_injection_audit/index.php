                ...
                <fieldset ng-show="step1 == true">
                    ...
                    <h4 style="font-size:22px;"><strong>{{lang.patient_info}}</strong></h4>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top: 10px;">
                        <div class="form-group">
                          <h6 style="font-size: 16px;margin-left:-6px;margin-top:13px;"><b></b></h6>
                          ...
                          <span class="has-float-label" style="margin-top: 5px;">
                            <input type="text" 
                                   class="form-cont" 
                                   ng-model="feedback.vital_signs_text" 
                                   placeholder="Remarks" 
                                   style="margin-left:-2px; margin-top:5px;" />
                          </span>
                        </div>
                          ...
                          <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.surgery_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                          ...
                          <span class="has-float-label" style="margin-top: 5px;">
                            <input type="text" 
                                   class="form-cont" 
                                   ng-model="feedback.complaints_communicated_text" 
                                   placeholder="Remarks" 
                                   style="margin-left:-2px; margin-top:5px;" />
                          </span>
                        </div>
                        ...
                        <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.allergies}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.allergies_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.medication}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.medication_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.diagnostic}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.diagnostic_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.lab_results}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.lab_results_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.pending_investigation}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.pending_investigation_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.medicine_order}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.medicine_order_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.facility_communicated}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.facility_communicatedr_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.health_education}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.health_education_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.risk_assessment}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.risk_assessment_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.urethral}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.urethral_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.urine_sample}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.urine_sample_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.bystander}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.bystander_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                           ...
                           <p style="font-size: 18px; margin-bottom: 6px;">{{lang.instruments}}</p>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" 
                                       class="form-cont" 
                                       ng-model="feedback.instruments_text" 
                                       placeholder="Remarks" 
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.sterile_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.antibiotics_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.surgical_site_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.documented_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.adequate_facilities_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.sufficient_lighting_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.storage_facility_for_food_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.personnel_hygiene_facilities_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text"
                                       class="form-cont"
                                       ng-model="feedback.food_material_testing_text"
                                       placeholder="Remarks"
                                       style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style=" margin-left: -19px; margin-top: 13px;">
