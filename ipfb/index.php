                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <!-- <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:1px;margin-top: 10px;">
                        <div class="form-group transparent-placeholder" style="margin-top: -21px; display: flex; flex-direction: column; position: relative;">
                          <span class="addon" style="font-size: 16px; margin-bottom: -18px;">Discharge Date & Time<br>
                            <p style="font-size: 14px;">{{lang.format}}</p>
                          </span>

                          <div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
                            <input class="form-control" ng-model="feedback.dischargeDate" type="datetime-local" id="formula_para1_hr" autocomplete="off" style="padding-top: 2px;padding-left: 6px;border: 1px solid #ced4da; margin-top:9px;width: calc(100% - 3px);" />
                    ...
                    <div ng-repeat="x in questioset">
                      ...
                      <div class="setsection">
                        ...
                        <div class="questionset" ng-repeat="q in x.question">
                          ...
                          <!-- <input ng-show="q.valuetext == 3" class="form-control " placeholder="Describe the reason for rating average (Optional)" id="diagnosticComment" ng-model="feedback.commentSet[q.type][q.type]" ng-change="setthevaluefeedback(x.question,this.value)" style="display: table;margin:0 auto;"></br>
                          <input ng-show="q.valuetext == 4" class="form-control " placeholder="Describe the reason for rating good (Optional)" id="diagnosticComment" ng-model="feedback.commentSet[q.type][q.type]" ng-change="setthevaluefeedback(x.question,this.value)" style="display: table;margin:0 auto;"></br>
                          <input ng-show="q.valuetext == 5" class="form-control " placeholder="Describe the reason for rating excellent (Optional)" id="diagnosticComment" ng-model="feedback.commentSet[q.type][q.type]" ng-change="setthevaluefeedback(x.question,this.value)" style="display: table;margin:0 auto;"></br> -->
