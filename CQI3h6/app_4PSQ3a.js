...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      // Validate for negatives and invalid inputs
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of reintubation within 48 hours of extubating"
        );
        return;
      }
      ...
      // Denominator cannot be zero when numerator > 0
      ...
      // Format result (whole or 2 decimals)
