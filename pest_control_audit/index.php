              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 30px; margin-left:5px;">
                    <!-- Pest Control Visit Planned/Scheduled -->
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      <p style="font-size: 18px; margin-bottom: 6px;">Is Pest Control Visit Planned/Scheduled?</p>
                    
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pest_planned" value="Yes" />
                          <span style="margin-left: 5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pest_planned" value="No" />
                          <span style="margin-left: 5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pest_planned" value="N/A" />
                      ...
                      <span class="has-float-label">
                        <input type="text" class="form-cont" 
                          ng-model="feedback.pest_planned_remarks"
                          placeholder="Remarks" 
                          style="margin-left:-2px; margin-top:5px;" />
                      </span>
                    </div>
                    
                    <!-- Pest Control Visit Executed -->
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      <p style="font-size: 18px; margin-bottom: 6px;">Is Pest Control Visit Executed?</p>
                    
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pest_executed" value="Yes" />
                          <span style="margin-left: 5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pest_executed" value="No" />
                          <span style="margin-left: 5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pest_executed" value="N/A" />
                          <span style="margin-left: 5px;">N/A</span>
                        </label>
                      </div>
                      ...
                      <span class="has-float-label">
                        <input type="text" class="form-cont" 
                          ng-model="feedback.pest_executed_remarks"
                          placeholder="Remarks" 
                          style="margin-left:-2px; margin-top:5px;" />
                      </span>
                    </div>
