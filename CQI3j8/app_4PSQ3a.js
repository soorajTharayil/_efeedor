  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of handovers done by doctors less than Number of handover opportunities Doctors"
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "Please enter Number of patient identification compliance in audited sample size less than Total number of opportunities observed"
        );
        return false;
      }
