...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $window) {
	...
	$scope.redirectToEditAsset = function (assetId) {
		var adminId = $rootScope.adminId || 'default'; // Replace with actual logic if needed
		var redirectUrl = '/asset/edit_asset/' + assetId;
		window.location.href = '/login/?userid=' + adminId + '&redirect=' + encodeURIComponent(redirectUrl);
	};
