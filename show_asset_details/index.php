                ...
                <fieldset class="form-card" ng-show="step2 == true">
                  ...
                  <div class="form-card" style="margin-top: -36px;">
                      ...
                      <div class="d-flex justify-content-start">
                        <div class="dropdown me-auto">
                          ...
                          <div class="dropdown-menu" aria-labelledby="assetActionsDropdown">
                            ...
                            <a class="dropdown-item" ng-click="redirectToEditAsset(assetDetails.id)" ng-if="profilen['EDIT-ASSET'] == true" style="cursor:pointer;">Edit Asset Details</a>
                    ...
                    <table class="table">
                      ...
                      <tr>
                        <th colspan="2" style="text-align: left;"><strong>Preventive Maintenance</strong></th>
                      </tr>
                      <tr>
                        <td><strong>Last Preventive Maintenance Date</strong></td>
                        <td>{{ assetDetails.preventive_maintenance_date || '-' }}</td>
                      </tr>
                      <tr>
                        <td><strong>Upcoming Preventive Maintenance Due</strong></td>
                        <td>{{ assetDetails.upcoming_preventive_maintenance_date || '-' }}</td>
                      </tr>

                      <!-- Calibration Info -->
                      <tr>
                        <th colspan="2" style="text-align: left;"><strong>Calibration Details</strong></th>
                      </tr>
                      <tr>
                        <td><strong>Last Preventive Calibration Date</strong></td>
                        <td>{{ assetDetails.asset_calibration_date || '-' }}</td>
                      </tr>
                      <tr>
                        <td><strong>Upcoming Preventive Calibration Due</strong></td>
                        <td>{{ assetDetails.upcoming_calibration_date || '-' }}</td>
                      </tr>
