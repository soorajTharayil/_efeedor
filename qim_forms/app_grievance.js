...
app.controller(
  ...
  function ($rootScope, $scope, $http, $window) {
    ...
    $scope.kpiGroups = {
      ...
      // Newly Added Groups
      Housekeeping: [
        79, 280, 281, 282, 283, 285, 292, 293, 335, 336, 337, 339, 341, 342, 344, 345,
      ],
      "Quality Office": [92, 109, 110, 111, 129, 135, 171, 172, 183, 217, 254],
      Physiotherapy: [114, 118, 119, 226, 240, 246],
      "Security & Safety": [120, 121, 122, 130, 132, 271, 288, 297],
      Pharmacy: [123, 124, 125, 189, 255, 256, 370],
      "SCM-Store": [126],
      "SCM-Purchase": [127],
