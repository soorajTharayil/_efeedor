                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top: 15px;">
                        <div class="form-group">
                          <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                                <h6 style="font-size: 18px;margin-left:-6px;margin-top:16px;"><b>Part A (filled after procedure)</b></h6>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.identification_details_remarks" placeholder="Remarks"
                          ...
                          <!-- Surgery -->
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.complaints_communicated_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                            ...
                            <!-- Allergies -->
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              <p style="font-size: 18px; margin-bottom: 6px;">{{lang.allergies}}</p>
                              <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                                <label style="display: flex; align-items: center;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.allergies_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <!-- Medication -->
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              <p style="font-size: 18px; margin-bottom: 6px;">{{lang.medication}}</p>
                              <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                                <label style="display: flex; align-items: center;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.medication_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            ...
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.diagnostic_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.lab_results_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.pending_investigation_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.medicine_order_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                            <p style="font-size: 18px; margin-bottom: 6px;">{{lang.facility_communicated}}</p>
                            <input class="form-control" type="text" ng-model="feedback.facility_communicated" placeholder="Enter your input" maxlength="30" autocomplete="off" />
                          </div>
                           <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.health_education_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                             <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.risk_assessment_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                            <h6 style="font-size: 18px;margin-left:-6px;margin-top:16px;"><b>Part 2 ( filled after 30 days)</b></h6>
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.urethral_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.urine_sample_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.bystander_remarks" placeholder="Remarks"
                                  style="margin-left:-2px; margin-top:5px;" />
                              </span>
                            </div>
