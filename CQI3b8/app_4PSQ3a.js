  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter the number of staff adhering to safety precautions."
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "The no. of staff adhering to safety precautions must be less than the no.of staff audited."
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "The no. of tstaff adhering to safety precautions must be less than the no. of staff audited"
        );
        return false;
      }
