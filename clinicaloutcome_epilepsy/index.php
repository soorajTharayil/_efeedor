                          ...
                          <!-- Surgery -->
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.identification_details_text" placeholder="Remarks"
                            ...
                            <input class="form-control" type="text" ng-model="feedback.surgery" placeholder="Enter your input" maxlength="30" autocomplete="off" />
                          </div>
                            ...
                            <input class="form-control" type="text" ng-model="feedback.output" placeholder="Enter your input" maxlength="30" autocomplete="off" />
                          </div>
                          <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                            <p style="font-size: 18px; margin-bottom: 6px;">{{lang.allergies}}</p>
                            <input class="form-control" type="text" ng-model="feedback.allergies" placeholder="Enter your input" maxlength="30" autocomplete="off" />
                          </div>
                           <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
