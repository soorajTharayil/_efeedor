  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of case sheets where nursing plan is documented"
        );
        return;
      }
      ...
      // ✅ Remove strict > check to allow equal or smaller numerator
      // ✅ Keep logic safe if both are zero
