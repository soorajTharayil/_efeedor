...
<head>
  ...
  <script src="app_5PSQ3a.js?<?php echo time(); ?>"></script>
            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <h4 style="font-size:18px; margin-left: 3px;"><strong>{{lang.kpi_info}} {{selectedMonths}} {{selectedYears}}</strong></h4>
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateAbbreviationErrorRate()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Percentage of medication chart with error-prone abbreviations: <span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
