...
<head>
  ...
  <script src="app_18PSQ3b.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateProphylacticAntibioticsRate()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult !==undefined" style="margin-top: 15px;text-align:left;"><br>

                    <div style="margin-left:15px;">
                      <strong>Percentage of cases who received appropriate prophylactic antibiotics within the specified time frame: <span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
                  ...
                  <!-- submit button -->
                  <div ng-if="calculatedResult !== undefined">
