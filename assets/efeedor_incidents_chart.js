...
function tickets_recived_by_department(callback) {
  ...
  var apiUrl = baseUrl +  "/analytics_incidents/tickets_recived_by_department"; // Replace with your API endpoint
      ...
      tooltips: {
        ...
        callbacks: {
          label: function (tooltipItems, data) {
            ...
            multistringText.push("Total Incidents: " + all_detail.data_field_count);
            multistringText.push("Open Incidents: " + all_detail.open_tickets);
            if (all_detail.addressed_tickets) {
              multistringText.push(
                "Addressed Incidents: " + all_detail.addressed_tickets
              );
            }
            multistringText.push("Closed Incidents: " + all_detail.closed_tickets);
