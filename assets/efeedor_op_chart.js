...
function patient_feedback_analysis(callback) {
  ...
  var apiUrl = baseUrl +  "/analytics_op/patient_feedback_analysis"; // Replace with your API endpoint
...
function handleBarClick(clickData) {
  ...
  var url = baseUrl +  "/opf/trend_analytic/" + clickData.type;
  window.location = url;
...
function patient_satisfaction_analysis(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_op/patient_satisfaction_analysis"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function net_permoter_analysis(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_op/net_permoter_analysis"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function why_patient_choose(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_op/why_patient_choose"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function tickets_recived_by_department(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_op/tickets_recived_by_department"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function tickets_recived_by_department_set(type,value) {
  ...
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_op/tickets_recived_by_department_set?settype="+type; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
