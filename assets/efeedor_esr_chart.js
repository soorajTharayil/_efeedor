...
function tickets_recived_by_department(callback) {
  ...
  var apiUrl = baseUrl +  "/analytics_esr/tickets_recived_by_department"; // Replace with your API endpoint
      ...
      tooltips: {
        ...
        callbacks: {
          label: function (tooltipItems, data) {
            ...
            multistringText.push("Total Requests: " + all_detail.data_field_count);
            multistringText.push("Open Requests: " + all_detail.open_tickets);
            if (all_detail.addressed_tickets) {
              multistringText.push(
                "Addressed Requests: " + all_detail.addressed_tickets
              );
            }
            multistringText.push("Closed Requests: " + all_detail.closed_tickets);
