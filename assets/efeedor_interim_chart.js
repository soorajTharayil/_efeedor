...
function tickets_recived_by_department(callback) {
  ...
  var apiUrl = baseUrl +  "/analytics_int/tickets_recived_by_department"; // Replace with your API endpoint
      ...
      tooltips: {
        ...
        callbacks: {
          label: function (tooltipItems, data) {
            ...
            multistringText.push("Complaints: " + all_detail.data_field_count);
            multistringText.push("Open Complaints: " + all_detail.open_tickets);
            if (all_detail.addressed_tickets) {
              multistringText.push(
                "Addressed Complaints: " + all_detail.addressed_tickets
              );
            }
            multistringText.push("Closed Complaints: " + all_detail.closed_tickets);
