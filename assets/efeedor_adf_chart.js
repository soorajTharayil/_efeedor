...
function patient_feedback_analysis(callback) {
  ...
  var apiUrl = baseUrl +  "/analytics_adf/patient_feedback_analysis"; // Replace with your API endpoint
...
function patient_satisfaction_analysis(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_adf/patient_satisfaction_analysis"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function net_permoter_analysis(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_adf/net_permoter_analysis"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function why_patient_choose(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_adf/why_patient_choose"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function tickets_recived_by_department(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_adf/tickets_recived_by_department"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
...
function resposnsechart(callback) {
  var xhr = new XMLHttpRequest();
  var apiUrl = baseUrl +  "/analytics_adf/resposnsechart"; // Replace with your API endpoint
  xhr.open("GET", apiUrl, true);
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
      var responseData = JSON.parse(xhr.responseText);
