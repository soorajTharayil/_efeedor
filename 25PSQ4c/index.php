...
<head>
  ...
  <script src="app_25PSQ4c.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateIncompleteConsentRate()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult !==undefined" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Percentage of medical records having incomplete and/or improper consent is: <span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
