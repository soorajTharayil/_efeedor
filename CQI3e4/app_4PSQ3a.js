  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of patients who did receive appropriate prophylactic antibiotic(s)"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter Number of patients who underwent surgeries in the OT"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "number of patients who did receive appropriate prophylactic antibiotic(s) less than Number of patients who underwent surgeries in the OT"
        );
        return;
      }
