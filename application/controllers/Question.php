...
// 	}
    ...
    public function add($id = null)
    {
        ...
        if ($this->form_validation->run() === false) {
            // -------------------------
            // Step 1: Load the form view
            // -------------------------
            $data = [];
    
            if ($id) {
                // Editing → load existing record
                $data['question'] = $this->questions_model->read_by_id($id);
            } else {
                // Adding → empty object
            ...
            $postData = [
                ...
                'questionk' => $this->input->post('questionk', true),
                'titlek'    => $this->input->post('titlek', true),
                'questionm' => $this->input->post('questionm', true),
                'titlem'    => $this->input->post('titlem', true),
            ];
