			...
			if ($this->input->post('status') == 'Asset Dispose') {
				...
				if ($row) {
					...
					if (is_array($existingDataset)) {
						...
						$existingDataset['warranty_alert_1'] = $this->input->post('warranty_alert_1');
						$existingDataset['warranty_alert_2'] = $this->input->post('warranty_alert_2');
						...
						$updatedepartmen_feedback = array(
							...
							'warranty_alert_1' => $this->input->post('warranty_alert_1'),
							'warranty_alert_2' => $this->input->post('warranty_alert_2'),
				...
				if ($row) {
					...
					if (is_array($existingDataset)) {
						...
						$contract_alert_1 = $this->input->post('contract_alert_1');
						$contract_alert_2 = $this->input->post('contract_alert_2');
						...
						if ($contract === 'AMC') {
							...
							$existingDataset['contract_alert_1'] = $contract_alert_1;
							$existingDataset['contract_alert_2'] = $contract_alert_2;
