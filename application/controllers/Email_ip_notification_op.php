...
class Email_ip_notification_op extends CI_Controller
{
	...
	public function weeklyreport()
	{
		...
		$subject = 'Efeedor: Weekly OP feedbacks & tickets report';
	...
	public function monthlyreport()
	{
		...
		$html .= '<p>Feedback parameters Analysis:</p>
						...
						<p>Efeedor Feedback System</p>';
		$subject = 'Efeedor: Monthly OP feedbacks & tickets report';
	...
	public function weeklynpsreport()
	{
		...
		$html = '<p>Hi,</p>
				...
				<p>-</p>
				<p>Efeedor Feedback System</p>';
		$subject = 'Efeedor: Weekly NPS Analysis on OutPatients';
	...
	public function monthlynpsreport()
	{
		...
		$html = '<p>Hi,</p>
				...
				<p>-</p>
				<p>Efeedor Feedback System</p>';
		$subject = 'Efeedor: Monthly NPS Analysis on OutPatients';
	...
	public function weeklypatientreport()
	{
		...
		$html .= '<p>&nbsp;</p>
				...
				<p>-</p>
				<p>Efeedor Feedback System</p>';
		$subject = 'Efeedor: Weekly Analysis on why your outpatients chose your hospital?';
		$user = $this->get_user_by_email_activity('OP-WEEKLY-FEEDBACKS-REPORT-EMAILS');
		foreach ($user as $rowuser) {
			$emails = $rowuser->email;
			$this->mailsend($html, $subject, $emails);
	...
	public function monthlypatientreport()
	{
		...
		$html .= '<p>&nbsp;</p>
				...
				<p>-</p>
				<p>Efeedor Feedback System</p>';
		$subject = 'Efeedor: Monthly Analysis on why your outpatients chose your hospital?';
