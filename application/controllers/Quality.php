...
class Quality extends CI_Controller
{
    ...
    public function feedbacks_report_2PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '2.PSQ3a- Number of reporting errors per 1000 investigations - ' . $titleSuffix;
    ...
    public function feedbacks_report_3PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '3.PSQ3a- Percentage of adherence to safety precautions by diagnostics staffs - ' . $titleSuffix;
    ...
    public function feedbacks_report_4PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '4.PSQ3a- Medication errors rate - ' . $titleSuffix;
    ...
    public function feedbacks_report_5PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '5.PSQ3a- Percentage of medication charts with error-prone abbreviations - ' . $titleSuffix;
    ...
    public function feedbacks_report_6PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '6.PSQ3a- Percentage of in-patients developing adverse drug reaction(s) - ' . $titleSuffix;
    ...
    public function feedbacks_report_7PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '7.PSQ3a- Percentage of unplanned return to OT - ' . $titleSuffix;
    ...
    public function feedbacks_report_8PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '8.PSQ3a- Percentage of surgeries where the organisations procedure to prevent adverse events- wrong site/wrong patient/wrong surgery have been adhered to - ' . $titleSuffix;
    ...
    public function feedbacks_report_9PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '9.PSQ3a- Percentage of transfusion reactions - ' . $titleSuffix;
    ...
    public function feedbacks_report_10PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '10.PSQ3a- Standardised mortality ratio for ICU - ' . $titleSuffix;
    ...
    public function feedbacks_report_11PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '11.PSQ3a- Return to the emergency department within 72 hours with similar presenting complaints - ' . $titleSuffix;
    ...
    public function feedbacks_report_12PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '12.PSQ3a- Incidence of hospital associated pressure ulcers after admission (Bed sore per 1000 patient days) - ' . $titleSuffix;
    ...
    public function feedbacks_report_13PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '13.PSQ3b- Catheter associated urinary tract infection rate - ' . $titleSuffix;
    ...
    public function feedbacks_report_14PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '14.PSQ3b- Ventilator associated pneumonia rate - ' . $titleSuffix;
    ...
    public function feedbacks_report_15PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '15.PSQ3b- Central line - associated blood stream infection rate - ' . $titleSuffix;
    ...
    public function feedbacks_report_16PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '16.PSQ3b- Surgical site infection rate - ' . $titleSuffix;
    ...
    public function feedbacks_report_17PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '17.PSQ3b- Hand hygiene compliance rate - ' . $titleSuffix;
    ...
    public function feedbacks_report_18PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '18.PSQ3b- Percentage of cases who received appropriate prophylactic antibiotics within the specified timeframe - ' . $titleSuffix;
    ...
    public function feedbacks_report_19PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '19.PSQ3c- Percentage of re- scheduling of surgeries - ' . $titleSuffix;
    ...
    public function feedbacks_report_20PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '20.PSQ3c- Turn around time for issue of blood and blood components - ' . $titleSuffix;
    ...
    public function feedbacks_report_21PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '21.PSQ3c- Nurse-patient ratio for ICUs - ' . $titleSuffix;
    ...
    public function feedbacks_report_21aPSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '21a.PSQ3c- Nurse-patient ratio for Wards - ' . $titleSuffix;
    ...
    public function feedbacks_report_22PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '22.PSQ3c - Waiting time for out- patient consultation - ' . $titleSuffix;
    ...
    public function feedbacks_report_23PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '23.PSQ4c- Waiting time for diagnostics - ' . $titleSuffix;
    ...
    public function feedbacks_report_23aPSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '23a.PSQ4c- Waiting time for laboratory diagnostics - ' . $titleSuffix;
    ...
    public function feedbacks_report_23bPSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '23b.PSQ4c- Waiting time for X-ray diagnostics - ' . $titleSuffix;
    ...
    public function feedbacks_report_23cPSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '23c.PSQ4c- Waiting time for USG diagnostics - ' . $titleSuffix;
    ...
    public function feedbacks_report_23dPSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '23d.PSQ4c- Waiting time for CT scan diagnostics - ' . $titleSuffix;
    ...
    public function feedbacks_report_24PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '24.PSQ4c- Time taken for discharge - ' . $titleSuffix;
    ...
    public function feedbacks_report_25PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '25.PSQ4c- Percentage of medical records having incomplete and/or improper consent - ' . $titleSuffix;
    ...
    public function feedbacks_report_26PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '26.PSQ4c- Stock out rate of emergency medications - ' . $titleSuffix;
    ...
    public function feedbacks_report_27PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '27.PSQ4d- Number of variations observed in mock drills - ' . $titleSuffix;
    ...
    public function feedbacks_report_28PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '28.PSQ4d- Patient fall rate (Falls per 1000 patient days) - ' . $titleSuffix;
    ...
    public function feedbacks_report_29PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '29.PSQ4d- Percentage of near misses - ' . $titleSuffix;
    ...
    public function feedbacks_report_30PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '30.PSQ3d- Incidence of needle stick injuries - ' . $titleSuffix;
    ...
    public function feedbacks_report_31PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '31.PSQ3d- Appropriate handovers during shift change (To be done separately for doctors and nurses) - ' . $titleSuffix;
    ...
    public function feedbacks_report_32PSQ3a()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = '32.PSQ3d- Compliance rate to medication prescription in capitals - ' . $titleSuffix;
