...
class Analytics_pdf extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table_feedback = 'bf_feedback_pdf';
        $this->table_patients = 'bf_patients';
        $this->sorttime = 'asc';
        $this->setup = 'setup_pdf';
        $this->asc = 'asc';
        $this->desc = 'desc';
        $this->table_tickets = 'tickets_pdf';
        $this->open = 'Open';
        $this->closed = 'Closed';
    ...
    public function patient_feedback_analysis()
    {
        ...
        $question_list_parent = $this->post_model->setup_result($this->setup);
        $feedback_data = $this->post_model->patient_and_feedback($this->table_patients, $this->table_feedback, $this->sorttime, $this->setup);
    ...
    public function patient_satisfaction_analysis()
    {
        ...
        //print_r($dates); exit;
        $all_tickets = $this->post_model->get_tickets($this->table_feedback, $this->table_tickets, $this->sorttime);
        //print_r($all_tickets);
        $feedback_data = $this->post_model->patient_and_feedback($this->table_patients, $this->table_feedback, $this->sorttime, $this->setup);
        $days = $_SESSION['days'];
        $set = array();
...
$report[$mon]['overall'] = count($feedback_data);
    ...
    {
        //$dates = get_from_to_date();
        $department = $this->post_model->get_department($this->type, false);
        $get_tickes = $this->post_model->get_tickets($this->table_feedback, $this->table_tickets);
        //  print_r($get_tickes); 
        $report = array();
        $response = array();
    ...
    public function trend_analysis()
    {
        ...
        $sresult = $this->post_model->setup_result($this->setup);
        $ip_feedbacks_count = $this->post_model->patient_and_feedback($this->table_patients, $this->table_feedback, $this->sorttime, $this->setup);
