...
class Ipd extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['content'] = $this->load->view('ipmodules/developer', $data, true);
    ...
    public function dep_tat_edit()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP Discharge Feedback - Manage Escalation Turn Around Time';

            #------------------------------#

            $data['content'] = $this->load->view('ipmodules/dep_tat_edit', $data, true);
    ...
    public function feedback_dashboard()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- FEEDBACKS DASHBOARD';
            #------------------------------#
            $data['content'] = $this->load->view('ipmodules/feedback_dashboard', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function escalation_report()
    {
        if ($this->session->userdata('isLogIn') == false)
            redirect('login');
        $data['title'] = 'ESCALATION REPORT- IP DISCHARGE FEEDBACK TICKETS';
        $data['departments'] = $this->tickets_model->alltickets();
        #------------------------------#
        $data['content'] = $this->load->view('ipmodules/escalation_report', $data, true);
        $this->load->view('layout/main_wrapper', $data);
    }
    ...
    public function trend_analytic()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            if (!empty($result)) {
                ...
                $data['title'] = "IP CATEGORY ANALYSIS DASHBOARD - $title_category";
            } else {
                // If no result found, fallback to default title
                $data['title'] = 'IP CATEGORY ANALYSIS DASHBOARD';
            }

            #------------------------------#
            $data['content'] = $this->load->view('ipmodules/trend_analytic', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function ticket_dashboard()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- TICKETS DASHBOARD';
            #------------------------------#
            $data['content'] = $this->load->view('ipmodules/ticket_dashboard', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_page()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- NPS ANALYSIS';
            #------------------------------#
            $data['content'] = $this->load->view('ipmodules/nps_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_promoter_list()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- NPS PROMOTERS LIST';
            $data['content'] = $this->load->view('ipmodules/nps_promoter_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_detractors_list()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- NPS DETRACTORS LIST';

            $data['content'] = $this->load->view('ipmodules/nps_detractors_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_passive_list()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- NPS PASSIVES LIST';

            $data['content'] = $this->load->view('ipmodules/nps_passive_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function psat_satisfied_list()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- SATISFIED PATIENTS LIST';
            $data['content'] = $this->load->view('ipmodules/psat_satisfied_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function psat_unsatisfied_list()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- UNSATISFIED PATIENTS LIST';
            $data['content'] = $this->load->view('ipmodules/psat_unsatisfied_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function psat_page()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- PSAT ANALYSIS';
            #------------------------------#
            $data['content'] = $this->load->view('ipmodules/psat_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function department_tickets()
    {
        if ($this->session->userdata('isLogIn') == false)
            redirect('login');
        if (ismodule_active('IP') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) {

            $data['title'] = 'IP- TICKETS DASHBOARD';
            $data['content'] = $this->load->view('ipmodules/department_tickets', $data, true);
            $this->load->view('layout/main_wrapper', $data);
    ...
    public function alltickets()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- ALL TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->tickets_model->alltickets();
            //print_r($data);
            if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('ipmodules/alltickets', $data, true);
            } else {
                $data['content'] = $this->load->view('ipmodules/dephead/alltickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
    ...
    public function addressedtickets()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- ADDRESSED TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->tickets_model->addressedtickets();
            if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('ipmodules/addressedtickets', $data, true);
            } else {
                $data['content'] = $this->load->view('ipmodules/dephead/addressedtickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
    ...
    public function track()
    {
        ...
        if ($LOAD == 'inpatient_modules') {
            ...
            if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('ipmodules/ticket_track', $data, true);
            } else {
                $data['content'] = $this->load->view('ipmodules/dephead/ticket_track', $data, true);
            }
            //    $data['content'] = $this->load->view('ipmodules/ticket_track', $data, true);
    ...
    public function opentickets()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- OPEN TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->tickets_model->read();
            if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('ipmodules/opentickets', $data, true);
            } else {
                $data['content'] = $this->load->view('ipmodules/dephead/opentickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
            $this->session->set_userdata('referred_from', NULL);
        } else {
    ...
    public function closedtickets()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- CLOSED TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->tickets_model->read_close();
            if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('ipmodules/closedtickets', $data, true);
            } else {
                $data['content'] = $this->load->view('ipmodules/dephead/closedtickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
    ...
    public function feedbacks_report()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- ALL FEEDBACKS REPORT';
    ...
    public function feedbacks_report_login_apk()
    {
        ...
        $data['title'] = 'IP feedbacks collected  by ' . $userName . '';
        $data['content'] = $this->load->view('ipmodules/ip_feedbacks_report_login_apk', $data, true);
        $this->load->view('layout/main_wrapper', $data);
        // redirect('report/feedbacks_report');
    ...
    public function comments()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- PATIENT COMMENTS LIST';
    ...
    public function staff_appreciation()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- STAFF RECOGNITION REPORT';
    ...
    public function patient_feedback()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['title'] = 'IP- PATIENT' . "'" . 'S FEEDBACK';
            #------------------------------#
            if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('ipmodules/patient_feedback', $data, true);
            } else {
                $data['content'] = $this->load->view('ipmodules/dephead/patient_feedback', $data, true);
            }
    ...
    public function notifications()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            $data['content'] = $this->load->view('ipmodules/notifications_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function download_capa_report_pdf()
    {
        if (ismodule_active('IP') === true) {
            ...
            if (!empty($departments)) {
                ...
                foreach ($departments as $department) {
                    if ($department->status == 'Closed') {
                        ...
                        $dataexport[] = array(
                            // 'SL No.' => $sl,
                            'TICKET ID' => 'IPDT- ' . $department->id,
                            'PATIENT DETAILS' => ($department->feed->name ?? '') . (!empty($department->feed->patientid) ? ' (' . $department->feed->patientid . ')' : '') . '<br>' . $department->feed->ward . ' in ' . $department->feed->bedno . '<br>' . (!empty($department->feed->contactnumber) ? '<i class="fa fa-phone"></i> ' . $department->feed->contactnumber : ''),
            ...
            $pdf->SetTitle('IP DISCHARGE FEEDBACK - CAPA REPORT - ' . $tdate . ' to ' . $fdate);
            $pdf->SetSubject('IP DISCHARGE FEEDBACK - CAPA REPORT - ' . $tdate . ' to ' . $fdate);
            ...
            $html .= '<h2 style="text-align:center;">IP DISCHARGE FEEDBACK- CAPA REPORT </h2>';
            ...
            $fileName = 'EF- IP CAPA REPORT - ' . $tdate . ' to ' . $fdate . '.pdf';
    ...
    public function ticket_resolution_rate()
    {
        ...
        if (ismodule_active('IP') === true) {
            ...
            #------------------------------#
            $data['content'] = $this->load->view('ipmodules/ticket_analisys_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
