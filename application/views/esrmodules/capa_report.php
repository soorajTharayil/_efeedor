			...
			<div class="col-lg-12">
				<div class="panel panel-default ">
					...
					<div class="panel-body">
						...
						<table class="esrcapa table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th style="white-space: nowrap;">
										Service Request Details</th>
									<!-- <th style="white-space: nowrap;">Incident Category</th> -->
									<th style="white-space: nowrap;">Request Timeline & History</th>
									<!-- <th style="white-space: nowrap;">
									...
									?>
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom"
											...
											<td style="overflow-wrap: break-word; word-break: normal;">
												...
												echo '<strong>Request ID:</strong> ' . ($department->id) . '<br>' .
												     '<strong>Service request:</strong> ' . ($issue ? $issue : 'Ticket was transferred') . '<br>' .
													'<strong>Category :</strong> ' . ($department->department->description) . '<br>' .
