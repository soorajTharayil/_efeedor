<div class="content">
	<div class="row">
		...
		$days = $dates['days'];
		$all_feedback = $this->efeedor_model->get_feedback('bf_employees_esr', 'bf_feedback_esr', $fdatet, $tdate);
		$sresult = $this->efeedor_model->setup_result('setup_esr');
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<a href="<?php echo base_url($this->uri->segment(1) . '/alltickets'); ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr', 'isr_view_list'); ?></a>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('isr', 'isr_open_requests'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $opentickect_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-envelope-open-o"></i>
							</div>
							<a href="<?php echo base_url($this->uri->segment(1) . '/opentickets'); ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr', 'isr_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
		<?php } ?>
		<?php if (ismodule_active('ISR') === true  && isfeature_active('IN-REJECTED-REQUESTS') === true) { ?>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small">Rejected request <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $addressedtickect_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-reply"></i>
							</div>
							<a href="<?php echo $int_link_rejecttickets; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr', 'isr_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('isr', 'isr_addressed_requests'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $addressedtickect_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-reply"></i>
							</div>
							<a href="<?php echo base_url($this->uri->segment(1) . '/addressedtickets'); ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr', 'isr_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<a href="<?php echo base_url($this->uri->segment(1) . '/assignedtickets'); ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('inc', 'inc_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<a href="<?php echo base_url($this->uri->segment(1) . '/closedtickets'); ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr', 'isr_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="panel-body" style="height: 150px; display:inline;">
						<div class="alert alert-success">
							<span style="font-size: 15px">
								<?php echo lang_loader('isr', 'isr_you_have_received_least_complaints_in'); ?> <strong><?php echo $lowest_complain; ?></strong>

							</span>
						</div>
						<div class="alert alert-warning ">
							<span style="font-size: 15px">
								<?php echo lang_loader('isr', 'isr_you_have_received_most_complaints_in'); ?><strong><?php echo $highest_complain; ?></strong>
	...
	<div class="row">
		...
		<div class="col-lg-7">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('isr', 'isr_requests_analysis'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('isr', 'isr_request_analysis_tooltip'); ?>."><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></h3>
				</div>
			...
			tooltips: {
				...
				callbacks: {
					label: function(tooltipItems, data, labels) {
						...
						multistringText.push(res[tooltipItems.index] + ' Requests');
