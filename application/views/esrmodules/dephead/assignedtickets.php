		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success"  target="_blank" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('isr','isr_download_open_requests_report_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_' . ($this->uri->segment(2)) ?>">
					...
					<?php   if (isfeature_active('ISR-REQUESTS-DASHBOARD') === true) { ?>
						...
						<table class="esrticketsopen table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<?php if (isr_tat('open_ticket') === true) { ?>
										...
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
                                            ...
                                            <?php if (ismodule_active('ISR') === true && isfeature_active('OPEN-REQUESTS') === true) { ?>
                                                <td style="align-items: center;">
                                                    <a style="font-size: 14px;" href="<?php echo base_url($this->uri->segment(1) . "/track/$department->id") ?>" data-placement="bottom"  data-toggle="tooltip" title="<?php echo $tool; ?>"  class="btn btn-sm btn-block <?php echo $color; ?>"><?php echo $department->status; ?> <i style="font-size:x-small;  " class="fa fa-edit"></i></a>
                                                </td>
                                            <?php } ?>
										</tr>
										<?php $sl++; ?>
