                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="font-size: 17px;">ISR and Incident floor wise controls</th>
                            </tr>
                        </thead>
                        <tbody>
                                                ...
                                                <?php } elseif ($module === 'QUALITY KPI MODULES' && $type === 'FEATURE') { ?>
                                                    ...
                                                    <div class="panel-group" id="subAccordion<?php echo md5($module . $type); ?>">
                                                        ...
                                                        $manualSubSections = [
                                                            ...
                                                            'Emergency Department' => array_merge([230], [234], [239], [246], [523], [528], range(630, 634), range(642, 643), [681], [683]),
                                                            'Cardiology' => [238],
                                                            'Clinical Nutrition & Dietetics' => array_merge([232], [636], [862]),
                                                            'Lab Service' => array_merge([237], [250], range(255, 257), [264], range(358, 359), [644], [648], range(711, 716)),
                                                            ...
                                                            'Housekeeping' => array_merge([518], range(719, 722), [724], range(731, 732), range(821, 823), [825], range(827, 828), range(830, 831)),
                                                            ...
                                                            'Security & Safety' => array_merge(range(559, 561), [569], [571], [710], [736], [727]),
                                                            'Pharmacy' => array_merge(range(562, 564), [628], range(694, 695), [864]),
                                                            'SCM-Store' => [565],
                                                            'SCM-Purchase' => [566],
                                                            ...
                                                            'F & B Services' => array_merge(range(728, 729), [735], [829]),
