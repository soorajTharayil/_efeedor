                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; font-size: 15px;">
                                                    ...
                                                    if ($user->lastname == 'ADMIN' || $user->lastname == 'SUPER ADMIN') {
                                                        ...
                                                        // Decode floor ward details
                                                        $floorDetails = json_decode($user->floor_ward, true);
                                                        $floorText = !empty($floorDetails) ? implode(', ', $floorDetails) : '';
                                                        ...
                                                        // Display floor details only if available
                                                        if ($floorText) {
                                                            echo '<b>Tagged to: ' . $floorText . '</b>';
                                                        }
