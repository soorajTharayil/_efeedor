					...
					<div class="row">
						<div class="col-md-8 col-sm-12 col-lg-12">
							...
							<div class="form-group row" id="empid">
								<label for="empid" class="col-xs-3 col-form-label">Employee Id <i class="text-danger">*</i></label>
								<div class="col-xs-9">
									<input name="empid" type="text" class="form-control" id="empid" placeholder="Enter Employee Id" value="<?php echo $department->emp_id ?>" required>
								</div>
							</div>
