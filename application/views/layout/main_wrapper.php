...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <?php if (ismodule_active('GLOBAL') === true && (isfeature_active('ADMINS-OVERALL-PAGE') === true || isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true)) { ?>
                            <li class="treeview">
                                <a href="<?php echo base_url('dashboard/welcome') ?>"> <i
                                        class="fa fa-globe"></i><span><?php echo lang_loader('global', 'global_overall_summary_s'); ?></span></a>
                            </li>
                        <?php } ?>
                        <?php if (isfeature_active('ADF-FEEDBACKS-DASHBOARD') === true || isfeature_active('IP-FEEDBACKS-DASHBOARD') === true || isfeature_active('PC-COMPLAINTS-DASHBOARD') === true || isfeature_active('OP-FEEDBACKS-DASHBOARD') === true || isfeature_active('ISR-REQUESTS-DASHBOARD') === true || isfeature_active('INC-INCIDENTS-DASHBOARD') === true || isfeature_active('SG-STAFF-GRIEVANCES-DASHBOARD') === true || isfeature_active('ASSET-DASHBOARD') === true) { ?>
                            ...
                            <?php if ($this->uri->segment(1) != "ipd" || $this->uri->segment(1) != "opf" || $this->uri->segment(1) != "pc" || $this->uri->segment(1) != "isr" || $this->uri->segment(1) != "asset") { ?>
                                <li
                                    class="treeview <?php echo (($this->uri->segment(1) == 'dashboard' || $this->uri->segment(1) == 'setupefeedor') ? "active" : null) ?>">
                                    <!-- <a href="#"> -->
                                    <a> <i
                                            class="fa fa-bars"></i><span><?php echo lang_loader('global', 'global_modules'); ?></span>
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-FEEDBACKS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("admissionfeedback/feedback_dashboard") ?>"><?php echo lang_loader('global', 'global_admission_feedbacks'); ?></a>
                                            </li>
                                        <?php } ?>

                                        <?php if (ismodule_active('IP') === true && isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("ipd/feedback_dashboard") ?>"><?php echo lang_loader('global', 'global_ipd_feedbacks'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('PCF') === true && isfeature_active('PC-COMPLAINTS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("pc/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_inp_complaints'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-FEEDBACKS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("post/feedback_dashboard") ?>"><?php echo lang_loader('global', 'global_pdf_feedbacks'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('OP') === true && isfeature_active('OP-FEEDBACKS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("opf/feedback_dashboard") ?>"><?php echo lang_loader('global', 'global_ops_feedbacks'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('ISR') === true && isfeature_active('ISR-REQUESTS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("isr/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_ir_request'); ?></a>
                                            </li>
                                        <?php } ?>
                                        ...
                                        <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('SG-STAFF-GRIEVANCES-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("grievance/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_sgs_report'); ?></a>
                                            </li>
                                        <?php } ?>
                            ...
                            <?php if ($this->uri->segment(2) != "welcome") { ?>
                                ...
                                <?php if (ismodule_active('IP') === true && isfeature_active('IP-FEEDBACKS-DASHBOARD') === true && $this->uri->segment(1) == 'ipd') { ?>
                                    <?php if (in_array('ip_dashboard', $this->session->userdata['active_menu'])) { ?>
                                        <li
                                            class="<?php echo (($this->uri->segment(2) == 'feedback_dashboard' && $this->uri->segment(1) == 'ipd') ? "active" : null) ?>">
                                            <a href="<?php echo base_url('ipd/feedback_dashboard') ?>">
                                                <i class="fa fa-home"></i> <span><?php echo lang_loader('global', 'global_dashboard'); ?>
                                                </span>
                                    ...
                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-TICKETS-DASHBOARD') === true && $this->uri->segment(1) == 'ipd') { ?>
                                        <?php if (in_array('ip_ticket', $this->session->userdata['active_menu'])) { ?>
                                            ...
                                            <li
                                                ...
                                                <ul class="treeview-menu">
                                                    <li><a
                                                            href="<?php echo base_url("ipd/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                                    </li>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-TOTAL-TICKETS') === true) { ?>
                                                        <li><a href="<?php echo base_url("ipd/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-OPEN-TICKETS') === true) { ?>
                                                        <li><a href="<?php echo base_url("ipd/opentickets") ?>"><?php echo lang_loader('global', 'global_open_tickets'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-CLOSED-TICKETS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("ipd/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_tickets'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                    ...
                                    <?php if (ismodule_active('IP') === true && $this->uri->segment(1) == 'ipd' && (isfeature_active('IP-FEEDBACK-REPORTS') === true || isfeature_active('IP-STAFF-APPRECIATION-REPORTS') === true || isfeature_active('IP-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('ip_reports', $this->session->userdata['active_menu'])) { ?>
                                            ...
                                            <li
                                                class="treeview  <?php echo (($this->uri->segment(1) == 'ipd' && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "feedbacks_report" || $this->uri->segment(2) == "staff_appreciation" || $this->uri->segment(2) == "capa_report")) ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                        <i class="fa fa-angle-left pull-right"></i>
                                                    </span>
                                                </a>
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-FEEDBACK-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("ipd/feedbacks_report") ?>"><?php echo lang_loader('global', 'global_feedback_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-STAFF-APPRECIATION-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("ipd/staff_appreciation") ?>"><?php echo lang_loader('global', 'global_staff_appreciation'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("ipd/capa_report") ?>"><?php echo lang_loader('global', 'global_capa_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                            ...
                                            <li
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-NPS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("ipd/nps_page") ?>"><?php echo lang_loader('global', 'global_nps'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('IP') === true && isfeature_active('IP-PSAT') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("ipd/psat_page") ?>"><?php echo lang_loader('global', 'global_psat'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                ...
                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-FEEDBACKS-DASHBOARD') === true && $this->uri->segment(1) == 'post') { ?>
                                    ...
                                    <li
                                        class="<?php echo (($this->uri->segment(2) == 'feedback_dashboard' && $this->uri->segment(1) == 'post') ? "active" : null) ?>">
                                    ...
                                    <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-TICKETS-DASHBOARD') === true && $this->uri->segment(1) == 'post') { ?>
                                        ...
                                        <li
                                            class="treeview <?php echo (($this->uri->segment(1) == 'post' && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "ticket_resolution_rate" || $this->uri->segment(2) == "average_resolution_time" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "ticket_dashboard" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                            <a href="#">
                                                <i class="fa fa-ticket"></i> <span><?php echo lang_loader('global', 'global_tickets'); ?>
                                                </span>
                                                <span class="pull-right-container">
                                            ...
                                            <ul class="treeview-menu">
                                                <li><a
                                                        href="<?php echo base_url("post/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                                </li>
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-TOTAL-TICKETS') === true) { ?>
                                                    <li><a href="<?php echo base_url("post/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                                                        </a></li>
                                                <?php } ?>
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-OPEN-TICKETS') === true) { ?>
                                                    <li><a href="<?php echo base_url("post/opentickets") ?>"><?php echo lang_loader('global', 'global_open_tickets'); ?>
                                                        </a></li>
                                                <?php } ?>
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-CLOSED-TICKETS') === true) { ?>
                                                    <li><a
                                                            href="<?php echo base_url("post/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_tickets'); ?></a>
                                                    </li>
                                                <?php } ?>
                                    ...
                                    <?php if (ismodule_active('PDF') === true && $this->uri->segment(1) == 'post' && (isfeature_active('PDF-FEEDBACK-REPORTS') === true || isfeature_active('PDF-STAFF-APPRECIATION-REPORTS') === true || isfeature_active('PDF-CAPA-REPORTS') === true)) { ?>
                                        ...
                                        <li
                                            class="treeview  <?php echo (($this->uri->segment(1) == 'post' && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "feedbacks_report" || $this->uri->segment(2) == "staff_appreciation" || $this->uri->segment(2) == "capa_report")) ? "active" : null) ?>">
                                            <a href="#">
                                                <i class="fa fa-bar-chart"></i>
                                                <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                <span class="pull-right-container">
                                            ...
                                            <ul class="treeview-menu">
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-FEEDBACK-REPORTS') === true) { ?>
                                                    <li><a
                                                            href="<?php echo base_url("post/feedbacks_report") ?>"><?php echo lang_loader('global', 'global_feedback_report'); ?></a>
                                                    </li>
                                                <?php } ?>
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-STAFF-APPRECIATION-REPORTS') === true) { ?>
                                                    <li><a
                                                            href="<?php echo base_url("post/staff_appreciation") ?>"><?php echo lang_loader('global', 'global_staff_appreciation'); ?></a>
                                                    </li>
                                                <?php } ?>
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-CAPA-REPORTS') === true) { ?>
                                                    <li><a
                                                            href="<?php echo base_url("post/capa_report") ?>"><?php echo lang_loader('global', 'global_capa_report'); ?></a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </li>
                                    ...
                                    <?php if (ismodule_active('PDF') === true && $this->uri->segment(1) == 'post' && (isfeature_active('PDF-NPS') === true || isfeature_active('PDF-PSAT') === true)) { ?>
                                        <li
                                            class="treeview <?php echo (($this->uri->segment(1) == 'post' && ($this->uri->segment(2) == "nps_page" || $this->uri->segment(2) == "nps_passive_list" || $this->uri->segment(2) == "nps_detractors_list" || $this->uri->segment(2) == "nps_promoter_list" || $this->uri->segment(2) == "psat_page" || $this->uri->segment(2) == "psat_satisfied_list" || $this->uri->segment(2) == "psat_unsatisfied_list")) ? "active" : null) ?> ">
                                            <a href="#">
                                                <i class="fa fa-pie-chart"></i>
                                                <span><?php echo lang_loader('global', 'global_analytics'); ?> </span>
                                                <span class="pull-right-container">
                                            ...
                                            <ul class="treeview-menu">
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-NPS') === true) { ?>
                                                    <li><a
                                                            href="<?php echo base_url("post/nps_page") ?>"><?php echo lang_loader('global', 'global_nps'); ?></a>
                                                    </li>
                                                <?php } ?>
                                                <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-PSAT') === true) { ?>
                                                    <li><a
                                                            href="<?php echo base_url("post/psat_page") ?>"><?php echo lang_loader('global', 'global_psat'); ?></a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </li>
                                ...
                                <?php if (ismodule_active('OP') === true || $this->uri->segment(1) == 'opf') { ?>
                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-FEEDBACKS-DASHBOARD') === true) { ?>
                                        <?php if (in_array('op_dashboard', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="<?php echo (($this->uri->segment(2) == 'feedback_dashboard' && $this->uri->segment(1) == 'opf') ? "active" : null) ?>">
                                    ...
                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-TICKETS-DASHBOARD') === true && $this->uri->segment(1) == 'opf') { ?>
                                        <?php if (in_array('op_ticket', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'opf' && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "ticket_resolution_rate" || $this->uri->segment(2) == "average_resolution_time" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "ticket_dashboard" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets") ? "active" : null) ?> ">
                                                <a href="#">
                                                    <i class="fa fa-ticket"></i> <span><?php echo lang_loader('global', 'global_tickets'); ?>
                                                    </span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-TICKETS-DASHBOARD') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("opf/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-TOTAL-TICKETS') === true) { ?>
                                                        <li><a href="<?php echo base_url("opf/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-OPEN-TICKETS') === true) { ?>
                                                        <li><a href="<?php echo base_url("opf/opentickets") ?>"><?php echo lang_loader('global', 'global_open_tickets'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-CLOSED-TICKETS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("opf/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_tickets'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('OP') === true && $this->uri->segment(1) == 'opf' && (isfeature_active('OP-FEEDBACK-REPORTS') === true || isfeature_active('OP-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('op_reports', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview  <?php echo ($this->uri->segment(1) == 'opf' && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "feedbacks_report" || $this->uri->segment(2) == "capa_report") ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-FEEDBACK-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("opf/feedbacks_report") ?>"><?php echo lang_loader('global', 'global_feedback_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("opf/capa_report") ?>"><?php echo lang_loader('global', 'global_capa_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('OP') === true && $this->uri->segment(1) == 'opf' && (isfeature_active('OP-NPS') === true || isfeature_active('OP-PSAT') === true)) { ?>
                                        <?php if (in_array('op_analysis', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo (($this->uri->segment(1) == 'opf' && ($this->uri->segment(2) == "nps_page" || $this->uri->segment(2) == "nps_passive_list" || $this->uri->segment(2) == "nps_detractors_list" || $this->uri->segment(2) == "nps_promoter_list" || $this->uri->segment(2) == "psat_page" || $this->uri->segment(2) == "psat_satisfied_list" || $this->uri->segment(2) == "psat_unsatisfied_list")) ? "active" : null) ?> ">
                                                <a href="#">
                                                    <i class="fa fa-pie-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_analytics'); ?> </span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-NPS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("opf/nps_page") ?>"><?php echo lang_loader('global', 'global_nps'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('OP') === true && isfeature_active('OP-PSAT') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("opf/psat_page") ?>"><?php echo lang_loader('global', 'global_psat'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                ...
                                <?php if (ismodule_active('PCF') === true || $this->uri->segment(1) == 'pc') { ?>
                                            ...
                                            <li
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('PCF') === true && isfeature_active('COMPLAINTS-DASHBOARD') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("pc/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_complaint_dash'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('PCF') === true && isfeature_active('TOTAL-COMPLAINTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("pc/alltickets") ?>"><?php echo lang_loader('global', 'global_all_complaints'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('PCF') === true && isfeature_active('OPEN-COMPLAINTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("pc/opentickets") ?>"><?php echo lang_loader('global', 'global_open_complaints'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('PCF') === true && isfeature_active('CLOSED-COMPLAINTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("pc/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_complaints'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('PCF') === true && $this->uri->segment(1) == 'pc' && (isfeature_active('SEARCH-COMPLAINTS') === true || isfeature_active('PC-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('int_reports', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'pc' && ($this->uri->segment(2) == "capa_report" || $this->uri->segment(2) == "patient_complaint") ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('PCF') === true && isfeature_active('SEARCH-COMPLAINTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("pc/patient_complaint") ?>"><?php echo lang_loader('global', 'global_search_complaint'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                ...
                                <?php if (ismodule_active('ADF') === true || $this->uri->segment(1) == 'admissionfeedback') { ?>
                                    <?php if (in_array('adf_dashboard', $this->session->userdata['active_menu'])) { ?>
                                        <li
                                            class="<?php echo (($this->uri->segment(2) == 'feedback_dashboard' && $this->uri->segment(1) == 'admissionfeedback') ? "active" : null) ?>">
                                    ...
                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TICKETS-DASHBOARD') === true && $this->uri->segment(1) == 'admissionfeedback') { ?>
                                        <?php if (in_array('adf_ticket', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo (($this->uri->segment(1) == 'admissionfeedback' && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "ticket_resolution_rate" || $this->uri->segment(2) == "average_resolution_time" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "ticket_dashboard" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                                <a href="#">
                                                    <i class="fa fa-ticket"></i> <span><?php echo lang_loader('global', 'global_tickets'); ?>
                                                    </span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TICKETS-DASHBOARD') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("admissionfeedback/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TOTAL-TICKETS') === true) { ?>
                                                        <li><a href="<?php echo base_url("admissionfeedback/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-OPEN-TICKETS') === true) { ?>
                                                        <li><a href="<?php echo base_url("admissionfeedback/opentickets") ?>"><?php echo lang_loader('global', 'global_open_tickets'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-CLOSED-TICKETS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("admissionfeedback/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_tickets'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('ADF') === true && $this->uri->segment(1) == 'admissionfeedback' && (isfeature_active('ADF-FEEDBACK-REPORTS') === true || isfeature_active('ADF-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('adf_reports', $this->session->userdata['active_menu'])) { ?>
                                            ...
                                            <li
                                                class="treeview  <?php echo (($this->uri->segment(1) == 'admissionfeedback' && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "feedbacks_report" || $this->uri->segment(2) == "staff_appreciation" || $this->uri->segment(2) == "capa_report")) ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-FEEDBACK-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("admissionfeedback/feedbacks_report") ?>"><?php echo lang_loader('global', 'global_feedback_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("admissionfeedback/capa_report") ?>"><?php echo lang_loader('global', 'global_capa_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                            ...
                                            <li
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-NPS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("admissionfeedback/nps_page") ?>"><?php echo lang_loader('global', 'global_nps'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-PSAT') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("admissionfeedback/psat_page") ?>"><?php echo lang_loader('global', 'global_psat'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                ...
                                <?php if (ismodule_active('ISR') === true || $this->uri->segment(1) == 'isr') { ?>
                                    <?php if (ismodule_active('ISR') === true && isfeature_active('REQUESTS-DASHBOARD') === true && $this->uri->segment(1) == 'isr') { ?>
                                        <?php if (in_array('esr_dashboard', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'isr' && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "ticket_resolution_rate" || $this->uri->segment(2) == "average_resolution_time" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "ticket_dashboard" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets") ? "active" : null) ?> ">
                                                <a href="#">
                                                    <i class="fa fa-ticket"></i>
                                                    <span><?php echo lang_loader('global', 'global_ir_request'); ?></span>
                                                    <span class="pull-right-container">
                                                        <i class="fa fa-angle-left pull-right"></i>
                                                    </span>
                                                </a>
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('REQUESTS-DASHBOARD') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("isr/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_request_dashboard'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('TOTAL-REQUESTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("isr/alltickets") ?>"><?php echo lang_loader('global', 'global_all_requests'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('OPEN-REQUESTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("isr/opentickets") ?>"><?php echo lang_loader('global', 'global_open_requests'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('CLOSED-REQUESTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("isr/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_requests'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('ISR') === true && $this->uri->segment(1) == 'isr' && (isfeature_active('SEARCH-REQUESTS') === true || isfeature_active('ISR-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('esr_reports', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'isr' && ($this->uri->segment(2) == "capa_report" || $this->uri->segment(2) == "employee_complaint") ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('SEARCH-REQUESTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("isr/employee_complaint") ?>"><?php echo lang_loader('global', 'global_search_requests'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('ISR-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("isr/capa_report") ?>"><?php echo lang_loader('global', 'global_action_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('ISR') === true && isfeature_active('ISR-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                ...
                                <?php if (ismodule_active('INCIDENT') === true || $this->uri->segment(1) == 'incident') { ?>
                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('INCIDENTS-DASHBOARD') === true && $this->uri->segment(1) == 'incident') { ?>
                                        <?php if (in_array('inci_dashboard', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'incident' && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "ticket_resolution_rate" || $this->uri->segment(2) == "average_resolution_time" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "ticket_dashboard" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets") ? "active" : null) ?> ">
                                                <a href="#">
                                                    <i class="fa fa-ticket"></i>
                                                    <span><?php echo lang_loader('global', 'global_incidents'); ?></span>
                                                    <span class="pull-right-container">
                                                        <i class="fa fa-angle-left pull-right"></i>
                                                    </span>
                                                </a>
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('INCIDENTS-DASHBOARD') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("incident/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_inc_dash'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('TOTAL-INCIDENTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("incident/alltickets") ?>"><?php echo lang_loader('global', 'global_all_inc'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('OPEN-INCIDENTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("incident/opentickets") ?>"><?php echo lang_loader('global', 'global_open_inc'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('CLOSED-INCIDENTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("incident/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_inc'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('INCIDENT') === true && $this->uri->segment(1) == 'incident' && (isfeature_active('SEARCH-INCIDENTS') === true || isfeature_active('IN-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('inci_reports', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'incident' && ($this->uri->segment(2) == "capa_report" || $this->uri->segment(2) == "employee_complaint") ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('SEARCH-INCIDENTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("incident/employee_complaint") ?>"><?php echo lang_loader('global', 'global_search_inc'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('IN-CAPA-REPORTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("incident/capa_report") ?>">Incident Report</a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('INCIDENT') === true && isfeature_active('IN-CAPA-REPORTS') === true) { ?>
                                                        <li><a href="<?php echo base_url("incident/escalation_report") ?>">Escalation Report</a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                ...
                                <?php if (ismodule_active('GRIEVANCE') === true || $this->uri->segment(1) == 'grievance') { ?>
                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('GRIEVANCES-DASHBOARD') === true && $this->uri->segment(1) == 'grievance') { ?>
                                        <?php if (in_array('grievance_dashboard', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'grievance' && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "ticket_resolution_rate" || $this->uri->segment(2) == "average_resolution_time" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "ticket_dashboard" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets") ? "active" : null) ?> ">
                                                <a href="#">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('GRIEVANCES-DASHBOARD') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("grievance/ticket_dashboard") ?>"><?php echo lang_loader('global', 'global_grievances_dash'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('TOTAL-GRIEVANCES') === true) { ?>
                                                        <li><a href="<?php echo base_url("grievance/alltickets") ?>"><?php echo lang_loader('global', 'global_all_gs'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('OPEN-GRIEVANCES') === true) { ?>
                                                        <li><a href="<?php echo base_url("grievance/opentickets") ?>"><?php echo lang_loader('global', 'global_open_grievance'); ?>
                                                            </a></li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('CLOSED-GRIEVANCES') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("grievance/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_grievance'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                                    ...
                                    <?php if (ismodule_active('GRIEVANCE') === true && $this->uri->segment(1) == 'grievance' && (isfeature_active('SEARCH-GRIEVANCES') === true || isfeature_active('SG-CAPA-REPORTS') === true)) { ?>
                                        <?php if (in_array('grievance_reports', $this->session->userdata['active_menu'])) { ?>
                                            <li
                                                class="treeview <?php echo ($this->uri->segment(1) == 'grievance' && ($this->uri->segment(2) == "capa_report" || $this->uri->segment(2) == "employee_complaint") ? "active" : null) ?>">
                                                <a href="#">
                                                    <i class="fa fa-bar-chart"></i>
                                                    <span><?php echo lang_loader('global', 'global_reports'); ?></span>
                                                    <span class="pull-right-container">
                                                ...
                                                <ul class="treeview-menu">
                                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('SEARCH-GRIEVANCES') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("grievance/employee_complaint") ?>"><?php echo lang_loader('global', 'global_search_grievances'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('SG-CAPA-REPORTS') === true) { ?>
                                                        <li><a
                                                                href="<?php echo base_url("grievance/capa_report") ?>"><?php echo lang_loader('global', 'global_action_report'); ?></a>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </li>
                        ...
                        <?php if (ismodule_active('GLOBAL') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) { ?>
                            <?php if ($this->uri->segment(1) != "ipd" || $this->uri->segment(1) != "opf" || $this->uri->segment(1) != "pc" || $this->uri->segment(1) != "isr") { ?>
                                <li
                                    class="treeview <?php echo (($this->uri->segment(2) == 'welcome' || $this->uri->segment(1) == 'setupefeedor') ? "active" : null) ?>">
                                    <!-- <a href="#"> -->
                                    <a href="<?php echo base_url('dashboard/welcome') ?>"> <i
                                            class="fa fa-area-chart"></i><span><?php echo lang_loader('global', 'global_ticket_dash'); ?></span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TICKETS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("admissionfeedback/department_tickets") ?>"><?php echo lang_loader('global', 'global_adfs_tickets'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('IP') === true && isfeature_active('IP-TICKETS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("ipd/department_tickets") ?>"><?php echo lang_loader('global', 'global_ips_tickets'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('PCF') === true && isfeature_active('COMPLAINTS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("pc/department_tickets") ?>"><?php echo lang_loader('global', 'global_inp_complaints'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-TICKETS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("post/department_tickets") ?>"><?php echo lang_loader('global', 'global_pdf_ticketss'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('OP') === true && isfeature_active('OP-TICKETS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("opf/department_tickets") ?>"><?php echo lang_loader('global', 'global_ops_tickets'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('ISR') === true && isfeature_active('REQUESTS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("isr/department_tickets") ?>"><?php echo lang_loader('global', 'global_ir_request'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('INCIDENT') === true && isfeature_active('INCIDENTS-DASHBOARD') === true) { ?>
                                            <li><a
                            ...
                            <?php if (ismodule_active('IP') === true && isfeature_active('IP-TICKETS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "ipd") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "ipd") && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i>
                                        <span><?php echo lang_loader('global', 'global_ips_tickets'); ?> </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('IP') === true && isfeature_active('IP-TICKETS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("ipd/department_tickets") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('IP') === true && isfeature_active('IP-TOTAL-TICKETS') === true) { ?>
                                            <li><a href="<?php echo base_url("ipd/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                            ...
                            <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-TICKETS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "post") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "post") && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i>
                                        <span><?php echo lang_loader('global', 'global_pdf_ticketss'); ?> </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-TICKETS-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("post/department_tickets") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('PDF') === true && isfeature_active('PDF-TOTAL-TICKETS') === true) { ?>
                                            <li><a href="<?php echo base_url("post/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                            ...
                            <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TICKETS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "admissionfeedback") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "admissionfeedback") && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i>
                                        <span><?php echo lang_loader('global', 'global_adfs_tickets'); ?> </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TICKETS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("admissionfeedback/department_tickets") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('ADF') === true && isfeature_active('ADF-TOTAL-TICKETS') === true) { ?>
                                            <li><a href="<?php echo base_url("admissionfeedback/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                            ...
                            <?php if (ismodule_active('OP') === true && isfeature_active('OP-TICKETS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "opf") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "opf") && ($this->uri->segment(2) == "patient_feedback" || $this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i>
                                        <span><?php echo lang_loader('global', 'global_ops_tickets'); ?> </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('OP') === true && isfeature_active('OP-TICKETS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("opf/department_tickets") ?>"><?php echo lang_loader('global', 'global_ticket_dashboard'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('OP') === true && isfeature_active('OP-TOTAL-TICKETS') === true) { ?>
                                            <li><a href="<?php echo base_url("opf/alltickets") ?>"><?php echo lang_loader('global', 'global_all_tickets'); ?>
                            ...
                            <?php if (ismodule_active('PCF') === true && isfeature_active('COMPLAINTS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "pc") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "pc") && ($this->uri->segment(2) == "patient_complaint" || $this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i>
                                        <span><?php echo lang_loader('global', 'global_patient_s_complaints'); ?> </span>
                                        <span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('PCF') === true && isfeature_active('COMPLAINTS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("pc/department_tickets") ?>"><?php echo lang_loader('global', 'global_complaint_dash'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('PCF') === true && isfeature_active('TOTAL-COMPLAINTS') === true) { ?>
                                            <li><a href="<?php echo base_url("pc/alltickets") ?>"><?php echo lang_loader('global', 'global_all_complaints'); ?>
                            ...
                            <?php if (ismodule_active('ISR') === true && isfeature_active('REQUESTS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "isr") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "isr") && ($this->uri->segment(2) == "employee_complaint" || $this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i> <span><?php echo lang_loader('global', 'global_ir_request'); ?>
                                        </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('ISR') === true && isfeature_active('REQUESTS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("isr/department_tickets") ?>"><?php echo lang_loader('global', 'global_request_dashboard'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('ISR') === true && isfeature_active('TOTAL-REQUESTS') === true) { ?>
                                            <li><a href="<?php echo base_url("isr/alltickets") ?>"><?php echo lang_loader('global', 'global_all_requests'); ?>
                            ...
                            <?php if (ismodule_active('INCIDENT') === true && isfeature_active('INCIDENTS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "incident") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "incident") && ($this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i> <span><?php echo lang_loader('global', 'global_incidents'); ?>
                                        </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('INCIDENT') === true && isfeature_active('INCIDENTS-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("incident/department_tickets") ?>"><?php echo lang_loader('global', 'global_inc_dash'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('INCIDENT') === true && isfeature_active('TOTAL-INCIDENTS') === true) { ?>
                                            <li><a href="<?php echo base_url("incident/alltickets") ?>"><?php echo lang_loader('global', 'global_all_inc'); ?>
                            ...
                            <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('GRIEVANCES-DASHBOARD') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true && $this->uri->segment(1) == "grievance") { ?>
                                ...
                                <li
                                    class="treeview <?php echo ((($this->uri->segment(1) == "grievance") && ($this->uri->segment(2) == "employee_complaint" || $this->uri->segment(2) == "track" || $this->uri->segment(2) == "addressedtickets" || $this->uri->segment(2) == "department_tickets" || $this->uri->segment(2) == "alltickets" || $this->uri->segment(2) == "opentickets" || $this->uri->segment(2) == "closedtickets")) ? "active" : null) ?> ">
                                    <a href="#">
                                        <i class="fa fa-ticket"></i>
                                        <span><?php echo lang_loader('global', 'global_gievance_ticket'); ?> </span>
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('GRIEVANCES-DASHBOARD') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("grievance/department_tickets") ?>"><?php echo lang_loader('global', 'global_grievance_dash'); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('TOTAL-GRIEVANCES') === true) { ?>
                                            <li><a href="<?php echo base_url("grievance/alltickets") ?>"><?php echo lang_loader('global', 'global_all_g'); ?>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('OPEN-GRIEVANCES') === true) { ?>
                                            <li><a href="<?php echo base_url("grievance/opentickets") ?>"><?php echo lang_loader('global', 'global_open_g'); ?>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (ismodule_active('GRIEVANCE') === true && isfeature_active('CLOSED-GRIEVANCES') === true) { ?>
                                            <li><a
                                                    href="<?php echo base_url("grievance/closedtickets") ?>"><?php echo lang_loader('global', 'global_closed_g'); ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                            ...
                            <?php } ?>
                            <li
                                class="treeview <?php echo (($this->uri->segment(2) == "departmenthead") ? "active" : null) ?> ">
                                <a href="<?php echo base_url("dashboard/departmenthead") ?>">
                                    <i
                                        class="fa fa-sitemap"></i><span><?php echo lang_loader('global', 'global_your_dep'); ?></span>
                                </a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (ismodule_active('GLOBAL') === true && isfeature_active('CONSOLIDATED-REPORT') === true && !($this->uri->segment(1) == 'asset' && (ismodule_active('ASSET') === true || isfeature_active('ASSET-DASHBOARD') === true))) { ?>
                            ...
                            <li class="treeview <?php echo (($this->uri->segment(1) == "view") ? "active" : null) ?>"
                                data-toggle="tooltip" data-placement="right"
                                title="View <?php echo lang_loader('global', 'global_consolidated_report'); ?>">
                                <a href="<?php echo base_url("view/consolidated_report") ?>" target="_blank"> <i
                                        class="fa fa-file"></i><span><?php echo lang_loader('global', 'global_consolidated_report'); ?></span></a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (ismodule_active('GLOBAL') === true && isfeature_active('ALL-DOWNLOADS') === true && !($this->uri->segment(1) == 'asset' && (ismodule_active('ASSET') === true || isfeature_active('ASSET-DASHBOARD') === true))) { ?>
                            ...
                            <li class="treeview <?php echo (($this->uri->segment(1) == "view") ? "active" : null) ?>"
                                data-toggle="tooltip" data-placement="right"
                                title="View <?php echo lang_loader('global', 'global_all_downloads'); ?>">
                                <a href="<?php echo base_url("/downloads") ?>" target="_blank"> <i
                                        class="fa fa-download"></i><span><?php echo lang_loader('global', 'global_all_downloads'); ?></span></a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === false && isfeature_active('ADMINS-OVERALL-PAGE') === false && isfeature_active('ADD-PATIENT') === false) { ?>
                            ...
                            <li class="treeview <?php echo (($this->uri->segment(1) == "view") ? "active" : null) ?>"
                                ...
                                <a href="<?php echo base_url("/Devcheck/devhome") ?>" target="_blank"> <i
                                        class="fa fa-download"></i><span>Add Departments</span></a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ((isfeature_active('EDIT-PATIENT') || isfeature_active('VIEW-PATIENT') || isfeature_active('ADD-PATIENT') || isfeature_active('DISCHARGE-PATIENT')) && !($this->uri->segment(1) == 'asset' && (ismodule_active('ASSET') || isfeature_active('ASSET-DASHBOARD')))) { ?>
                            ...
                            <li class="treeview <?php echo (($this->uri->segment(1) == "patient") ? "active" : null) ?>">
                                <a href="#">
                                    <i class="fa fa-bed"></i>
                                    <span><?php echo lang_loader('global', 'global_admission_section'); ?></span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <?php if (ismodule_active('ADMISSION SECTION') === true && isfeature_active('ADD-PATIENT') === true) { ?>
                                        <li><a
                                                href="<?php echo base_url("patient/create") ?>"><?php echo lang_loader('global', 'global_admit_patient'); ?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (ismodule_active('ADMISSION SECTION') === true && (isfeature_active('VIEW-PATIENT') === true || isfeature_active('DISCHARGE-PATIENT') === true)) { ?>
                                        <li><a
                                                href="<?php echo base_url("patient") ?>"><?php echo lang_loader('global', 'global_ip_list'); ?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (ismodule_active('ADMISSION SECTION') === true && isfeature_active('DISCHARGE-PATIENT') === true) { ?>
                                        <li><a href="<?php echo base_url("patient/discharged") ?>"><?php echo lang_loader('global', 'global_dis_ip'); ?>
                                            </a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        ...
                        <?php if (isfeature_active('EDIT-OUTPATIENT') === true || isfeature_active('VIEW-OUTPATIENT') === true || isfeature_active('ADD-OUTPATIENT') === true || isfeature_active('DISCHARGE-OUTPATIENT') === true) { ?>
                            <li class="treeview <?php echo (($this->uri->segment(1) == "patientop") ? "active" : null) ?>">
                                <a href="#">
                                    ...
                                    <span><?php echo lang_loader('global', 'global_admission_section_op'); ?></span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <?php if (ismodule_active('OUTPATIENT SECTION') === true && isfeature_active('ADD-OUTPATIENT') === true) { ?>
                                        <li><a
                                                href="<?php echo base_url("patientop/create") ?>"><?php echo lang_loader('global', 'global_admit_patient_op'); ?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (ismodule_active('OUTPATIENT SECTION') === true && (isfeature_active('VIEW-OUTPATIENT') === true || isfeature_active('DISCHARGE-OUTPATIENT') === true)) { ?>
                                        <li><a
                                                href="<?php echo base_url("patientop") ?>"><?php echo lang_loader('global', 'global_ip_list_op'); ?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (ismodule_active('OUTPATIENT SECTION') === true && isfeature_active('DISCHARGE-OUTPATIENT') === true) { ?>
                                        <li><a href="<?php echo base_url("patientop/discharged") ?>"><?php echo lang_loader('global', 'global_dis_op'); ?>
                                            </a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        ...
                        <?php if (ismodule_active('GLOBAL') === true && isfeature_active('SETTINGS') === true || $this->session->userdata['user_role'] == 1) { ?>
                            ...
                            <li class="treeview <?php echo ($this->uri->segment(1) == "settings" ? "active" : null) ?>">
                                <a href="#">
                                    ...
                                    <span><?php echo lang_loader('global', 'global_settings'); ?></span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <?php if (ismodule_active('GLOBAL') === true && isfeature_active('ORGANIZATION-PROFILE') === true || $this->session->userdata['user_role'] == 1) { ?>
                                        <li><a
                                                href="<?php echo base_url("settings/organization_profile") ?>"><?php echo lang_loader('global', 'global_org_profile'); ?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (ismodule_active('GLOBAL') === true && isfeature_active('APPLICATION-SETTINGS') === true || $this->session->userdata['user_role'] == 1) { ?>
                                        <li><a
                                                href="<?php echo base_url("settings") ?>"><?php echo lang_loader('global', 'global_app_setting'); ?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (ismodule_active('GLOBAL') === true && isfeature_active('MANAGE-SUBSCRIPTION') === true || $this->session->userdata['user_role'] == 1) { ?>
                                        <li><a
                                                href="<?php echo base_url("subscription/organization") ?>"><?php echo lang_loader('global', 'global_manage_sub'); ?></a>
                                        </li>
                                    <?php } ?>
                                </ul>
                            </li>
                        ...
                        <?php if (ismodule_active('GLOBAL') === true && isfeature_active('ARCHIVE-DATA') === true) { ?>
                            ...
                            ?>
                            <li class="treeview" data-toggle="tooltip" data-placement="bottom"
                                title="This section provides access to all historical data collected prior to the software version and structural update, allowing admins to review past information.">
                                <a href="<?php echo $new_url; ?>" target="_blank"> <i
                                        class="fa fa-archive"></i><span><?php echo lang_loader('global', 'global_archive_data'); ?></span></a>
                            </li>
                        ...
                        <?php if (ismodule_active('GLOBAL') === true && isfeature_active('USER-ACTIVITY') === true) { ?>
                            <li><a href="<?php echo base_url("view/stats") ?>"><i class="fa fa-user"></i> Alerts Statistics</a>
                            </li>
                ...
                <?php if ($this->session->userdata['user_role'] >= 1) { ?>
                    <a href="<?php echo base_url('dashboard/swithc?type=1') ?>" class="logo">
                        ...
                        <span class="logo-mini">
                            <img src="<?php echo (!empty($a) ? base_url('uploads/' . $a['logo']) : null) ?>" width="50px"
                                height="60px" alt="">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo (!empty($a) ? base_url('uploads/' . $a['logo']) : null) ?>" width="130"
                                height="60px" alt="">
                        </span>
                    </a>
                <?php } else { ?>
                    ...
                    <ul class="nav navbar-nav" style="display: inline-flex; float:left;">
                        ...
                        <li>
                            <span class="nav navbar-nav"
                                style="margin-left: 10px; margin-bottom: 2px; margin-top:5px; position:absolute;">
                                <span class="content-icon"><img src="<?php echo base_url("assets/images/eflogo.png"); ?>"
                                        style="height: 40px; width: 40px; margin-top: 5px;" alt=""></span>
                            </span>
                        </li>
                        <li>
                    ...
                    <ul class="nav navbar-nav p-r-30" style="display: inline-flex; float:right; ">
                        ...
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu"
                                style="margin-left: -114px; width: 100px;     position: absolute;   background: #fff;">
                                <li><a href="<?php echo base_url('dashboard/profile'); ?>"><i class="fa fa-id-card"></i>
                                        <?php echo display('profile') ?></a></li>
                                <li><a href="<?php echo base_url('dashboard/form'); ?>"><i class="fa fa-pencil-square"></i>
                                        <?php echo display('edit_profile') ?></a></li>
                                <li><a href="<?php echo base_url('logout') ?>"><i class="fa fa-sign-out"></i>
                                    ...
                                    <?php if (hide_cal_seg2($this->uri->segment(2)) !== true) { ?>
                                        ...
                                        <?php if (is_mobile() === true) { ?>
                                            <div style=" width: 231px;float: right;margin-top: -23px;">
                                                <h5><?php echo lang_loader('global', 'global_from'); ?>&nbsp;<b><?php echo date('d/m/Y', strtotime($tdate)); ?>
                ...
                <div class="panel panel-default">
                    <div class="title" style="text-align:center;align-items:center; ">
                        <a href="" data-toggle="tooltip" data-placement="bottom"
                            title="<?php echo lang_loader('global', 'global_efeedor_patient_exp_tooltip'); ?>"> <img
                                src="<?php echo base_url(); ?>assets/icon/loginlogo1.png"
                                style=" height: 35px; width: 100px; margin-bottom: -14px;  margin-top: 14px;">
                        </a>
                    </div>

                    <div class="panel-body" style="height: 50px; ">
                        <h5 style="text-align: center;"><?php echo lang_loader('global', 'global_if_an_org_emp'); ?> <a
                                href="<?php echo base_url(); ?> "><?php echo lang_loader('global', 'global_login'); ?></a>
                            <?php echo lang_loader('global', 'global_view_more_con'); ?></h5>
                    </div>
                </div>
            </div>
            <?php echo (!empty($content) ? $content : null) ?>
        ...
        <?php if ($this->uri->segment(1) == 'track' && $this->session->userdata('isLogIn') == false && ($this->uri->segment(2) == 'ipdf' || $this->uri->segment(2) == 'opf' || $this->uri->segment(2) == 'isr' || $this->uri->segment(2) == 'adf' || $this->uri->segment(2) == 'pc' || $this->uri->segment(2) == 'inc')) { ?>
            <?php echo (!empty($content) ? $content : null) ?>
        <?php } ?>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">
                            <?php echo lang_loader('global', 'global_select_your_data_range'); ?>
                        </h5>
                    ...
                    <form>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                data-dismiss="modal"><?php echo lang_loader('global', 'global_close'); ?></button>
                            <button type="submit"
                                class="btn btn-primary"><?php echo lang_loader('global', 'global_search'); ?></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $('.33psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Beta-blocker prescription with a diagnosis of CHF with reduced EF',
                    className: 'btn-sm',
                    title: 'PSQ3a- Beta-blocker prescription with a diagnosis of CHF with reduced EF',
                },
                {
    ...
    <script>
        $('.34psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Patients with myocardial infarction for whom door to balloon time of 90 minutes is achieved',
                    className: 'btn-sm',
                    title: 'PSQ3a- Patients with myocardial infarction for whom door to balloon time of 90 minutes is achieved',
                },
                {
    ...
    <script>
        $('.35psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Hospitalized patients with hypoglycemia who achieved targeted blood glucose level',
                    className: 'btn-sm',
                    title: 'PSQ3a- Hospitalized patients with hypoglycemia who achieved targeted blood glucose level',
                },
                {
    ...
    <script>
        $('.36psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Spontaneous Perineal Tear Rate',
                    className: 'btn-sm',
                    title: 'PSQ3a- Spontaneous Perineal Tear Rate',
                },
                {
    ...
    <script>
        $('.37psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Postoperative Endophthalmitis Rate',
                    className: 'btn-sm',
                    title: 'PSQ3a- Postoperative Endophthalmitis Rate',
                },
                {
    ...
    <script>
        $('.38psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Patients undergoing colonoscopy who are sedated',
                    className: 'btn-sm',
                    title: 'PSQ3a- Patients undergoing colonoscopy who are sedated',
                },
                {
    ...
    <script>
        $('.39psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Bile Duct injury rate requiring operative intervention during Laparoscopic cholecystectomy',
                    className: 'btn-sm',
                    title: 'PSQ3a- Bile Duct injury rate requiring operative intervention during Laparoscopic cholecystectomy',
                },
                {
    ...
    <script>
        $('.40psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- POCT results which led to a clinical intervention',
                    className: 'btn-sm',
                    title: 'PSQ3a- POCT results which led to a clinical intervention',
                },
                {
    ...
    <script>
        $('.41psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Functional gain following rehabilitation',
                    className: 'btn-sm',
                    title: 'PSQ3a- Functional gain following rehabilitation',
                },
                {
    ...
    <script>
        $('.42psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Sepsis patients who receive care as per the Hour-1 sepsis bundle',
                    className: 'btn-sm',
                    title: 'PSQ3a- Sepsis patients who receive care as per the Hour-1 sepsis bundle',
                },
                {
    ...
    <script>
        $('.43psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- COPD patients receiving COPD Action plan at the time of discharge',
                    className: 'btn-sm',
                    title: 'PSQ3a- COPD patients receiving COPD Action plan at the time of discharge',
                },
                {
    ...
    <script>
        $('.44psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Stroke patients in whom the Door-to-Needle Time (DTN) of 60 minutes is achieved',
                    className: 'btn-sm',
                    title: 'PSQ3a- Stroke patients in whom the Door-to-Needle Time (DTN) of 60 minutes is achieved',
                },
                {
    ...
    <script>
        $('.45psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Bronchiolitis patients treated inappropriately',
                    className: 'btn-sm',
                    title: 'PSQ3a- Bronchiolitis patients treated inappropriately',
                },
                {
    ...
    <script>
        $('.46psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Oncology patients who had treatment initiated following Multidisciplinary meeting',
                    className: 'btn-sm',
                    title: 'PSQ3a- Oncology patients who had treatment initiated following Multidisciplinary meeting',
                },
                {
    ...
    <script>
        $('.47psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Adverse reaction to radiopharmaceutical',
                    className: 'btn-sm',
                    title: 'PSQ3a- Adverse reaction to radiopharmaceutical',
                },
                {
    ...
    <script>
        $('.48psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Intravenous Contrast Media Extravasation',
                    className: 'btn-sm',
                    title: 'PSQ3a- Intravenous Contrast Media Extravasation',
                },
                {
    ...
    <script>
        $('.49psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Time taken for triage',
                    className: 'btn-sm',
                    title: 'PSQ3a- Time taken for triage',
                },
                {
    ...
    <script>
        $('.50psq3a').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'csv',
                    title: 'PSQ3a- Patients undergoing dialysis who are able to achieve target hemoglobin levels',
                    className: 'btn-sm',
                    title: 'PSQ3a- Patients undergoing dialysis who are able to achieve target hemoglobin levels',
                },
                {
