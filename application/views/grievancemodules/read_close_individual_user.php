		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('sg','sg_download_capa_report_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_capa_report' ; ?>">
					...
					<?php   if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) { ?>
							<form>
								<p> 
									<!-- <span style="font-size:15px; font-weight:bold;">Sort Grievance By : </span> -->
						...
						<table class="grievanceticketsclose table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th style="white-space: nowrap;"><?php echo lang_loader('sg','sg_rca'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('sg','sg_capa'); ?></th>
									<th style="white-space: nowrap;">Closed by</th>
									<?php if (close_comment('sg_close_comment') === true) { ?> 
										<th style="white-space: nowrap;"><?php echo lang_loader('sg','sg_comment'); ?></th>
									<?php } ?>
									<?php if (grievance_tat('close_ticket') === true) { ?>
