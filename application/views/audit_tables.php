...
$initial_assesment_info_tooltip = "Ensures medical record completeness, accuracy & compliance (times, consent, discharge) per NABH, WHO, CAHO, ICMR, JCI, CDC standards.";
$report_error_info_tooltip = "Ensures radiology staff comply with PPE, ALARA, patient ID & hygiene protocols as per NABH, WHO, AERB, ICRP, CAHO & CDC standards to enhance safety and minimize radiation risks.";
$lab_error_info_tooltip="Ensures lab staff follow PPE, hygiene, biomedical waste, and biosafety protocols per NABH, WHO, ICMR, CDC, CAHO & JCI standards to ensure safety, compliance, and infection control.";
$safety_precautions_info_tooltip = "Tracks OPD waiting time from registration to consultation as per NABH, JCI, CAHO, MoHFW & WHO guidelines to monitor patient flow, enhance service efficiency, and support patient-centered care.";
$medication_errors_info_tooltip = "Monitors lab waiting time from billing to sample receipt as per NABH, WHO, ICMR, CDC, CAHO & JCI standards to improve efficiency, streamline services, and enhance patient satisfaction.";
$medication_charts_info_tooltip = "Tracks X-ray waiting time from billing to procedure completion as per NABH, WHO, AERB, ICMR, CDC, CAHO & JCI standards to improve workflow, ensure safety, and enhance patient care.";
$adverse_drug_info_tooltip= "Tracks USG waiting time from billing to report delivery as per NABH, WHO, ICMR, CDC, CAHO & JCI standards to enhance efficiency, streamline workflow, and improve patient satisfaction.";
$unplanned_return_info_tooltip= "Tracks CT scan waiting time from billing to procedure completion as per NABH, WHO, ICMR, CDC, CAHO & JCI standards to optimize workflow, ensure safety, and enhance patient satisfaction.";
$wrong_surgery_info_tooltip = "Validates OR safety compliance—patient ID, consent, site marking, infection control & equipment checks as per NABH, JCI, CAHO, WHO Safe Surgery & CDC perioperative standards.";
$transfusion_reactions_info_tooltip= "Assesses safe prescribing, dispensing & administration of medications as per NABH, JCI, CAHO, WHO Medication Safety, ISMP & CDSCO standards to ensure compliance and patient safety.";
$mortality_ratio_info_tooltip= "Ensures safe, timely & accurate medication administration with patient rights, infection control & documentation checks as per NABH, JCI, CAHO & WHO safe medication standards.";
$theemergency_info_tooltip= "Monitors safe, complete patient handover including ID, vitals, meds, risks & pending results as per NABH, JCI, CAHO & WHO communication standards (SBAR/IPASS) to ensure continuity of care.";
$ulcers_info_tooltip= "Audits prescriptions for legibility & completeness—drug, dose, route, frequency, patient ID & doctor signature—as per NABH, JCI, CAHO, MCI & WHO safe prescribing standards.";
$urinary_info_tooltip= "Tracks staff hand hygiene practices & compliance by role/department to prevent HAIs, aligned with NABH, JCI, CAHO, WHO 5 Moments & CDC infection control guidelines.";
$pneumonia_info_tooltip= "Monitors turnaround time for blood and component requests to ensure timely transfusion, as per NABH, JCI, CAHO, NACO & WHO standards on blood bank safety and transfusion practices.";
$blood_infection_info_tooltip= "Tracks ICU nurse-patient ratio to ensure safe staffing and quality care, aligned with NABH, JCI, CAHO, MoHFW & Indian Nursing Council standards for critical care units.";
$site_infection_info_tooltip= "Monitors ICU readmissions within 48 hours of discharge to evaluate care quality, prevent adverse events, and improve outcomes as per NABH, JCI, CAHO, MoHFW & ICMR patient safety standards.";
$hand_hygiene_info_tooltip= "Validates ICU readmission data within 24–48 hrs to ensure accuracy, support quality reviews, and minimize errors as per NABH, JCI, CAHO, MoHFW & ICMR patient safety guidelines.";
$prophylactic_info_tooltip= "Tracks ED revisits within 72 hours with similar complaints to assess care adequacy, detect missed diagnoses, and enhance patient safety as per NABH, JCI, CAHO, MoHFW & ICMR guidelines.";
$re_scheduling_info_tooltip= "Verifies ED revisit data within 24–72 hrs to ensure accurate documentation, monitor patient outcomes, and improve emergency care as per NABH, JCI, CAHO, MoHFW & ICMR standards.";
$mock_drill_info_tooltip= "Audits code mock drills to assess emergency response, child safety, staff readiness & debriefing, aligned with NABH, JCI, CAHO, MoHFW & hospital safety protocols for preparedness.";
$code_originals_info_tooltip="Audits Code emergency response, CPR quality, patient transport & CCU readiness to ensure staff efficiency and patient safety, aligned with NABH, JCI, CAHO & hospital emergency protocols.";
$facility_inspection_info_tooltip= "Audits hospital facility safety—stairways, corridors, lighting, electricals, fire safety, cleanliness & signage—to prevent accidents and ensure compliance with NABH, JCI, CAHO & safety standards.";
$ward_info_tooltip= "Monitors nurse-to-patient ratios in wards to ensure adequate staffing and safe patient care, aligned with NABH, JCI, CAHO & Indian hospital staffing standards.";

$vap_info_tooltip= "Ensures compliance with VAP prevention in ICU patients—covering hygiene, positioning, sedation & prophylaxis—as per NABH, JCI, CAHO & Indian ICU care standards to improve safety and outcomes.";
$catheter_info_tooltip= "Ensures safe, sterile urinary catheter insertion with patient ID, consent, aseptic technique & post-care education as per NABH, JCI, CAHO & Indian hospital catheter care standards.";
$ssi_info_tooltip= "Ensures compliance with SSI bundle—pre, intra & post-op care, sterile technique, antibiotic prophylaxis & documentation—as per NABH, JCI, CAHO & Indian surgical infection prevention standards.";
$urinary_info_tooltip= "Audits urinary catheter care—aseptic handling, drainage, hygiene & documentation—to prevent CAUTI, aligned with NABH, JCI, CAHO & Indian infection control standards.";
$central_info_tooltip= "Audits central line insertion—aseptic technique, site prep, consent, hand hygiene & documentation—to prevent CLABSI, aligned with NABH, JCI, CAHO & Indian infection control standards.";
$maintenance_info_tooltip= "Audits central line maintenance—hand hygiene, aseptic access, dressing care, daily assessment & documentation—to prevent CLABSI, aligned with NABH, JCI, CAHO & Indian infection control standards.";
$room_clean_info_tooltip= "Audits patient room cleaning—trash, linens, surfaces, high-touch areas, floors & toilets—ensuring hygiene as per NABH, JCI, CAHO & Indian hospital infection control and housekeeping standards.";
$area_clean_info_tooltip= "Audits cleaning of non-patient areas—trash, surfaces, floors, fixtures, toilets & equipment—ensuring hygiene as per NABH, JCI, CAHO & Indian hospital housekeeping and infection control standards.";
$toilet_info_tooltip= "Audits toilet cleaning—hygiene, disinfection, supplies, odor control & maintenance—ensuring compliance with NABH, JCI, CAHO & Indian hospital infection control and housekeeping protocols.";
$canteen_info_tooltip= "Audits canteen hygiene, food handling, storage, transport, pest control & staff training per NABH, JCI, FSSAI, CAHO & Indian hospital food safety and infection control standards.";
