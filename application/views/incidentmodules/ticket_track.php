                    ...
                    <div class="col-sm-12" id="verify" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-sm-12" style="overflow:auto;">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <textarea class="form-control" rows="5" minlength="15" id="comment" name="reply" placeholder="Reason for verifying incident" required></textarea>
                                        <input type="hidden" name="reply_by" value="Admin">
                                        <input type="hidden" name="status" value="Verified">
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12" id="capa" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-sm-12" style="overflow:auto;">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <textarea class="form-control" rows="5" minlength="15" id="rootcause" name="rootcause" placeholder="Enter the Root Cause Analysis( RCA) for incident closure:" required></textarea>
                                    </div>
                                </div>

                                <div class="col-sm-12">
                                    <div class="form-group row" id="correctiveid">
                                        <textarea class="form-control" rows="5" minlength="15" id="corrective" name="corrective" placeholder="Enter the Corrective and Preventive Action( CAPA) for incident closure:" required></textarea>
                                ...
                                <!-- <div class="col-sm-12">
                                    <div class="form-group row">
                                        <textarea class="form-control" rows="5" minlength="15" id="note" name="resolution_note" placeholder="Enter the verification and closure remark here" required></textarea>
                                    </div>
                                </div> -->
                    ...
                    <div class="col-sm-12" id="describe" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-sm-12" style="overflow:auto;">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <textarea class="form-control" rows="5" minlength="15" id="rootcause_describtion" name="rootcause_describtion" placeholder="Enter the Root Cause Analysis (RCA)" required></textarea>
                                    </div>
                                </div>

                                <div class="col-sm-12">
                                    <div class="form-group row" id="correctiveid">
                                        <textarea class="form-control" rows="5" minlength="15" id="corrective_description" name="corrective_description" placeholder="Enter CAPA(Corrective Action and Preventive Action)" required></textarea>
                                        <input type="hidden" name="preventive">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <textarea class="form-control" rows="5" minlength="15" id="comment" name="reply" placeholder="Additional notes" required></textarea>
                                        <input type="hidden" name="reply_by" value="Admin">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="hidden" name="describe_picture_hidden"> <!-- Changed name here -->
                                    </div>
                                </div>
