									...
									<table class=" table table-striped table-bordered  no-footer dtr-inline ">
										<tr>
											...
											<td>
												...
												<strong> Incident Short Name</strong>
											...
											<td>
												...
												<?php if ($result->status != 'Closed') { ?>
													<?php if (
														...
														isfeature_active('EDIT-ASSIGNEDRISK-INCIDENTS') === true &&
												...
												<?php if (
													...
													<select name="incident_type" id="incidentTypeDropdown"
														...
														<option value="" <?php echo ($incident_type == 'Unassigned') ? 'selected' : ''; ?>
															style="color:#6c757d;">Unassigned</option>
														<option value="Near miss" <?php echo ($incident_type == 'Near miss') ? 'selected' : ''; ?> style="color:#1cb23cff;">Near miss</option>
														<option value="No-harm" <?php echo ($incident_type == 'No-harm') ? 'selected' : ''; ?> style="color:#2138ccff;">No-harm</option>
														<option value="Adverse" <?php echo ($incident_type == 'Adverse') ? 'selected' : ''; ?> style="color:#fbc02d;">Adverse</option>
														<option value="Hazardous Condition" <?php echo ($incident_type == 'Hazardous Condition') ? 'selected' : ''; ?> style="color:#ff9800;">Hazardous Condition
														</option>
													...
													<script>
														document.getElementById("incidentTypeDropdown").addEventListener("change", function () {
															...
															// ✅ Fix: use style.color, not style.colors
