						...
						<?php if (isfeature_active('INC-INCIDENTS-DASHBOARD') === true) { ?>
							<form>
								<p>
									...
									<select name="dep" class="form-control" id="subsecid"
										onchange="gotonextdepartment_user(this.value)"
										style="width:200px; margin:0px 0px 20px 20px;">
										...
										foreach ($result as $row) {
											if ($row->firstname != 'developer') {
												...
												<?php if ($this->input->get('depsec') == $row->firstname) { ?>
													<option value="<?php echo str_replace('&', '%26', $row->firstname); ?>" selected>
														<?php echo $row->firstname; ?></option>
												<?php } else { ?>
													<option value="<?php echo str_replace('&', '%26', $row->firstname); ?>">
														<?php echo $row->firstname; ?></option>
												<?php } ?>
							...
							<thead>
								<tr>
									...
									<th style="white-space: nowrap;">
										<?php echo lang_loader('inc', 'inc_incident_reported_by'); ?></th>
									...
									<th style="white-space: nowrap;">Additional Note</th>
								...
								<?php if (!empty($departments)) { ?>
									...
									<?php foreach ($departments as $department) {
										...
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom"
											...
											<!-- <td style="overflow-wrap: break-word; word-break: normal;">
												<?php foreach ($department->replymessage as $r) { ?>
													<?php if ($r->reply != NULL && $r->ticket_status == 'Verified') { ?>
