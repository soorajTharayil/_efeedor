								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline ">
									...
									<table class=" table table-striped table-bordered  no-footer dtr-inline ">
										...
										<tr>
											...
											<td>
												<?php
												echo $cresult1[0]->type_of_incident;
												?>
											</td>
										</tr>
										<tr>
											<td>Priority</td>
											<td>
												<?php if (ismodule_active('INCIDENT') === true && isfeature_active('EDIT-PRIORITY-INCIDENTS') === true && $result->status != 'Closed') { ?>
													...
													<span style="margin-left: 20px;">
														<button id="save_button" type="submit"
															class="ui positive button"><?php echo display('save') ?></button>
													</span>
										...
										<tr>
											<td>Severity</td>
											<td>
												<?php if (ismodule_active('INCIDENT') === true && isfeature_active('EDIT-SEVERITY-INCIDENTS') === true && $result->verified_status != 1 && $result->status != 'Closed') { ?>
													<!-- Show editable dropdown if conditions are met -->
