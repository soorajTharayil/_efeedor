...
<div class="content">
    <div class="ticket-card" style="overflow: hidden;">
        <div class="panel panel-bd" style="width:100%; text-align:center">
            <img src="<?php echo (!empty($logo_img) ? base_url('uploads/' . $logo_img['logo']) : null) ?>"
                style=" height: 60px; width: 180px; margin-top:5px;   margin-bottom: 0px;">
            <br>
            <p
                style="font-family: Arial, sans-serif;font-size:20px; margin-bottom: 5px; margin-top: 2px;font-weight: bold;">
                <?php echo $logo_img['title']; ?>
            </p>
            <div class="panel-body">
                ...
                <?php if ($this->session->userdata['isLogIn'] == false) { ?>
                    <?php if ($department->status == 'Closed') { ?>
                        ...
                        <span class="navheader" style="color:  #198754;font-weight: bold;"><i class="fa fa-circle"
                                aria-hidden="true"></i></span>
                    <?php } ?>
                    <?php if ($department->status == 'Addressed') { ?>
                        <span class="navheader"><?php echo lang_loader('inc', 'inc_inprogress'); ?></span>
                        <span class="navheader" style="color:  #f0ad4e;font-weight: bold;"><i class="fa fa-circle"
                                aria-hidden="true"></i></span>
                    <?php } ?>
                    <?php if ($department->status == 'Open') { ?>
                        <span class="navheader" style="color: #d9534f;"><?php echo lang_loader('inc', 'inc_assigned'); ?></span>
                        <span class="navheader" style="color: #d9534f;font-weight: bold;"><i class="fa fa-circle"
                                aria-hidden="true"></i>&nbsp;</span>
                    <?php } ?>
                    <style>
                        .navheader {
                ...
                <?php if ($department->status == 'Closed') { ?>
                    ...
                    <div id="reopen-question" style="display: none; text-align: center;">
                        ...
                        <div style="display: inline-flex; gap: 10px;">
                            <button type="button" class="reopen-option btn-yes" data-value="yes"
                                style="cursor: pointer; padding: 5px 15px; background-color: #4CAF50; color: white; border: none; border-radius: 5px; font-size: 14px;">
                                Yes
                            </button>
                            <button type="button" class="reopen-option btn-no" data-value="no"
                                style="cursor: pointer; padding: 5px 15px; background-color: #f44336; color: white; border: none; border-radius: 5px; font-size: 14px;">
                                No
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="reopen-reason" style="display: none;">
                        ...
                        <textarea rows="4" cols="50" placeholder="Enter your reason here..." required id="comment"
                            name="reply"></textarea>
                ...
                <?php if ($department->status == 'Closed') { ?>
                    <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                        <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                            <tr>
                                <td class="inbox-item-author" colspan="2" style="text-align: center;">
                                    <b><?php echo lang_loader('inc', 'inc_incident_summary'); ?></b>
                                </td>
                            </tr>

                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;">
                                    <?php echo lang_loader('inc', 'inc_incident_summary'); ?>
                                </td>
                                <td style="text-align: left;"><?php echo $department->department->description; ?></td>
                            </tr>
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;"><?php echo lang_loader('inc', 'inc_incidents'); ?>
                                </td>
                                <td style="text-align: left;"><?php echo $issues; ?></td>
                            </tr>
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;"><?php echo lang_loader('pcf', 'pcf_status'); ?>
                                </td>
                                <td style="text-align: left;">
                                    <?php if ($department->status == 'Closed') { ?>
                                        <span style="color: #198754;"><?php echo lang_loader('pcf', 'pcf_closed'); ?></span>
                                        <span style="color:  #198754;font-weight: bold;"><i class="fa fa-circle"
                                                aria-hidden="true"></i></span>
                                        <!-- <?php if ($department->status == 'Closed' && $department->patient_verified_status == 1) { ?>
                                            <span
                                    ...
                                    <?php if ($department->status == 'Addressed') { ?>
                                        ...
                                        <span style="color:  #f0ad4e;font-weight: bold;"><i class="fa fa-circle"
                                                aria-hidden="true"></i></span>
                                    <?php } ?>
                                    <?php if ($department->status == 'Open') { ?>
                                        <span style="color: #d9534f;"><?php echo lang_loader('pcf', 'pcf_assigned'); ?></span>
                                        <span style="color: #d9534f;font-weight: bold;"><i class="fa fa-circle"
                                                aria-hidden="true"></i>&nbsp;</span>
                                    <?php } ?>
                            ...
                            <?php if ($comment) { ?>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;"><?php echo lang_loader('inc', 'inc_comment'); ?>
                                    </td>
                                    <td style="text-align: left;">
                                        <?php echo '"' . $comment . '"'; ?>
                                    </td>
                            ...
                            <?php } ?>
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;">Resolution Comment </td>
                                <td style="text-align: left;">
                            ...
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;"><?php echo lang_loader('inc', 'inc_created_on'); ?>
                                </td>
                                <td style="text-align: left;">
                            ...
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;">Closed on</td>
                                <td style="text-align: left;">
                            ...
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;">Time Taken</td>
                                <td style="text-align: left;">
                                    <?php
                ...
                <?php } else { ?>
                    ...
                    <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                        <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                            <tr>
                                <td class="inbox-item-author" colspan="2" style="text-align: center;">
                                    <b><?php echo lang_loader('inc', 'inc_incident_report'); ?></b>
                                </td>
                            </tr>
                            <span class="navheader">
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">Incident Reported on
                                    </td>
                                    <td style="text-align: left;">
                                        <?php echo date('g:i a,', strtotime($department->created_on)); ?>
                                        <?php echo date('d-m-y', strtotime($department->created_on)); ?>
                                ...
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">
                                        <?php echo lang_loader('inc', 'inc_incidents'); ?>
                                    </td>
                                    <td style="text-align: left;"><?php echo $issues; ?></td>
                                </tr>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">Incident Occured On</td>
                                    <td style="text-align: left;">
                                        <?php
                                        if (!empty($param['incident_occured_in'])) {
                                            // Convert ISO string to timestamp
                                            $timestamp = strtotime($param['incident_occured_in']);
                                            echo date('g:i a, d-m-y', $timestamp);
                                        } else {
                                            echo 'NA';
                                        }
                                        ?>
                                ...
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">Assigned Risk</td>
                                    <td style="text-align: left;">
                                        <?php echo ' ' . $param['risk_matrix']['level'] . '. '; ?>
                                    </td>
                                </tr>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">Assigned Priority</td>
                                    <td style="text-align: left;">
                                        <?php echo ' ' . $param['priority'] . '. '; ?>
                                    </td>
                                </tr>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">Assigned Category</td>
                                    <td style="text-align: left;">
                                        <?php echo ' ' . $param['incident_type'] . '. '; ?>
                                    </td>
                                </tr>
                            </span>
                            <tr style="margin-left: 10px;margin-right: 10px;">
                                <td style="text-align: left;width:40px;">Site</td>
                                <td style="text-align: left;">
                            ...
                            <?php if ($param['what_went_wrong']) { ?>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">What went wrong
                                    </td>
                                    <td style="text-align: left;">
                            ...
                            <?php } ?>
                             <?php if ($param['action_taken']) { ?>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;">Immediate action taken
                                    </td>
                                    <td style="text-align: left;">
                            ...
                            <?php if ($department->last_modified > $department->created_on) { ?>
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:40px;"><?php echo lang_loader('inc', 'inc_updated_on'); ?>
                                    </td>
                                    <td style="text-align: left;">
                                        <?php echo date('g:i a,', strtotime($department->last_modified)); ?>
                                        <?php echo date('d-m-y', strtotime($department->last_modified)); ?>
                    ...
                    <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                        <?php if (incident_tat('department_information') === true) { ?>
                            <?php if ($department->department->pname) { ?>
                                <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                                    <tr>
                                        <td class="inbox-item-author" colspan="2" style="text-align: center;">
                                            <b><?php echo lang_loader('inc', 'inc_department_info'); ?></b>
                                        </td>
                                    </tr>
                                    <tr style="margin-left: 10px;margin-right: 10px;">
                                        <td style="text-align: left;width:40px;">
                                    ...
                                    <tr style="margin-left: 10px;margin-right: 10px;">
                                        <td style="text-align: left;width:40px;"><?php echo lang_loader('inc', 'inc_contact'); ?>
                                        </td>
                                        <td style="text-align: left;">
                        ...
                        <?php } else { ?>
                            <table class="table table-no-border no-footer no-header" style="display:none;">
                                <tr>
                                    <td class="inbox-item-author" colspan="2" style="text-align: center;">
                                        <b><?php echo lang_loader('inc', 'inc_did_you_know'); ?></b>
                                    </td>
                                </tr>
                        ...
                        <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                            ...
                            <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                                <tr>
                                    <td class="inbox-item-author" colspan="2" style="text-align: center;">
                                        <b><?php echo lang_loader('inc', 'inc_employee_info'); ?></b>
                                    </td>
                                </tr>
                                <tr colspan="2" style="margin-left: 10px;margin-right: 10px;">
