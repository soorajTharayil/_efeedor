<div class="content">
	...
	$this->db->select('bf_outfeedback.*,bf_opatients.name as pname,bf_opatients.patient_id as pid,bf_opatients.mobile as pmobile,bf_opatients.email as pemail');
						...
						?>
								...
								<a href="javascript:return false;">
									<div class="inbox-item">
										<strong class="inbox-item-author"><?php echo $r->pname; ?> (<a href="<?php echo base_url('report/op_patient_feedback?patientid=' . $r->pid); ?>"><?php echo $r->pid; ?></a>) </strong>
