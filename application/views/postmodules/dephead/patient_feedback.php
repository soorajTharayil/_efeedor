					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> PDFT- <?php echo $result->id; ?> </h3>
							</div>
...
// exit;
									...
									$sresult = $this->post_model->setup_result('setup_pdf');
								}
								...
								foreach ($sresult as $r) {
									...
									// print_r($setarray[$r->type]);
									
								}

								foreach ($sresult as $r) {
									$questioarray[$r->type][$r->shortkey] = $r->question;
									// print_r($questioarray[$r->type][$r->shortkey]);
								...
								<div style="padding:10px; background:#fff;">
									<?php foreach ($questioarray as $k => $paramkey) { 
										// echo '<pre>';
				                        // print_r($questioarray);
				                        // print_r($setarray);
				                        // print_r($param['reason']);
										...
										<?php foreach ($paramkey as $key => $r) { ?>
											...
											<?php if ((int)$param[$key] < 3 && (int)$param[$key] != 0) {
												//    print_r($param[$key]);
