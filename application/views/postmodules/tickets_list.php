<div class="content">
	<div class="row">
		...
		$ip_link_patient_feedback = base_url('post/patient_feedback?id=');
						...
						<?php foreach ($departments as $department) { ?>
							...
							<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
								...
								<td style="align-items: center;">
									<a href="<?php echo base_url("post/admin_track/$department->id") ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $tool; ?>" class="btn btn-sm btn-block btn-<?php echo $color; ?>"><?php echo $department->status; ?> <i style="font-size:x-small;" class="fa fa-edit"></i></a>
								</td>
							</tr>
						<?php } ?>
					</table>
