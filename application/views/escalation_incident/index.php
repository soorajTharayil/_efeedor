			...
			<div class="panel panel-default thumbnail">
				<div class="panel-body">
					...
					<?php if ($escalation->status == 'ACTIVE') { ?>
						<?php echo form_open('escalation_incident/create'); ?>
						<div class="accordion">Assign to Incident Explanation Escalation</div>
						...
						<div class="panel paneld" style="display:block; background:#FFF;">
							...
							<div class="col-xs-12">
								...
								<div class="form-group row">
									...
									<label for="name" class="col-xs-3 col-form-label">Select Users for Escalation<i class="text-danger">*</i></label>
									<br />
									<br />
									<ul class="list-group" style="margin-left: 15px;">
										...
										foreach ($users as $u) {
											if ($u->user_id > 1 && ($u->user_role != 10) && ($u->user_role != 8)) {
										?>
												<li class="list-group-item">
						...
						<div class="accordion">Assign Escalation to Admins</div>
						...
						<div class="accordion">Assign Escalation to Sr. Admins</div>
...
<script>
	function set_active(active) {
		if (active == 1) {
			var url = "<?php echo base_url(); ?>escalation_incident/action/active";
			window.location.href = url;
		} else {
			var url = "<?php echo base_url(); ?>escalation_incident/action/inactive";
			window.location.href = url;
		}
	}
</script>
