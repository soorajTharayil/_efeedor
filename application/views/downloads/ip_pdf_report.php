...
$close_rate = $this->ipd_model->ticket_rate($table_tickets, $status, $table_feedback, $table_ticket_action);
...
$overallarray = array('location' => 'Location', 'specificservice' => 'Referred by other doctor/ hospital', 'referred' => 'Affordable cost', 'friend' => 'Experienced doctors', 'previous' => 'Previous Experience', 'docAvailability' => 'Employee/ Friend/ Family recommendation', 'companyRecommend' => 'Insurance facilities', 'otherReason' => 'Print/ Online Media');
...
$feedbacktaken = $this->ipd_model->patient_and_feedback($table_patients, $table_feedback, $sorttime, $setup);
...
$key_highlights = $this->ipd_model->key_highlights($table_patients, $table_feedback, $sorttime, $setup);


$ip_satisfied_count = $this->ipd_model->get_satisfied_count($table_feedback, $table_tickets);
$ip_unsatisfied_count = $this->ipd_model->get_unsatisfied_count($table_feedback, $table_tickets);
...
$ticket = $this->ipd_model->get_tickets($table_feedback, $table_tickets);
