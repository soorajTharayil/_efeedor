			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="handhygiene table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $hygiene_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td style="overflow: clip;"><?php echo $r->employeename; ?></td>
										<td><?php echo $r->designation; ?></td>
										<td><?php echo $r->department; ?></td>
										<td><?php echo $r->indication; ?></td>
										<td><?php echo $r->action; ?></td>
										<td><?php echo $r->compliance; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_hand_hygiene"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>HAND HYGIENE AUDIT REPORT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'HAND HYGIENE AUDIT REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
