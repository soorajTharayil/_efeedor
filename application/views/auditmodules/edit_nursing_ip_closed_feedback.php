            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Nursing (IP Closed Cases) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td><b>Does the discharge process checklist assess transportation needs (Daycare, ED, IPD)?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>In the Haemodialysis Record, is there evidence of pain screening during initial assessment?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>In the Mobile ICU transfer record, is there evidence of patient handover to another facility?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>In the Mobile ICU transfer record, is the patient monitoring form available in the ambulance?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is procedure safety checklist documented outside OT (Endoscopy, ENT, OPD Procedure Room, Radiology, Urology)?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Does the sedation documentation include pre-sedation assessment and monitoring during endoscopy, ED, or ICU?</b></td>
                                <td>
