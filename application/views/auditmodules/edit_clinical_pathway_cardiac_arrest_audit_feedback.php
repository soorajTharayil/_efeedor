            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Cardiac Arrest - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Whether 5 Hs and 5 Ts have been considered and documented during the cardiac arrest?</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether patient transferred to the Cath lab within 90 minutes of arrival to hospital (for STEMI and high risk NSTEMI)</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether examination findings of pupillary reflex, motor score and corneal reflex has been documented in day 1</td>
                                <td>
