            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Cardiac Arrest -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_cardiac_arrest_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Whether 5 Hs and 5 Ts have been considered and documented during the cardiac arrest?
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Whether 12 Lead ECG was done within 10 minutes of attaining ROSC?</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether patient transferred to the Cath lab within 90 minutes of arrival to hospital
                                (for STEMI and high risk NSTEMI)</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether TTM has been initiated from Emergency department?</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether TTM is continued for 24 hrs in ICU?</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether examination findings of pupillary reflex, motor score and corneal reflex has
                                been documented in day 1</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether MRI brain has been done on day 3 (after 72 hrs)</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether EEG has been done on day 3</td>
                            <td>
