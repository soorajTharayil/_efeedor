...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_code_originals"; // Replace with your API endpoint
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'CODE - ORIGINALS AUDIT.png';
			link.click();
		};
		img.src = chartImage;
	}
