			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="opconsultationtime table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Patients consultation room entry time</th>
								<th>Waiting time for consultation</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $op_consultation_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo $r->register_time; ?></td>
										<td><?php echo $r->room_enter_time; ?></td>
										<td><?php echo $r->consultation_wait_time; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_consultation_time"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>OP CONSULTATION WAITING TIME REPORT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'OP CONSULTATION WAITING TIME REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
