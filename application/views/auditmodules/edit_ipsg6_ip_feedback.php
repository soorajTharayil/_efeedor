            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; IPSG-6-IP  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                           ...
                           <tr>
                                <td>Are adequate lighting maintained?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is it ensured that No tangling tubes and phone cords are present in the patient room?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are nurse call bell placed within the patients reach?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are floors maintained wet free and no tripping hazards in the room?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are fall prevention screening completed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are patients aware of fall risk and precautions?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is fall risk status communicated in shift handover report?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are furnishings well maintained (bed locked, walker/commode with rubber caps available)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is correctness of fall risk score verified?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is cognitive impairment identified?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is physical impairment identified?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are safety interventions implemented (side rails)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is patient accompanied by staff / attenders to rest rooms / side of the bed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the awareness of fall prevention protocol adequate?</td>
                                <td>
