            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; CABG  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_cabg_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did the patient undergo open CABG?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient undergo minimally invasive surgery (CABG)?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the graft taken from the left internal mammary artery?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was bail out intra-aortic balloon pump needed for the patient?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have a perioperative myocardial infarction?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have a perioperative stroke?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient need a surgical re exploration?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient develop a deep sternal wound infection?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have any other post operative complication? If yes, please specify</td>
                            <td>
                        ...
                        <tr>
                            <td>Has the patient had a repeat admission within 30 days of discharge after CABG?</td>
                            <td>
                        ...
                        <tr>
                            <td>If the patient did not survive, was the mortality predicted?</td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">
                                Part B (filled after 30 days)
                            </th>
                        </tr>
                        
                        <tr>
                            <td>Did the patient come for a review 30 days after surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>In case of Re- Exploration did this patient undergo CABG from our hospital during last 1 month?</td>
                            <td>
