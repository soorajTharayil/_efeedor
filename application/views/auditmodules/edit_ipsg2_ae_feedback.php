            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; IPSG-2-A&E  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                           ...
                           <tr>
                                <td>Is the patient correctly identified using two identifiers (full name & MID)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the transfer order verified and documented properly?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the patient properly introduced to the incoming staff?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the handover performed correctly using ISBAR format? Are MLC cases handed over as per protocol?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are pre-procedure/surgery preparations completed, including site marking, consent, medications, and investigations?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is handover of investigations, valuables, and diagnostic measures done appropriately for the patient (in/out)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the handover of medication administration accurate and complete?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are staff knowledgeable and compliant with the handover process and workflow?</td>
                                <td>
