            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; IPSG-2-A&E -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_ipsg2_ae_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Is the patient correctly identified using two identifiers (full name & MID)?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the transfer order verified and documented properly?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the patient properly introduced to the incoming staff?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the handover performed correctly using ISBAR format? Are MLC cases handed over as
                                    per protocol?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are pre-procedure/surgery preparations completed, including site marking, consent,
                                    medications, and investigations?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is handover of investigations, valuables, and diagnostic measures done appropriately
                                    for the patient (in/out)?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the handover of medication administration accurate and complete?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are staff knowledgeable and compliant with the handover process and workflow?</b>
                            </td>
                            <td>
