						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Clinicians–Anesthesia(Closed) - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_anesthesia_closed_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Is the type of Anesthesia selected in consent properly?</td>
										<td>
									...
									<tr>
										<td>Has the Anesthetist signed the consent with date and time?</td>
										<td>
									...
									<tr>
										<td>Is the risks, benefits, and alternatives of anesthesia, moderate sedation, or deep sedation explained and fully documented on administration of anesthesia consent form?</td>
										<td>
									...
									<tr>
										<td>Is a pre-anesthesia assessment completed for an applicable patient?</td>
										<td>
									...
									<tr>
										<td>Is a pre-induction assessment completed immediately before induction?</td>
										<td>
									...
									<tr>
										<td>Is a Plan of Anesthesia documented?</td>
										<td>
									...
									<tr>
										<td>Is Post Anesthesia order completed?</td>
										<td>
									...
									<tr>
										<td>Is the Anesthesia document completed?</td>
										<td>
									...
									<tr>
										<td>Is PACU Document complete?</td>
										<td>
									...
									<tr>
										<td>Are the times of each dose of anesthesia medications recorded?</td>
										<td>
