						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Clinical Pharmacy-(Closed) - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_clinical_pharmacy_closed_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Is Past medication History available?</td>
										<td>
									...
									<tr>
										<td>Is Drug appropriateness review noted?</td>
										<td>
									...
									<tr>
										<td>Are Current Medication details available?</td>
										<td>
									...
									<tr>
										<td>Is the Source of Information noted?</td>
										<td>
									...
									<tr>
										<td>Is the Physician decision recorded?</td>
										<td>
									...
									<tr>
										<td>Is Reconciliation during Transfer done?</td>
										<td>
