            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; MRD Audit-OP - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_mrd_op_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Is the patient’s history documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the admitting complaint recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are the vitals recorded during OP assessment?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are the physical findings documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the diagnosis recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the treatment plan documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the medicine prescription recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is follow-up advice documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is patient and family education (PFE) documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the medication history recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the practice of 'copy and paste' avoided?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are abbreviations avoided in documentation?</td>
                                <td>
