            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Febrile Seizure - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_febrile_seizure_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Whether patient’s age, temperature and family history of febrile seizure documented.</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether red flag signs like abnormal development, neurological deficit and signs of meningitis checked.</td>
                                <td>
                            ...
                            <tr>
                                <td>Was seizure appropriately classified as Simple/ Complex febrile seizure.</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether blood tests like CBC, CRP, Glucose, Electrolytes were ordered in appropriate context.</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether 1st episode febrile seizure was advised admission.</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether the family was properly educated regarding febrile, when to seek emergency care and how to perform first aid.</td>
                                <td>
