            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Febrile Seizure -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Whether patientâ€™s age, temperature and family history of febrile seizure documented.
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Whether red flag signs like abnormal development, neurological deficit and signs of
                                meningitis checked.</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether blood tests like CBC, CRP, Glucose, Electrolytes were ordered in appropriate
                                context.</td>
                            <td>
                        ...
                        <tr>
                            <td>Whether the family was properly educated regarding febrile, when to seek emergency care
                                and how to perform first aid.</td>
                            <td>
