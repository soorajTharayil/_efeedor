            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; CPR Analysis Record -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Was there a clearly documented physiological monitoring plan indicating the type and
                                    frequency of observations in the 24 hours before the arrest?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Were the patientâ€™s Early Warning Scores recorded in the 12 hours preceding the
                                    arrest?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Was the Rapid Response Team (RRT) called appropriately?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>If there were other reasons for escalation, was the correct escalation procedure
                                    followed?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the patient receive appropriate assessment and/or treatment in response to a
                                    clearly identified reason for escalation?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>If the patient did not improve, was escalation to a more senior level performed in a
                                    timely manner? Was there documentation and discussion of ceilings of care, including
                                    resuscitation status?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the review identify any other deficiencies (e.g., missing equipment or drugs,
                                    equipment failures, or problems with team performance or communication)?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Was there a need to immediately call the CPR committee? If yes, please provide
                                    comments.</b></td>
                            <td>
