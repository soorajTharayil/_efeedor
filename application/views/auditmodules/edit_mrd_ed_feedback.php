            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; MRD Audit-ED - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_mrd_ed_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th colspan="2">ED Doctor checkpoints</th>
                            </tr>
                            
                            <tr>
                                <td>Is diagnosis recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is admitting complaint recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Vital Signs recorded in ED summary?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are physical findings recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is arrival and discharge time recorded?</td>
                                <td>
                            ...
                            <tr>
                                <th colspan="2">ED Nurse checkpoints</th>
                            </tr>
                            
                            <tr>
                                <td>Are allergy details recorded?</td>
                                <td>
