            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; CoffeeShop PCI Audit  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_coffee_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                           ...
                           <tr>
                                <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Personnel</th>
                            </tr>
                            <tr>
                                <td>Staffs are wearing clean, appropriate uniform?</td>
                                <td>
                            ...
                            <tr>
                                <td>Good personnel hygiene practiced?</td>
                                <td>
                            ...
                            <tr>
                                <td>Fingernails are clean and trimmed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Protective clothing is used appropriately?</td>
                                <td>
                            ...
                            <tr>
                                <td>Staff with respiratory, gastrointestinal, or skin infectious are restricted from handling food and sent for treatment?</td>
                                <td>
                            ...
                            <tr>
                                <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Storage</th>
                            </tr>
                            <tr>
                                <td>All food items are labeled with product name and expiry date?</td>
                                <td>
                            ...
                            <tr>
                                <td>Prepared or ready eat food is covered and labeled with production date?</td>
                                <td>
                            ...
                            <tr>
                                <td>No food is stored on the floor?</td>
                                <td>
                            ...
                            <tr>
                                <td>Cleaning chemicals are stored separately from food items?</td>
                                <td>
                            ...
                            <tr>
                                <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Equipments</th>
                            </tr>
                            <tr>
                                <td>All refrigerator temperature charts are checked regularly as per schedule?</td>
                                <td>
                            ...
                            <tr>
                                <td>Equipment as grinders, slicers, knives, mixers etc. are cleaned and sanitized between uses?</td>
                                <td>
                            ...
                            <tr>
                                <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Others</th>
                            </tr>
                            <tr>
                                <td>All working surfaces are kept clean with no spill left?</td>
                                <td>
                            ...
                            <tr>
                                <td>Hand hygiene is performed before starting duty and in between?</td>
                                <td>
                            ...
                            <tr>
                                <td>Received food items are in good conditions?</td>
                                <td>
                            ...
                            <tr>
                                <td>Food is served in clean paper dishes?</td>
                                <td>
                            ...
                            <tr>
                                <td>Appropriate utensils are immediately refrigerated?</td>
                                <td>
                            ...
                            <tr>
                                <td>Dining area is kept clean, spills immediately removed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Garbage receptacles are lined with plastic bags and covered?</td>
                                <td>
                            ...
                            <tr>
                                <td>Coffee shop is kept clean and dry with no stagnant water spills?</td>
                                <td>
