            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; CoffeeShop PCI Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Staff with respiratory, gastrointestinal, or skin infectious are restricted from
                                handling food and sent for treatment?</td>
                            <td>
                        ...
                        <tr>
                            <td>Equipment as grinders, slicers, knives, mixers etc. are cleaned and sanitized between
                                uses?</td>
                            <td>
