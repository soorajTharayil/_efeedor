            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Initial Assessment
                        Accident and Emergency (A&E) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_initial_assessment_ae_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Is General Information documented?</b></td>
                            <td>
                                ...
                                <div>
                                    Remarks:
                                    <input class="form-control" type="text" name="identification_remarks"
                                        value="<?php echo isset($param['identification_remarks']) ? htmlspecialchars($param['identification_remarks'], ENT_QUOTES, 'UTF-8') : ''; ?>"
                                        placeholder="Remarks">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td><b>Is Vulnerability documented?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Modified Morse Scale completed?</b></td>
                            <td>
