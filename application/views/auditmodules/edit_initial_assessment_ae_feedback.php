            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Initial Assessment Accident and Emergency (A&E) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Is General Information documented?</td>
                                <td>
                                    ...
                                    Remarks:
                                    <input type="text" name="identification_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['identification_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>Are Allergies noted?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Vulnerability documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Modified Morse Scale completed?</td>
                                <td>
