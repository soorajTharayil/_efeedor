            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Clinicians-Surgeons (Active) - <?php echo $row->id; ?></h3>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                    ...
                                    <tr>
                                        <td>Are the risks, benefits, potential complications and alternatives to surgery explained and fully documented on informed consent form?</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Is a list of medications taken prior to admission documented (or documentation of none taken)?</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Is it ensured that during all phases of inpatient care, the individual responsible for the patient's care is identified?</td>
                                        <td>
