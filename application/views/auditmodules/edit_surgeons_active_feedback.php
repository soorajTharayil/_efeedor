            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Clinicians-Surgeons
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_surgeons_active_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Is the date, time and signature of surgeon documented in informed consent for surgery?
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Are the risks, benefits, potential complications and alternatives to surgery explained
                                and fully documented on informed consent form?</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                Remarks:
                                <input type="text" class="form-control" name="ensure_text"
                        ...
                        <tr>
                            <td>Is the operation record recorded before the patient is transferred to the next level of
                                care?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is a post-operative report available before the patient leaves the post-anesthesia
                                recovery area?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is a list of medications taken prior to admission documented (or documentation of none
                                taken)?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is it ensured that during all phases of inpatient care, the individual responsible for
                                the patient's care is identified?</td>
                            <td>
