			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="returntoed table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Initial consultation date</th>
								<th>Complaint at the time of consultation</th>
								<th>Treatment given at the time of consultation</th>
								<th>Patient revisit date</th>
								<th>Duration between initial consultation and revisit time</th>
								<th>Complaint at the time of re-consultation</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $return_to_emr_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td style="overflow: clip;">
											<?php echo $r->patientname; ?>
											<br>
											(<?php echo $r->patientid; ?>)
											<br>
										</td>

										<td><?php echo $r->initial_consultation; ?></td>
										<td><?php echo $r->complaintConsultation; ?></td>
										<td><?php echo $r->treatmentConsultation; ?></td>
										<td><?php echo $r->revisit_time; ?></td>
										<td><?php echo $r->time_duration; ?></td>
										<td><?php echo $r->complaintReconsultation; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_return_to_ed"; // Replace with your API endpoint
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'EMERGENCY RETURN REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
