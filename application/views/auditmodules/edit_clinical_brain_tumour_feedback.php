            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Brain tumour surgery  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_brain_tumour_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did this patient have any post operative complication, other than infection? If yes, please specify</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have to undergo a revision surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient get readmitted anytime for a condition related to surgery?</td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">
                                Part B (filled 30 days after procedure)
                            </th>
                        </tr>
                        ...
                        <tr>
                            <td>Did this patient come for a review 180 days after surgery?</td>
                            <td>
