            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Laparoscopic Donor
                        Nephrectomy - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_laproscopic_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Was the consent taken by operating team?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the site marked during Pre-operation?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient given Chlorhexidine bath & area prepared?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient shift to room from ICU on POD1?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the Foleys catheter removed on POD 1?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the wound inspected / dressing done on POD 2?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient discharged on POD 5?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was there a conversion from laparoscopic donor nephrectomy to open donor nephrectomy?
                            </td>
                            <td>
