			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Pest Control Audit - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed audit report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_pest_control_audit' ?>">
						...
						<table class="ClinicalDietetics table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $pest_control_audit_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
                                    ...
                                    <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 6px;">
                                        <a href="<?php echo $pest_control_audit_feedback . $id; ?>"
                                            class="btn btn-info btn-sm"
                                            style="padding: 6px 14px; font-size: 13px; width: 100px;">
                                            View Details
                                        </a>
                                        ...
                                        <?php if (isfeature_active('DELETE-AUDIT') === true) { ?>
                                            <a class="btn btn-sm btn-danger"
                                                ...
                                                style="font-size: 13px; padding: 4px 12px; width: 100px;">
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_pest_control_audit"; // Replace with your API endpoint
