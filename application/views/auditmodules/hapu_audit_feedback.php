						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Hospital acquired pressure ulcers ( HAPU) Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_hapu_audit_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Type of lesion (HAPU / CAPU / Other)</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['spiritual_text'])); ?>
										</td>
									</tr>
									

									<tr>
										<td>Stage of lesion (1 / 2 / 3 / 4 / NA)</td>
										<td>
									...
									<tr>
										<td>Total number of lesions identified</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['complaints_communicated_text'])); ?>
										</td>
									</tr>
									<tr>
										<td>Total number of lesions reported</td>
										<td>
