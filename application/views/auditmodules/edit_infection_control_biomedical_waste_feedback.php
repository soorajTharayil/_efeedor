            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Biomedical Waste Management Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Are Sharp items (Needles, Scalpels, blades) disposed in Puncture proof sharps Container?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Autoclavable waste (Plastic items, tubing's, catheters, syringes without needles, gloves & hand care) discarded in RED COVER?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Incinerator wastes (Cotton, gauze, diaper, mask, cap, lab waste, placenta, cytotoxic drugs, anatomical body parts) discarded in YELLOW COVER?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Glass ware (ampoules, Vials, Glass bottles, nails, discarded metallic Body implants) discarded in BLUE CONTAINER?</td>
                                <td>
                            ...
                            <tr>
                                <td>Collection of waste by housekeeping staff - Is the segregation maintained during the collection process & transported in closed containers?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are House-keeping staff wearing appropriate PPE (Hard gloves, Mask, Cap, shoes) while handling the biomedical waste, bags or containers?</td>
                                <td>
