            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Biomedical Waste
                        Management Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_biomedical_waste_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Are Sharp items (Needles, Scalpels, blades) disposed in Puncture proof sharps
                                    Container?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Autoclavable waste (Plastic items, tubing's, catheters, syringes without needles,
                                    gloves & hand care) discarded in RED COVER?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Incinerator wastes (Cotton, gauze, diaper, mask, cap, lab waste, placenta,
                                    cytotoxic drugs, anatomical body parts) discarded in YELLOW COVER?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Glass ware (ampoules, Vials, Glass bottles, nails, discarded metallic Body
                                    implants) discarded in BLUE CONTAINER?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Collection of waste by housekeeping staff - Is the segregation maintained during the
                                    collection process & transported in closed containers?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are House-keeping staff wearing appropriate PPE (Hard gloves, Mask, Cap, shoes) while
                                    handling the biomedical waste, bags or containers?</b></td>
                            <td>
