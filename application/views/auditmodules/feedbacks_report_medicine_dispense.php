			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="medicinedispense table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Patient UHID</th>
								<th>Medicine name</th>
								<th>Was correct medicine dispensed?</th>
								<th>Was correct quantity dispensed?</th>
								<th>Was medicine within its expiry date?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $medicine_dispensing_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo $r->correct_medicine; ?></td>
										<td><?php echo $r->correct_quantity; ?></td>
										<td><?php echo $r->medicine_expiry; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_medicine_dispense"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>MEDICINE DISPENSING AUDIT REPORT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'MEDICINE DISPENSING AUDIT REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
