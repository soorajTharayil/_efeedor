            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; IPSG-2- ER -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_ipsg2_er_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Is ISBAR format used during handover between staff/units?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are interdepartmental transfers (ED → Ward/ICU/OT) documented using a transfer checklist?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are critical content of hand over, investigation and pending procedures clearly mentioned during hand over?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is medication handover complete (time, dose, high-alert drugs, infusions, etc.)?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is family/patient education documented (diagnosis, plan, transfer, safety measures)?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are shift handovers done at bedside with active participation of incoming team?</b></td>
                            <td>
