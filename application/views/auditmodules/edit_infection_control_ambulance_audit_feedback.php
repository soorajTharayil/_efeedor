            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Ambulance PCI Audit  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_ambulance_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                           ...
                           <tr>
                                <th colspan="2">Infection Control Supplies & Environment</th>
                            </tr>
                            <tr>
                                <td>Alcohol dispenser available and not empty?</td>
                                <td>
                            ...
                            <tr>
                                <td>PPE available (gloves, masks, gowns, goggles, etc.)?</td>
                                <td>
                            ...
                            <tr>
                                <td>All equipments and surfaces are cleaned and disinfected?</td>
                                <td>
                            ...
                            <tr>
                                <td>Blood and body fluid spills immediately cleaned?</td>
                                <td>
                            ...
                            <tr>
                                <td>Sharp containers available, not overfilled?</td>
                                <td>
                            ...
                            <tr>
                                <td>Blood spill kits available with all its contents?</td>
                                <td>
                            ...
                            <tr>
                                <td>Soiled linen properly collected and sent to laundry?</td>
                                <td>
                            ...
                            <tr>
                                <td>Clean sheet placed on bed or stretcher?</td>
                                <td>
                            ...
                            <tr>
                                <td>Air exhaust is properly functioning?</td>
                                <td>
