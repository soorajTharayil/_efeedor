            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; IV cannula audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_peripheralivline_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Topical Chlorhexidine bath given?</td>
                                <td>
                            ...
                            <tr>
                                <td>Applied Mupirocin ointment in topical areas?</td>
                                <td>
                            ...
                            <tr>
                                <td>Blood sugar maintained pre-op &lt; 180mg/dl</td>
                                <td>
                            ...
                            <tr>
                                <td>Evidence of pre-op infection: If 'yes' to above, what is the site of infection</td>
                                <td>
                            ...
                            <tr>
                                <td>Class of surgery / Wound surveillance</td>
                                <td>
                                    <input type="text" name="allergies" class="form-control" value="<?php echo htmlspecialchars($param['allergies']); ?>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Has the ward staff educated patient/relatives on the care of the surgical wound?</td>
                                <td>
