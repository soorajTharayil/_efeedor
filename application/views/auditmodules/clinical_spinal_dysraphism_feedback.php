						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Spinal Dysraphism Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_clinical_spinal_dysraphism_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Did the patient experience limb weakness after spinal dysraphism?</td>
										<td>
									...
									<tr>
										<td>Did the patient experience Bowel/Bladder incontenence after spinal dysraphism?</td>
										<td>
									...
									<tr>
										<td>Did this patient require a revision surgery ?</td>
										<td>
									...
									<tr>
										<td>Did this patient came for a review 30 days after surgery?</td>
										<td>
