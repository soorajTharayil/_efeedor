            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; COPD Protocol Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinicalkpi_copd_protocol_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Evaluate ability to cope in his/her usual environment?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Re-assessment of inhaler technique?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Enrolment in Pulmonary rehabilitation?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Re-assess need for long term Oxygen / Home BIPAP support?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>PFT â€“ If not done already</b></td>
                            <td>
