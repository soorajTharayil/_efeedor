            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; COPD Protocol Audit  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Evaluate ability to cope in his/her usual environment?</td>
                            <td>
                        ...
                        <tr>
                            <td>Re-assessment of inhaler technique?</td>
                            <td>
                        ...
                        <tr>
                            <td>Enrolment in Pulmonary rehabilitation?</td>
                            <td>
                        ...
                        <tr>
                            <td>Re-assess need for long term Oxygen / Home BIPAP support?</td>
                            <td>
