            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Physiotherapy- (Closed) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_physiotherapy_closed_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Is Reason for referral available?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Patient complaint noted?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Range of Motion and Muscle power recorded/assessed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the Goal plan available?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Patient Education imparted?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Progress Notes maintained?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Pain Assessment periodically done and recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Fall risk Assessment periodically done and recorded?</td>
                                <td>
