			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Infection control bundle audit - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed audit report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_infection_control_bundle_audit' ?>">
					...
					<div class="panel-body">
						<table class="infection_control_bundle_audit table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $infection_control_bundle_audit_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td>
											<a href="<?php echo $infection_control_bundle_audit_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_infection_control_bundle_audit"; // Replace with your API endpoint
