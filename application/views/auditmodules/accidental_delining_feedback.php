						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Accidental Delining Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_accidental_delining_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['initial_assessment_hr5'])); ?>
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['initial_assessment_hr3'])); ?>
										</td>
									</tr>
