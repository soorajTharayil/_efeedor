            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; CSSD audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Is Recall Register Maintained and Updated?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are all the Machines cleaned with alcohol-based solution adequately?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Environmental cleaning of the CSSD with 1.5% Quaternary ammonium compound adequately performed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Daily BDS test For Autoclave Machines adequately performed and documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are BMS test for all Loads adequately performed and documented?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Staffs wearing Proper PPE?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Daily Process records of ETO and Steam Autoclave Machine Maintained?</td>
                                <td>
