            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; CSSD audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_cssd_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Is Recall Register Maintained and Updated?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are all the Machines cleaned with alcohol-based solution adequately?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Environmental cleaning of the CSSD with 1.5% Quaternary ammonium compound
                                    adequately performed?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Daily BDS test For Autoclave Machines adequately performed and documented?</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are BMS test for all Loads adequately performed and documented?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Staffs wearing Proper PPE?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are Daily Process records of ETO and Steam Autoclave Machine Maintained?</b></td>
                            <td>
