			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Diet consultation (OP) - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed audit report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_diet_consultation_op' ?>">
					...
					<div class="panel-body">
						<table class="dietconsultation_op_mdc table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $diet_consultation_op_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td>
											<a href="<?php echo $diet_consultation_op_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_dietconsultation_op_mdc"; // Replace with your API endpoint
