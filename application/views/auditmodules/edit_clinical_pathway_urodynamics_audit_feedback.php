            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Urodynamics - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_urodynamics_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Was the anticholinergic withheld 48 hours prior?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was patient screened for UTI – Urine R/E and urine culture?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the prophylactic antibiotic given as per the recommendation?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was any post procedure infection identified?</td>
                                <td>
