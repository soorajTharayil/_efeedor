            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; MRD Audit-LAMA - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_mrd_lama_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Is Time of Arrival recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is specialist consultation recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is reasons for visit and diagnosis recorded in EMR?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is reason of LAMA recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Patient identification properly recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Patient/companion’s signature recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is witness signature recorded?</td>
                                <td>
