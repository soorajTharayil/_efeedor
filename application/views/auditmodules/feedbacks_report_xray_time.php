							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $xray_wait_time_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<?php if (allfeedbacks_page('feedback_id') == true) { ?>
											<td>
												<a href="<?php echo  $xray_wait_time_feedback . $id; ?>">IPDF-<?php echo $id; ?></a>
											</td>
										<?php } ?>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_xray_time"; // Replace with your API endpoint
