            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Bronchodilators Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Treated with Antimicrobials?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Treated with bronchodilators?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Appropriateness of Treatment?</b></td>
                            <td>
