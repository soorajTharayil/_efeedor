            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Radiology PCI Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Pillows and mattresses are covered with a cleanable material such as vinyl and are
                                intact.</td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Hand washing and
                                personal protective equipment (PPE)</th>
                        </tr>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Waste and Sharps
                                Disposal</th>
                        </tr>

                        <tr>
                            <td>There is color-coded footâ€“operated waste bins for regular and infectious waste. Bins are
                                labeled.</td>
                            <td>
                        ...
                        <tr>
                            <td>There are adequate puncture resistant leak-proof sharp containers available. These
                                should be wall mounted.</td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Clean / Sterile
                                Supplies</th>
                        </tr>
                        ...
                        <tr>
                            <td>Appropriate measures are taken if temperature in medication refrigerators/freezers is
                                out of range.</td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Cleaning of
                                Environmental Surfaces and Equipment</th>
                        </tr>

                        <tr>
                            <td>Environmental surface are disinfected beginning and end of day and in between patients.
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Cleaners are aware of needle stick/sharps injury protocol.</td>
                            <td>
