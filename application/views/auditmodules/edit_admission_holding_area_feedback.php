            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Admission Holding Area Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_admission_holding_area_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Does planned patient care affected in anyway due to holding?</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether intended drugs proposed in admission were started at holding?</td>
                                <td>
                            ...
                            <tr>
                                <td>Able to provide intended level of care including ICU level if applicable?</td>
                                <td>
                            ...
                            <tr>
                                <td>Does continuity of care and documentation is maintained during holding?</td>
                                <td>
                            ...
                            <tr>
                                <td>Competency of staff at holding were matching to the level of care required?</td>
                                <td>
                            ...
                            <tr>
                                <td>Any reported adverse event during holding?</td>
                                <td>
