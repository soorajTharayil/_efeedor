            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Epilepsy  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_epilepsy_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did this patient have generalized seizure?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have focal seizure?</td>
                            <td>
                        ...
                        <tr>
                            <td>What was the frequency of seizures- before surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>What was the frequency of seizures – after 3 months of surgery (Class I – Seizure free, Class II – Rare Seizures, Class III – Worthwhile improvement, Class IV – No worthwhile improvement)</td>
                            <td>
                        ...
                        <tr>
                            <td>How many days after surgery did this patient get discharged?</td>
                            <td>
