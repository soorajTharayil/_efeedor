						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Cardio Pulmonary Resuscitation analysis record - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_cardio_pulmonary_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Was there a clearly documented physiological monitoring plan indicating the type and frequency of observations in the 24 hours before the arrest?</td>
										<td>
									...
									<tr>
										<td>Were the patient’s Early Warning Scores recorded in the 12 hours preceding the arrest?</td>
										<td>
									...
									<tr>
										<td>Was the Rapid Response Team (RRT) called appropriately?</td>
										<td>
									...
									<tr>
										<td>If there were other reasons for escalation, was the correct escalation procedure followed?</td>
										<td>
									...
									<tr>
										<td>Did the patient receive appropriate assessment and/or treatment in response to a clearly identified reason for escalation?</td>
										<td>
									...
									<tr>
										<td>If the patient did not improve, was escalation to a more senior level performed in a timely manner? Was there documentation and discussion of ceilings of care, including resuscitation status?</td>
										<td>
									...
									<tr>
										<td>Did the review identify any other deficiencies (e.g., missing equipment or drugs, equipment failures, or problems with team performance or communication)?</td>
										<td>
									...
									<tr>
										<td>Was there a need to immediately call the CPR committee? If yes, please provide comments.</td>
										<td>
