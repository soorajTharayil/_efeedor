			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="vapPrevention table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Staff name</th>
								<th>Is hand washing done before and after touching the patient/surrounding/ventilator?</th>
								<th>Are subglottic tubes used?</th>
								<th>Is cuff pressure maintained between 20-30 mcH20?</th>
								<th>Is cuff pressure monitored every 4-6 hours?</th>
								<th>Is the patient nursed in a semi-recumbent position?</th>
								<th>Are ventilator tubings visibly clean?</th>
								<th>Are suction tubings visibly clean?</th>
								<th>Is stress ulcer prophylaxis given judiciously and only to patients at high risk of upper gastrointestinal bleeding?</th>
								<th>Is oral care provided using Chlorhexidine Gluconate?</th>
								<th>Are oral suction tubes sterile?</th>
								<th>Are bedsore preventive measures followed?</th>
								<th>Is a sedation vacation and readiness to wean assessed?</th>
								<th>Is daily sedation hold performed (unless contraindicated)?</th>
								<th>Is patient temperature monitored and maintained below 99°F?</th>
								<th>Is deep vein thrombosis prophylaxis initiated?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $vap_prevention_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_vap_prevention"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>VAP PREVENTION CHECKLIST</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'VAP PREVENTION CHECKLIST.png';
			link.click();
		};
		img.src = chartImage;
	}
