<div class="content">
	...
	if ($this->input->post('id') || $this->input->get('id')) {
		...
		$this->db->where('id', $id);
		$query = $this->db->get('bf_feedback_mrd_audit');
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									MRD file audit - <?php echo $result->id; ?>
								</h3>
							</div>
							<?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_mrd_audit/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										...
										<td><?php echo date("H:i:s", strtotime($result->initial_assessment)); ?></td>
									</tr>
									...
									<tr>
										...
										<td><?php echo date("H:i:s", strtotime($result->time_taken_for_discharge)); ?></td>
									</tr>
									<tr>
