			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Cardio Pulmonary Resuscitation analysis record - Audit Summary</strong>
						</div>
						<div>
					...
					<div class="panel-body">
						<table class="cardio_pulmonary_audit table table-striped table-hover table-bordered" cellspacing="0"
							width="100%">
							<thead>
							...
							<tbody>
								...
								<?php foreach ($feedbacktaken as $r) {
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>"
										onclick="window.location='<?php echo $cardio_pulmonary_feedback . $id; ?>';"
										...
										<td>
											<a href="<?php echo $cardio_pulmonary_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_cardio_pulmonary_checklist"; // Replace with your API endpoint
