            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Spine and disc
                        surgery-Fusion procedures - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_spine_disc_surgery_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Filled after procedure
                            </th>
                        </tr>

                        <tr>
                            <td><b>Did this patient have any post operative complication?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient get readmitted anytime for a condition related to surgery?</b></td>
                            <td>
