            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Extravasation Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_extravasation_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>When was the IV cannula inserted? (Date)</td>
                                <td>
                                    <input type="text" name="identification_details_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['identification_details_text']); ?>"><br>
                                    Remarks:
                            ...
                            <tr>
                                <td>What type of IV device was used? (e.g., peripheral cannula, central venous catheter)</td>
                                <td>
                                    <input type="text" name="vital_signs" class="form-control"
                                           value="<?php echo htmlspecialchars($param['vital_signs']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="vital_signs_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['vital_signs_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>What was the site of insertion?</td>
                                <td>
                                    <input type="text" name="surgery_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['surgery_text']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="surgery_text_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['surgery_text_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>How long was the IV cannula in place before extravasation occurred?</td>
                                <td>
                                    <input type="text" name="intake_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['intake_text']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="intake_text_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['intake_text_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>What is the name and classification of the drug administered? (e.g., vesicant, irritant)</td>
                                <td>
                                    <input type="text" name="output_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['output_text']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="output_text_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['output_text_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>What was the drug concentration and total volume infused?</td>
                                <td>
                                    <input type="text" name="allergies_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['allergies_text']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="allergies_text_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['allergies_text_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>What was the duration and rate of infusion?</td>
                                <td>
                                    <input type="text" name="medication_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['medication_text']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="medication_text_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['medication_text_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>What method of infusion was used? (e.g., manual bolus, pump-driven)</td>
                                <td>
                                    <input type="text" name="diagnostic_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['diagnostic_text']); ?>"><br>
                                    Remarks:
                                    <input type="text" name="diagnostic_text_remarks" class="form-control"
                                           value="<?php echo htmlspecialchars($param['diagnostic_text_remarks']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <th colspan="2">Signs and symptoms noted</th>
                            </tr>
                            
                            <tr>
                                <td>Was swelling observed at the insertion site?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the patient experiencing pain?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was redness present at the site?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was there any discoloration noted?</td>
                                <td>
                            ...
                            <tr>
                                <th colspan="2">Immediate actions taken</th>
                            </tr>
                            
                            <tr>
                                <td>Was the infusion stopped immediately after detection?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the cannula removed after extravasation?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was aspiration of the extravasated drug attempted?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the affected limb elevated?</td>
                                <td>
                            ...
                            <tr>
                                <td>Were cold or warm compresses applied as per the drug protocol?</td>
                                <td>
                            ...
                            <tr>
                                <td>Were antidotes administered (if applicable)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the incident documented in the patient’s medical record?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the incident reported to the appropriate healthcare team?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the patient referred to specialized care (e.g., plastic surgery, wound care)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Were any long-term complications observed (e.g., tissue necrosis, scarring)? If yes, please specify.</td>
                                <td>
