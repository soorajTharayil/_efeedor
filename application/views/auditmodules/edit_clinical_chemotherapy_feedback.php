            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Chemotherapy (Medical
                        oncology) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_chemotherapy_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did this patient have any chemotherapy related complications?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the patient require a re admission any time for chemotherapy related indication?
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient come for review on the proposed follow up date?</td>
                            <td>
