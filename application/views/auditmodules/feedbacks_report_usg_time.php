			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="usgtime table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Waiting time for USG</th>
								<th>Report received time</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $usg_wait_time_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<?php if (allfeedbacks_page('feedback_id') == true) { ?>
											<td>
												<a href="<?php echo  $usg_wait_time_feedback . $id; ?>">IPDF-<?php echo $id; ?></a>
											</td>
										<?php } ?>
										...
										<td><?php echo $r->usg_wait_time; ?></td>
										<td><?php echo $r->report_getting_time; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_usg_time"; // Replace with your API endpoint
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'USG WAITING TIME REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
