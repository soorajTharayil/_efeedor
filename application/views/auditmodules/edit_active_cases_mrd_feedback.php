            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Active Cases MRD Audit (IP) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="social" value="<?php echo $param['social']; ?>"><br>
                               <span>Remarks: <input class="form-control" type="text" name="social_text" value="<?php echo $param['social_text']; ?>" placeholder="Remarks">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" name="dataAnalysis" value="<?php echo htmlspecialchars($param['dataAnalysis']); ?>">
                            </td>
                        </tr>
