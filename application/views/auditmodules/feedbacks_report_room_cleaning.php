			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="room table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								<th><?php echo lang_loader('ip', 'ip_slno'); ?></th>
								<th>Audited by</th>
								<th>Date</th>
								<th>Room/ Area</th>
								<th>Is trash removed and properly disposed of?</th>
								<th>Are bed linens changed every day?</th>
								<th>Are high-touch surfaces disinfected regularly?</th>
								<th>Are bedrails cleaned and disinfected?</th>
								<th>Are bedside tables wiped down?</th>
								<th>Are remote accessories and switches cleaned?</th>
								<th>Are windows and curtains cleaned?</th>
								<th>Is the floor mopped regularly?</th>
								<th>Are furniture and fixtures dusted?</th>
								<th>Is the fan cleaned properly?</th>
								<th>Are all spills cleaned and disinfected immediately?</th>
								<th>Are items labeled properly?</th>
								<th>Is the three-step Water-Disinfectant-Plain water cleaning method used?</th>
								<th>Is the room maintained with a fresh smell?</th>
								<th>Are toilets and washbasins cleaned properly?</th>
								<th>Are floor mats clean and properly placed?</th>
								<th>Are housekeeping equipment arranged in their designated spaces?</th>
								<th>Is the cleaning checklist properly filled out and signed?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $room_cleaning_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_room_cleaning"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>PATIENT ROOM CLEANING AUDIT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'PATIENT ROOM CLEANING AUDIT.png';
			link.click();
		};
		img.src = chartImage;
	}
