						...
						<table class="npratio table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location.href='<?php echo base_url('audit/nurse_patient_ward_feedback?id=') . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo !empty($r->ward) ? $r->ward : '-'; ?></td>
