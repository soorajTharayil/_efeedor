			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="labtime table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Sample received time</th>
								<th>Waiting time for laboratory</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $lab_wait_time_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<?php if (allfeedbacks_page('feedback_id') == true) { ?>
											<td>
												<a href="<?php echo  $lab_wait_time_feedback . $id; ?>">IPDF-<?php echo $id; ?></a>
											</td>
										<?php } ?>
										...
										<td><?php echo $r->sample_received_time; ?></td>
										<td><?php echo $r->lab_wait_time; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_lab_time"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>LABORATORY WAITING TIME REPORT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'LABORATORY WAITING TIME REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
