            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Canteen Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Are personal grooming of the staff satisfactory - hairs, nails cut short, clean uniforms?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are all staffs wearing PPEs while handling food items, (cap, mask, hand care gloves)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is it verified that no staff is suffering from gastrointestinal disorders such as diarrhea etc?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the daily cleaning of the kitchen done adequately?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the cooking area kept clean?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the fridge temperature maintained at 0-5 degree C?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are all food items that are stored kept closed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is cooked food kept above 65 Degree C?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the freezer temperature kept below -3 Degree C?</td>
                                <td>
                                    <input type="text" name="freezer_temp" class="form-control"
                                           value="<?php echo htmlspecialchars($param['diagnostic']); ?>"><br>
                                    <strong>Remarks:</strong>
                                    <input type="text" name="freezer_temp_text" class="form-control"
                                           value="<?php echo htmlspecialchars($param['diagnostic_text']); ?>">
                                </td>
                            </tr>
