            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Canteen Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_canteen_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
                        ...
                        <tr>
                            <td><b>Are personal grooming of the staff satisfactory - hairs, nails cut short, clean
                                    uniforms?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are all staffs wearing PPEs while handling food items, (cap, mask, hand care
                                    gloves)?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is it verified that no staff is suffering from gastrointestinal disorders such as
                                    diarrhea etc?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the daily cleaning of the kitchen done adequately?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the cooking area kept clean?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the fridge temperature maintained at 0-5 degree C?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are all food items that are stored kept closed?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is cooked food kept above 65 Degree C?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the freezer temperature kept below -3 Degree C?</b></td>
                            <td>
                                <?php $val = isset($param['freezer_temp']) ? strtolower(trim($param['freezer_temp'])) : ''; ?>
                                <select class="form-control" name="freezer_temp">
                                    <option value="" <?php if ($val === '')
                                        echo 'selected'; ?>></option>
                                    <option value="Yes" <?php if ($val === 'yes')
                                        echo 'selected'; ?>>Yes</option>
                                ...
                                <div>
                                    Remarks:
                                    <input class="form-control" type="text" name="freezer_temp_text"
                                        value="<?php echo isset($param['freezer_temp_text']) ? htmlspecialchars($param['freezer_temp_text'], ENT_QUOTES, 'UTF-8') : ''; ?>"
                                        placeholder="Remarks">
                                </div>
                            </td>
                        </tr>
