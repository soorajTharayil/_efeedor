            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; IPSG4-Timeout- Outside OT
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_ipsg4_timeout_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Name of procedure</b></td>
                            <td>
                                <input type="text" class="form-control" name="identification_details"
                                    value="<?php echo isset($param['identification_details']) ? htmlspecialchars($param['identification_details'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Date and time of procedure</b></td>
                            <td>
                                <input class="form-control datetime-picker" type="datetime-local" name="vital_signs"
                                    value="<?php echo ($param['vital_signs'] && $param['vital_signs'] != '1970-01-01 05:30:00')
                                        ? date('Y-m-d\TH:i', strtotime($param['vital_signs']))
                                        : ''; ?>">
                            </td>
                        </tr>
