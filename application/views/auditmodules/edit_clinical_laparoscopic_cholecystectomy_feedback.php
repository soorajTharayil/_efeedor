            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Laparoscopic Cholecystectomy  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Was it an emergency cholecystectomy?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the patient have a bile duct injury?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have a bile leak post operatively?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have any post operative infection?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have any post operative complication, other than infection and bile duct injury?</td>
                            <td>
