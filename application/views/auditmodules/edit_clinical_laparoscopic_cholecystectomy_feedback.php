            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                        ...
                        Cholecystectomy - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_laparoscopic_cholecystectomy_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Was it an emergency cholecystectomy?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the patient have a bile duct injury?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient have a bile leak post operatively?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient have any post operative complication, other than infection and bile
                                    duct injury?</b></td>
                            <td>
