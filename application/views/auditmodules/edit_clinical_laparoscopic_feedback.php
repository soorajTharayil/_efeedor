            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Laparoscopic
                        appendicectomy - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_laparoscopic_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Was it an emergency appendicectomy?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the surgery get converted to open surgery?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient have any bowel injury?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient have any post operative complication other than bowel injury?</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Part B (filled after 30
                                days)</th>
                        </tr>
                        ...
                        <tr>
                            <td><b>Did this patient develop an intra-abdominal abscess during the first 30 days after
                                    surgery?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient get readmitted anytime for a condition related to surgery within 30
                                    days?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient require any procedural re intervention after surgery?</b></td>
                            <td>
