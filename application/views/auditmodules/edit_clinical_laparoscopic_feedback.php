            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Laparoscopic appendicectomy  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Was it an emergency appendicectomy?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the surgery get converted to open surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have any bowel injury?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have any post operative complication other than bowel injury?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient develop an intra-abdominal abscess during the first 30 days after surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient get readmitted anytime for a condition related to surgery within 30 days?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient require any procedural re intervention after surgery?</td>
                            <td>
