						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Point Prevalence Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_point_prevelance_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Is the patient’s skin intact?</td>
										<td>
									...
									<tr>
										<td>If not intact, specify type: HAPU, CAPU, DAP, IRD, or Other</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['vital_signs'])); ?><br>
											Remarks: <?php echo ucfirst(htmlspecialchars($param['vital_signs_text'])); ?>
										</td>
									</tr>
									

									<tr>
										<td>Number of ulcers or lesions identified</td>
										<td>
									...
									<tr>
										<td>Number of ulcers or lesions reported</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['complaints_communicated_text'])); ?>
										</td>
									</tr>
									

									<tr>
										<td>Stage of ulcer/lesion (1/2/3/4/NA)</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['intake_text'])); ?>
										</td>
									</tr>
									<tr>
										<td>Size of the ulcer/lesion (in cm or mm)</td>
										<td>
