            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; TKR -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_tkr_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>What was the type of surgery performed on this patient? (Robotic, Manual)</b></td>
                            <td>
                                <?php $val = isset($param['vital_signs']) ? strtolower(trim($param['vital_signs'])) : ''; ?>
                                <select class="form-control" name="vital_signs">
                                    <option value="" <?php if ($val === '')
                                        echo 'selected'; ?>></option>
                                    <option value="Robotic" <?php if ($val === 'robotic')
                                        echo 'selected'; ?>>Robotic
                                    </option>
                                    <option value="Manual" <?php if ($val === 'manual')
                        ...
                        <tr>
                            <td><b>Did this patient have any post operative infection?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient have any post operative complication, other than infection?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>What is this patientâ€™s knee society score - before surgery?</b></td>
                            <td>
                                <?php $val = isset($param['intake']) ? strtolower(trim($param['intake'])) : ''; ?>
                                <select class="form-control" name="intake">
                                    <option value="" <?php if ($val === '')
                                        echo 'selected'; ?>></option>
                                    <option value="Recorded" <?php if ($val === 'recorded')
                                        echo 'selected'; ?>>Recorded
                                    </option>
                                    <option value="Not Recorded" <?php if ($val === 'not recorded')
                                        echo 'selected'; ?>>
                                        Not Recorded</option>
                                    <option value="N/A" <?php if ($val === 'n/a')
                                        echo 'selected'; ?>>N/A</option>
                        ...
                        <tr>
                            <td><b>What is this patientâ€™s knee society score - after surgery?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient get re admitted within 30 days after surgery?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient require any revision surgery during admission?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient come for a review 30 days after surgery?</b></td>
                            <td>
