            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; TKR  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                       ...
                       <tr>
                        ...
                        <tr>
                            <td>What was the type of surgery performed on this patient? (Robotic, Manual)</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient have any post operative complication, other than infection?</td>
                            <td>
                        ...
                        <tr>
                            <td>What is this patient’s knee society score - before surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>What is this patient’s knee society score - after surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient require any revision surgery during admission?</td>
                            <td>
