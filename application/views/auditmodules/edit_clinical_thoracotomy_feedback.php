            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Thoracotomy  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did this patient develop Broncho-pleural fistula (BPF) after Thoracotomy?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient get readmitted anytime for a related condition within 30 days?</td>
                            <td>
