            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Stroke -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_stroke_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Imaging delay &lt; 20 minutes</td>
                            <td>
                        ...
                        <tr>
                            <td>Door to needle time &lt; 45min</td>
                            <td>
                        ...
                        <tr>
                            <td>Post IV tPA BP monitoring</td>
                            <td>
                        ...
                        <tr>
                            <td>Door to puncture within 60 minutes of arrival</td>
                            <td>
