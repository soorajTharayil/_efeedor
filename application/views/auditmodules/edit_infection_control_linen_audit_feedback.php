            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Linen Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_linen_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <th colspan="2">Linen Handling / Laundry Practices</th>
                            </tr>
                            <tr>
                                <td>Are Collection of linen & Handling adequately performed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Hygiene of containment area maintained adequately?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Protective measures by linen personnel during segregation adequate?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the Segregation of linen of infected patients adequate?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the Transportation of linen in carts adequately performed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is the Storage of clean linen adequate?</td>
                                <td>
