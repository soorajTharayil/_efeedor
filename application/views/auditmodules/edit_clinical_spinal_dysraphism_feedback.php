            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Spinal Dysraphism -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_spinal_dysraphism_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Did the patient experience limb weakness after spinal dysraphism?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the patient experience Bowel/Bladder incontinence after spinal dysraphism?</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient require a revision surgery?</b></td>
                            <td>
