            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Infection control bundle audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Are hand hygiene performed immediately prior to access or manipulation of the indwelling urinary catheter?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is Site of insertion cleaned with 2% CHG (chlorhexidine gluconate with alcohol) solution and transparent dressing changed, when it is wet, soiled, or dislodged?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are any erythema at or near the line insertion site is immediately reported & CVC removed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are access ports or hub cleaned with friction immediately prior to each use with 70% Alcohol swab?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Daily sedation free interval and daily assessment of readiness to extubate monitored & recorded?</td>
                                <td>
