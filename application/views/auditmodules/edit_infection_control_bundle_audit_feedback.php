            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Infection control bundle
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_bundle_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <th colspan="2">CAUTI</th>
                        </tr>
                        <tr>
                            <td>Is Adherence to aseptic technique while insertion satisfactory?</td>
                            <td>
                                <select name="identification_details" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['identification_details'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['identification_details'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['identification_details'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                        ...
                        <tr>
                            <td>Are indwelling urinary catheter continuously connected to the drainage system?</td>
                            <td>
                                <select name="vital_signs" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['vital_signs'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['vital_signs'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['vital_signs'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Meatal hygiene been performed at regular intervals?</td>
                            <td>
                                <select name="surgery" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['surgery'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['surgery'] ?? '') == 'No' ? 'selected' : ''; ?>>
                                        No</option>
                                    <option value="NA" <?php echo ($param['surgery'] ?? '') == 'NA' ? 'selected' : ''; ?>>
                                        NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Drainage bags are emptied when 3/4th full ?</td>
                            <td>
                                <select name="complaints_communicated" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['complaints_communicated'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['complaints_communicated'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['complaints_communicated'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are hand hygiene performed immediately prior to access or manipulation of the indwelling
                                urinary catheter?</td>
                            <td>
                                <select name="intake" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['intake'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['intake'] ?? '') == 'No' ? 'selected' : ''; ?>>
                                        No</option>
                                    <option value="NA" <?php echo ($param['intake'] ?? '') == 'NA' ? 'selected' : ''; ?>>
                                        NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Urine drainage bag kept below the Bladder level?</td>
                            <td>
                                <select name="output" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['output'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['output'] ?? '') == 'No' ? 'selected' : ''; ?>>
                                        No</option>
                                    <option value="NA" <?php echo ($param['output'] ?? '') == 'NA' ? 'selected' : ''; ?>>
                                        NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <th colspan="2">CLABSI</th>
                        </tr>
                        <tr>
                            <td>Are aseptic Practices adhered to while insertion of CVC?</td>
                            <td>
                                <select name="focus" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['focus'] ?? '') == 'Yes' ? 'selected' : ''; ?>>
                                        Yes</option>
                                    <option value="No" <?php echo ($param['focus'] ?? '') == 'No' ? 'selected' : ''; ?>>No
                                    </option>
                                    <option value="NA" <?php echo ($param['focus'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA
                                    </option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Is Site of insertion cleaned with 2% CHG (chlorhexidine gluconate with alcohol) solution
                                and transparent dressing changed, when it is wet, soiled, or dislodged?</td>
                            <td>
                                <select name="meti" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['meti'] ?? '') == 'Yes' ? 'selected' : ''; ?>>
                                        Yes</option>
                                    <option value="No" <?php echo ($param['meti'] ?? '') == 'No' ? 'selected' : ''; ?>>No
                                    </option>
                                    <option value="NA" <?php echo ($param['meti'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA
                                    </option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are any erythema at or near the line insertion site is immediately reported & CVC
                                removed?</td>
                            <td>
                                <select name="diagnostic" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['diagnostic'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['diagnostic'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['diagnostic'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are access ports or hub cleaned with friction immediately prior to each use with 70%
                                Alcohol swab?</td>
                            <td>
                                <select name="lab_results" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['lab_results'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['lab_results'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['lab_results'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Infusion lines and 3 way connectors changed every 72 hrs?</td>
                            <td>
                                <select name="pending_investigation" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['pending_investigation'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['pending_investigation'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['pending_investigation'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <th colspan="2">VAP/VAE</th>
                        </tr>

                        <tr>
                            <td>Are head end elevation of 30-45 degrees given?</td>
                            <td>
                                <select name="medicine_order" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['medicine_order'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['medicine_order'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['medicine_order'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Daily sedation free interval and daily assessment of readiness to extubate monitored
                                & recorded?</td>
                            <td>
                                <select name="psychological" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['psychological'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['psychological'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['psychological'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are peptic Ulcer Prophylaxis monitored?</td>
                            <td>
                                <select name="vulnerab" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['vulnerab'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['vulnerab'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['vulnerab'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are DVT prophylaxis monitored?</td>
                            <td>
                                <select name="social" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['social'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['social'] ?? '') == 'No' ? 'selected' : ''; ?>>
                                        No</option>
                                    <option value="NA" <?php echo ($param['social'] ?? '') == 'NA' ? 'selected' : ''; ?>>
                                        NA</option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Chlorhexidine gluconate mouth wash at regular intervals performed?</td>
                            <td>
                                <select name="nutri" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['nutri'] ?? '') == 'Yes' ? 'selected' : ''; ?>>
                                        Yes</option>
                                    <option value="No" <?php echo ($param['nutri'] ?? '') == 'No' ? 'selected' : ''; ?>>No
                                    </option>
                                    <option value="NA" <?php echo ($param['nutri'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA
                                    </option>
                                </select>
                                <strong>Remarks:</strong>
                        ...
                        <tr>
                            <td>Are Intermittent closed suctioning done?</td>
                            <td>
                                <select name="spiritual" class="form-control">
                                    <option value="">Select</option>
                                    <option value="Yes" <?php echo ($param['spiritual'] ?? '') == 'Yes' ? 'selected' : ''; ?>>Yes</option>
                                    <option value="No" <?php echo ($param['spiritual'] ?? '') == 'No' ? 'selected' : ''; ?>>No</option>
                                    <option value="NA" <?php echo ($param['spiritual'] ?? '') == 'NA' ? 'selected' : ''; ?>>NA</option>
                                </select>
                                <strong>Remarks:</strong>
