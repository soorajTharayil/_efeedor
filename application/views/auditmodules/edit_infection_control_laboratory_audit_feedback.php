            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Laboratory PCI Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Refrigerators and freezers temperatures are monitored on regularly basis and records are
                                kept.</td>
                            <td>
                        ...
                        <tr>
                            <td>A class type biological safety cabinet is available when working with highly infectious
                                agents. The type is dependent on the classification of the infectious agent.</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $val = isset($param['food']) ? strtolower(trim($param['food'])) : ''; ?>
                                ...
                                <div>
                                    Remarks:
                                    <input type="text" class="form-control" name="food_text"
                                        value="<?php echo isset($param['food_text']) ? htmlspecialchars($param['food_text'], ENT_QUOTES, 'UTF-8') : ''; ?>"
                                        placeholder="Remarks">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Waste and Sharp
                                Disposal</th>
                        </tr>

                        <tr>
                            <td>There are adequate colorâ€“coded footâ€“operated waste bins for regular infectious waste.
                                Bins are labeled.</td>
                            <td>
                        ...
                        <tr>
                            <td>There are adequate leak-proof sharps containers available. These should be wall mounted.
                                Sharps containers are replaced when they are three quarters Â¾.</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $val = isset($param['needle']) ? strtolower(trim($param['needle'])) : ''; ?>
                                <select class="form-control" name="needle">
                                    <option value="" <?php if ($val === '')
                                        echo 'selected'; ?>></option>
                                    <option value="Yes" <?php if ($val === 'yes')
                                        echo 'selected'; ?>>Yes</option>
                                ...
                                <div>Remarks:
                                    <input type="text" class="form-control" name="needle_text"
                                        value="<?php echo isset($param['needle_text']) ? htmlspecialchars($param['needle_text'], ENT_QUOTES, 'UTF-8') : ''; ?>"
                                        placeholder="Remarks">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Personal Protective
                                Equipment (PPE), Standard precautions and isolation</th>
                        </tr>
                        ...
                        <tr>
                            <td>Personnel respiratory protection is used when handling Tuberculosis or Suspected TB
                                specimens.</td>
                            <td>
                        ...
                        <tr>
                            <td>Person responsible for blood spill cleanup has adequate training and proper PPE for
                                procedures.</td>
                            <td>
                        ...
                        <tr>
                            <td>Housekeeper is educated in cleaning techniques using separate cleaning supplies for
                                regular cleaning, for bathrooms and for isolation rooms.</td>
                            <td>
                                <?php $val = isset($param['disch']) ? strtolower(trim($param['disch'])) : ''; ?>
                                <select class="form-control" name="disch">
                                    <option value="" <?php if ($val === '')
