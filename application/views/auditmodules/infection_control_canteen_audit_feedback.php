						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Canteen Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_infection_control_canteen_audit_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Are all staffs are wearing PPEs while handling food items, (cap, mask, hand care gloves)?</td>
										<td>
									...
									<tr>
										<td>Is it verified that no staffs are suffering from gastrointestinal disorders such as diarrhea etc?</td>
										<td>
									...
									<tr>
										<td>Is cooked food is kept above 65 Degree c?</td>
										<td>
