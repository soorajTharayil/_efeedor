            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Nursing (OP Closed Cases) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_nursing_op_closed_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td><b>Are Allergies entries available?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are all medication orders administered in HIS (eMAr)?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Nursing initial Assessment completed in 60 minutes?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Fall Risk Screening completed within 60 minutes of registration/Billing?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Patient & Family Education: Educational Status recorded?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Screening for abuse and neglect during initial assessment recorded?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Screening for alcohol or drug dependency during initial assessment recorded?</b></td>
                                <td>
