						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Pest Control Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_pest_control_audit_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
                                ...
                                <tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['pest_planned'])); ?><br>
											Remarks: <?php echo htmlspecialchars($param['pest_planned_remarks']); ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['pest_executed'])); ?><br>
											Remarks: <?php echo htmlspecialchars($param['pest_executed_remarks']); ?>
										</td>
									</tr>
