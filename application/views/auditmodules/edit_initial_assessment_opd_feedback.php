            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Initial Assessment OPD -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_initial_assessment_opd_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                       ...
                       <script>
                        ...
                        <tr>
                            <td><b>Is physical examination finding recorded?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Initial assessment done by:</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is initial admission assessment completed OPD?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is assessment done in defined TAT?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are allergies recorded?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Are fall risk assessment completed?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is general information recorded?</b></td>
                            <td>
