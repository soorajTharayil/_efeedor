            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Initial Assessment OPD - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                           ...
                           <tr>
                                <td>Is physical examination finding recorded?</td>
                                <td>
                            ...
                            <tr>
                                <td>Initial assessment done by:</td>
                                <td>
                            ...
                            <tr>
                                <td>Is initial admission assessment completed OPD ?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is assessment done in defined TAT?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are fall risk assessment completed?</td>
                                <td>
                            ...
                            <tr>
                                <td>Is general information recorded?</td>
                                <td>
