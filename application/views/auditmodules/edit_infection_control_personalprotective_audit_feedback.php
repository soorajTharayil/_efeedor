            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Personal Protective Equipment Usage audit  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_personalprotective_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Are Nurses wearing appropriate PPE while doing & assisting for aseptic procedures (Cap, Mask, Apron, Gloves)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Doctors wearing appropriate PPE while doing aseptic procedures (Cap, Mask, Apron, Gloves)?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Physiotherapists wearing appropriate PPE (Mask, Apron, Gloves) during the procedures?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Technicians (X-ray, Echo) wearing appropriate PPE (Gloves, Mask, Apron) during the procedures?</td>
                                <td>
                            ...
                            <tr>
                                <td>Are Housekeeping staff wearing appropriate PPE while cleaning & removing BM (Hard Gloves, Mask, Cap, Shoes)?</td>
                                <td>
