            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Heart Transplant
                        Recipient - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_heart_transplant_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did the patient physical and psychological condition - fit for surgery.</td>
                            <td>
                        ...
                        <tr>
                            <td>Inform the patient and relatives regarding the donors agree and came of the brain death.
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Inform the patient and relatives regarding organs health.</td>
                            <td>
                        ...
                        <tr>
                            <td>Was pre-operative workup/ assessment in outpatient department with Multi department
                                consultations done?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the consent taken by Doctors and operation team</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient shifted to operation Theatre with surgical safety checklist?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was Prophylactic antibiotic given at the induction of anaesthesia</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient shift to room from ICU after stabilization</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the Foleys catheter and lines inspected everyday</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the wound inspected everyday</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient discharged after stabilization and after getting consent from
                                Cardiologist, Cardiac Surgeon, Infection control physician and Nephrologist</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient get counselling from physiotherapist, Dietician, Social worker,
                                Co-ordinator and Clinical Pharmacist</td>
                            <td>
