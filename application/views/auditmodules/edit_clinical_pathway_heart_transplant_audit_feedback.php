            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Heart Transplant Recipient - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Inform the patient and relatives regarding the donors agree and came of the brain death.</td>
                                <td>
                            ...
                            <tr>
                                <td>Was pre-operative workup/ assessment in outpatient department with Multi department consultations done?</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the patient discharged after stabilization and after getting consent from Cardiologist, Cardiac Surgeon, Infection control physician and Nephrologist</td>
                                <td>
                            ...
                            <tr>
                                <td>Was the patient get counselling from physiotherapist, Dietician, Social worker, Co-ordinator and Clinical Pharmacist</td>
                                <td>
