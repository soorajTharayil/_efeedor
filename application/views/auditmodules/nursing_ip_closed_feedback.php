						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									MDC Audit – Nursing (IP Closed Cases) - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_nursing_ip_closed_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Are allergy entries documented?</td>
										<td>
									...
									<tr>
										<td>Are verbal/telephonic orders compliant with IPSG:2?</td>
										<td>
									...
									<tr>
										<td>Are all medication orders administered through HIS (eMAR)?</td>
										<td>
									...
									<tr>
										<td>Is triage documentation in emergency recorded?</td>
										<td>
									...
									<tr>
										<td>Is compliance to blood transfusion monitoring recorded?</td>
										<td>
									...
									<tr>
										<td>Is intra-cath monitoring performed?</td>
										<td>
									...
									<tr>
										<td>Is post-cath monitoring performed?</td>
										<td>
									...
									<tr>
										<td>Is pre-cath monitoring performed?</td>
										<td>
									...
									<tr>
										<th colspan="2">Discharge Process checklist</th>
									</tr>

									<tr>
										<td>Does the discharge process checklist assess transportation needs (Daycare, ED, IPD)?</td>
										<td>
									...
									<tr>
										<td>In the Haemodialysis Record, is there evidence of pain screening during initial assessment?</td>
										<td>
									...
									<tr>
										<th colspan="2">Mobile ICU transfer record</th>
									</tr>

									<tr>
										<td>In the Mobile ICU transfer record, is there evidence of patient handover to another facility?</td>
										<td>
									...
									<tr>
										<td>In the Mobile ICU transfer record, is the patient monitoring form available in the ambulance?</td>
										<td>
									...
									<tr>
										<td>Is the ability to learn, barriers to learning, and learning needs documented?</td>
										<td>
									...
									<tr>
										<td>Is the care plan documentation available?</td>
										<td>
									...
									<tr>
										<td>Is fall risk reassessment completed in every shift?</td>
										<td>
									...
									<tr>
										<td>Is shift-to-shift handover entry available?</td>
										<td>
									...
									<tr>
										<td>Is handover during inter-department transfer documented?</td>
										<td>
									...
									<tr>
										<td>Are invasive lines records documented?</td>
										<td>
									...
									<tr>
										<td>Is MEWS monitoring in wards done as per policy?</td>
										<td>
									...
									<tr>
										<td>Is pain reassessment recorded, if applicable?</td>
										<td>
									...
									<tr>
										<td>Is risk of self-harm assessment documented, if applicable?</td>
										<td>
									...
									<tr>
										...
										<tr>
										<td>Is fall risk assessment completed within 2 hours of admission?</td>
										<td>
										...
										<tr>
										<td>Is fall risk reassessment completed, if applicable?</td>
										<td>
										...
										<tr>
										<td>Is nursing initial assessment completed within 60 minutes?</td>
										<td>
										...
										<td>
											...
											Remarks: <?php echo htmlspecialchars($param['urine_samplel_text']); ?>
										</td>
									</tr>
										<tr>
										<td>Is pain screening done during initial assessment?</td>
										<td>
										...
										<tr>
										<td>Is patient and family education status documented?</td>
										<td>
									...
									<tr>
										<td>Is screening for abuse and neglect during initial assessment documented?</td>
										<td>
									...
									<tr>
										<td>Is screening for alcohol or drug dependency during initial assessment documented?</td>
										<td>
									...
									<tr>
										<td>Is fall risk screening completed within 30 minutes of registration/billing?</td>
										<td>
									...
									<tr>
										<td>Is nursing initial assessment completed within 30 minutes?</td>
										<td>
									...
									<tr>
										<td>Is care plan documentation available?</td>
										<td>
									...
									<tr>
										<td>Is nursing initial assessment completed within 4 hours for ICU patients?</td>
										<td>
									...
									<tr>
										<td>Is nursing initial assessment completed within 6 hours for ward patients?</td>
										<td>
									...
									<tr>
										<th colspan="2">PACU or Post Sedation Discharge notes</th>
									</tr>
									<tr>
										<td>Is care plan documentation recorded?</td>
										<td>
									...
									<tr>
										<td>Is fall risk reassessment completed every shift for post-surgery patients?</td>
										<td>
									...
									<tr>
										<td>Are vitals monitored in PACU recorded?</td>
										<td>
									...
									<tr>
										...
										<tr>
										<th colspan="2">Procedure Safety checklist</th>
									</tr>
									<tr>
										<td>Is procedure safety checklist documented outside OT (e.g., Endoscopy, ENT, OPD Procedure Room, Radiology, Urology)?</td>
										<td>
									...
									<tr>
										<th colspan="2">Sedation documentation</th>
									</tr>
									<tr>
										<td>Does the sedation documentation include pre-sedation assessment?</td>
										<td>
									...
									<tr>
										<td>Does the sedation documentation include pre-sedation assessment and monitoring during endoscopy, ED, or ICU?</td>
										<td>
									...
									<tr>
										<th colspan="2">Surgical Safety checklist</th>
									</tr>
									<tr>
										<td>Is sign-in recorded?</td>
										<td>
