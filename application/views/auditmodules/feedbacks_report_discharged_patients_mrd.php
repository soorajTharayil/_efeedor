			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Discharged Patients MRD Audit - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								title="Download detailed audit report"
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_discharged_patients_mrd' ?>">
					...
					<div class="panel-body">
						<table class="Discharged table table-striped table-hover table-bordered" cellspacing="0"
							width="100%">
							<thead>
							...
							<tbody>
								...
								<?php foreach ($feedbacktaken as $r) {
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>"
										onclick="window.location='<?php echo $discharged_patients_mrd_feedback . $id; ?>';"
										...
										<td>
											<a href="<?php echo $discharged_patients_mrd_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_discharged_patients_mrd"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>Discharged Patients MRD Audit 2023</h3>
			<p>${reportText}</p>
