            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Uro-oncology procedures -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_uro_oncology_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>For how many days after surgery was this patient kept NPO/ on NGT?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient require ventilatory support for more than 48 hours after
                                    surgery?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient have any post operative complications?</b></td>
                            <td>
