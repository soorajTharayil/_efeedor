            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Uro-oncology procedures   - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                       ...
                       <tr>
                            <td>For how many days after surgery was this patient kept NPO/ on NGT?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient require ventilatory support for more than 48 hours after surgery?</td>
                            <td>
