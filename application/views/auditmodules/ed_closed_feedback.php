						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Clinicians–ED (Closed) - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_ed_closed_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Is the General Consent form obtained?</td>
										<td>
									...
									<tr>
										<td>Is Triage completed soon after the arrival?</td>
										<td>
									...
									<tr>
										<td>Is the initial assessment completed within 10 minutes of arrival?</td>
										<td>
									...
									<tr>
										<td>Is it ensured that only approved abbreviations are used?</td>
										<td>
									...
									<tr>
										<td>Are the Chief complaints and history are documented in Initial assessment?</td>
										<td>
									...
									<tr>
										<td>Are the Physical examination and diagnosis documented in Initial assessment?</td>
										<td>
									...
									<tr>
										<td>Is the time of arrival documented in Initial assessment?</td>
										<td>
									...
									<tr>
										<td>Is the time of discharge documented in ED Discharge summary?</td>
										<td>
									...
									<tr>
										<td>Are Advise and follow up instructions documented in ED Discharge summary?</td>
										<td>
									...
									<tr>
										<td>Is the ED transfer note documented if the patient is admitted?</td>
										<td>
									...
									<tr>
										<td>Is the Transfer order documented for Referred /Transferred patient?</td>
										<td>
									...
									<tr>
										<td>Is the consent for transfer obtained for the Referred/Transferred patient?</td>
										<td>
									...
									<tr>
										<td>Is Transfer summary/Discharge summary complete?</td>
										<td>
									...
									<tr>
										<td>Is the name of the accepting physician/organization documented?</td>
										<td>
									...
									<tr>
										<td>Is the Record during transfer complete?</td>
										<td>
