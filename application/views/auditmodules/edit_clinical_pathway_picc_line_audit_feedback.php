            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; PICC LINE Insertion -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_picc_line_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Procedure safety checklist completed</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the patient prepared using Chlorhexidine?</td>
                            <td>
                        ...
                        <tr>
                            <td>Procedure done under sedation</td>
                            <td>
                        ...
                        <tr>
                            <td>Insertion procedure done</td>
                            <td>
                        ...
                        <tr>
                            <td>Back flow of blood present</td>
                            <td>
                        ...
                        <tr>
                            <td>Post-Insertion Confirmation done</td>
                            <td>
                        ...
                        <tr>
                            <td>Post procedure management and education</td>
                            <td>
                        ...
                        <tr>
                            <td>Additional remarks if any</td>
                            <td>
