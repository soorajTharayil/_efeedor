						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Clinical Dietetics (closed) - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_clinical_closed_mdc_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Is Initial assessment done within 24 hrs?</td>
										<td>
									...
									<tr>
										<td>Is Diagnosis recorded in Initial assessment?</td>
										<td>
									...
									<tr>
										<td>Are food allergies recorded in initial assessment?</td>
										<td>
									...
									<tr>
										<td>Are food preferences recorded in initial assessments?</td>
										<td>
									...
									<tr>
										<td>Are all columns of food intake filled?</td>
										<td>
									...
									<tr>
										<td>Are Biochemical Markers, Nutrition Assessment Rating, Plan of Care filled?</td>
										<td>
									...
									<tr>
										<td>Is the Dieticians Name, Signature, Date & Time filled?</td>
										<td>
									...
									<tr>
										<td>Is Nutritional Risk Assessment filled?</td>
										<td>
									...
									<tr>
										<th colspan="2">Diet Progress note</th>
									</tr>
									<tr>
										<td>Is Name & Date filled?</td>
										<td>
									...
									<tr>
										<td>Is Energy, Protein, Nutrition Plan filled?</td>
										<td>
									...
									<tr>
										<td>Is Dietician comment entered?</td>
										<td>
