						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Extravasation Audit - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_extravasation_audit_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['identification_details_text'])); ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['vital_signs'])); ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['surgery_text'])); ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['intake_text'])); ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<?php echo ucfirst(htmlspecialchars($param['output_text'])); ?>
										</td>
									</tr>
									<tr>
										<td>What was the drug concentration and total volume infused?</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['allergies_text'])); ?>
										</td>
									</tr>
									<tr>
										<td>What was the duration and rate of infusion?</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['medication_text'])); ?>
										</td>
									</tr>
									<tr>
										<td>What method of infusion was used? (e.g., manual bolus, pump-driven)</td>
										<td>
											<?php echo ucfirst(htmlspecialchars($param['diagnostic_text'])); ?>
										</td>
									</tr>
									<tr>
