						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Initial Assessment IPD - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_initial_assessment_ipd_feedback/$id") ?>">
