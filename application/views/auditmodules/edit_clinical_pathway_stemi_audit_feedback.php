            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; STEMI-Primary PCI
                        Clinical Pathway - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Optimal Treatment as per doctorâ€™s advice</td>
                            <td>
                        ...
                        <tr>
                            <td>All discharge medications, discharge summary and procedure related documents provided to
                                patient</td>
                            <td>
