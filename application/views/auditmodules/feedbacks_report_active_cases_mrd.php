			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						...
						<div>
							<?php if (isset($_GET['filtertype']) && $_GET['filtertype'] === 'admission') { ?>
								<a class="btn btn-success" target="_blank" data-toggle="tooltip"
					...
					<div class="panel-body">
						<table class="activecasesmrd table table-striped table-hover table-bordered" cellspacing="0"
							width="100%">
							<thead>
							...
							<tbody>
								...
								<?php foreach ($feedbacktaken as $r) {
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>"
										onclick="window.location='<?php echo $active_cases_mrd_feedback . $id; ?>';"
