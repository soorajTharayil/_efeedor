			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Physiotherapy- (Open) - Audit Summary</strong>
						</div>
						<div>
					...
					<div class="panel-body">
						<table class="physiotherapy_open_mdc table table-striped table-hover table-bordered" cellspacing="0"
							width="100%">
							<thead>
							...
							<tbody>
								...
								<?php foreach ($feedbacktaken as $r) {
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>"
										onclick="window.location='<?php echo $physiotherapy_open_feedback . $id; ?>';"
										...
										<td>
											<a href="<?php echo $physiotherapy_open_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_physiotherapy_open_mdc"; // Replace with your API endpoint
