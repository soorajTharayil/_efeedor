            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Mortuary PCI Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_infection_control_mortuary_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Refrigerator temperature 2-8Â°C</td>
                            <td>
                        ...
                        <tr>
                            <td>Well ventilated room, designed so that cleaning is easily carried out and fly proofing
                                is there.</td>
                            <td>
                        ...
                        <tr>
                            <td>Mortuary staff is informed of patients who have died from and was suffering of
                                communicable disease. Warning label is attached to them.</td>
                            <td>
                        ...
                        <tr>
                            <td>Hand washing facility available with microbial soap and tissue paper dispensers</td>
                            <td>
                        ...
                        <tr>
                            <td>Mortuary staff should wear gloves, rubber boots and gown â€“ when in contact with dead
                                body. Hands to be washed after removing the gloves.</td>
                            <td>
                        ...
                        <tr>
                            <td>If eyes are splashed, it should be thoroughly washed.</td>
                            <td>
                        ...
                        <tr>
                            <td>Daily cleaning and periodic disinfection (using floor disinfectant and surface
                                disinfectant).</td>
                            <td>
                        ...
                        <tr>
                            <td>There are adequate color-coded foot-operated waste bins for regular and infectious
                                waste. Bins are labeled.</td>
                            <td>
                        ...
                        <tr>
                            <td>There are adequate sinks available for hand washing.</td>
                            <td>
                        ...
                        <tr>
                            <td>All PPE are readily available to use.</td>
                            <td>
