            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Mechanical Thrombectomy  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did the patient experience Wire perforation after MT?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the patient have an embolization in a new or distal territory during the MT?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was the Arterial dissection detected after thrombectomy?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient come for a review 30 days after MT?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the patient have a repeat admission within 30 days after MT?</td>
                            <td>
