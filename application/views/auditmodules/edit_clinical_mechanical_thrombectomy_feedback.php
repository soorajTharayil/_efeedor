            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Mechanical Thrombectomy -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_mechanical_thrombectomy_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Did the patient experience Wire perforation after MT?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the patient have an embolization in a new or distal territory during the MT?</b>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td><b>Was the Arterial dissection detected after thrombectomy?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did this patient come for a review 30 days after MT?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the patient have a repeat admission within 30 days after MT?</b></td>
                            <td>
