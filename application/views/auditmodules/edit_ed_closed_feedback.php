            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Clinicians–ED (Closed) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_ed_closed_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td><b>Is the General Consent form obtained?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the General Consent form complete?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Triage completed soon after the arrival?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the initial assessment completed within 10 minutes of arrival?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is it ensured that only approved abbreviations are used?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are the Physical examination and diagnosis documented in Initial assessment?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the time of arrival documented in Initial assessment?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the time of discharge documented in ED Discharge summary?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are Advise and follow up instructions documented in ED Discharge summary?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the ED transfer note documented if the patient is admitted?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the Transfer order documented for Referred /Transferred patient?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the consent for transfer obtained for the Referred/Transferred patient?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Transfer summary/Discharge summary complete?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the name of the accepting physician/organization documented?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the Record during transfer complete?</b></td>
                                <td>
