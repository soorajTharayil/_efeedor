            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Point Prevalence Audit -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_point_prevelance_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Is the patientâ€™s skin intact?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>If not intact, specify type: HAPU, CAPU, DAP, IRD, or Other</b></td>
                            <td>
                                <?php $val = isset($param['vital_signs']) ? strtolower(trim($param['vital_signs'])) : ''; ?>
                                <select class="form-control" name="vital_signs">
                                    <option value="" <?php if ($val === '')
                                        echo 'selected'; ?>></option>
                                    <option value="HAPU" <?php if ($val === 'hapu')
                                        echo 'selected'; ?>>HAPU</option>
                                    <option value="CAPU" <?php if ($val === 'capu')
                                        echo 'selected'; ?>>CAPU</option>
                                    <option value="DAP" <?php if ($val === 'dap')
                                        echo 'selected'; ?>>DAP</option>
                                    <option value="IRD" <?php if ($val === 'ird')
                                        echo 'selected'; ?>>IRD</option>
                                    <option value="Other" <?php if ($val === 'other')
                                        echo 'selected'; ?>>Other</option>
                                </select>
                                <div>
                                    Remarks:
