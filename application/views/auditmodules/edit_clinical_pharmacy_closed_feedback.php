            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Clinical Pharmacy-(Closed) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pharmacy_closed_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td><b>Is Past medication History available?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Drug appropriateness review noted?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are Current Medication details available?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the Source of Information noted?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the Physician decision recorded?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Reconciliation during Transfer done?</b></td>
                                <td>
