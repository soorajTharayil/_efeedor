						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									IPSG-2-ER  - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_ipsg2_er_feedback/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										<td>Is ISBAR format used during handover between staff/units?</td>
										<td>
									...
									<tr>
										<td>Are interdepartmental transfers (ED → Ward/ICU/OT) documented using a transfer checklist?</td>
										<td>
									...
									<tr>
										<td>Are critical content of hand over, investigation and pending procedures clearly mentioned during hand over?</td>
										<td>
									...
									<tr>
										<td>Is medication handover complete (time, dose, high-alert drugs, infusions, etc.)?</td>
										<td>
									...
									<tr>
										<td>Is family/patient education documented (diagnosis, plan, transfer, safety measures)?</td>
										<td>
									...
									<tr>
										<td>Are shift handovers done at bedside with active participation of incoming team?</td>
										<td>
