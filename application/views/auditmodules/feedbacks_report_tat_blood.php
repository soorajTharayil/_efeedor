			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="tatblood table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Transfusion request time</th>
								<th>Blood received time</th>
								<th>TAT for issue of blood and blood components</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $tat_blood_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo $r->transfusion; ?></td>
										<td><?php echo $r->transfusion_request_time; ?></td>
										<td><?php echo $r->blood_received_time; ?></td>
										<td><?php echo $r->tat_blood; ?></td>
										<td><?php echo $r->benchmark; ?></td>
										<td><?php echo $r->transfusion_started_time; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_tat_blood"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>TAT FOR BLOOD ISSUE REPORT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'TAT FOR BLOOD ISSUE REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
