			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="ssi table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Staff name</th>
								<th>Is the patient diagnosed by following all clinical protocols?</th>
								<th>Are allergies mentioned?</th>
								<th>Are the 5 moments of hand hygiene followed?</th>
								<th>Has the patient been scrubbed or bathed with an antiseptic solution prior to surgery?</th>
								<th>Is the patient’s hair clipped or removed as required?</th>
								<th>Is the patient’s skin cleaned before surgery?</th>
								<th>Are prophylactic antibiotics administered within 60 minutes before the incision?</th>
								<th>Are all surgical team members scrubbed and in proper OT attire?</th>
								<th>Are the surgical instruments properly sterilized?</th>
								<th>Have informed consents been taken and duly signed?</th>
								<th>Is the patient covered with a drape?</th>
								<th>Are blood glucose levels monitored and maintained?</th>
								<th>Is foot traffic in the surgical area restricted to a minimum?</th>
								<th>Are the patient details, surgery, site, and procedures read before the incision?</th>
								<th>Are the counts of instruments and consumables listed out before the procedure?</th>
								<th>Is a sterile technique followed throughout the procedure?</th>
								<th>Is hypothermia maintained during the procedure?</th>
								<th>Are vitals and fluid balances continuously monitored?</th>
								<th>Are counts of instruments and consumables performed after the procedure?</th>
								<th>Is a sterile dressing applied?</th>
								<th>Are post-operative antibiotics administered?</th>
								<th>Is the surgical site assessed?</th>
								<th>Are necessary wound management instructions documented?</th>
								<th>Are pre-operative, intra-operative, and post-operative notes and advice documented?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $ssi_bundle_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo $r->instruments; ?></td>
										<td><?php echo $r->sterile; ?></td>
										<td><?php echo $r->antibiotics; ?></td>
										<td><?php echo $r->surgical_site; ?></td>
										<td><?php echo $r->wound; ?></td>
										<td><?php echo $r->documented; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_ssi_bundle"; // Replace with your API endpoint
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'SSI BUNDLE CARE POLICY.png';
			link.click();
		};
		img.src = chartImage;
	}
