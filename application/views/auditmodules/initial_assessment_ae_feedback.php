						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									Initial Assessment Accident and Emergency (A&E) - <?php echo $result->id; ?>
								</h3>
							</div>
							 <?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_initial_assessment_ae_feedback/$id") ?>">
								...
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											...
											Remarks: <?php echo htmlspecialchars($param['identification_remarks']); ?>
										</td>
									</tr>
