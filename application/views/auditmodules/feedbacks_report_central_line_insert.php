			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="central table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Staff name</th>
								<th>Have alternatives been considered and documented?</th>
								<th>Has the patient been confirmed using two identifications?</th>
								<th>Are the clinical reasons for insertion specified, communicated to the patient/bystander, and documented?</th>
								<th>Has the need, possible complications, potential outcomes, and procedure been explained, and has the patient/bystander's informed consent been obtained by the performing doctor?</th>
								<th>Have the person performing the procedure and their assistants performed hand hygiene?</th>
								<th>Is the person performing the procedure wearing PPE?</th>
								<th>Is the person performing the procedure using sterile gloves?</th>
								<th>Is the insertion kit available?</th>
								<th>Has the insertion site been prepared with chlorhexidine/alcohol, and has hand hygiene been re-performed?</th>
								<th>Has the site been properly positioned and draped?</th>
								<th>Was local anesthesia or sedation used?</th>
								<th>Was aseptic technique maintained throughout the insertion, and was hand hygiene re-performed?</th>
								<th>Is it ensured that lumens are not cut?</th>
								<th>Are unused ports clamped?</th>
								<th>Has blood been aspirated from each lumen, and is the site cleaned?</th>
								<th>Has the site been checked and cleaned with chlorhexidine?</th>
								<th>Has sterile dressing been applied, and has hand hygiene been re-performed?</th>
								<th>Has the placement been verified by X-Ray?</th>
								<th>Has the patient/bystander been educated regarding central line care and the frequency of follow-ups, and has the procedure been documented?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $central_line_insert_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_central_line_insert"; // Replace with your API endpoint
...
<script>
	function printChart() {
		...
		<body>
			<h3>CENTRAL LINE INSERTION CHECKLIST</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'CENTRAL LINE INSERTION CHECKLIST.png';
			link.click();
		};
		img.src = chartImage;
	}
