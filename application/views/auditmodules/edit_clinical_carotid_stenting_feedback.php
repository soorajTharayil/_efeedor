            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; carotid Stenting  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_carotid_stenting_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Did the patient have hyperperfusion after stenting?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was there a stroke in the patient after stenting?</td>
                            <td>
                        ...
                        <tr>
                            <td>Was there IC bleed in the patient after stenting?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient come for a review 30 days after Stenting?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the patient have a repeat admission within 30 days after initial discharge?</td>
                            <td>
