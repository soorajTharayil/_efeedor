            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Clinicians–Anesthesia (Active) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_anesthesia_active_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td><b>Is the high-risk procedures and treatments consent form (includes surgical or invasive procedures) available in the health record of an applicable patient?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are the risks, benefits, and alternatives of anesthesia, moderate sedation, or deep sedation explained and fully documented on administration of anesthesia consent form?</b></td>
                                <td>
                            ...
                            <tr>
                                <th colspan="2">Anesthesia documents</th>
                            </tr>
                            
                            <tr>
                                <td><b>Is Planned care documented in the form of measurable progress (goals)?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is a pre-anesthesia assessment completed for an applicable patient?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is a pre-induction assessment completed immediately before induction?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is a Plan of Anesthesia documented?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Post Anesthesia order completed?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is the Anesthesia document completed?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is PACU Document complete?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are the times of each dose of anesthesia medications recorded?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Are names of Anesthesia staff including technicians recorded?</b></td>
                                <td>
