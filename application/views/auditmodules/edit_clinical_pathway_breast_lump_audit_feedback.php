            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Breast Lump Consensus
                        Guidelines - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Whether BIRADS 3 patients were followed up with repeat imaging within 4 to 6 months.
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>In BIRADS 4 and 5 patients whether all patients underwent prior tissue diagnosis before
                                surgery</td>
                            <td>
