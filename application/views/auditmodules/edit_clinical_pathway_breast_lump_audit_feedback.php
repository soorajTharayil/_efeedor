            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Breast Lump Consensus Guidelines - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_pathway_breast_lump_audit_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Whether imaging is done prior to obtaining tissue for diagnosis.</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether BIRADS 3 patients were followed up with repeat imaging within 4 to 6 months.</td>
                                <td>
                            ...
                            <tr>
                                <td>In BIRADS 4 and 5 patients whether all patients underwent prior tissue diagnosis before surgery</td>
                                <td>
                            ...
                            <tr>
                                <td>Whether all patients taken up for surgery with prior preoperative staging workup.</td>
                                <td>
