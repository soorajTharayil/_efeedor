            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Allogenic Bonemarrow
                        transplantation - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_allogenic_bone_marrow_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Was there mortality after 30 days of bone marrow transplant?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Was there mortality after 100 days of bone marrow transplant?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Did the patient undergo engraftment post-transplant?</b></td>
                            <td>
