			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="handover table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Designation</th>
								<th>Staff name</th>
								<th>Were patient identification details communicated?</th>
								<th>Were patient's vital signs communicated?</th>
								<th>Was admitting diagnosis communicated?</th>
								<th>Were presenting complaints communicated?</th>
								<th>Was patient's intake communicated?</th>
								<th>Was patient's output communicated?</th>
								<th>Were any allergies communicated?</th>
								<th>Was medication administered communicated?</th>
								<th>Were diagnostic results communicated?</th>
								<th>Were pending lab results communicated?</th>
								<th>Were pending investigations communicated?</th>
								<th>Were new medicine orders communicated?</th>
								<th>Was transfer of patient communicated?</th>
								<th>Was health education given?</th>
								<th>Was risk assessment communicated?</th>
								<th>Were any other details communicated?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $handover_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo $r->relevant_details; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_handover"; // Replace with your API endpoint
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'HANDOVER AUDIT REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
