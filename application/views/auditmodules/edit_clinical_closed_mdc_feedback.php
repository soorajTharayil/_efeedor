            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Clinical Dietetics (closed) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_closed_mdc_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td><b>Is Signature available?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Energy, Protein, Nutrition Plan filled?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Dietician comment entered?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is date and time filled?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is Diet Advice entered?</b></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Is signature entered?</b></td>
                                <td>
