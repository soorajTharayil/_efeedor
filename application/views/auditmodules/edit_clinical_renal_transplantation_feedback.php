            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Renal Transplantation  - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_clinical_renal_transplantation_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <th colspan="2" style="background-color: #f5f5f5; text-align: left;">Filled in after procedure</th>
                        </tr>
                        
                        <tr>
                            <td>Did this patient have any post transplantation complications?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did the patient undergo a living donor kidney transplantation?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is the graft surviving at the review after completion of the first year?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is the graft surviving at the review after completion of the third year?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient come for a review 1 year after surgery?</td>
                            <td>
                        ...
                        <tr>
                            <td>Did this patient come for a review 3 year after surgery?</td>
                            <td>
