            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Cliniciansâ€“Sedation
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_sedation_active_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td>Are the risks, benefits, potential complications and alternatives to surgery explained
                                and fully documented on high-risk procedures and treatments consent form (includes
                                surgical or invasive procedures)?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is the administration of anesthesia/sedation consent form available in the health record
                                of an applicable patient?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is the risks, benefits, and alternatives of anesthesia, moderate sedation, or deep
                                sedation explained and fully documented on administration of anesthesia consent form?
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>Is a pre-sedation assessment performed on an applicable patient?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is an applicable patient monitored during sedation?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is a Patient post sedation status monitored until reach recovery criteria?</td>
                            <td>
                        ...
                        <tr>
                            <td>Is Procedure Note / Report documented?</td>
                            <td>
