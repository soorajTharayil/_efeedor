            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Accidental Delining Audit
                        - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_accidental_delining_feedback_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Date & Time of Insertion</b></td>
                            <td>
                                <input class="form-control datetime-picker" type="datetime-local"
                                    name="initial_assessment_hr5" value="<?php echo ($param['initial_assessment_hr5'] && $param['initial_assessment_hr5'] != '1970-01-01 05:30:00')
                                        ? date('Y-m-d\TH:i', strtotime($param['initial_assessment_hr5']))
                                        : ''; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Site of insertion</td>
                            <td>
                                <input type="text" name="vital_signs" class="form-control"
                                    value="<?php echo htmlspecialchars($param['vital_signs']); ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Date & Time of Declining</b></td>
                            <td>
                                <input class="form-control datetime-picker" type="datetime-local"
                                    name="initial_assessment_hr3" value="<?php echo ($param['initial_assessment_hr3'] && $param['initial_assessment_hr3'] != '1970-01-01 05:30:00')
                                        ? date('Y-m-d\TH:i', strtotime($param['initial_assessment_hr3']))
                                        : ''; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td><b>Was the line secured with appropriate dressing/ tape?</b></td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2">Type of line</th>
                        </tr>

                        <tr>
                            <td><b>a) Central venous catheter (CVC)</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>b) Peripherally inserted central catheter (PICC)</b></td>
                            <td>
                        ...
                        <tr>
                            <th colspan="2">Causative factor</th>
                        </tr>

                        <tr>
                            <td><b>a) Restlessness or agitation</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>b) Frequent movement or ambulation</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>c) Inadequate monitoring of the line</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>d) Poor adherence to securing techniques</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>e) Lapse in following line-care protocols</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>f) Crowded or cluttered patient area</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>g) Line caught on bed rails or equipment</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>h) Patient factors (Excessive sweating)</b></td>
                            <td>
