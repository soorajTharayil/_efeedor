            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp; Accidental Delining Audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>Date & time of insertion</td>
                                <td>
                                    <input type="text" name="initial_assessment_hr5" class="form-control"
                                           value="<?php echo htmlspecialchars($param['initial_assessment_hr5']); ?>">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Date & time of delining</td>
                                <td>
                                    <input type="text" name="initial_assessment_hr3" class="form-control"
                                           value="<?php echo htmlspecialchars($param['initial_assessment_hr3']); ?>">
                                </td>
                            </tr>
                            
                            <tr>
                                <td>Was the line secured with appropriate dressing/ tape?</td>
                                <td>
                            ...
                            <tr>
                                <td>a) Central venous catheter (CVC)</td>
                                <td>
                            ...
                            <tr>
                                <td>b) Peripherally inserted central catheter (PICC)</td>
                                <td>
                            ...
                            <tr>
                                <td>a) Restlessness or agitation</td>
                                <td>
                            ...
                            <tr>
                                <td>b) Frequent movement or ambulation</td>
                                <td>
                            ...
                            <tr>
                                <td>c) Inadequate monitoring of the line</td>
                                <td>
                            ...
                            <tr>
                                <td>d) Poor adherence to securing techniques</td>
                                <td>
                            ...
                            <tr>
                                <td>e) Lapse in following line-care protocols</td>
                                <td>
                            ...
                            <tr>
                                <td>f) Crowded or cluttered patient area</td>
                                <td>
                            ...
                            <tr>
                                <td>g) Line caught on bed rails or equipment</td>
                                <td>
                            ...
                            <tr>
                                <td>h) Patient factors (Excessive sweating)</td>
                                <td>
