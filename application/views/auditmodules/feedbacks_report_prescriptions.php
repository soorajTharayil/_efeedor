			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="prescriptions table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Is the prescription written in capital?</th>
								<th>Is the administration route mentioned?</th>
								<th>Is the dose mentioned?</th>
								<th>Is the frequency mentioned?</th>
								<th>Is the patient identification present?</th>
								<th>Does it use non-standard abbreviations?</th>
								<th>Is the date mentioned?</th>
								<th>Is the name & sign of Doctor present?</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $prescriptions_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td><?php echo $r->date_mentioned; ?></td>
										<td><?php echo $r->sign_doctor; ?></td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = baseUrl +  "/analytics_audit_quality/resposnsechart_prescriptions"; // Replace with your API endpoint
				...
				tooltips: {
					...
					callbacks: {
						label: function(tooltipItems, data) {
							...
							multistringText.push("Audit Form Collected: " + all_detail.count);
...
<script>
	function printChart() {
		...
		<body>
			<h3>PRESCRIPTIONS AUDIT REPORT</h3>
			<p>${reportText}</p>
...
<script>
	function downloadChartImage() {
		...
		img.onload = function() {
			...
			link.download = 'PRESCRIPTIONS AUDIT REPORT.png';
			link.click();
		};
		img.src = chartImage;
	}
