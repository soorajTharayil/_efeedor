			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>Admission Holding Area Audit - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								title="Download detailed audit report"
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_admission_holding_area' ?>">
					...
					<div class="panel-body">
						<table class="admission_area_audit table table-striped table-hover table-bordered" cellspacing="0"
							width="100%">
							<thead>
							...
							<tbody>
								...
								<?php foreach ($feedbacktaken as $r) {
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>"
										onclick="window.location='<?php echo $admission_holding_area_feedback . $id; ?>';"
										...
										<td>
											<a href="<?php echo $admission_holding_area_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_admissionholding_area_audit"; // Replace with your API endpoint
