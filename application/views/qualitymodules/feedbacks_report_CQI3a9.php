<div class="content">
	...
	//individual link
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3a9?id=');
...
<script>
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			{
				label: ' Average Time for initial assessment of in-patients (Nurses)-(Nursing-Ward) ',
