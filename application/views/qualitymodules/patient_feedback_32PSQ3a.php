<div class="content">
	...
	?>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total no. of prescriptions in capital letters</b></td>
										<td>
											<?php echo $result->no_of_prescriptions_in_capitals; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of prescriptions</b></td>
										<td>
											<?php echo $result->no_of_prescriptions; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of compliance rate to medication prescription in capitals</b></td>
										<td>
											<?php echo $result->compliance_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_prescriptions_in_capitals; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_prescriptions; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Total no. of prescriptions in capital letters', 'Total no. of prescriptions'],
							datasets: [{
								label: 'Total no. of prescriptions in capital letters compare with Total no. of prescriptions',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of compliance rate to medication prescription in capitals for ' + monthyear,
									font: {
		...
		<body>
			<h3>32.PSQ3d- Compliance rate to medication prescription in capitals</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '32.PSQ3d- Compliance rate to medication prescription in capitals.png'; // Name of downloaded file
