<div class="content">
	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_27PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of variations observed in a mock drill</b></td>
										<td>
											<?php echo $result->no_of_variations; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total number of opportunities of variations</b></td>
										<td>
											<?php echo $result->no_of_variations_opportunities; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of number of variations observed in mock</b></td>
										<td>
											<?php echo $result->percentage_of_variations; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_variations; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_variations_opportunities; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Total number of variations observed in a mock drill', 'Total number of opportunities of variations'],
							datasets: [{
								label: 'Total number of variations observed in a mock drill compare with Total number of opportunities of variations',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of number of variations observed in mock for ' + monthyear,
									font: {
		...
		<body>
			<h3>27.PSQ4d- Number of variations observed in mock drills</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '27.PSQ4d- Number of variations observed in mock drills.png'; // Name of downloaded file
