<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Environmental cleaning &
									disinfection compliance rate(JCI8-PCI 4.0)-(House Keeping)<?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3g6/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No of Environmental cleaning & disinfection (terminal cleaning) completed</b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>No of Environmental cleaning & disinfection (terminal cleaning) Scheduled</b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Environmental cleaning & disinfection compliance rate(JCI8-PCI 4.0)-(House
												Keeping):</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['No of Environmental cleaning & disinfection (terminal cleaning) completed in the month', 'No of Environmental cleaning & disinfection (terminal cleaning) Scheduled in the month'],
				datasets: [{
					label: 'Environmental cleaning & disinfection compliance rate',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Environmental cleaning & disinfection compliance rate - ' + monthyear,
						font: {
