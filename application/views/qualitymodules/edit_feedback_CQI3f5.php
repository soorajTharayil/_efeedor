            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Turn-around time for blood and blood components cross matched / reserved(Blood Center)- <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3f5_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Total number of blood & blood components cross-matched/reserved</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Turn-around time for blood and blood components cross matched / reserved(Blood Center)is:</b></td>
                            <td>
