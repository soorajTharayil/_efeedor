<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Door to stroke team ≤15
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4j2/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total stroke cases assessed by the stroke team with in 15mins </b></td>
									...
									<tr>
										<td><b>Door to stroke team ≤15 min(Stroke Unit)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total stroke cases assessed by the stroke team with in <15mins', 'Total number of stroke patients in ED'],
				datasets: [{
					label: 'Door to stroke team ≤15 min',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Door to stroke team ≤15 min - ' + monthyear,
						font: {
