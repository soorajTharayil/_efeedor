					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patients undergoing dialysis who are able to achieve target hemoglobin levels (in Nos.)</th>

								<th>Total number of patients undergoing dialysis (in Nos.)</th>

								<th>Percentage of patients undergoing dialysis who are able to achieve target hemoglobin levels(Nephrology)</th>
