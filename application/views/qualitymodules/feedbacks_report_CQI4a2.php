					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4a2_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of drugs and consumables procured from inside the formulary and outside from
									local purchases (in Nos.)</th>

								<th>Percentage of of drugs and consumables procured by local purchase outside the
									formulary-(Pharmacy) </th>
