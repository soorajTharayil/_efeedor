					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4j12_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Total ischemic stroke patients receiving the intravenous thrombolysis with in
									appropriate time (in Nos.)</th>

								<th>Total eligible ischemic stroke patients receiving the intravenous thrombolysis with in
									appropriate time (in Nos.)</th>

								<th>Percentage of ischemic stroke patients eligible for intravenous thrombolysis who receive
									it within the appropriate time window(Stroke Unit)</th>
