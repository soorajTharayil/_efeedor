<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI4c7?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI4c7';
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of ICU bed utilised days  (in Nos.)</th>

								<th>ICU bed days available(in Nos.)</th>

								<th>ICU Bed utilisation rate (Nursing - ICU)</th>
