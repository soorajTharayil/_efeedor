					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_34psq3a_report' ?>">
					...
					<div class="panel-body">
						<table class="34psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Total no. of AMI patients during primary angioplasty for whom door to balloon time of 90
									minutes is achieved</th>
								<th>Total no. of AMI patients undergoing primary angioplasty</th>
								<th>Percentage of patients with myocardial infarction for whom door to balloon time of 90
									minutes</th>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_35ps"; // Replace with your API endpoint
