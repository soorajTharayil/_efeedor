<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CLOTCM30?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CLOTCM30';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CLOTCM30_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patient safety events (in Nos.)</th>

								<th>Total number of Leuco Depleted PRBC transfusions (in Nos.)</th>

								<th>Prevalence of transfusion reactions in Leuco depleted PRBC transfusions (Blood Center)</th>
