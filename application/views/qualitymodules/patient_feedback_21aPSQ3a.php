<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 21a. PSQ3c - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_21aPSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_of_nursing_staff; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of occupied beds</b></td>
										<td>
											<?php echo $result->no_of_beds; ?>
										</td>
									</tr>
									<tr>
										<td><b>Nurse-patient ratio</b></td>
										<td>
											<?php echo $result->nurse_patients_ratio; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_nursing_staff; ?>"; // Benchmark value
					var calculated = "<?php echo   $result->no_of_beds;  ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						data: {
							...
							datasets: [{
								label: 'Number of nursing staff compare with Number of occupied beds',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Nurse-patient ratio for ' + monthyear,
									font: {
		...
		<body>
			<h3>21a.PSQ3c- Nurse-patient ratio for Wards</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '21a.PSQ3c- Nurse-patient ratio for Wards.png'; // Name of downloaded file
