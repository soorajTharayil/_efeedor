<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Percentage of Beta-blocker
									prescriptions with a diagnosis of CHF with reduced EF - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3a11/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of patients discharged with a diagnosis of CHF with reduced EF and prescribed
												a beta blocker at discharge</b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Number of patients discharged with a diagnosis of CHF</b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Percentage of Beta-blocker prescriptions with a diagnosis of CHF with reduced EF</b>
										</td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of patients discharged with a diagnosis of CHF with reduced EF ', 'Number of patients discharged with a diagnosis of CHF'],
				datasets: [{
					label: 'Percentage of Beta-blocker prescriptions with a diagnosis of CHF with reduced EF',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of Beta-blocker prescriptions with a diagnosis of CHF with reduced EF - ' + monthyear,
						font: {
