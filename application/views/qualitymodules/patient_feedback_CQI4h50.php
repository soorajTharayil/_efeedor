<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>To Monitor the energy
									consumption (JCI8-GHI 3)-(Engineering & Maintenance)<?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4h50/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total amount of energy used in the month</b></td>
									...
									<tr>
										<td><b>To Monitor the energy consumption (JCI8-GHI 3)-(Engineering & Maintenance)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total amount of energy used in the month', 'Total number of days per month'],
				datasets: [{
					label: 'To Monitor the energy consumption',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'To Monitor the energy consumption - ' + monthyear,
						font: {
