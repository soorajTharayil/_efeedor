	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_39PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of cases where bile duct injuries occurred</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Laparoscopic cholecystectomies performed</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Bile Duct Injury Rate</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['No. of cases where bile duct injuries occurred', 'Laparoscopic cholecystectomies performed'],
							datasets: [{
								label: 'No. of cases where bile duct injuries occurred compared to the laparoscopic cholecystectomies performed.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Bile Duct Injury Rate for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Bile Duct injury rate during Laparoscopic cholecystectomy</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Bile Duct injury rate during Laparoscopic cholecystectomy.png'; // Name of downloaded file
