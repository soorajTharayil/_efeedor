<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 26. PSQ4c - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_26PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of stock outs of emergency drugs</b></td>
										<td>
											<?php echo $result->emergency_drugs_stock; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of drugs listed as emergency drugs in hospital formulary</b></td>
										<td>
											<?php echo $result->no_listed_emergency_drugs; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of stock out rate for emergency medications</b></td>
										<td>
											<?php echo $result->percentage_stock_out_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->emergency_drugs_stock; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_listed_emergency_drugs; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of stock outs of emergency drugs', 'Number of drugs listed as emergency drugs in hospital formulary'],
							datasets: [{
								label: 'Number of stock outs of emergency drugs compare with Number of drugs listed as emergency drugs in hospital formulary',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of stock out rate for emergency medications for ' + monthyear,
									font: {
		...
		<body>
			<h3>26.PSQ4c- Stock out rate of emergency medications</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '26.PSQ4c- Stock out rate of emergency medications.png'; // Name of downloaded file
