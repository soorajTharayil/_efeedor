					...
					<div class="panel-body">
						<table class="35psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patients with hypoglycemic events where the target glucose level was achieved</th>
								<th>Number of patients with Hypoglycemic events</th>
								<th>Percentage of Hospitalized patients with hypoglycemia who achieved blood glucose level</th>
