<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_35PSQ3a?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_35PSQ3a';
					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_35psq3a_report' ?>">
								<i class="fa fa-download"></i>
							</a>
						</div>
					</div>
					<div class="panel-body">
						<table class="35psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patients with hypoglycemic events where the target glucose level was achieved
								</th>
								<th>Number of patients with Hypoglycemic events</th>
								<th>Percentage of Hospitalized patients with hypoglycemia who achieved blood glucose level
								</th>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_36ps"; // Replace with your API endpoint
