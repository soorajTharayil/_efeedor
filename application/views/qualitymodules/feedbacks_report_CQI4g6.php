					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of records compliant with approved abbreviations in the month (in Nos.)</th>

								<th>Total number of records reviewed in the month (in Nos.)</th>

								<th>Monthly Abbreviation Compliance(MRD)</th>
