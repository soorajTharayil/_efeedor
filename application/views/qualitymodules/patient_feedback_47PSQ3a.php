	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_47PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of patients who developed adverse reaction</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>No. of patients receiving the radiopharmaceutical</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of adverse reaction to radiopharmaceutical</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Patients who developed adverse reaction', 'No. of patients receiving the radiopharmaceutical'],
							datasets: [{
								label: 'Patients who developed adverse reaction compared to total no. of patients receiving the radiopharmaceutical',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of adverse reaction to radiopharmaceutical for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of adverse reaction to radiopharmaceutical</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of adverse reaction to radiopharmaceutical.png'; // Name of downloaded file
