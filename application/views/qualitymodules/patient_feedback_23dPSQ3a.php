	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 23d. PSQ4c - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_23dPSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of patients reported in CT scan</b></td>
										<td>
											<?php echo $result->no_of_patients_in_diagnostics; ?>
										</td>
									</tr>
									<tr>
										<td><b>Avg. waiting time for CT scan</b></td>
										<td>
											<?php
											...
											<span style="color: <?php echo $color; ?>">
												<?php echo $result->ctscan_wait_time; ?>
											</span>
										</td>
									</tr>
									<tr>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Benchmark Time', 'Avg. waiting time for CT scan'],
							datasets: [{
								label: 'Benchmark Time compared with Avg. waiting time for CT scan',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Avg. waiting time for CT scan for ' + monthyear,
									font: {
		...
		<body>
			<h3>23d.PSQ4c- Waiting time for CT scan diagnostics</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '23d.PSQ4c- Waiting time for CT scan diagnostics.png'; // Name of downloaded file
