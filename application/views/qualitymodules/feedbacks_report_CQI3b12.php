<div class="content">
	...
	//individual link
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3b12?id=');
	$table_feedback_2PSQ3a = 'bf_feedback_CQI3b12';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3b12_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a1 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Sum total patient reporting time (Out patients (in Hrs)</th>
								<th>Number of patients reported in Laboratory (in Nos.)</th>
								<th>Waiting time for Laboratory services for the month of (in Hrs)</th>
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [{
				...
				{
					label: ' Average Time for initial assessment of in-patients (Nurses)-(Nursing-ICU) ',
...
<script>
	function printChart() {
		...
		<body>
			<h3>Average Time for initial assessment of Emergency patients</h3>
...
<script>
	function downloadChartImage() {
		...
		link.href = image;
		link.download = 'Average Time for initial assessment of Emergency patients.png'; // Name of downloaded file
