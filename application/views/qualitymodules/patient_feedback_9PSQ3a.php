<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 9. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_9PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of transfusion reactions</b></td>
										<td>
											<?php echo $result->no_transfusion_reactions; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of units transfused (in Units)</b></td>
										<td>
											<?php echo $result->no_units_transfused; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of transfusion reactions</b></td>
										<td>
											<?php echo $result->percentage_of_transfusion_reactions; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_transfusion_reactions; ?>"; // Benchmark value
					var calculated = "<?php echo  $result->no_units_transfused; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of transfusion reactions', 'Number of units transfused (in Units)'],
							datasets: [{
								label: 'Number of transfusion reactions compare with Number of units transfused (in Units)',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of transfusion reactions for ' + monthyear,
									font: {
		...
		<body>
			<h3>9.PSQ3a- Percentage of transfusion reactions</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '9.PSQ3a- Percentage of transfusion reactions.png'; // Name of downloaded file
