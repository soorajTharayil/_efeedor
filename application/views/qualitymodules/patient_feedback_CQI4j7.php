<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Door to IV thrombolytic bolus
									(≥50% compliance) ≤45 min [Achieving Door to needle times (time of bolus administration) within
									45 minutes in 50% or more of acute ischemic stroke patients treated with IV thrombolytic(Stroke
									Unit) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4j7/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of cases with initiation of thrombolysis with in 45 minutes of arrival
											</b></td>
									...
									<tr>
										<td><b>Door to IV thrombolytic bolus (≥50% compliance) ≤45 min [Achieving Door to needle
												times (time of bolus administration) within 45 minutes in 50% or more of acute
												ischemic stroke patients treated with IV thrombolytic(Stroke Unit) </b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total number of cases with initiation of thrombolysis with in 45 minutes of arrival', 'Total number of stroke patients requiring thrombolysis'],
				datasets: [{
					label: 'Door to IV thrombolytic bolus',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Door to IV thrombolytic bolus - ' + monthyear,
						font: {
