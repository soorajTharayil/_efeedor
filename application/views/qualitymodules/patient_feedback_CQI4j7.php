						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4j7/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of cases with initiation of thrombolysis with in 45 minutes of arrival </b></td>
									...
									<tr>
										<td><b>Door to IV thrombolytic bolus (≥50% compliance) ≤45 min [Achieving Door to needle times (time of bolus administration) within 45 minutes in 50% or more of acute ischemic stroke patients treated with IV thrombolytic(Stroke Unit) </b></td>
