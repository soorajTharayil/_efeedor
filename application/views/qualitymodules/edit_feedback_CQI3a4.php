            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Percentage of Care-plan is documented for inpatients(MRD) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3a4_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateErrorRate(event) {
        ...
        if (numeratorValue === "") {
            alert("Please enter the number of case sheets where care plan is documented");
            numeratorField.focus();
            return;
        }

        if (denominatorValue === "") {
            alert("Please enter the total number of in-patients for the month");
        ...
        if (isNaN(numerator) || numerator < 0) {
            alert("Please enter a valid number for case sheets where care plan is documented");
            numeratorField.focus();
            return;
        }

        if (isNaN(denominator) || denominator < 0) {
            alert("Please enter a valid number for total number of in-patients for the month");
            denominatorField.focus();
            return;
        }
