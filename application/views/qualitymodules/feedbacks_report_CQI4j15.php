<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI4j15?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI4j15';
					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4j15_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patients with ischemic stroke developing SICH (in Nos.)</th>

								<th>Total number of patients receiving recanalization treatment(IVT/EVT /IVT+EVT) (in Nos.)
								</th>

								<th>Percentage of ischemic stroke patients who develop a symptomatic intracranial hemorrhage
									(i.e., clinical deterioration ≥ 4-point increase on NIHSS and brain image finding of
									parenchymal hematoma, or subarachnoid hemorrhage, or intraventricular hemorrhage) within
									(≤) 36 hours after the onset of treatment with intra-venous (IV) or intra-arterial (IA)
									thrombolytic (t-PA) therapy, or mechanical endovascular reperfusion procedure (i.e.,
									mechanical endovascular thrombectomy with a clot retrieval dev (Stroke Unit)</th>
