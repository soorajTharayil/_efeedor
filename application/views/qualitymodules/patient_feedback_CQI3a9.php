	...
	?>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Avg. Time for initial assessment of in-patients (Nurses)-(Nursing-Ward): (in Hrs)</b></td>
										<td>
											<?php
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['BenchMark Time','Average Time for initial assessment of in-patients'],
							datasets: [{
