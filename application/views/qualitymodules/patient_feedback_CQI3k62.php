<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Timeliness of initiation of
									advanced cardiovascular life support (ACLS) within 5 Min(JCI8-COP 4)-(Nursing
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3k62/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total no of code blue where ACLS protocols initiated within 5 min /b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total No of code blue activated in the month</b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Timeliness of initiation of advanced cardiovascular life support (ACLS) within 5
												Min(JCI8-COP 4)-(Nursing)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total no of code blue where ACLS protocols initiated within 5 min', 'Total No of code blue activated in the month'],
				datasets: [{
					label: 'Timeliness of initiation of advanced cardiovascular life support',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Timeliness of initiation of advanced cardiovascular life support - ' + monthyear,
						font: {
