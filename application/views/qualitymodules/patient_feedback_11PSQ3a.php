<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 11. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_11PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of returns to emergency within 72 hours with similar presenting complaints</b></td>
										<td>
											<?php echo $result->return_to_emergency; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of patients who have come to the emergency</b></td>
										<td>
											<?php echo $result->no_of_patients_emergency; ?>
										</td>
									</tr>
									<tr>
										<td><b>The percentage of patients returning to the emergency department within 72 hours with similar presenting complaints</b></td>
										<td>
											<?php echo $result->percentage_of_return; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo   $result->return_to_emergency;  ?>"; // Benchmark value
					var calculated = "<?php echo   $result->no_of_patients_emergency;  ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of returns to emergency within 72 hours', 'Number of patients who have come to the emergency'],
							datasets: [{
								label: 'Number of returns to emergency within 72 hours compare with Number of patients who have come to the emergency',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'The percentage of patients returning to the emergency department within 72 hours for ' + monthyear,
									font: {
		...
		<body>
			<h3>11.PSQ3a- Return to the emergency department within 72 hours with similar presenting complaints</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '11.PSQ3a- Return to the emergency department within 72 hours with similar presenting complaints.png'; // Name of downloaded file
