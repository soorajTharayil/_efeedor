	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_36PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Cases where a spontaneous perineal tear occurs', 'Total number of vaginal deliveries'],
							datasets: [{
								label: 'Cases where a spontaneous perineal tear occurs compared to the total number of vaginal deliveries.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of cases where a spontaneous perineal tear occurs for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Spontaneous Perineal Tear Rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Spontaneous Perineal Tear Rate.png'; // Name of downloaded file
