<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Average number of training
									hours(HR) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4e5/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td><?php echo htmlspecialchars($param->initial_assessment_hr2 ?? '00') . ':' . htmlspecialchars($param->initial_assessment_min2 ?? '00') . ':' . htmlspecialchars($param->initial_assessment_sec2 ?? '00'); ?>
										</td>
									</tr>
									<tr>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total hours of training attended', 'Total hours of training required to attend'],
				datasets: [{
					label: 'Average number of training hours',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Average number of training hours - ' + monthyear,
						font: {
