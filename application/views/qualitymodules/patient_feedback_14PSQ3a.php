<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 14. PSQ3b - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_14PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of “ventilator associated pneumonia” in a month</b></td>
										<td>
											<?php echo $result->no_of_pneumonia; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of ventilator days in that month</b></td>
										<td>
											<?php echo $result->no_ventilator_days; ?>
										</td>
									</tr>
									<tr>
										<td><b>Ventilator associated pneumonia rate (per 1000 ventilator days)</b></td>
										<td>
											<?php echo $result->ventilator_pneumonia_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_pneumonia; ?>"; // Benchmark value
					var calculated = "<?php echo  $result->no_ventilator_days; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of ventilator associated pneumonia in a month', 'Number of ventilator days in that month'],
							datasets: [{
								label: 'Number of ventilator associated pneumonia compare with Number of ventilator days ',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Ventilator associated pneumonia rate (per 1000 ventilator days) for ' + monthyear,
									font: {
		...
		<body>
			<h3>14.PSQ3b- Ventilator associated pneumonia rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '14.PSQ3b- Ventilator associated pneumonia rate.png'; // Name of downloaded file
