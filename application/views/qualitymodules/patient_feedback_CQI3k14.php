<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Time for first
									defibrillation-(Emergency Department) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3k14/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Numerator: Sum of (Time for first defibrillation applied - Time of code blue team
												reached the patient) (in Hrs)</b></td>
										<td><?php echo $param->initial_assessment_total; ?></td>
									</tr>
									<tr>
										<td><b>Denominator: Total number of code blue(in No.s)</b></td>
										<td><?php echo $param->total_admission; ?></td>
									</tr>
									<tr>
										<td><b>Time for first defibrillation-(Emergency Department) (in Hrs)</b></td>
										<td>
											<?php
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Sum of (Time for first defibrillation applied - Time of code blue team reached the patient)-', 'Total number of code blue'],
				datasets: [{
					label: 'Time for first defibrillation-',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Time for first defibrillation- - ' + monthyear,
						font: {
