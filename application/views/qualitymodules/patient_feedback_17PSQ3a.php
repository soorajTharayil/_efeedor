<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 17. PSQ3b - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_17PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of hand hygiene actions performed</b></td>
										<td>
											<?php echo $result->no_of_hygiene_action; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total number of hand hygiene opportunities</b></td>
										<td>
											<?php echo $result->no_of_hygiene_oppurtunities; ?>
										</td>
									</tr>
									<tr>
										<td><b>Hand hygiene compliance rate</b></td>
										<td>
											<?php echo $result->hygiene_compliance_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_hygiene_action; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_hygiene_oppurtunities; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Total number of hand hygiene actions performed', 'Total number of hand hygiene opportunities'],
							datasets: [{
								label: 'Total number of hand hygiene actions performed compare with Total number of hand hygiene opportunities',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Hand hygiene compliance rate for ' + monthyear,
									font: {
		...
		<body>
			<h3>17.PSQ3b- Hand hygiene compliance rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '17.PSQ3b- Hand hygiene compliance rate.png'; // Name of downloaded file
