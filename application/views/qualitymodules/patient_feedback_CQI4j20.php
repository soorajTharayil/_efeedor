<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									patients with a post-treatment reperfusion grade of TICI 2B or higher in the vascular territory
									beyond the target arterial occlusion at the end of treatment with intra-arterial (IA)
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4j20/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of patients with TICI>2b </b></td>
									...
									<tr>
										<td><b>Percentage Ischemic stroke patients with a post-treatment reperfusion grade of TICI
												2B or higher in the vascular territory beyond the target arterial occlusion at the
												end of treatment with intra-arterial (IA) thrombolytic (t-PA) therapy and/or
												mechanical endovascular reperfusion therapy.(Stroke Unit) </b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of patients with TICI>2b', 'Total Number of patients undergoing MER'],
				datasets: [{
					label: 'Percentage Ischemic stroke patients with a post-treatment reperfusion grade of TICI 2B or higher in the vascular territory beyond the target arterial occlusion at the end of treatment with intra-arterial',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage Ischemic stroke patients with a post-treatment reperfusion grade of TICI 2B or higher in the vascular territory beyond the target arterial occlusion at the end of treatment with intra-arterial - ' + monthyear,
						font: {
