	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_35PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of patients with hypoglycemic events where the target glucose level was achieved</b></td>
										<td>
									...
									<tr>
										<td><b>Percentage of Hospitalized patients with hypoglycemia who achieved blood glucose level</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Patients with hypoglycemia achieving glucose level', 'Patients with Hypoglycemic events'],
							datasets: [{
								label: 'Patients with hypoglycemia achieving glucose level compared to the total patients with Hypoglycemic events.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of Hospitalized patients with hypoglycemia who achieved blood glucose level for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of Hospitalized patients with hypoglycemia who achieved targeted blood glucose level</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of Hospitalized patients with hypoglycemia who achieved targeted blood glucose level.png'; // Name of downloaded file
