	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> Average Time for initial assessment of Emergency patients(Nurses)-(Emergency Department)- <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3a7/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Numerator: Sum of time taken for initial assessment Emergency patients (in Hrs)</b></td>
									...
									<tr>
										<td><b>Avg.Time for initial assessment of Emergency patients(Nurses) (in Hrs)</b></td>
										<td>
											<?php
									...
									<tr>
										...
										<td>
											<?php
											$period = new DateTime($param->datetime); // KPI period
											$submitted = new DateTime($param->datet); // actual submission
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['BenchMark Time','Avg.Time for initial assessment of Emergency patients'],
							datasets: [{
								label: 'Average Time for initial assessment of Emergency patients',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Average Time for initial assessment of Emergency patients - ' + monthyear,
									font: {
