<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									critical values in Lab (within 30 min)-(Lab Service) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4h27/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total values reported as per policy </b></td>
									...
									<tr>
										<td><b>Compliance to reporting of critical values in Lab (within 30 min)-(Lab Service) </b>
										</td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total values reported as per policy', 'Total number of critical values'],
				datasets: [{
					label: 'Compliance to reporting of critical values in Lab',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Compliance to reporting of critical values in Lab - ' + monthyear,
						font: {
