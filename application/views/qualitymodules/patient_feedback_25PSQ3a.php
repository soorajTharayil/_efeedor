<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 25. PSQ4c - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_25PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_of_incomplete_medical_records; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of discharges and deaths</b></td>
										<td>
											<?php echo $result->no_of_discharge; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of medical records having incomplete and/or improper consent</b></td>
										<td>
											<?php echo $result->percentage_of_medical_records; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_incomplete_medical_records; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_discharge; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of medical records having incomplete  consent', 'Number of discharges and deaths'],
							datasets: [{
								label: 'Number of medical records having incomplete  consent compare with Number of discharges and deaths',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of medical records having incomplete and/or improper consent for ' + monthyear,
									font: {
		...
		<body>
			<h3>25.PSQ4c- Percentage of medical records having incomplete and/or improper consent</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '25.PSQ4c- Percentage of medical records having incomplete and/or improper consent.png'; // Name of downloaded file
