<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI4g5?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI4g5';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4g6_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Total No of patients treated with self harm/suicidal risk adhering with the hospital policies, protocols, & environment safety measures implemented (in Nos.)</th>

								<th>Total No of patients with self harm/suicidal risk treated/admitted in the month  (in Nos.)</th>

								<th>Compliance rate of adhering with policies and procedures for care of patients at risk for suicide and self-harm(JCI8-COP 5)-(MRD)</th>
