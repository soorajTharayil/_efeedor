					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 4. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_medication_errors; ?>
										</td>
									</tr>
									<tr>
										...
										<td>
											<?php echo $result->no_opportunity_errors; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of medication error</b></td>
										<td>
											<?php echo $result->percentage_medication_errors; ?>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						data: {
							...
							datasets: [{
								label: 'Total number of medication errors compare with Total number of opportunities of medication errors',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of medication error for ' + monthyear,
									font: {
