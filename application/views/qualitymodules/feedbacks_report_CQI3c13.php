<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3c13?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI3c13';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3c13_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>No of restricted antibiotics prescribed As per hospital policy with proper indications (in Nos.)</th>

								<th>Total no of restricted antibiotics prescribed in the month (in Nos.)</th>

								<th>Restricted antibiotics usage compliance rate(JCI8-MMU1.1)-(Clinical Pharmacy)</th>
