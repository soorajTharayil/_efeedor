<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_50PSQ3a?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_50PSQ3a';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
						<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_50psq3a_report' ?>">
								<i class="fa fa-download"></i>
							</a>
						</div>
					</div>
					<div class="panel-body">
						<table class="50psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>No. of dialysis patients with target hemoglobin</th>
								<th>Total no. of patients undergoing dialysis</th>
								<th>Percentage of dialysis patients with target hemoglobin levels</th>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_51ps"; // Replace with your API endpoint
