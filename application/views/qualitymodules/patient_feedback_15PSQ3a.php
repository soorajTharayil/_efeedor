<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 15. PSQ3b - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_15PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of central line - associated blood stream infections in a month</b></td>
										<td>
											<?php echo $result->no_of_blood_stream_infection; ?>
										</td>
									</tr>
									<tr>
										<td><b>No. of central line days in that month</b></td>
										<td>
											<?php echo $result->no_central_line_days; ?>
										</td>
									</tr>
									<tr>
										<td><b>Central line - associated blood stream infection rate (per 1000 central line days)</b></td>
										<td>
											<?php echo $result->blood_stream_infection_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_blood_stream_infection; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_central_line_days; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of central line - associated blood stream infections', 'No. of central line days'],
							datasets: [{
								label: 'Number of central line - associated blood stream infections compare with No. of central line days ',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Central line - associated blood stream infection rate (per 1000 central line days) for ' + monthyear,
									font: {
		...
		<body>
			<h3>15.PSQ3b- Central line - associated blood stream infection rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '15.PSQ3b- Central line - associated blood stream infection rate.png'; // Name of downloaded file
