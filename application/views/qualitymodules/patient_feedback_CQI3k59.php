<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Percentage of cases where in
									Initial assessment done in physiotherapy with in 24 hours (OPD)-(Physical therapy and
									Rehabilitation Department - Medical records) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3k59/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of cases where in Initial assessment done in physiotherapy with in 24
												hours </b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total number of out-patients requiring physiotherapy </b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Percentage of cases where in Initial assessment done in physiotherapy with in 24
												hours (OPD)-(Physical therapy and Rehabilitation Department - Medical records) </b>
										</td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total number of cases where in Initial assessment done in physiotherapy with in 24 hours', 'Total number of out-patients requiring physiotherapy'],
				datasets: [{
					label: 'Percentage of cases where in Initial assessment done in physiotherapy with in 24 hours',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of cases where in Initial assessment done in physiotherapy with in 24 hours - ' + monthyear,
						font: {
