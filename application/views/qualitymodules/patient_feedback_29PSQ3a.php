<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 29. PSQ4d - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_29PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_of_near_misses; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of incidents reported</b></td>
										<td>
											<?php echo $result->no_of_incident_reported; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of near misses</b></td>
										<td>
											<?php echo $result->percentage_of_near_misses; ?>
										</td>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_near_misses;  ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_incident_reported; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of near misses reported', 'Number of incidents reported'],
							datasets: [{
								label: 'Number of near misses reported compare with Number of incidents reported',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of near misses for ' + monthyear,
									font: {
		...
		<body>
			<h3>29.PSQ4d- Percentage of near misses</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '29.PSQ4d- Percentage of near misses.png'; // Name of downloaded file
