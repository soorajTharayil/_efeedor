						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									(≥75% compliance) ≤60 min [Achieving Door to needle times (time of bolus administration) within
									60 minutes in 75% or more of acute ischemic stroke(Stroke Unit) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4j6/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of cases with initiation of thrombolysis with in 60 minutes of arrival
											</b></td>
									...
									<tr>
										<td><b>Door to IV thrombolytic bolus (≥75% compliance) ≤60 min [Achieving Door to needle
												times (time of bolus administration) within 60 minutes in 75% or more of acute
												ischemic stroke(Stroke Unit)</b></td>
