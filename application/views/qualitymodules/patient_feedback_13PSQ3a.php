<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 13. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_13PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of urinary catheter associated UTIs in a month</b></td>
										<td>
											<?php echo $result->no_of_urinary_tract_infection; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of urinary catheter days in that month</b></td>
										<td>
											<?php echo $result->no_of_urinary_catheter_days; ?>
										</td>
									</tr>
									<tr>
										<td><b>Catheter associated Urinary tract infection rate (per 1000 urinary catheter days)</b></td>
										<td>
											<?php echo $result->urinary_tract_infection_rate; ?>
										</td>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_urinary_catheter_days; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_urinary_tract_infection; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of urinary catheter days in that month', 'Number of urinary catheter associated UTIs in a month'],
							datasets: [{
								label: 'Number of urinary catheter days compare with Number of urinary catheter associated UTIs ',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Catheter associated Urinary tract infection rate for ' + monthyear,
									font: {
		...
		<body>
			<h3>13.PSQ3b- Catheter associated urinary tract infection rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '13.PSQ3b- Catheter associated urinary tract infection rate.png'; // Name of downloaded file
