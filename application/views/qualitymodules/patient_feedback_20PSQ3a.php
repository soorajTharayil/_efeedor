<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 20. PSQ3c - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_20PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->sum_of_time_taken; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of blood and blood components crossmatched/reserved</b></td>
										<td>
											<?php echo $result->no_of_blood_crossmatched; ?>
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											list($calculatedHours, $calculatedMinutes, $calculatedSeconds) = explode(':', $result->average_turn_around_time);
											...
											<span style="color: <?php echo $color; ?>">
												<?php echo $result->average_turn_around_time; ?>
											</span>
										</td>
									</tr>
									<tr>
				...
				<script>
					...
					var calculated = "<?php echo $result->average_turn_around_time; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Benchmark Time', 'Avg. turn around time for issue of blood and blood components'],
							datasets: [{
								label: 'Benchmark Time compared with Avg. turn around time for issue of blood and blood components',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Avg. turn around time for issue of blood and blood components for ' + monthyear,
									font: {
		...
		<body>
			<h3>20.PSQ3c- Turn around time for issue of blood and blood components</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '20.PSQ3c- Turn around time for issue of blood and blood components.png'; // Name of downloaded file
