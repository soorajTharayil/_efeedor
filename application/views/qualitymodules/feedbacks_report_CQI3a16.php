<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3a16?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI3a16';
					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3a16_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patients treated inappropriately (in Nos.)</th>

								<th>Total number of patients with bronchiolitis (in Nos.)</th>

								<th>Percentage of bronchiolitis patients treated inappropriately (Pediatrics)</th>
