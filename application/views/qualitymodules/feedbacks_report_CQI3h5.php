					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3h5_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of return to emergency department after 72 hours with similar presenting
									complaints (in Nos.)</th>

								<th>Number patients who have come to the emergency (in Nos.)</th>

								<th>Return to the emergency department after 72 hours with similar presenting
									complaints-(Emergency-Department) </th>
