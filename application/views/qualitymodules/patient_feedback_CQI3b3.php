<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Percentage of reports
									correlating to clinical diagnosis (Lab Services) - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3b3/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of test reports correlating with clinical diagnosis</b></td>
									...
									<tr>
										<td><b>Percentage of reports correlating to clinical diagnosis (Lab Services)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of test reports correlating with clinical diagnosis', 'Number of tests'],
				datasets: [{
					label: 'Percentage of reports correlating to clinical diagnosis',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of reports correlating to clinical diagnosis - ' + monthyear,
						font: {
