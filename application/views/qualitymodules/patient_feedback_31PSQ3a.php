<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 31. PSQ3d - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_31PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_of_handovers_done; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of handover opportunities</b></td>
										<td>
											<?php echo $result->no_of_handover_opportunities; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of appropriate handovers during shift change</b></td>
										<td>
											<?php echo $result->percentage_of_handovers; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_handovers_done; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_handover_opportunities; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Total no. of handovers done appropriately', 'Total no. of handover opportunities'],
							datasets: [{
								label: 'Total no. of handovers done appropriately compare with Total no. of handover opportunities',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of appropriate handovers during shift change for ' + monthyear,
									font: {
		...
		<body>
			<h3>31.PSQ3d- Appropriate handovers during shift change</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '31.PSQ3d- Appropriate handovers during shift change.png'; // Name of downloaded file
