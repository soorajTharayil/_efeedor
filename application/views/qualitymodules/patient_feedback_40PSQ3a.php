	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_40PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of POCT tests which resulted in clinical intervention</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>No. of POCT tests where clinical intervention was necessary</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of POCT results that led to clinical intervention</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['POCT tests which resulted in clinical intervention', 'POCT tests where clinical intervention was necessary'],
							datasets: [{
								label: 'POCT tests which resulted in clinical intervention compared to POCT tests where clinical intervention was necessary.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of POCT results that led to a clinical intervention for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of POCT results which led to clinical intervention</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of POCT results which led to clinical intervention.png'; // Name of downloaded file
