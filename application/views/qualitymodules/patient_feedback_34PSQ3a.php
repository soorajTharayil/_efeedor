<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_34PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total no. of AMI patients during primary angioplasty for whom door to balloon time of 90 minutes is achieved</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of AMI patients undergoing primary angioplasty</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of patients with myocardial infarction for whom door to balloon time of 90 minutes</b></td>
										<td>
											<?php echo $result->percentage_of_mortality_ratio; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->actual_deaths_icu; ?>"; // Benchmark value
					var calculated = "<?php echo $result->predicted_deaths_icu; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['AMI patients with door-to-balloon within 90 mins', 'Total AMI patients undergoing primary angioplasty'],
							datasets: [{
								label: 'AMI patients undergoing primary angioplasty with door-to-balloon time within 90 minutes compared to the total AMI patients with primary angioplasty.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of patients with myocardial infarction for whom door to balloon time of 90 minutes for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a- Percentage of patients with myocardial infarction for whom door to balloon time of 90 minutes is achieved</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a- Percentage of patients with myocardial infarction for whom door to balloon time of 90 minutes is achieved.png'; // Name of downloaded file
