					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4j21_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Percentage Ischemic stroke patients with a large vessel cerebral occlusion (i.e.,
									internal carotid artery (ICA) or ICA terminus (T lesion; T-occlusion), middle cerebral
									artery (MCA) M1 or M2, basilar artery) who receive mechanical endovascular reperfusion
									(MER) therapy (time of first pass or deployment of device) within 120 minutes (≥ 0 min.
									and ≤150 min.) of hospital arrival and achieve TICI 2B or higher at the end of the
									treatment</th>
