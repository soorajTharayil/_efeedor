	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_50PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of dialysis patients with target hemoglobin</b></td>
										<td>
									...
									<tr>
										<td><b>Percentage of dialysis patients with target hemoglobin levels</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Dialysis patients with target hemoglobin', 'No. of patients undergoing dialysis'],
							datasets: [{
								label: 'Dialysis patients with target hemoglobin compared to total no. of patients undergoing dialysis',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of dialysis patients with target hemoglobin levels for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of dialysis patients with target hemoglobin levels</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of dialysis patients with target hemoglobin levels.png'; // Name of downloaded file
