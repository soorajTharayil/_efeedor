<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									consumables rejected before preparation of Goods Receipt Note(SCM-Store)
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4a4/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total quantity rejected</b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total quantity received before Goods Receipt Note </b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Percentage of drugs and consumables rejected before preparation of Goods Receipt
												Note(SCM-Store)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total quantity rejected', 'Total quantity received before Goods Receipt Note'],
				datasets: [{
					label: 'Percentage of drugs and consumables rejected before preparation of Goods Receipt Note',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of drugs and consumables rejected before preparation of Goods Receipt Note - ' + monthyear,
						font: {
