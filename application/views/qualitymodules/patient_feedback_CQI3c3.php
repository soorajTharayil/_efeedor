<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									-Dispensing errors (IP)( As per NABH 4th edition)-(Clinical Pharmacy) -
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3c3/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of dispensing errors</b></td>
									...
									<tr>
										<td><b>Incidence of medication errors -Dispensing errors (IP)( As per NABH 4th
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total number of dispensing errors', 'Total number of in-patient days for the month'],
				datasets: [{
					label: 'Incidence of medication errors -Dispensing errors',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Incidence of medication errors -Dispensing errors - ' + monthyear,
						font: {
