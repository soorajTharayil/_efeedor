<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_16PSQ3a?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_16PSQ3b';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_16psq3a_report' ?>">
								<i class="fa fa-download"></i>
							</a>
						</div>
					</div>
					<div class="panel-body">
						<table class="16psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of surgical site infections in a given month</th>
								<th>Number of surgeries performed in that month</th>
								<th>Surgical site infection rate per 100 surgical procedures</th>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC"; ?>" onclick="window.location.href='<?php echo $patient_feedback_1PSQ3a . $id; ?>'" style="cursor: pointer;">
										...
										<td>
											<?php echo $r->no_of_surgical_infection; ?>
										</td>
										<td>
											<?php echo $r->no_of_surgery_perform; ?>
										</td>
										<td>
											<?php echo $r->surgical_infection_rate; ?>
										</td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_16ps"; // Replace with your API endpoint
