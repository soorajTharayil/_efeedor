			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4j20_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Percentage Ischemic stroke patients with a post-treatment reperfusion grade of TICI 2B or higher in the vascular territory beyond the target arterial occlusion at the end of treatment with intra-arterial (IA) thrombolytic (t-PA) therapy and/or mechanical endovascular reperfusion therapy.(Stroke Unit)</th>
