	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_41PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Sum of functional gain patients in neurorehabilitation</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of patients undergoing neurorehabilitation</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of neurorehabilitation patient with functional gain</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Sum of functional gain patients in neurorehabilitation', 'Total no. of patients undergoing neurorehabilitation'],
							datasets: [{
								label: 'Sum of functional gain patients in neurorehabilitation compared to no. of patients undergoing neurorehabilitation.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of neurorehabilitation patient with functional gain for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Functional gain following rehabilitation</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Functional gain following rehabilitation.png'; // Name of downloaded file
