<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a> Percentage of Intravenous
									Contrast Media Extravasation (Radiology) - <?php echo $result->id; ?> </h3>
							</div>
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of Contrast extravasation</b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Number of patients receiving contrast</b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Percentage of Intravenous Contrast Media Extravasation (Radiology)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of Contrast extravasation', 'Number of patients receiving contrast'],
				datasets: [{
					label: 'Percentage of Intravenous Contrast Media Extravasation',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of Intravenous Contrast Media Extravasation - ' + monthyear,
						font: {
