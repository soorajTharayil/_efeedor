            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Door to thrombolysis time in ischemic stroke in ER(Emergency Department)- <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3k10_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>Difference in time taken from thrombolysis started to patient arrived ED </b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Total number of patients underwent thrombolysis therapy</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Door to thrombolysis time in ischemic stroke in ER(Emergency Department) is:</b></td>
                            <td>
