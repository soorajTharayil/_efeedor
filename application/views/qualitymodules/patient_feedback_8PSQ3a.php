<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 8. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_8PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->surgery_procedure_followed; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of surgeries performed</b></td>
										<td>
											<?php echo $result->no_surgery_performed; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of Surgeries Following Adverse Event Prevention Procedures</b></td>
										<td>
											<?php echo $result->percentage_of_surgery_adherence; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->surgery_procedure_followed; ?>"; // Benchmark value
					var calculated = "<?php echo  $result->no_surgery_performed; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of surgeries where the procedure was followed', 'Number of surgeries performed'],
							datasets: [{
								label: 'Number of surgeries where the procedure was followed compare with Number of surgeries performed',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of Surgeries Following Adverse Event Prevention Procedures for ' + monthyear,
									font: {
		...
		<body>
			<h3>8.PSQ3a- Percentage of surgeries where the organisations procedure to prevent adverse events</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '8.PSQ3a- Percentage of surgeries where the organisations procedure to prevent adverse events.png'; // Name of downloaded file
