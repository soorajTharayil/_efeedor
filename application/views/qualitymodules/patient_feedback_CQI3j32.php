<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Rate of Safety, sceurity
									incidents related to Work place violence (JCI8-FMS 3.0, 4.0)-(Security and Safety)
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3j32/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No of Safety, security incidents related to Work place violence </b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>No of safety, security related incidents reported in the month </b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Rate of Safety, sceurity incidents related to Work place violence (JCI8-FMS 3.0,
												4.0)-(Security and Safety)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['No of Safety, security incidents related to Work place violence', 'No of safety, security related incidents reported in the month'],
				datasets: [{
					label: 'Rate of Safety, sceurity incidents related to Work place violence',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Rate of Safety, sceurity incidents related to Work place violence - ' + monthyear,
						font: {
