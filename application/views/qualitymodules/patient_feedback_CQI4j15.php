						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4j15/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total number of patients receiving recanalization treatment(IVT/EVT /IVT+EVT) </b></td>

									<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Percentage of ischemic stroke patients who develop a symptomatic intracranial hemorrhage (i.e., clinical deterioration ≥ 4-point increase on NIHSS and brain image finding of parenchymal hematoma, or subarachnoid hemorrhage, or intraventricular hemorrhage) within (≤) 36 hours after the onset of treatment with intra-venous (IV) or intra-arterial (IA) thrombolytic (t-PA) therapy, or mechanical endovascular reperfusion procedure (i.e., mechanical endovascular thrombectomy with a clot retrieval dev (Stroke Unit)</b></td>
