            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Waiting time for diagnostic services(Radiology - MRI) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI4d6_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>Sum of patient in time for procedure - patient reporting time in diagnostics dept</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Number of patients reported in diagnostic department</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Waiting time for diagnostic services(Radiology - MRI) is:</b></td>
                            <td>
