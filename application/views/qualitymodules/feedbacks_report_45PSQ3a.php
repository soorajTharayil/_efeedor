<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_45PSQ3a?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_45PSQ3a';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="45psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>No. of patients treated inappropriately</th>
								<th>Total no. of patients with bronchiolitis</th>
								<th>Percentage of bronchiolitis patients treated inappropriately</th>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_46ps"; // Replace with your API endpoint
