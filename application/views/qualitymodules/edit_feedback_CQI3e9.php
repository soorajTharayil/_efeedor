            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;All major patient safety events or errors related to surgical procedures(JCI8-QPS 3.04)- <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3e9_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>No of major patient safety events or errors related to surgical procedures reported in the month</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>All major patient safety events or errors related to surgical procedures(JCI8-QPS 3.04)</b></td>
                            <td>
