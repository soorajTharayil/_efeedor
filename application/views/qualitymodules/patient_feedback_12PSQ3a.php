<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 12. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_12PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_of_pressure_ulcer; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of patient days</b></td>
										<td>
											<?php echo $result->no_of_patient_days; ?>
										</td>
									</tr>
									<tr>
										<td><b>Incidence of hospital associated pressure ulcers after admission</b></td>
										<td>
											<?php echo $result->incidence_of_pressure_ulcer; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo  $result->no_of_pressure_ulcer; ?>"; // Benchmark value
					var calculated = "<?php echo   $result->no_of_patient_days;  ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of patients who develop new / worsening of pressure ulcer', 'Total no. of patient days'],
							datasets: [{
								label: 'Number of patients who develop new / worsening of pressure ulcer compare with Total no. of patient days',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Incidence of hospital associated pressure ulcers after admission for ' + monthyear,
									font: {
		...
		<body>
			<h3>12.PSQ3a- Incidence of hospital associated pressure ulcers after admission</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '12.PSQ3a- Incidence of hospital associated pressure ulcers after admission.png'; // Name of downloaded file
