<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a> Turnaround time for Platelet
									Apheresis (Blood Center) - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3f9/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total time taken for all Platelet Apheresis procedure (in minutes)</b></td>
										<td><?php echo $param->initial_assessment_total; ?></td>
									</tr>
									<tr>
										<td><b>Total number of Platelet Apheresis performed</b></td>
										<td><?php echo $param->total_admission; ?></td>
									</tr>
									<tr>
										<td><b>Turnaround time for Platelet Apheresis (Blood Center) </b></b></td>
										<td>
											<?php
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['BenchMark Time', 'Turnaround time for Platelet Apheresis '],
				datasets: [{
					label: 'Turnaround time for Platelet Apheresis',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Turnaround time for Platelet Apheresis - ' + monthyear,
						font: {
