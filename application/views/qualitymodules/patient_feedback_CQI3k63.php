<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Timeliness of staff response to
									cardiac arrest (JCI8-COP 4)-(Emergency Department) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3k63/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total No of patients achieved ROSC after code blue </b></td>
									...
									<tr>
										<td><b>Timeliness of staff response to cardiac arrest (JCI8-COP 4)-(Emergency Department)
											</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Total No of code blue activated in the month', 'Total no of code blues in which code blue team members responded within the specified time'],
				datasets: [{
					label: 'Timeliness of staff response to cardiac arrest',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Timeliness of staff response to cardiac arrest - ' + monthyear,
						font: {
