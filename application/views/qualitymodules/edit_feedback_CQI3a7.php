            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Average Time for initial assessment of Emergency patients(Nurses)-(Emergency Department) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3a7_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>Sum of time taken for initial assessment Emergency patients </b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Total number of emergency patients</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Average Time for initial assessment of in-patients (Nurses)-(Emergency Department) is:</b></td>
                            <td>
