<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Cath lab utilization rate (Cath
									Lab - Nursing) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4c9/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Numerator: Cath lab utilization time in hours (in Hrs)</b></td>
										<td>
											<?php
									...
									<tr>
										<td><b>Denominator: Cath lab resource hours(in No.s)</b></td>
										<td>
											<?php
									...
									<tr>
										<td><b>Cath lab utilization rate (Cath Lab - Nursing) </b></b></td>
										<td>
											<?php
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Cath lab utilization time in hours', 'Cath lab resource hours'],
				datasets: [{
					label: 'Cath lab utilization rate',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Cath lab utilization rate - ' + monthyear,
						font: {
