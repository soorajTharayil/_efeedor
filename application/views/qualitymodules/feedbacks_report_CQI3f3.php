<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3f3?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI3f3';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3f3_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of blood and blood components wasted among those stored in blood bank (in Nos.)</th>

								<th>Number of blood components stored in the blood bank (in Nos.)</th>

								<th>Percentage of waste of blood and blood components among those stored(Blood Center)</th>
