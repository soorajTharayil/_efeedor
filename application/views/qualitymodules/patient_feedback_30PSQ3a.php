<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 30. PSQ3d - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_30PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
											<?php echo $result->no_of_parenteral_exposures; ?>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<?php echo $result->needle_stick_injuries; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_parenteral_exposures; ?>"; // Benchmark value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of parenteral exposures', 'Number of in-patient days'],
							datasets: [{
								label: 'Number of parenteral exposures compare with Number of in-patient days',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Incidence of needle stick injuries (per 1000 patient days) for ' + monthyear,
									font: {
		...
		<body>
			<h3>30.PSQ3d- Incidence of needle stick injuries</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '30.PSQ3d- Incidence of needle stick injuries.png'; // Name of downloaded file
