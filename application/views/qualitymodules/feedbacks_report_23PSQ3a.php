<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_23PSQ3a?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_23PSQ4c';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="23psq3a table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of patients reported in diagnostics</th>
								<th>Avg. waiting time for diagnostics</th>
								...
								<?php foreach ($feedbacktaken as $r) {
									...
									<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC"
										...
										<td>
											...
											list($calculatedHours, $calculatedMinutes, $calculatedSeconds) = explode(':', $r->diagnostics_wait_time);
											...
											<span style="color: <?php echo $color; ?>">
												<?php echo $r->diagnostics_wait_time; ?>
											</span>
										</td>
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "http://" + domain + "/analytics_audit_quality/resposnsechart_23ps"; // Replace with your API endpoint
