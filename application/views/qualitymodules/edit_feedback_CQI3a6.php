            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Percentage of Nursing care is documented for inpatients (MRD - Nursing)- <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3a6_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateErrorRate(event) {
        ...
        if (isNaN(numerator) || numerator < 0) {
            alert("Please Number of case sheets where nursing plan is documented");
            numeratorField.focus();
            return;
        }
