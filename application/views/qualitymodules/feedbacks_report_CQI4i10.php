<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI4i10?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CQI4i10';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4i10_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Total No. of damaged linen identified in the month (in Nos.)</th>

								<th>Total No of laundry sent for washing in the month (in Nos.)</th>

								<th>Number of laundry loads reduced by optimizing and sorting laundry (GHI 3ME4) (JCI8-GHI 3)-(House Keeping) </th>
