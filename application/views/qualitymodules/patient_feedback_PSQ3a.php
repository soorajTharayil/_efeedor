<div class="content">
	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Total no. of readmission to ICU within 48 hours after discharged</b></td>
										<td>
											<?php echo $result->no_of_readmissions_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Total no. of admissions</b></td>
										<td>
											<?php echo $result->no_of_admissions; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of readmission rate</b></td>
										<td>
											<?php echo $result->readmission_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_readmissions_icu; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_admissions; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Total no. of readmission to ICU within 48 hours', 'Total no. of admissions'],
							datasets: [{
								label: 'Total no. of readmission to ICU within 48 hours compare with Total no. of admissions',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of readmission rate for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Readmission to ICU within 48 hours after being discharged from ICU</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Readmission to ICU within 48 hours after being discharged from ICU.png'; // Name of downloaded file
