<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Door to image time in Stroke
									patients(Emergency Department) <?php echo $result->id; ?> </h3>
							</div>
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Numerator:Sum of total time (CT Start Time – Registration Time)-(in Hrs)</b></td>
									...
									<tr>
										<td><b>Door to image time in Stroke patients(Emergency Department) (in Hrs)</b></td>
										<td>
											<?php
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Sum of total time (CT Start Time – Registration Time)-', 'Total sample size'],
				datasets: [{
					label: 'Door to image time in Stroke patients',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Door to image time in Stroke patients - ' + monthyear,
						font: {
