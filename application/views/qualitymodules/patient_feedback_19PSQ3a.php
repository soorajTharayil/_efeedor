<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 19. PSQ3c - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_19PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of cases rescheduled</b></td>
										<td>
											<?php echo $result->no_of_reschedule; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of surgeries planned</b></td>
										<td>
											<?php echo $result->no_of_surgery_planned; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of re-scheduling of surgeries</b></td>
										<td>
											<?php echo $result->percentage_of_reschedule; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_reschedule; ?>"; // Benchmark value
					var calculated = "<?php echo  $result->no_of_surgery_planned; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of cases rescheduled', 'Number of surgeries planned'],
							datasets: [{
								label: 'Number of cases rescheduled compare with Number of surgeries planned',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of re-scheduling of surgeries for ' + monthyear,
									font: {
		...
		<body>
			<h3>19.PSQ3c- Percentage of re- scheduling of surgeries</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '19.PSQ3c- Percentage of re- scheduling of surgeries.png'; // Name of downloaded file
