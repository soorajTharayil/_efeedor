<div class="content">
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4g2/$id") ?>"> <i
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of medical records not having codification as per ICD', 'Number of discharges and deaths in that month'],
				datasets: [{
					label: 'Percentage of Medical records not having codification as per ICD',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of Medical records not having codification as per ICD - ' + monthyear,
						font: {
