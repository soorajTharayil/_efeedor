<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 5. PSQ3a - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_5PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of medication charts with error prone abbreviation</b></td>
										<td>
											<?php echo $result->no_medication_chart_errors; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of medication charts reviewed</b></td>
										<td>
											<?php echo $result->no_chart_reviewed; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of medication chart with error-prone abbreviations</b></td>
										<td>
											<?php echo $result->percentage_medication_chart_errors; ?>
										<td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_medication_chart_errors; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_chart_reviewed; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of medication charts with error prone abbreviation', 'Number of medication charts reviewed'],
							datasets: [{
								label: 'Number of medication charts with error prone abbreviation compare with Number of medication charts reviewed',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of medication chart with error-prone abbreviations for ' + monthyear,
									font: {
		...
		<body>
			<h3>5.PSQ3a- Percentage of medication charts with error-prone abbreviations</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '5.PSQ3a- Percentage of medication charts with error-prone abbreviations.png'; // Name of downloaded file
