<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Average quantity of Medical
									waste disposed per month in Kgs - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI4i13/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Medical waste disposed in the month in Kgs </b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total No of days medical waste discarded</b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Average quantity of Medical waste disposed per month in Kgs (Clinical practices to
												reduce the environmental impact -JCI8-GHI 3)-(House Keeping) </b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Medical waste disposed in the month in Kgs', 'Total No of days medical waste discarded'],
				datasets: [{
					label: 'Average quantity of Medical waste disposed per month in Kgs',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Average quantity of Medical waste disposed per month in Kgs - ' + monthyear,
						font: {
