            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Time for first defibrillation-(Emergency Department) - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3k14_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>Sum of (Time for first defibrillation applied - Time of code blue team reached the patient) </b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Total number of code blue</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Time for first defibrillation-(Emergency Department) is:</b></td>
                            <td>
