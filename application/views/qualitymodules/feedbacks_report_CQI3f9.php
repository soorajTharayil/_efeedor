<div class="content">
	...
	//individual link
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3f9?id=');
	$table_feedback_2PSQ3a = 'bf_feedback_CQI3f9';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3f9_report' ?>">
								<i class="fa fa-download"></i>
							</a>
						</div>
					</div>
					<div class="panel-body">
						<table class="cqi3a2 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Total time taken for all Platelet Apheresis procedure (in minutes) </th>
								<th>Total number of Platelet Apheresis performed (in Nos.)</th>
								<th>Turnaround time for Platelet Apheresis (Blood Center) (in Hrs)</th>
...
<script>
	// Example Data
	var benchmark = ["<?php echo $param->benchmark; ?>"];
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [{
				...
				{
					label: 'Avg. Time taken for assessment of in-patients in MRD (WARD)',
...
<script>
	function printChart() {
		...
		<body>
			<h3>Average Time for initial assessment of in-patients in MRD (WARD)</h3>
...
<script>
	function downloadChartImage() {
		...
		link.href = image;
		link.download = 'Average Time for initial assessment of in-patients in MRD (WARD).png'; // Name of downloaded file
