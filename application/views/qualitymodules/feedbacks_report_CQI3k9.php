<div class="content">
	...
	//individual link
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3k9?id=');
	$table_feedback_1PSQ3a = 'bf_feedback_CQI3k9';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3k9_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a1 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Sum of time taken (Time of recovery face is completed - Time of recovery is started) (in Hrs)</th>
								<th>Total patients recovery (in Nos.)</th>
								<th>Average recovery time(OT-Post OP) (in Hrs)</th>
