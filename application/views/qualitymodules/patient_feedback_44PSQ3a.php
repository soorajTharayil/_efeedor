	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_44PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of stroke patients with DTN time within 60 minutes</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>No. of stroke patients receiving thrombolytic therapy</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of stroke patients with DTN time within 60 minutes</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Stroke patients with DTN time within 60 mins', 'Stroke patients receiving thrombolytic therapy'],
							datasets: [{
								label: 'Stroke patients with DTN time within 60 mins compared to Stroke patients receiving thrombolytic therapy.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of stroke patients with DTN time within 60 minutes for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of stroke patients in whom the DTN of 60 minutes is achieved</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of stroke patients in whom the DTN of 60 minutes is achieved.png'; // Name of downloaded file
