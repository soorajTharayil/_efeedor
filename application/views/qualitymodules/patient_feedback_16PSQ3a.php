<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 16. PSQ3b - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_16PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of surgical site infections in a given month</b></td>
										<td>
											<?php echo $result->no_of_surgical_infection; ?>
										</td>
									</tr>
									<tr>
										<td><b>Number of surgeries performed in that month</b></td>
										<td>
											<?php echo $result->no_of_surgery_perform; ?>
										</td>
									</tr>
									<tr>
										<td><b>Surgical site infection rate per 100 surgical procedures</b></td>
										<td>
											<?php echo $result->surgical_infection_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_surgical_infection; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_of_surgery_perform; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of surgical site infections', 'Number of surgeries performed'],
							datasets: [{
								label: 'Number of surgical site infections compare with Number of surgeries performed',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Surgical site infection rate per 100 surgical procedures for ' + monthyear,
									font: {
		...
		<body>
			<h3>16.PSQ3b- Surgical site infection rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '16.PSQ3b- Surgical site infection rate.png'; // Name of downloaded file
