            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Percentage of Nutritional assessment is documented for inpatients (Clinical Nutrition and Dietetics)- <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI3a5_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            <td><b>Percentage of Nutritional assessment is documented for inpatients (Clinical Nutrition and Dietetics)</b></td>
                            <td>
...
<script>
    ...
    function calculateErrorRate(event) {
        ...
        //Numerator
        if (numeratorValue === "") {
            alert("Please enter Number of case sheets where nutritional assessment is documented");
        ...
        if (isNaN(numerator) || numerator < 0) {
            alert("Please enter a valid Number of case sheets where nutritional assessment is documented");
            numeratorField.focus();
            return;
        }
        ...
        if (isNaN(denominator) || denominator < 0) {
            alert("Please enter a valid Total number of in-patients for the month");
            denominatorField.focus();
            return;
        }
