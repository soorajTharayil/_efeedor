	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_42PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of sepsis patients receiving Hour-1 bundle care</b></td>
										<td>
									...
									<tr>
										<td><b>Percentage of sepsis patients receiving Hour-1 bundle care</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['No. of sepsis patients receiving Hour-1 bundle care', 'Total number of sepsis cases'],
							datasets: [{
								label: 'No. of sepsis patients receiving Hour-1 bundle care compared to Total number of sepsis cases.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of sepsis patients receiving Hour-1 bundle care for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of sepsis patients who receive care as per the Hour-1 sepsis bundle</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of sepsis patients who receive care as per the Hour-1 sepsis bundle.png'; // Name of downloaded file
