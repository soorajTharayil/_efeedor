<div class="content">
	...
	?>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> 28. PSQ4d - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_28PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of patient falls</b></td>
										<td>
											<?php echo $result->no_of_patients_fall; ?>
										</td>
									<tr>
										<td><b>Total number of patient days</b></td>
										<td>
											<?php echo $result->no_patient_days; ?>
										</td>
									</tr>
									<tr>
										<td><b>Patient fall rate (per 1000 patient days)</b></td>
										<td>
											<?php echo $result->patient_fall_rate; ?>
										</td>
									</tr>
				...
				<script>
					// Data
					var benchmark = "<?php echo $result->no_of_patients_fall; ?>"; // Benchmark value
					var calculated = "<?php echo $result->no_patient_days; ?>"; // Calculated value
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['Number of patient falls', 'Total number of patient days'],
							datasets: [{
								label: 'Number of patient falls compare with Total number of patient days',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Patient fall rate (per 1000 patient days) for ' + monthyear,
									font: {
		...
		<body>
			<h3>28.PSQ4d- Patient fall rate</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = '28.PSQ4d- Patient fall rate.png'; // Name of downloaded file
