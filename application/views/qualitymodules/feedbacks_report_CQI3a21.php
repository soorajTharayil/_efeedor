					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Total no of critical results the physician acted/ responded with the specified timeframe as per policy (in Nos.)</th>

								<th>Total No of critical results reported in the month (in Nos.)</th>

								<th>Percentage of Compliance rate of timeliness of physician responding to the reported critical results</th>
