<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									prevention measures in OPD-(Nursing - OPD) <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3j25/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of Fall prevention opportunities complied in OPD </b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total Number of parameters audited in OPD </b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>IPSG 6 - Compliance to Fall prevention measures in OPD-(Nursing - OPD)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of Fall prevention opportunities complied in OPD', 'Total Number of parameters audited in OPD'],
				datasets: [{
					label: 'IPSG 6 - Compliance to Fall prevention measures in OPD-',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'IPSG 6 - Compliance to Fall prevention measures in OPD- - ' + monthyear,
						font: {
