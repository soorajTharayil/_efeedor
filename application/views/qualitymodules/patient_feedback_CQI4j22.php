					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a>Percentage Ischemic stroke patients with a large vessel cerebral occlusion (i.e., internal carotid artery (ICA) or ICA terminus (T lesion; T-occlusion), middle cerebral artery (MCA) M1 or M2, basilar artery) who receive mechanical endovascular reperfusion (MER) therapy (time of first pass or deployment of device) and achieve TICI 2B or higher ≤60 minutes from the time of skin puncture(Stroke Unit)  <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>First pass <60 mins from skin puncture </b></td>
									...
									<tr>
										<td><b>Percentage Ischemic stroke patients with a large vessel cerebral occlusion (i.e., internal carotid artery (ICA) or ICA terminus (T lesion; T-occlusion), middle cerebral artery (MCA) M1 or M2, basilar artery) who receive mechanical endovascular reperfusion (MER) therapy (time of first pass or deployment of device) and achieve TICI 2B or higher ≤60 minutes from the time of skin puncture(Stroke Unit)</b></td>
