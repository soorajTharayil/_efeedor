<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									device) and achieve TICI 2B or higher ≤60 minutes from the time of skin puncture(Stroke Unit)
									<?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>First pass <60 mins from skin puncture </b>
										</td>
									...
									<tr>
										<td><b>Percentage Ischemic stroke patients with a large vessel cerebral occlusion (i.e.,
												...
												reperfusion (MER) therapy (time of first pass or deployment of device) and achieve
												TICI 2B or higher ≤60 minutes from the time of skin puncture(Stroke Unit)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['First pass <60 mins from skin puncture', 'Total Number of patients undergoing MER'],
				datasets: [{
