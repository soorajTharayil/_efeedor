<div class="content">
	...
	//individual link
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI4d8?id=');
	$table_feedback_2PSQ3a = 'bf_feedback_CQI4d8';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI4d8_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a1 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Sum of Patient in time for consultation - Patient reporting time in OPD (in Hrs)</th>
								<th>Number of patients reported in OPD (in Nos.)</th>
								<th>Waiting Time for OPD appointments (Patient Care Services - OPD) (in Hrs)</th>
