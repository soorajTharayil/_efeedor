            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Percentage of OP Medication dispensed within less than 15 mints- <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_CQI4j23_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>Number of OP Prescriptions dispensed within <15 mints</b></td>
                            <td>
                                <div style="display: flex; flex-direction: row; align-items: center;">
                                    <span class="has-float-label" style="display: flex; align-items: center; ">
                                        <input class="form-control" value="<?php echo $param['initial_assessment_hr']; ?>" name="initial_assessment_hr" oninput="restrictToNumerals(event);" type="number" id="reportingErrors" style="padding-top: 2px; padding-left: 6px; margin-top:9px;" />
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" oninput="restrictToNumerals(event);" type="number" id="testsPerformed" name="total_admission" value="<?php echo $param['total_admission']; ?>">
                                <br>
...
<script>
    ...
    // Add event listener to the calculate button (fixed: no duplicate calling)
    document.getElementById('calculateButton').addEventListener('click', function(event) {
        calculateErrorRate(event);
    ...
    function calculateErrorRate(event) {
        ...
        if (numeratorValue === "") {
            alert("Please enter Number of OP Prescriptions dispensed within <15 mints");
            numeratorField.focus();
            return;
        }

        if (denominatorValue === "") {
            alert("Please enter Total number of OP Prescriptions dispensed");
        ...
        if (isNaN(numerator) || numerator < 0) {
            alert("Please enter a valid Number of OP Prescriptions dispensed within <15 mints");
            numeratorField.focus();
            return;
        }

        if (isNaN(denominator) || denominator < 0) {
            alert("Please enter a valid number for Total number of OP Prescriptions dispensed");
            denominatorField.focus();
            return;
        }
