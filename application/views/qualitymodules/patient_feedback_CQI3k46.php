<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="QUALITY INDICATOR MANAGER <KPI ID>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a> Radiology TAT orders for
									CT(Radiology)<?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3k46/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Radiology TAT orders for CT(Radiology) (in Hrs)</b></td>
										<td>
											<?php
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Sum of time taken (Time of recovery face is completed - Time of recovery is started)', 'Radiology TAT orders for CT'],
				datasets: [{
					label: 'Sum of time taken (Time of recovery face is completed - Time of recovery is started compared with Radiology TAT orders for CT',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Average recovery time - ' + monthyear,
						font: {
