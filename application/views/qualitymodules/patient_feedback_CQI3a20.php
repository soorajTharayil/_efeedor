<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
									...
									undergoing dialysis who are able to achieve target hemoglobin levels(Nephrology) -
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_4PSQ3a/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Number of patients undergoing dialysis who are able to achieve target hemoglobin
												levels</b></td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total number of patients undergoing dialysis</b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Percentage of patients undergoing dialysis who are able to achieve target hemoglobin
												levels(Nephrology)</b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['Number of patients undergoing dialysis who are able to achieve target hemoglobin levels', 'Total number of patients undergoing dialysis'],
				datasets: [{
					label: 'Percentage of patients undergoing dialysis who are able to achieve target hemoglobin levels',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Percentage of patients undergoing dialysis who are able to achieve target hemoglobin levels - ' + monthyear,
						font: {
