<div class="content">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip"
										title="<?php echo lang_loader('ip', 'ip_discharge_feedback_id_tooltip'); ?>"> <i
											class="fa fa-question-circle" aria-hidden="true"></i></a>Emperical Antibiotics therapy
									compliance rate for high risk infections(JCI8-MMU1.1)-(Clinical Pharmacy
							...
							<?php if (ismodule_active('QUALITY') === true && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;"
										href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_CQI3c12/$id") ?>"> <i
							...
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No of empirical antibiotics prescribed for the high risk infections as per policy</b>
										</td>

										<td><?php echo $param['initial_assessment_hr']; ?></td>
									</tr>
									<tr>
										<td><b>Total No of high risk infections prescribed with antibiotics </b></td>

										<td><?php echo $param['total_admission']; ?></td>
									</tr>
									<tr>
										<td><b>Emperical Antibiotics therapy compliance rate for high risk
												infections(JCI8-MMU1.1)-(Clinical Pharmacy) </b></td>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			responsive: true,
			data: {
				labels: ['No of empirical antibiotics prescribed for the high risk infections as per policy', 'Total No of high risk infections prescribed with antibiotics'],
				datasets: [{
					label: 'Emperical Antibiotics therapy compliance rate for high risk infections',
			...
			options: {
				plugins: {
					...
					title: {
						display: true,
						text: 'Emperical Antibiotics therapy compliance rate for high risk infections - ' + monthyear,
						font: {
