<div class="content">
	...
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CLOTCM28?id=');

	$table_feedback_2PSQ3a = 'bf_feedback_CLOTCM28';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CLOTCM28_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Number of ventilator associated pneumonias in a month (in Nos.)</th>

								<th>Number of ventilator days in month (in Nos.)</th>

								<th>Ventilator associated pneumonias (VAP) in 1000 ventilator days-(Infection Control - Ortho THR)</th>
