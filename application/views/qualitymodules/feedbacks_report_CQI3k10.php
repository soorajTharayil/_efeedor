<div class="content">
	...
	//individual link
	$patient_feedback_1PSQ3a = base_url($this->uri->segment(1) . '/patient_feedback_CQI3k10?id=');
	$table_feedback_2PSQ3a = 'bf_feedback_CQI3k10';
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed KPI report" href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3k10_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a1 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>Difference in time taken from thrombolysis started to patient arrived ED  (in Hrs)</th>
								<th>Total number of patients underwent thrombolysis therapy(in Nos.)</th>
								<th>Door to thrombolysis time in ischemic stroke in ER(Emergency Department) (in Hrs)</th>
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [{
				...
				{
					label: 'Avg. Time taken for assessment of in-patients in MRD (ICU)',
...
<script>
	function printChart() {
		...
		<body>
			<h3>Average Time for initial assessment of in-patients in MRD (ICU)</h3>
