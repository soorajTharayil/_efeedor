					...
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_CQI3e9_report' ?>">
					...
					<div class="panel-body">
						<table class="cqi3a4 table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<th>No of major patient safety events or errors related to surgical procedures reported in
									the month (in Nos.)</th>

								<th>Total No of surgeries done in the month (in Nos.)</th>

								<th>All major patient safety events or errors related to surgical procedures(JCI8-QPS
									3.04)-(OT)</th>
