	...
	?>
						...
						<div class="panel panel-default">
							...
							<?php if (ismodule_active('QUALITY') === true  && isfeature_active('QUALITY-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group no-print" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_feedback_43PSQ3a/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>No. of COPD patients provided with COPD action plan</b></td>
										<td>
											<?php echo $result->actual_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>No. of COPD patients discharged</b></td>
										<td>
											<?php echo $result->predicted_deaths_icu; ?>
										</td>
									</tr>
									<tr>
										<td><b>Percentage of COPD patients receiving COPD action plan at the time of discharge</b></td>
										<td>
				...
				<script>
					...
					var myChart = new Chart(ctx, {
						...
						responsive: true,
						data: {
							labels: ['COPD patients provided with COPD action plan', 'No. of COPD patients discharged'],
							datasets: [{
								label: 'COPD patients provided with COPD action plan compared to no. of COPD patients discharged.',
						...
						options: {
							plugins: {
								...
								title: {
									display: true,
									text: 'Percentage of COPD patients receiving COPD action plan at the time of discharge for ' + monthyear,
									font: {
		...
		<body>
			<h3>PSQ3a - Percentage of COPD patients receiving COPD Action plan at the time of discharge</h3>
	...
	`;
				...
				<script>
					function downloadChartImage() {
						...
						link.href = image;
						link.download = 'PSQ3a - Percentage of COPD patients receiving COPD Action plan at the time of discharge.png'; // Name of downloaded file
