                ...
                <div class="panel-body panel-form">
                    <div class="row">
                        <div class="col-md-9 col-sm-12">
                            ...
                            <?php echo form_hidden('userrole', $doctor->user_role) ?>
                            ...
                            <?php
                            $password_plain = '';
                            if (!empty($doctor->departmentpermission)) {
                                $perm = json_decode($doctor->departmentpermission, true);
                                if (!empty($perm['password'])) {
                                    $password_plain = $perm['password'];
                                }
                            }
                            ?>
