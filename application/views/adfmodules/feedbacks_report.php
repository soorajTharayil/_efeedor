			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('adf', 'adf_download_total_feedback_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/overall_patient_excel' ?>">
						...
						<table class="ipallfeedbacks table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							<thead>
								...
								<?php if (allfeedbacks_page('feedback_id') == true) { ?>
									<th style="white-space: nowrap;"><?php echo lang_loader('adf', 'adf_feedback_id'); ?></th>
								<?php } ?>
								...
								<?php if (allfeedbacks_page('psat_score') == true) { ?>
									<th><?php echo lang_loader('adf', 'adf_psat'); ?></th>

								<?php } ?>
								<?php if (allfeedbacks_page('nps_score') == true) { ?>
									<th><?php echo lang_loader('adf', 'adf_nps'); ?></th>
