			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success"  target="_blank" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('pcf','pcf_download_addressed_complaint_report_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_opentickets'; ?> ">
					...
					<div class="panel-body">
						...
						<table class="pcticketsaddressed table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<?php } ?>
									<th style="white-space: nowrap;"><?php echo lang_loader('pcf','pcf_addresal_comment'); ?></th>
