...
<div class="content">
    ...
    <div class="row">
        <div class="panel-heading">
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url("settings/escalationpc") ?>"> <i class="fa fa-gear" style="padding-right: 5px;"></i> Assign Escalation Users</a>
            </div>
