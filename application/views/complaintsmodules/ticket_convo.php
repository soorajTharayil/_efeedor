<div class="col-lg-12">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			<h3><?php echo lang_loader('pcf', 'pcf_complaint_history'); ?></h3>
		</div>
					...
					<div class="timeline-item">
						...
						<div class="timeline-panel">
							...
							<div class="timeline-body">
								...
								<?php if ($r->reply && $r->ticket_status != 'Described' && $r->ticket_status != 'Assigned' && $r->ticket_status != 'Re-assigned' && $r->ticket_status != 'Reopen' && $r->ticket_status != 'Transfered'): ?>
								...
								<?php if ($r->ticket_status == 'Described') { ?>
									...
									<?php } ?>
								<?php } ?>
								<?php if ($r->reply && $r->ticket_status != 'Described' && $r->ticket_status != 'Transfered' && $r->ticket_status != 'Addressed') { ?>
									<p class="inbox-item-text" style="overflow: clip; word-break: break-all;font-size: 14px;">
