...
<div class="content">
	<div class="row">
		...
		<div class="no-print" class="row" style="position: relative;display: none;" id="showdownload">
			<div class="p-l-30 p-r-30" style="float:right;margin-bottom: 20px;">
				<a data-toggle="tooltip" title="Click here to download department wise patient complaints report"
					target="_blank" href="<?php echo $int_download_department_excel; ?>"
					style="float:right;margin:0px 0px;"><img src="<?php echo base_url(); ?>assets/icon/department.png"
						style="float: right;
			   width: 32px;
			   cursor: pointer;"></a>
				<a data-toggle="tooltip" title="Click here to download patient wise complaints report" target="_blank"
			   ...
			   cursor: pointer;">
				...
				<a data-toggle="tooltip" title="Download Overall Patient Complaints Report in pdf format"
					target="_blank" href="<?php echo $int_download_overall_pdf; ?>"
					style="float:right;margin:0px 10px;"><img src="<?php echo base_url(); ?>assets/icon/pdfdownload.png"
						style="float: right;
			   width: 32px;
			   color: 	#62c52d;
			   cursor: pointer;"></a>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							<h2><span class="count-number"><?php echo $int_department['alltickets']; ?></span> <span
									class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2>
							<div class="small"><?php echo lang_loader('pcf', 'pcf_total_compliants'); ?> <a
							...
							<a class="no-print" href="<?php echo $int_link_alltickets; ?>"
								style="float: right;    margin-top: -9px;"><?php echo lang_loader('pcf', 'pcf_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
		...
		<?php if (ismodule_active('PCF') === true && isfeature_active('OPEN-COMPLAINTS') === true) { ?>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							<h2><span class="count-number"><?php echo $int_department['opentickets']; ?></span> <span
									class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2>
							<div class="small"><?php echo lang_loader('pcf', 'pcf_open_complaints'); ?> <a
									href="javascript:void()" data-toggle="tooltip"
							...
							<a class="no-print" href="<?php echo $int_link_opentickets; ?>"
								style="float: right;    margin-top: -9px;"><?php echo lang_loader('pcf', 'pcf_view_list'); ?></a>
						</div>
					</div>
				</div>
		...
		<?php if (ismodule_active('PCF') === true && isfeature_active('ADDRESSED-COMPLAINTS') === true) { ?>
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							<h2><span class="count-number"><?php echo $int_department['addressedtickets']; ?></span> <span
									class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2>
							<div class="small"><?php echo lang_loader('pcf', 'pcf_addressed_complaints'); ?> <a
									href="javascript:void()" data-toggle="tooltip"
							...
							<a class="no-print" href="<?php echo $int_link_addressedtickets; ?>"
								style="float: right;    margin-top: -9px;"><?php echo lang_loader('pcf', 'pcf_view_list'); ?></a>
						</div>
					</div>
				</div>
		...
		<?php if (ismodule_active('PCF') === true && isfeature_active('CLOSED-COMPLAINTS') === true) { ?>
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							<h2><span class="count-number"><?php echo $int_department['closedticket']; ?></span> <span
									class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2>
							<div class="small"><?php echo lang_loader('pcf', 'pcf_closed_complaints'); ?> <a
									href="javascript:void()" data-toggle="tooltip"
							...
							<a class="no-print" href="<?php echo $int_link_closedtickets; ?>"
								style="float: right;    margin-top: -9px;"><?php echo lang_loader('pcf', 'pcf_view_list'); ?></a>
						</div>
					</div>
				</div>
					...
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							<h2><span class="count-number"><?php echo $ticket_resolution_rate; ?></span>% <span
									class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2>
							<div class="small"><?php echo lang_loader('pcf', 'pcf_complaint_resolution_rate'); ?> <a
									href="javascript:void()" data-toggle="tooltip"
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('pcf', 'pcf_average_resolution_time'); ?> <a
									href="javascript:void()" data-toggle="tooltip"
						...
						<div class="panel-body" style="height: 150px; display:inline;">
							<div class="alert alert-success">
								<span style="font-size: 15px">
									<?php echo lang_loader('pcf', 'pcf_you_have_received_least_complaints_in'); ?>
									<strong><?php echo $highest_complain; ?></strong>
								</span>
							</div>
							<div class="alert alert-warning ">
								<span style="font-size: 15px">
									<?php echo lang_loader('pcf', 'pcf_you_have_received_most_complaints_in'); ?>
	...
	<?php
	$all_feedback = $this->pc_model->patient_and_feedback($table_patients, $table_feedback, $desc, $setup);
	$sresulte = $this->pc_model->setup_result($setup);
	...
	<div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
						...
						<h4> <?php echo lang_loader('pcf', 'pcf_complaint_received_by_department'); ?> <a
		...
		<div class="col-lg-5">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('pcf', 'pcf_recent_complaints'); ?> <a href="javascript:void()"
							data-placement="bottom" data-toggle="tooltip"
									...
									<?php if ($ticketdata->feed->comment == true) { ?>
										...
										foreach ($ticketdata->feed->comment as $key => $value) { ?>
											<p class="inbox-item-text" style="overflow: clip; word-break: break-all;">
												...
												<?php if ($value) { ?>
													<i class="fa fa-comment-o"></i> <?php echo lang_loader('pcf', 'pcf_comment'); ?> :
													"<?php echo $value; ?>"
												<?php } ?>
	...
	<script src="<?php echo base_url(); ?>assets/efeedor_interim_chart.js"></script>
</div>
