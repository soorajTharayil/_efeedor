...
<?php
    ...
    <div class="row">
        <div class="panel-heading">
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url("settings/escalationop") ?>"> <i class="fa fa-gear" style="padding-right: 5px;"></i> Assign Escalation Users</a>
            </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default thumbnail">
                ...
                <div class="panel-body">
                    ...
                    <input value="Save" onclick="validateForm()" class="btn btn-primary">
