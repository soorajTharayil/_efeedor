			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								title="<?php echo lang_loader('op', 'op_download_capa_report_tooltip'); ?>"
					...
					<div class="panel-body">
						...
						<table class="opticketsclose table table-striped table-bordered table-hover" cellspacing="0"
							width="100%">
							<thead>
								<tr>
									<th><?php echo lang_loader('op', 'op_slno'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('op', 'op_ticket_id'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('op', 'op_patient_details'); ?>
									</th>
										...
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom"
											...
											<td style="overflow: clip; word-break: break-all;">
												<?php echo $department->feed->name; ?>&nbsp;(<a
													href="<?php echo $ip_link_patient_feedback . $department->feedbackid; ?>"><?php echo $department->feed->patientid; ?></a>)
												<br>
											...
											<td style="align-items: center;">
												<a href="<?php echo base_url($this->uri->segment(1) . "/track/$department->id") ?>"
													...
													class="btn btn-sm btn-block btn-<?php echo $color; ?>"><?php echo $department->status; ?>
													<i style="font-size:x-small;" class="fa fa-edit"></i></a>
											</td>
										</tr>
										<?php $sl++; ?>
									<?php } ?>
