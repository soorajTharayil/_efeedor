			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success"   target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download open tickets report" href="<?php echo base_url($this->uri->segment(1)) . '/download_' . ($this->uri->segment(2)) ?>">
					...
					<div class="panel-body">
						...
						<table class="opticketsopen table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<?php if (op_tat('open_ticket') === true) { ?>
