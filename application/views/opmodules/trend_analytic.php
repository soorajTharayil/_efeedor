...
//     }
// }
$allFeedback = $this->efeedor_model->get_feedback('bf_opatients', 'bf_outfeedback', $fdate, $tdate);
$setup = $this->efeedor_model->setup_result('setupop');
...
if (!empty($parameterTicketCount)) {
    $maxKey = array_search(min($parameterTicketCount), $parameterTicketCount);
} else {
    $maxKey = null; // or handle it as needed
}
...
if (!empty($nonZeroCounts)) {
    ...
    $minKey = null; // or handle it as needed
}
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body" style="height: 100px;">
                <div class="statistic-box">
                    ...
                    <div class="small"> Satisfied Patient <a href="javascript:void()" data-toggle="tooltip" title="Patients who rated above average and have no negative experiences in your category."><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
                    <div class="icon">
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body" style="height: 100px;">
                <div class="statistic-box">
                    ...
                    <div class="small"> Unsatisfied Patient <a href="javascript:void()" data-toggle="tooltip" title="Patients who rated below average and have one or more negative experiences in your category."><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
                    <div class="icon">
        ...
        <div class="col-lg-12 col-sm-12 col-md-12" style="overflow:auto;margin-bottom: 30px;">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Patient Rating Distribution for <?php echo $result[0]->title; ?>
                        <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip"
                            title="Bar chart displaying the distribution of patient ratings for this category.">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Performance Percentage by <?php echo $result[0]->title; ?> Over Time
                        <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="Line chart showing the category's performance score or percentage over time, based on patient ratings.">
                            <i class="fa fa-info-circle" aria-hidden="true"></i>
                        </a>
                    </h3>
                </div>
