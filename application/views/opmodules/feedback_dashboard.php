...
<div class="content">
	...
	<div class="no-print" class="row" style="position: relative;display: none;" id="showdownload">
		<div class="p-l-30 p-r-30" style="float:right;margin-bottom: 20px;">
			<a data-toggle="tooltip" title="Click here to download department wise patient feedback report" target="_blank" href="<?php echo $ip_download_department_excel; ?>" style="float:right;margin:0px 0px;"><img src="<?php echo base_url(); ?>assets/icon/department.png" style="float: right;
			   width: 32px;
			   cursor: pointer;"></a>
			<a data-toggle="tooltip" title="Download Outpatient Feedbacks Patient Wise Report" target="_blank" href="<?php echo $ip_download_patient_excel; ?>" style="float:right;margin:0px 10px;"><img src="<?php echo base_url(); ?>assets/icon/hospital.png" style="float: right;
			   width: 32px;
			   cursor: pointer;"></a>
			<a data-toggle="tooltip" title="Download Outpatient Overall Feedbacks Report in excel format" target="_blank" href="<?php echo $ip_download_overall_excel; ?>" style="float:right;margin:0px 10px;"><img src="<?php echo base_url(); ?>assets/icon/download.png" style="float: right;
			   width: 32px;
			   cursor: pointer;"></a>
			<a data-toggle="tooltip" title="Download Outpatient Overall Feedbacks Report in pdf format" target="_blank" href="<?php echo $ip_download_overall_pdf; ?>" style="float:right;margin:0px 10px;"><img src="<?php echo base_url(); ?>assets/icon/pdfdownload.png" style="float: right;
			   width: 32px;
			   color: 	#62c52d;
			   cursor: pointer;"></a>
			<span style="float:right;margin:5px 10px;">
				<h4><strong><?php echo lang_loader('op', 'op_downloads'); ?>:</strong></h4>
			</span>
				...
				<div class="panel panel-bd">
					...
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<a class="no-print" href="<?php echo $ip_link_feedback_report; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('op', 'op_psat_satisfied'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $satisfiedpatients_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-smile-o"></i>
							</div>
							<a class="no-print" href="<?php echo $ip_link_satisfied_list; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('op', 'op_unsatisfied_patients'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $unsatisfiedpatients_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-frown-o"></i>
							</div>
							<a class="no-print" href="<?php echo $ip_link_unsatisfied_list; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip" title="<?php echo $ip_tickets_tool; ?>">
						<div class="statistic-box">
							...
							<a class="no-print" href="<?php echo $ip_link_ticket_dashboard; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip" title="<?php echo $ip_psat_tool; ?>">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('op', 'op_psat'); ?> <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $psat_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-star-half-o"></i>
							</div>
							<a class="no-print" href="<?php echo $ip_link_psat_page; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;" style="height: 100px;" data-placement="top" data-toggle="tooltip" title="<?php echo $ip_nps_tool; ?>">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('op', 'op_nps'); ?> <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $nps_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-tachometer"></i>
							</div>
							<a class="no-print" href="<?php echo $ip_link_nps_page; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						...
						<a class="no-print" href="<?php echo $ip_link_ticket_resolution_rate; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						...
						<a class="no-print" href="<?php echo $ip_link_average_resolution_time; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_list'); ?></a>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow:hidden;">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4><?php echo lang_loader('op', 'op_key_takeaways'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="Key takeaway section will showcase key points to be learned from the patient experience data."><i class="fa fa-info-circle" aria-hidden="true"></i></a></h4>
					</div>
					<div class="p-l-30 p-r-30">
						<div class="panel-body" style="height: 150px; display:inline;">
							<div class="alert alert-success">
								<span style="font-size: 15px">
									<?php echo lang_loader('op', 'op_your'); ?> <strong><?php echo $key_highlights['best_param']; ?></strong> <?php echo lang_loader('op', 'op_received_the_highest_satisfaction_rating'); ?>
								</span>
							</div>
							<div class="alert alert-warning ">
								<span style="font-size: 15px">
									<?php echo lang_loader('op', 'op_your'); ?> <strong><?php echo $key_highlights['lowest_param']; ?></strong> <?php echo lang_loader('op', 'op_has_to_be_improved'); ?>
		...
		<div class="col-lg-12 col-sm-12 col-md-12" style="overflow:auto;">
			<div class="panel panel-default">
				<div class="panel-heading"
					...
					<h3 style="margin: 0;">
						<?php echo lang_loader('op', 'op_patient_feedbacks_analysis'); ?>
					...
					<div class="no-print">
						<span style="font-size:15px">Download Chart:</span>
						<span style="margin-right: 10px;">
							<i data-placement="bottom" class="fa fa-file-pdf-o"
								style="font-size: 20px; color: red; cursor: pointer;"
								onclick="printChart_patient_feedback_analysis()" data-toggle="tooltip"
						...
						<span>
							<i data-placement="bottom" class="fa fa-file-image-o"
								...
								onclick="downloadChartImage_patient_feedback_analysis()" data-toggle="tooltip"
	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading"
					style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
					<h3><?php echo lang_loader('op', 'op_patient_satisfaction_analysis'); ?> <a href="javascript:void()"
					...
					<div class="no-print">
						<span style="margin-right: 10px;">
							<i data-placement="bottom" class="fa fa-file-pdf-o"
								style="font-size: 20px; color: red; cursor: pointer;"
								onclick="printChart_patient_satisfaction_analysis()" data-toggle="tooltip"
								title="Download Chart as PDF"></i>
						</span>
						<span>
							<i data-placement="bottom" class="fa fa-file-image-o"
								style="font-size: 20px; color: green; cursor: pointer;"
								onclick="downloadChartImage_patient_satisfaction_analysis()" data-toggle="tooltip"
								title="Download Chart as Image"></i>
						</span>
					</div>
				</div>
		...
		<div class="col-lg-6 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading"
					style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
					<h3><?php echo lang_loader('op', 'op_netpromoter_analysis'); ?> <a href="javascript:void()"
							data-toggle="tooltip" data-placement="bottom"
					...
					<div class="no-print">
						<span style="margin-right: 10px;">
							<i data-placement="bottom" class="fa fa-file-pdf-o"
								style="font-size: 20px; color: red; cursor: pointer;"
								onclick="printChart_net_permoter_analysis()" data-toggle="tooltip"
								title="Download Chart as PDF"></i>
						</span>
						<span>
							<i data-placement="bottom" class="fa fa-file-image-o"
								style="font-size: 20px; color: green; cursor: pointer;"
								onclick="downloadChartImage_net_permoter_analysis()" data-toggle="tooltip"
								title="Download Chart as Image"></i>
						</span>
					</div>
				</div>
	...
	<div class="row" class="no-print">
				...
				<div class="panel-heading">
					<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
						<h4 style="margin: 0; font-size: 16px;">
							<?php echo lang_loader('op', 'op_tickets_received_by_department'); ?>
							<a href="javascript:void()" data-placement="bottom" data-toggle="tooltip"
		...
		<div class="col-lg-5" class="no-print">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('op', 'op_recent_patient_feedbacks'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $recentpatientfeedback_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
				...
				<div class="no-print" style="padding: 20px;    background: #f5f5f5;"><a href="<?php echo base_url($this->uri->segment(1)); ?>/notifications" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_all'); ?></a></div>
			</div>
			<!-- /.row -->
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-lg-7 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading"
					style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
					<h3> <?php echo lang_loader('op', 'op_hospital_selection_analysis'); ?> <a href="javascript:void()"
					...
					<div>
						<span style="margin-right: 10px;">
							<i data-placement="bottom" class="fa fa-file-pdf-o"
								style="font-size: 20px; color: red; cursor: pointer;"
								onclick="printChart_why_patient_choose()" data-toggle="tooltip"
								title="Download Chart as PDF"></i>
						</span>
						<span>
							<i data-placement="bottom" class="fa fa-file-image-o"
								style="font-size: 20px; color: green; cursor: pointer;"
								onclick="downloadChartImage_why_patient_choose()" data-toggle="tooltip"
								title="Download Chart as Image"></i>
						</span>
					</div>
				</div>
		...
		<div class="col-lg-5" class="no-print">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('op', 'op_recent_patient_comments'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $recentpatientcomment_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
				<div class="panel-body" style="   height: 460px;      overflow: auto;">
					<div class="message_inner">
						...
						?>
								<a href="<?php echo base_url($this->uri->segment(1)); ?>/patient_feedback?id=<?php echo $r->id; ?>">
									<div class="inbox-item">
										...
										<p class="inbox-item-text"><?php echo lang_loader('op', 'op_from'); ?>
											<?php
										...
										<?php if (!empty($param->suggestionText)) { ?>
											<p class="inbox-item-text" style="overflow: clip; word-break: break-all;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;<b>Comments</b>:
												"<?php
				...
				<div class="no-print" style="padding: 20px;    background: #f5f5f5;"><a href="<?php echo base_url($this->uri->segment(1)); ?>/comments" style="float: right;    margin-top: -9px;"><?php echo lang_loader('op', 'op_view_all'); ?></a></div>
			</div>
