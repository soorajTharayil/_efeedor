<div class="content">
    ...
    // $this->db->where_in('assignstatus', ['Asset Reassign', 'Asset in Use', 'Asset Assign', 'Asset Transfer']);
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="assetuse table table-striped table-bordered table-hover" cellspacing="0" width="100%" style=" white-space: nowrap; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Sl. <br> No</th>
                                    <th>Asset Details</th>
