...
<div class="content">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            $contract_service_charges  =    $result->contract_service_charges;
            $contract_alert_1  =    $result->contract_alert_1;
            $contract_alert_2  =    $result->contract_alert_2;



            $warrenty1  =   $result->warrenty;
            $warrenty_end1  =   $result->warrenty_end;
            $warranty_alert_1  =    $result->warranty_alert_1;
            $warranty_alert_2  =    $result->warranty_alert_2;
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display: flex; align-items: center; margin-top: -15px;">
                                    ...
                                    <span><?php echo $warrenty_end1; ?></span>
                                </div>
                                <br>
                                ...
                                <div style="display: flex; align-items: center; margin-top: -15px;">
                                    ...
                                    <span><strong><?php echo $warranty_alert_1; ?></strong></span>
                                </div>
                                <br>
                                ...
                                <div style="display: flex; align-items: center; margin-top: -15px;">
                                    ...
                                    <span><strong><?php echo $warranty_alert_2; ?></strong></span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Contract Type -->
                                Contract Type: <?php echo $contract; ?>
                                <br>

                                <!-- Start Date -->
                                Start Date:
                                <?php echo $contract_start_date; ?>
                                <br>

                                <!-- End Date -->
                                End Date:
                                <?php echo $contract_end_date; ?>
                                <br>

                                <!-- Cost -->
                                Cost:
                                <?php echo $contract_service_charges; ?>
                                <br>

                                <!-- Reminder Alert 1 -->
                                <div style="display: flex; align-items: center; margin-top: -5px;">
                                    <span>Reminder Alert 1:</span>
                                    <span><strong><?php echo $contract_alert_1; ?></strong></span>
                                </div>
                                <br>
                                ...
                                <div style="display: flex; align-items: center; margin-top: -15px;">
                                    <span>Reminder Alert 2:</span>
                                    <span><strong><?php echo $contract_alert_2; ?></strong></span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <span><?php echo  $preventive_maintenance_date1; ?></span>
                                </div>
                                <br>
                                ...
                                <div style="display: flex; align-items: center; margin-top: -15px;">
                                    ...
                                    <span><?php echo  $upcoming_preventive_maintenance_date1; ?></span>
                                </div>
                                <br>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display: flex; align-items: center;">
                                    ...
                                    <span><?php echo  $asset_calibration_date1; ?></span>
                                </div>
                                <br>
                                ...
                                <div style="display: flex; align-items: center; margin-top: -15px;">
                                    ...
                                    <span><?php echo  $upcoming_calibration_date1; ?></span>
                                </div>
                                <br>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="datetime-local" class="form-control" id="repairStartDateTime" name="repair_start_date_time"
                                            value=""
                                            <?php echo  isset($sr_open_time) ? 'required' : '' ?> onclick="this.showPicker && this.showPicker();">
                                    </div>
                                </div>


                                <div class="form-group row">
                                    <label for="expenseCost" class="col-xs-3 col-form-label">Expected Cost:</label>
                                    <div class="col-xs-9">
                                        <input type="number" class="form-control" id="expected_cost" name="expected_cost" placeholder="Enter your input here" required>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="datetime-local" class="form-control" id="repairCompletionDateTime" name="repair_completion_date_time"
                                            value="<?php echo  isset($sr_close_time) ? date('Y-m-d\TH:i', strtotime($sr_close_time)) : '' ?>"
                                            <?php echo  isset($sr_close_time) ? 'required' : '' ?>>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="margin-top: 15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="preventive_maintenance_date" name="preventive_maintenance_date"
                                            value="<?php echo isset($preventive_maintenance_date1) ? htmlspecialchars($preventive_maintenance_date1) : ''; ?>"
                                            <?php echo isfeature_active('EDIT-PREVENTIVE-MAINTENANCE') ? '' : 'readonly'; ?>
                                ...
                                <div class="form-group row" style="margin-top: 5px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="upcoming_preventive_maintenance_date" name="upcoming_preventive_maintenance_date"
                                            value="<?php echo isset($upcoming_preventive_maintenance_date1) ? htmlspecialchars($upcoming_preventive_maintenance_date1) : ''; ?>"
                                ...
                                <div class="form-group row" style="margin-top: -15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="reminder_alert_1" name="reminder_alert_1"
                                            <?php echo isfeature_active('EDIT-PREVENTIVE-MAINTENANCE') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('reminder_alert_1', 'upcoming_preventive_maintenance_date')">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group row" style="margin-top: -15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="reminder_alert_2" name="reminder_alert_2"
                                            <?php echo isfeature_active('EDIT-PREVENTIVE-MAINTENANCE') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('reminder_alert_2', 'upcoming_preventive_maintenance_date')">
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12" id="asset_warranty" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-sm-12" style="overflow:auto;">
                                ...
                                <div class="form-group row" style="margin-top: 15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="warrenty" name="warrenty"
                                            value="<?php echo isset($warrenty1) ? htmlspecialchars($warrenty1) : ''; ?>"
                                ...
                                <div class="form-group row" style="margin-top: 5px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="warrenty_end" name="warrenty_end"
                                            value="<?php echo isset($warrenty_end1) ? htmlspecialchars($warrenty_end1) : ''; ?>"
                                            <?php echo isfeature_active('EDIT-ASSET-WARRANTY') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();">
                                    </div>
                                </div>
                                <br>
                                ...
                                <!-- Set Reminder Alert 1 (Default: 15 days before) -->
                                <div class="form-group row" style="margin-top: -15px;">
                                    <label for="warranty_alert_1" class="col-xs-3">Set Reminder Alert 1:</label>
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="warranty_alert_1" name="warranty_alert_1"
                                            <?php echo isfeature_active('EDIT-ASSET-WARRANTY') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('warranty_alert_1', 'warrenty_end')">
                                    </div>
                                </div>
                                <br>
                                ...
                                <!-- Set Reminder Alert 2 (Default: 2 days before) -->
                                <div class="form-group row" style="margin-top: -15px;">
                                    <label for="warranty_alert_2" class="col-xs-3">Set Reminder Alert 2:</label>
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="warranty_alert_2" name="warranty_alert_2"
                                            <?php echo isfeature_active('EDIT-ASSET-WARRANTY') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('warranty_alert_2', 'warrenty_end')">
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="col-sm-12" style="overflow:auto;">
                                ...
                                <div class="form-group row" style="margin-top: 15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="contract_start_date" name="contract_start_date"
                                            value="<?php echo isset($contract_start_date) ? htmlspecialchars($contract_start_date) : ''; ?>"
                                ...
                                <div class="form-group row" style="margin-top: 5px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="contract_end_date" name="contract_end_date"
                                            value="<?php echo isset($contract_end_date) ? htmlspecialchars($contract_end_date) : ''; ?>"
                                            <?php echo isfeature_active('EDIT-ASSET-AMC/CMC') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group row" style="margin-top: 5px;">
                                    <label for="reminder_alert_1" class="col-xs-3">Set Reminder Alert 1:</label>
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="contract_alert_1" name="contract_alert_1"
                                            <?php echo isfeature_active('EDIT-ASSET-AMC/CMC') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('contract_alert_1', 'contract_end_date')">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group row" style="margin-top: -15px;">
                                    <label for="reminder_alert_2" class="col-xs-3">Set Reminder Alert 2:</label>
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="contract_alert_2" name="contract_alert_2"
                                            <?php echo isfeature_active('EDIT-ASSET-AMC/CMC') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('contract_alert_2', 'contract_end_date')">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="margin-top: 15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="asset_calibration_date" name="asset_calibration_date"
                                            value="<?php echo isset($asset_calibration_date1) ? htmlspecialchars($asset_calibration_date1) : ''; ?>"
                                ...
                                <div class="form-group row" style="margin-top: 5px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="upcoming_calibration_date" name="upcoming_calibration_date"
                                            value="<?php echo isset($upcoming_calibration_date1) ? htmlspecialchars($upcoming_calibration_date1) : ''; ?>"
                                ...
                                <div class="form-group row" style="margin-top: -15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="calibration_reminder_alert_1" name="calibration_reminder_alert_1"
                                            <?php echo isfeature_active('EDIT-ASSET-CALIBRATION') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('calibration_reminder_alert_1', 'upcoming_calibration_date')">
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group row" style="margin-top: -15px;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="date" class="form-control" id="calibration_reminder_alert_2" name="calibration_reminder_alert_2"
                                            <?php echo isfeature_active('EDIT-ASSET-CALIBRATION') ? '' : 'readonly'; ?> required onclick="this.showPicker && this.showPicker();" onchange="validateReminderDate('calibration_reminder_alert_2', 'upcoming_calibration_date')">
                                    </div>
                                </div>
...
<script>
    function validateReminderDate(reminderId, dueDateId) {
        const reminderDate = document.getElementById(reminderId).value;
        const dueDate = document.getElementById(dueDateId).value;

        if (reminderDate && dueDate && new Date(reminderDate) > new Date(dueDate)) {
            alert("Reminder date cannot be after the due date.");
...
<script>
    ...
    document.getElementById('approveBtn').addEventListener('click', function() {
        window.location.href = "<?php echo  base_url('asset/approve_transfer/') ?>" + ticketId;
    });

    document.getElementById('denyBtn').addEventListener('click', function() {
        window.location.href = "<?php echo  base_url('asset/deny_transfer/') ?>" + ticketId;
    });
</script>
