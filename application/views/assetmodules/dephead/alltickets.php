                                        ...
                                        <tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo htmlspecialchars($rowmessage, ENT_QUOTES, 'UTF-8'); ?>" style="cursor: pointer;">
                                            ...
                                            <td style="max-width: 250px; word-wrap: break-word; white-space: normal;">
                                                ...
                                                <!-- <div style="display: flex; align-items: center; gap: 10px; margin-top: 5px;">
                                                    <span>Asset Image/ QR:</span>

                                                    <?php if ($department->qr_code_image != '' && $department->qr_code_image != NULL) {
                                                        $encodedImage = $department->qr_code_image; ?>

                                                        
                                                        <a href="<?php echo $encodedImage; ?>" download="QR_Code_Image.png" title="Download QR Code">
                                                            <i class="fa fa-qrcode" style="font-size: 20px;"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <?php if ($department->image != '' && $department->image != NULL) {
                                                        $encodedImages = $department->image; ?>

                                                        
                                                        <a href="<?php echo $encodedImages; ?>" download="Asset_Image.png" title="Download Asset Image">
