<div class="content">
    ...
    // $this->db->where('assignstatus', 'Asset in Use');
    // $this->db->where("(depart IS NULL OR depart = '') AND (assignee IS NULL OR assignee = '')");
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="assetunall table table-striped table-bordered table-hover" cellspacing="0" width="100%" style=" white-space: nowrap; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Sl. <br> No</th>
                                    <th>Asset Details</th>
...
<script>
    ...
    function gotonextdepartment2(groupType) {
        ...
        var url = "<?php echo base_url($this->uri->segment(1) . '/asset_unallocate_tickets?depsec=') ?>" + groupType;
    ...
    function gotonextdepartment3(departmentType) {
        ...
        var url = "<?php echo base_url($this->uri->segment(1) . '/asset_unallocate_tickets?dep=') ?>" + departmentType;
