							...
							<div class="timeline-panel">
								...
								<div class="timeline-body">
									...
									<?php if ($r->ticket_status === 'Asset Sold') : ?>
										<p><strong>Sale Date:</strong> <?php echo  !empty($r->sold_start_date_time) ? $r->sold_start_date_time : 'N/A'; ?></p>

										<?php if (!empty($r->sale_price)) : ?>
											<p><strong>Sale Price:</strong> <?php echo  $r->sale_price; ?></p>
										<?php endif; ?>
										<?php if (!empty($r->reply)) : ?>
											<p><strong>Remarks:</strong> <?php echo  $r->reply; ?></p>
										<?php endif; ?>
									<?php endif; ?>
