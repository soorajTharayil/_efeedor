        ...
        <table cellpadding="10" cellspacing="0" style="border-collapse: collapse; width: 100%; margin-top: 30px; font-family: Arial, sans-serif; font-size: 14px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <tbody>
                <tr style="background-color: #f9f9f9;">
                    ...
                    <td style="padding: 12px; border: 1px solid #ddd;">₹ <?php echo  formatIndianCurrency($totalAssetValue) ?></td>
                </tr>
                <tr>
                    <td style="padding: 12px; border: 1px solid #ddd;">Current Net Book Value (Value after accumulated depreciation)</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">₹ <?php echo  formatIndianCurrency($netBookValue) ?></td>
                </tr>
                <tr style="background-color: #f9f9f9;">
                    <td style="padding: 12px; border: 1px solid #ddd;">Year-to-Date Depreciation (Total depreciation expense for the current year)</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">₹ <?php echo  formatIndianCurrency($ytdDepreciation) ?></td>
                </tr>
                <tr>
                    <td style="padding: 12px; border: 1px solid #ddd;">Cost of New Assets (Total capital spent on new assets this year)</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">₹ <?php echo  formatIndianCurrency($newAssetCost) ?></td>
                </tr>
                <tr style="background-color: #f9f9f9;">
                    <td style="padding: 12px; border: 1px solid #ddd;">Value of Disposed Assets (Financial impact of disposed assets)</td>
                    <td style="padding: 12px; border: 1px solid #ddd;">₹ <?php echo  formatIndianCurrency($disposedAssetsValue) ?></td>
                </tr>
            </tbody>
        </table>
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Amount (₹)',
                        data: [
                            <?php echo  $totalAssetValue ?>,
                            <?php echo  $netBookValue ?>,
                            <?php echo  $ytdDepreciation ?>,
                            <?php echo  $newAssetCost ?>,
                            <?php echo  $disposedAssetsValue ?>
                        ],
                        backgroundColor: [
                            '#4caf50',
                            '#2196f3',
