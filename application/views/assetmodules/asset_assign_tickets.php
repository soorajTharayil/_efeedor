<div class="content">
    ...
    // $this->db->where_in('assignstatus', ['Asset Assign', 'Asset Reassign', 'Asset Transfer', 'Asset in Use']);
    // $this->db->where("(depart IS NOT NULL AND depart != '') OR (assignee IS NOT NULL AND assignee != '')");
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="assetassign table table-striped table-bordered table-hover" cellspacing="0" width="100%" style=" white-space: nowrap; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Sl. <br> No</th>
                                    <th>Asset Details</th>
...
<script>
    ...
    function gotonextdepartment2(groupType) {
        ...
        var url = "<?php echo base_url($this->uri->segment(1) . '/asset_use_tickets?depsec=') ?>" + groupType;
    ...
    function gotonextdepartment3(departmentType) {
        ...
        var url = "<?php echo base_url($this->uri->segment(1) . '/asset_use_tickets?dep=') ?>" + departmentType;
