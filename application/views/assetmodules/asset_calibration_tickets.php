        ...
        <div class="row">
            ...
            if (!empty($results)) {
                foreach ($results as $department) {
                    ...
                    $assetWithCalibration = trim($department->assetWithCalibration);
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Represents the total count of assets with Calibration">
                                <h2><span class="count-number">
                                        <?php echo $applicableCount; ?>
                                    </span> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning">
                                        </i></span></h2>
                                <div class="small">Calibration Applicable Assets</div>
                                <div class="icon">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Calibration is not required for this asset.">
                                <h2><span class="count-number">
                                        <?php echo $notApplicableCount; ?>
                                    </span> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning">
                                        </i></span></h2>
                                <div class="small">Calibration Not Applicable</div>
                                <div class="icon">
                                    <i class="fa fa-calendar-times-o"></i>
                                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Upcoming calibration is planned and scheduled.">
                                <h2><span class="count-number">
                                        <?php echo $scheduleCount; ?>
                                    </span> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning">
                                        </i></span></h2>
                                <div class="small">Calibration Scheduled</div>
                                <div class="icon">
                                    <i class="fa fa-calendar-times-o"></i>
                                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Calibration is due by the end of this month.">
                                <h2><span class="count-number">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Calibration is due within 45 days and should be performed soon.">
                                <h2><span class="count-number">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Calibration is overdue and should be performed soon.">
                                <h2><span class="count-number">
                                        <?php echo $overdueCount; ?>
                                    </span> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning">
                                        </i></span></h2>
                                <div class="small">Calibration Overdue</div>
                                <div class="icon">
                                    <i class="fa fa-calendar-times-o"></i>
                                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip">
                            ...
                            <div class="statistic-box" title="Calibration is overdue by over 30 days and should be performed soon.">
                                <h2><span class="count-number">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: right;">
                        <div class="btn-group">
                            <a class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="Update Calibration details"
                                href="<?php echo  base_url() .  '/asset_calibration?user_id=' . $this->session->userdata['user_id']; ?>"
                                target="_blank">
                                <i class="fa fa-pencil"></i> Update Calibration details
                            </a>
                    ...
                    <div class="panel-body">
                        <?php if ($this->session->userdata('user_role') != 4) { ?>
                            <div style="display: flex; align-items: center; gap: 17px; flex-wrap: wrap;">
                                <form method="get" action="<?php echo site_url('asset/asset_calibration_tickets'); ?>">
                                    <b>Calibration Status:</b> <select name="status" class="form-control" onchange="this.form.submit()" style="width: 150px;">
                                        <option value="all" <?php echo $statusFilter === 'all' ? 'selected' : ''; ?>>All</option>
                                        <option value="Calibration Overdue" <?php echo $statusFilter === 'Calibration Overdue' ? 'selected' : ''; ?>>Calibration Overdue</option>
                        ...
                        <table class="assetcalibration table table-striped table-bordered table-hover" cellspacing="0" width="100%" style=" white-space: nowrap; width: 100%;">
                            <thead>
                                <tr>
                                    <th>Sl. <br> No</th>
                                    <th>Asset Details</th>
                                    ...
                                    <th style="width: 15%;">Calibration <br>Details</th>


                                    <th style="width: 5%;">Days Until Due</th>
                                    <!-- <th>Asset Image</th> -->
                                    <?php if (ismodule_active('ASSET') === true  && isfeature_active('ASSET-DASHBOARD') === true) { ?>
                                        <th style="text-align: center;">Calibration Status</th>
                                    <?php } ?>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                if (!empty($results)) { ?>
                                    ...
                                    ?>
                                        ...
                                        if ($assetWithCalibration === 'Calibration not applicable') {
                                            ...
                                            $tooltipDetail = "Calibration is not required for this asset.";
                                            $color = "btn-primary";
                                        } elseif ($assetWithCalibration === 'Calibration applicable') {
                                            if (empty($upcomingDate)) {
                                                // Calibration applicable but date missing → Scheduled
                                                $tooltipText = "Scheduled";
                                                $tooltipDetail = "Upcoming calibration is planned and scheduled.";
                                                $color = "btn-success";
                                            } else {
                                                ...
                                                if ($daysRemaining < 0) {
                                                    if ($daysRemaining <= -30) {
                                                        ...
                                                        $tooltipDetail = "Calibration is overdue by over 30 days and should be performed soon.";
                                                        $color = "btn-danger";
                                                    } else {
                                                        $tooltipText = "Overdue";
                                                        $tooltipDetail = "Calibration is due and should be performed soon.";
                                                        $color = "btn-danger";
                                                    }
                                                } elseif ($currentDate->format('Y-m') == $upcomingDate->format('Y-m')) {
                                                    $tooltipText = "Due this Month";
                                                    $tooltipDetail = "Calibration is due by the end of this month.";
                                                    $color = "btn-orange";
                                                } elseif ($daysRemaining >= 1 && $daysRemaining <= 45) {
                                                    $tooltipText = "Due in 45 Days";
                                                    $tooltipDetail = "Calibration is due within 45 days and should be performed soon.";
                                                    $color = "btn-warning";
                                                } else {
                                                    $tooltipText = "Scheduled";
                                                    $tooltipDetail = "Upcoming Calibration is planned and scheduled.";
                                            ...
                                            // fallback if calibration field has unknown value
                                            $tooltipText = "Not Applicable";
                                            $tooltipDetail = "Calibration info not defined for this asset.";
                                            $color = "btn-primary";
                                        }
                                        ...
                                        <?php if ($matches) { ?>
                                            <tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>"
                                                ...
                                                <td>
                                                    <?php echo $department->assetWithCalibration; ?> <br>
                                                    Last Calibration date: <?php echo $department->asset_calibration_date; ?> <br>
                                                    Upcoming Calibration Due: <?php echo $department->upcoming_calibration_date; ?>
                                                    ...
                                                    if ($assetWithCalibration === 'Calibration not applicable') {
                                                        ...
                                                        if (empty($upcomingDate)) {
                                                            ...
                                                            if ($currentDate > $upcomingDateObj) {
                                                                echo '<span style="color: red;">🔴 Calibration Overdue</span>';
                                                            } else {
                                                                $interval = $currentDate->diff($upcomingDateObj);
...
<script>
    ...
    function gotonextdepartment2(groupType) {
        ...
        var url = "<?php echo base_url($this->uri->segment(1) . '/asset_calibration_tickets?depsec=') ?>" + groupType;
    ...
    function gotonextdepartment3(departmentType) {
        ...
        var url = "<?php echo base_url($this->uri->segment(1) . '/asset_calibration_tickets?dep=') ?>" + departmentType;
    ...
    function pm_status(type) {
        const url = "<?php echo base_url($this->uri->segment(1) . '/asset_calibration_tickets') ?>?pm_status=" + encodeURIComponent(type);
        window.location.href = url;
    }
</script>