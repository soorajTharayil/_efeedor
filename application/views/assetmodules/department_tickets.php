<div class="content">
	<div class="row">
		...
		$days = $dates['days'];
		$all_feedback = $this->efeedor_model->get_feedback('bf_patients', 'bf_feedback_int', $fdatet, $tdate);
...
<?php if (ismodule_active('PCF') === true  && isfeature_active('TOTAL-COMPLAINTS') === true) { ?>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow:hidden;">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<h4><?php echo lang_loader('pcf', 'pcf_key_takeaways'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('pcf', 'pcf_key_takeaways_tooltip'); ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h4>
	...
	<div class="row">
		...
		<div class="col-lg-7">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('pcf', 'pcf_complaints_analysis'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('pcf', 'pcf_complaints_analysis_tooltip'); ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></h3>
				</div>
		...
		<div class="col-lg-5">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('pcf', 'pcf_recent_complaints'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $recentpatientticket_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
				<div class="panel-body" style="   height: 460px;      overflow: auto;">
					<div class="message_inner">

						<?php $a = $this->ticketsint_model->alltickets();
						$ticket_data = $a;
			...
			tooltips: {
				...
				callbacks: {
					label: function(tooltipItems, data, labels) {
						...
						multistringText.push(res[tooltipItems.index] + ' Complaints');
