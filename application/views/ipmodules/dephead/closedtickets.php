			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success"  target="_blank" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('ip','ip_download_capa_report_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_capa_report' ?>">
						...
						<table class="ipticketsclose table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th style="white-space: nowrap;"><?php echo lang_loader('ip','ip_rca'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('ip','ip_capa'); ?></th>
									<th style="white-space: nowrap;">Closed by</th>
									<?php if (close_comment('ip_close_comment') === true) { ?> 
										<th style="white-space: nowrap;"><?php echo lang_loader('ip','ip_action'); ?></th>
									<?php } ?>

									<?php if (ip_tat('close_ticket') === true) { ?>
										<th style="white-space: nowrap;">Turn Around Time (TAT)</th>
									<?php } ?>
							...
							<tbody>
								<?php if (!empty($departments)) {		?>
									...
									<?php foreach ($departments as $department) {
										// echo '<pre>';
// print_r($department->replymessage);exit;
									...
									?>
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
											<td><?php echo $sl; ?></td>
											<td>IPDT-<?php echo $department->id; ?></td>
