            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;<?php echo lang_loader('ip', 'ip_ipdt'); ?><?php echo $department->id; ?></h3>
                                ...
                                <?php if ($this->session->userdata['isLogIn'] == true) { ?>
                                    ...
                                    <select class="form-control" onchange="ticket_options(this.value)" style="max-width: 300px;" required>
                                        ...
                                        <?php if ($department->status != 'Closed') {
                                            ...
                                            <?php if (ismodule_active('IP') === true  && isfeature_active('IP-CLOSING-TICKETS') === true) { ?>
                                                <option value="capa"><?php echo lang_loader('ip', 'ip_close'); ?></option>
                                            <?php } ?>
                                            <?php if (ismodule_active('IP') === true  && isfeature_active('IP-TRANSFER-TICKETS') === true) { ?>
                                        ...
                                        <?php if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) {
                                            ...
                                            $closed = true; ?>
                                            <?php if ($department->status == 'Closed') { ?>
                                                <?php if (ismodule_active('IP') === true  && isfeature_active('IP-REOPEN-TICKETS') === true) { ?>
                    ...
                    <div class="col-sm-12" id="reopen" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-sm-12" style="overflow:auto;">
                                ...
                                <br />
                                <?php echo form_open_multipart('tickets/create', 'class="form-inner"') ?>
                ...
                <?php if (($department->status != 'Closed')) { ?>
                    ...
                    <div class="col-sm-12" id="move" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <br />
                                <?php echo form_open('tickets/create', 'class="form-inner"') ?>
