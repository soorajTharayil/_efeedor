...
<div class="content">
	...
	// $hi = $this->ipd_model->comm($table_patients, $table_feedback, $desc, $setup, $type);
	if (count($feedbacktaken)) {
	?>
			...
			<div class="col-lg-12 col-sm-12 col-md-12" style="overflow:auto;">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3><?php echo lang_loader('ip','ip_patient_comment_analysis'); ?><a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php //echo $patientfeedbackanalysis_tooltip; 
					...
					<div class="panel-body" style="height: 450px;" id="word">
						...
						<div class="btn-group" style="float: right;		display: flex;">
							...
							<?php echo lang_loader('ip','ip_general_comment'); ?> <i class="fa fa-angle-down" aria-hidden="true" style="margin-right:0px;"></i>
							</button>
						...
						<div class="inbox-item" style="width:100%; ">
							...
							<p class="inbox-item-text" style="margin-top: 2px; margin-left: 5px;margin-bottom:2px;font-size:13px;"><?php echo lang_loader('ip','ip_peaple_often_mention'); ?></p>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<?php if ($feedbacktaken) { ?>
									...
									<a href="<?php echo  $ip_link_patient_feedback . $r->id; ?>">
										...
										<div class="inbox-item">
											...
											<strong class="inbox-item-author"><?php echo $param->name; ?>
												...
												?>
												<?php if ((array)$param->suggestionText != '' && $param->suggestionText != NULL) { ?>
													<p class="inbox-item-text" style="overflow: clip; word-break: break-all;"><b><?php echo lang_loader('ip','ip_comment'); ?></b>: <?php echo $param->suggestionText; ?></p>
												<?php } ?>
										</div>
									</a>
								<?php	} ?>
						...
						<?php } else { ?>
							<h3 style="text-align: center; color:tomato;"><?php echo lang_loader('ip','ip_no_comments'); ?></h3>
						<?php	} ?>
						</div>
