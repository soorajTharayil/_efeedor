            ...
            <div class="col-lg-12">
                <div class="panel panel-default ">
                    <div class="panel-heading" style="text-align: right;">
                        <div class="btn-group">
                            <a class="btn btn-success"  target="_blank"  data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_download_all_report'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_' . ($this->uri->segment(2)) ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="ipticketsall table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="white-space: nowrap;"><?php echo lang_loader('ip', 'ip_modified_on'); ?></th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
                                        ...
                                        <td>
                                            <?php
                                            if (!empty($department->feed->suggestionText)) {
                                                echo $department->feed->suggestionText;
                                            } else {
                                                echo "-"; // Replace this with whatever you'd like to show in the 'else' case.
                                            }
                                            ?>
                                        </td>
