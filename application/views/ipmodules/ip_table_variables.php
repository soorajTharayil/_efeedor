...
$allTickes = $this->ipd_opt_model->get_tickets($table_feedback, $table_tickets);
//$ticket = $this->ipd_opt_model->tickets_recived_by_department($type, $table_feedback, $table_tickets,$department,$allTickes);
// print_r($ticket);
...
// $ip_department = $this->departmenthead_model->departmenthead_values($table_patients, $table_feedback, $table_tickets, $sorttime, $department, $setup, $type);
$ticket_analisys = $this->ipd_opt_model->tickets_recived_by_department($type, $table_feedback, $table_tickets,$department,$allTickes);
...
foreach ($ticket_analisys as $item) {
...
$ticket_resolution_rate = $this->ipd_model->ticket_resolution_rate($table_tickets, $closed, $table_feedback,$allTickets);
$close_rate = $this->ipd_model->ticket_rate($table_tickets, $status, $table_feedback, $table_ticket_action,$allTickets);
$ticket_close_rate = secondsToTime($close_rate);



// $close_rate = $this->ipd_model->ticket_rate($table_tickets, $closed, $table_feedback, $table_ticket_action);
...
// $close_rate = $this->ipd_model->ticket_rate($table_tickets, $table_ticket_action, $closed);
// $close_time = $this->ipd_model->convertSecondsToTime($close_rate);
