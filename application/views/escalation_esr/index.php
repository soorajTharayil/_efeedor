			...
			<div class="panel panel-default thumbnail">
				<div class="panel-body">
					...
					<?php if ($escalation->status == 'ACTIVE') { ?>
						<?php echo form_open('escalation_esr/create'); ?>
						<div class="accordion">Assign Escalation to Dept. Heads</div>
...
<script>
	function set_active(active) {
		if (active == 1) {
			var url = "<?php echo base_url(); ?>escalation_esr/action/active";
			window.location.href = url;
		} else {
			var url = "<?php echo base_url(); ?>escalation_esr/action/inactive";
			window.location.href = url;
		}
	}
</script>
