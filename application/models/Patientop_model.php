...
class Patientop_model extends CI_Model
{

	private $patient_from_admission = "patients_from_admission_op";
	private $patient_admitted = "patient_admitted_op";
	private $patient_discharged = "patient_discharge_op";
