                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top:-23px;">
                        <div class="form-group">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.housekeeping}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                                <input type="radio" ng-model="feedback.housekeeping" value="yes" />
                                <span style="margin-left: 5px;">Yes</span>
                              </label>
                              <label style="display: flex; align-items: center;">
                                <input type="radio" ng-model="feedback.housekeeping" value="no" />
                                <span style="margin-left: 5px;">No</span>
                              </label>
                              <label style="display: flex; align-items: center;">
                                <input type="radio" ng-model="feedback.housekeeping" value="N/A" />
                                <span style="margin-left: 5px;">N/A</span>
                              </label>
                            </div>
                          </div>
                          <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                            <p style="font-size: 16px; margin-bottom: 6px;">{{lang.checklist}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
