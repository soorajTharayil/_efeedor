...
<head>
  ...
  <script src="app_28PSQ4d.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculatePatientFallRate()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult !==undefined" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Patient fall rate (per 1000 patient days) is: <span style="color: blue; font-size:16px;">{{calculatedResult}}</span></strong><br><br>
