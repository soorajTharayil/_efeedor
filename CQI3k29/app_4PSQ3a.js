  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Please enter number of deaths for COVID 19 be less than number of discharges and deaths in that month"
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "lease enter number of deaths for COVID 19 be less than number of discharges and deaths in that month"
        );
        return false;
      }
