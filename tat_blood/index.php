...
<head>
  ...
  <script src="app_tat_blood.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step0 == true">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" id="department" ng-required="true" ng-model="feedback.department" ng-change="updateBenchmarkTime()" autocomplete="off" style="padding-top:0px;padding-left:0px;margin-top: 5px;">
                              <option value="" disabled selected>Select Transfusion Type</option>
                              <option ng-repeat="x in transfusion.transfusion" ng-show="x.title != 'ALL'" value="{{x.title}}">{{x.title}}</option>
                            </select>
                  ...
                  <div ng-if="calculatedResultTime" style="margin-top: 15px;text-align:left;"><br>
                    <div style="margin-left:15px;">
                      <strong>Turn around time for issue of blood and blood components: <span ng-style="{ color: getTextColor() }">{{calculatedResultTime}}</span></strong><br><br>
                      <strong>Benchmark Time: {{benchmark}}</strong>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px; margin-top: 20px;">
                        <div class="form-group transparent-placeholder" style="display: flex; flex-direction: column; position: relative;">
                          ...
                          <div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
                            <input class="form-control" ng-model="feedback.initial_assessment_hr3" oninput="restrictYearLength(this)" type="datetime-local" id="formula_para3_hr" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid #ced4da;margin-top:9px;width: calc(100% - 8px);" />
                            <span class="calendar-icon-container" style="position: absolute; right: 5px; top: 76%; transform: translateY(-50%); margin-left:-29px;">
                              <svg class="calendar-icon" style="margin-left:-24px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zm0 1V1h8v-.5a.5.5 0 0 1 1 0V1h1a1 1 0 0 1 1 1v2H1V2a1 1 0 0 1 1-1h1V.5a.5.5 0 0 1 1 0V1zm-2 4v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V5H1z" />
                              </svg>
                            </span>
                            <span style="position: absolute; right: 5px; top: 50%; transform: translateY(-50%);">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="padding-right: 0px; padding-left: 12px; margin-left: 5px; margin-top: 10px;">
