...
$scope.user_id = ehandor.userid;
	...
	$scope.savefeedback = function () {
		...
		$http.post($rootScope.baseurl_main + '/save_ma_ipsg2_er.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
