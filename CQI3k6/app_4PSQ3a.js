  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of patients receiving Surgical prophylactic Antibiotics more than 48 hrs (IV)"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter No. of patients receiving Surgical prophylactic Antibiotics "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Please enter number of patients receiving Surgical prophylactic Antibiotics more than 48 hrs (IV) be less than no. of patients receiving Surgical prophylactic Antibiotics"
        );
        return;
      }
