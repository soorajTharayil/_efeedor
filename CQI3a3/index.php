                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong> Avg.Time for initial assessment of in-patients (Doctors)-(Emergency Department) : <span ng-style="{ color: getTextColor() }">{{calculatedResult}}</span></strong><br><br>
