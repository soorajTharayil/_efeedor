...
<head>
  ...
  <script src="app_return_to_emr.js?<?php echo time(); ?>"></script>
            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step0 == true">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:16px;margin-bottom:13px;">
                        <div class="form-group transparent-placeholder" style="display: flex; flex-direction: column; position: relative;">
                          <span class="addon" style="font-size: 16px; margin-bottom: -10px;margin-left: -14px;">{{lang.formula_para1}}<sup style="color:red">*</sup><br>
                            <p style="font-size: 14px;">{{lang.format}}</p>
                          </span>

                          <div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
                            <input class="form-control" ng-model="feedback.initial_assessment_hr1" oninput="restrictYearLength(this)" type="datetime-local" id="formula_para1_hr" autocomplete="off" style="padding-top: 2px;margin-left: -14px;padding-left: 6px;border: 1px solid #ced4da; margin-top:2px;width: calc(100% - 0px);" />
                            <span class="calendar-icon-container" style="position: absolute; right: 5px; top: 72%; transform: translateY(-50%); margin-left:-29px;">
                              <svg class="calendar-icon" style="margin-left:-30px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px;">
                        <div class="form-group">
                          ...
                          <div style="margin-top: 2px; text-align: left;margin-left: -5px;">
                            <p style="font-size: 16px; margin-bottom: 6px;margin-top: 10px;">{{lang.gloves}}</p>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.gloves === 'yes'" style="margin-top: 10px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;"><b>{{lang.explain}}</b></p>
                            <input class="form-control" ng-model="feedback.gloves_comment" rows="3" placeholder="What is the patient condition at initial consultation?" style="margin-top: 10px;margin-left:-15px;padding-left: 5px; border:1px solid #ced4da; width: 100%;">
                          </div>

                          <div style="margin-top: 8px; text-align: left;margin-left: -5px;">
                            <p style="font-size: 16px; margin-bottom: 6px;margin-top: 10px;">{{lang.mask}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.mask === 'yes'" style="margin-top: 10px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;"><b>{{lang.explain}}</b></p>
                            <input class="form-control" ng-model="feedback.mask_comment" rows="3" placeholder="What is the patient condition at initial consultation?" style="margin-top: 10px;margin-left:-15px;padding-left: 5px; border:1px solid #ced4da; width: 100%;">
                          </div>

                          <div style="margin-top: 8px; text-align: left;margin-left: -5px;">
                            <p style="font-size: 16px; margin-bottom: 6px;margin-top: 10px;">{{lang.same_op}}</p>
                            <div style="display: flex; gap: 20px; align-items: center;">
                              <label style="display: flex; align-items: center;">
                                <input type="radio" ng-model="feedback.same_op" value="yes" />
                                <span style="margin-left: 5px;">Yes</span>
                              </label>
                              <label style="display: flex; align-items: center;">
                                <input type="radio" ng-model="feedback.same_op" value="no" />
                                <span style="margin-left: 5px;">No</span>
                              </label>
                            </div>
                          </div>

                          <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.same_op === 'yes'" style="margin-top: 10px; text-align: left;">
                            <p style="font-size: 16px; margin-bottom: 6px;"><b>{{lang.explain}}</b></p>
                            <input class="form-control" ng-model="feedback.same_op_comment" rows="3" placeholder="What is the patient condition at initial consultation?" style="margin-top: 10px;margin-left:-15px;padding-left: 5px; border:1px solid #ced4da; width: 100%;">
                          </div>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group" style="margin-left: -20px;margin-top:10px;">
                              ...
                              <span class="addon" style="font-size: 16px; margin-top:15px;">{{lang.test_name}}<sup style="color:red">*</sup></span>

                              <span class="has-float-label">

                                <input class="form-control" placeholder="{{lang.test_name_placeholder}}" maxlength="20" type="text" id="contactnumber" ng-required="true" ng-model="feedback.condition" autocomplete="off" style="padding-top:0px;" />
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-12" style="padding-right: 0px; padding-left: 12px; margin-left: 5px; margin-top: 15px;">
                            <p style="font-size: 16px; margin-bottom: 6px; margin-left: -18px;">{{lang.data_analysis}}</p>
                            <textarea style="border:1px solid #ced4da; margin-left: -18px; margin-top: 6px; padding: 10px; width: 85%; height: 85px;" class="form-control" id="textarea1" ng-model="feedback.dataAnalysis" rows="5"></textarea>
                          </div>
                  ...
                  <!-- submit button -->
                  <input type="button" name="previous" class="previous action-button-previous" style=" font-size:small;margin-left:12px;" ng-click="prev()" value="{{lang.previous}}" />
