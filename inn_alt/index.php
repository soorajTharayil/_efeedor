...
<body ng-app="ehandorApp" ng-controller="PatientFeedbackCtrl" style="display:none;" id="body">
	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
		...
		<!-- <button type="button" class="btn btn-success"  style="margin: -30px;" ng-click="raiseAnonymousIncident()" ng-show="AnonymousIncident_show == true">
										...
										<div class="text-left details-section" style="background: white;">
											...
											<table class="details-content" style="border-spacing: 10px; border-collapse: collapse; width: 100%; margin-bottom: 0px; border: 1px solid #dddddd;">
												...
												<tr ng-show="feedback.file">
													<td class="details-label" style="border: 1px solid #dddddd; padding: 10px;">{{lang.file}}</td>
													<td style="border: 1px solid #dddddd; padding: 10px;">
														<a ng-href="{{feedback.file}}" download="{{feedback.fileName}}" ng-show="feedback.file">
															{{feedback.fileName}}
														</a>
													</td>
												</tr>
											...
											<div style="display: flex; margin-top: 30px;">
												<label style="display: flex; cursor: pointer;">
													<input type="checkbox" ng-model="anonymousIncident" ng-change="onAnonymousIncidentChange()" style="margin-right: 10px; margin-top: 2px;  width: 25px; height: 25px;">
													<p> I would like to report this incident anonymously.</p>
												</label>
											</div>
											<br><br>
