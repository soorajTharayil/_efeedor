...
<head>
  ...
  <script src="app_24PSQ4c.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    <div style="margin-left:15px;">
                      <strong>Avg. time taken for discharge: <span ng-style="{ color: getTextColor() }">{{calculatedResult}}</span></strong><br><br>
                      <strong>Benchmark Time: {{ feedback.benchmark8 }}</strong><br><br>
                      <strong>Performance Vs Benchmark: <span ng-style="{ color: getTextColor() }">{{feedback.excessTimeText}}</span></strong>
                    </div>
                  </div>

                  <!-- Code for insurance patient-->
                  <div class="form-card" style="margin-top:30px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px;">
                        <div class="form-group transparent-placeholder" style="display: flex; flex-direction: column;">
                          <span class="addon" style="font-size: 16px; margin-bottom: 1px;"><b>{{lang.formula_para1_i}}</b><sup style="color:red">*</sup></span>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px;">
                        <div class="form-group transparent-placeholder">
                          <span class="addon" style="font-size: 16px; margin-bottom: 15px;"><b>{{lang.formula_para2}}</b><sup style="color:red">*</sup></span>
                          <span class="has-float-label">
                            <input class="form-control" oninput="restrictToNumerals(event)" ng-model="feedback.total_admission2" placeholder="{{lang.formula_para2_placeholder}}" type="number" id="formula_para2_i" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid grey;margin-top:9px;width: 52%;" />
                            <label for="para2"></label>
                          </span>
                        </div>
                      </div>
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateTimeFormat2(); " style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult2" style="margin-top: 15px;text-align:left;"><br>
                    <div style="margin-left:15px;">
                      <strong>Avg. time taken for discharge: <span ng-style="{ color: getTextColor2() }">{{calculatedResult2}}</span></strong><br><br>
                      <strong>Benchmark Time: {{ feedback.benchmark9 }}</strong><br><br>
                      <strong>Performance Vs Benchmark: <span ng-style="{ color: getTextColor2() }">{{feedback.excessTimeText2}}</span></strong>
                    </div>
                  </div>

                  <!-- Code for corparte patient-->
                  <div class="form-card" style="margin-top: 30px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px;">
                        <div class="form-group transparent-placeholder" style="display: flex; flex-direction: column;">
                          <span class="addon" style="font-size: 16px; margin-bottom: 1px;"><b>{{lang.formula_para1_c}}</b><sup style="color:red">*</sup></span>

                          <div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
                            <span class="has-float-label" style="display: flex; align-items: center; ">
                              <input class="form-control" oninput="restrictToNumerals(event)" placeholder="{{lang.hr_placeholder}}" ng-model="feedback.initial_assessment_hr3" type="number" id="formula_para1_hr3" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid grey;margin-top:9px;width: 90%;" />
                              <span style="margin-left: 4px; margin-right: 9px;">hr </span>
                              <label for="para1"></label>
                            </span>
                            <span class="has-float-label" style="display: flex; align-items: center;  ">
                              <input class="form-control" oninput="restrictToNumerals(event)" placeholder="{{lang.min_placeholder}}" ng-model="feedback.initial_assessment_min3" type="number" id="formula_para1_min3" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid grey;margin-top:9px;width: 90%;" />
                              <span style="margin-left: 4px; margin-right: 9px;">min </span>
                              <label for="para1"></label>
                            </span>
                            <span class="has-float-label" style="display: flex; align-items: center; ">
                              <input class="form-control" oninput="restrictToNumerals(event)" placeholder="{{lang.sec_placeholder}}" ng-model="feedback.initial_assessment_sec3" type="number" id="formula_para1_sec3" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid grey;margin-top:9px;width: 90%;" />
                              <span style="margin-left: 4px;">sec</span>
                              <label for="para1"></label>
                            </span>
                          </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px;">
                        <div class="form-group transparent-placeholder">
                          <span class="addon" style="font-size: 16px; margin-bottom: 15px;"><b>{{lang.formula_para2}}</b><sup style="color:red">*</sup></span>
                          <span class="has-float-label">
                            <input class="form-control" oninput="restrictToNumerals(event)" ng-model="feedback.total_admission3" placeholder="{{lang.formula_para2_placeholder}}" type="number" id="formula_para2_c" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid grey;margin-top:9px;width: 52%;" />
                            <label for="para2"></label>
                          </span>
                        </div>
                      </div>
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateTimeFormat3(); " style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult3" style="margin-top: 15px;text-align:left;"><br>
                    <div style="margin-left:15px;">
                      <strong>Avg. time taken for discharge: <span ng-style="{ color: getTextColor3() }">{{calculatedResult3}}</span></strong><br><br>
                      <strong>Benchmark Time: {{ feedback.benchmark7 }}</strong><br><br>
                      <strong>Performance Vs Benchmark: <span ng-style="{ color: getTextColor3() }">{{feedback.excessTimeText3}}</span></strong>
                    </div>
                  </div>
                  ...
                  <!-- submit button -->
                  <div ng-if="calculatedResult || calculatedResult2 || calculatedResult3">
