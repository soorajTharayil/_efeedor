...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window) {
    ...
    $scope.calculateTimeFormat2 = function () {
      ...
      // Get total admission
      var totalPatientsDischarged = parseInt(
        document.getElementById("formula_para2_i").value
      );
