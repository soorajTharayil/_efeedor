                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div ng-if="calculatedResult !==undefined" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Bile Duct Injury Rate Requiring Operative Intervention During Laparoscopic Cholecystectomy (per 100 cases): <span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
