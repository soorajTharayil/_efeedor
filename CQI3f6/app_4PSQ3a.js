  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter total No of adverse events and near miss events involving blood bank and/or transfusion services reported in the month"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter total number of Blood and blood Products transfused in the month "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Total No of adverse events and near miss events involving blood bank and/or transfusion services reported in the month less than Total number of Blood and blood Products transfused in the month "
        );
        return;
      }
