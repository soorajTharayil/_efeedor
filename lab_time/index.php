...
<head>
  ...
  <script src="app_lab_time.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step0 == true">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <button type="button" class="btn btn-primary" ng-click="calculateTimeFormat()" style=" margin-top:15px; margin-left:33px;">
                          Calculate laboratory wait time
                        </button>
                  ...
                  <div ng-if="calculatedResultTime" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Waiting time for laboratory: <span style="color: blue; font-size:16px;">{{calculatedResultTime}}</span></strong><br><br>
