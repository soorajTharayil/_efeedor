              ...
              <form id="msform">
                  ...
                  <div class="form-card">
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin: 0px 0px 0 0px;">
                        ...
                        <div class="form-group">
                          ...
                          <div style="position: relative; width: 100%;">
                            <input class="form-control" ng-model="feedback.initial_assessment_hr2" type="datetime-local"
                              id="formula_para1_hr" ng-required="true" min="{{minDateTime}}" max="{{todayDateTime}}"
                        ...
                        <h6 style="font-size: 18px;margin-left:1px;margin-top:30px;"><b>Staff Information</b></h6>
                        <!-- MID No -->
                        <!-- Department -->
                        ...
                        <div class="form-group">
                          <span class="addon" style="font-size: 18px;margin-bottom: 6px; ">{{lang.mid}}<sup
                              style="color: red;">*</sup></span>
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label" style="margin-top: 8px;">
                            <input type="text" class="form-control" ng-model="feedback.patient_name"
                              placeholder="Enter Officer Name" maxlength="50" autocomplete="off" />
                          </span>
                        </div>
                        <!-- Supervisor Name  -->

                        <div class="form-group">
                          <span class="addon" style="font-size: 18px;margin-bottom: 6px;">{{lang.supname}}<sup
                              style="color: red;">*</sup></span>
                          <span class="has-float-label" style="margin-top: 8px;">
                            <input type="text" class="form-control" ng-model="feedback.supervisor_name"
                              placeholder="Enter Supervisor Name" maxlength="50" autocomplete="off" />
                          </span>
                        </div>
                        <!-- Driver Name -->

                        <div class="form-group">
                          <span class="addon" style="font-size: 18px;margin-bottom: 6px;">{{lang.driname}}<sup
                              style="color: red;">*</sup></span>
                          <span class="has-float-label" style="margin-top: 8px;">
                            <input type="text" class="form-control" ng-model="feedback.driver_name"
                              placeholder="Enter Driver Name" maxlength="50" autocomplete="off" />
                          </span>
                        </div>
                        <!-- Picker Name -->

                        <div class="form-group">
                          <span class="addon" style="font-size: 18px;margin-bottom: 6px;">{{lang.pickname}}<sup
                              style="color: red;">*</sup></span>
                          <span class="has-float-label" style="margin-top: 8px;">
                            <input type="text" class="form-control" ng-model="feedback.picker_name"
                              placeholder="Enter Picker Name" maxlength="50" autocomplete="off" />
                          </span>
                        </div>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 30px; margin-left:5px;">
                    <div style="margin-top: 10px; text-align: left; margin-left:-6px; display: flex; flex-direction: column; gap: 12px; max-width: 600px;">

                  <!-- Yellow Bags -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">No. of Yellow Bags<sup style="color: red;"></sup></label>
                    <input type="number" class="form-control"
                      ng-model="feedback.yellow_bags"
                  ...
                  <!-- Red Bags -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">No. of Red Bags<sup style="color: red;"></sup></label>
                    <input type="number" class="form-control"
                      ng-model="feedback.red_bags"
                  ...
                  <!-- White Bags -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">No. of White Bags<sup style="color: red;"></sup></label>
                    <input type="number" class="form-control"
                      ng-model="feedback.white_bags"
                  ...
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">No. of Brownish Yellow Bags<sup style="color: red;"></sup></label>
                    <input type="number" class="form-control"
                      ng-model="feedback.brownish_yellow_bags"
                  ...
                  <!-- Blue Bags -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">No. of Blue Bags<sup style="color: red;"></sup></label>
                    <input type="number" class="form-control"
                      ng-model="feedback.blue_bags"
                  ...
                  <!-- Total Bags -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">Total Bags</label>
                    <input type="number" class="form-control"
                      ng-model="feedback.total_bags"
                      placeholder="Auto Calculated" min="0" readonly
                      style="width: 50%; background:#f8f8f8; margin-top:5px;" />
                  </div>
                
                  <!-- Total Bags Processed -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">Total Bags Processed</label>
                    <input type="number" class="form-control"
                      ng-model="feedback.total_bags_processed"
                      placeholder="Enter total processed" min="0"
                      style="width: 50%; margin-top:5px;" />
                  </div>
                
                  <!-- Total Quantity (Kg) -->
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size: 18px; width: 45%;">Total Quantity (Kg)</label>
                    <input type="number" class="form-control"
                      ng-model="feedback.total_quantity"
                      placeholder="Enter total quantity in Kg" min="0" step="0.1"
                      style="width: 50%; margin-top:5px;" />
                  </div>
                ...
                <!-- submit button -->
                  <input type="button" name="previous" class="previous action-button-previous" style=" font-size:small;margin-left:-8px;margin-top:35px;" ng-click="prev1()" value="{{lang.previous}}" />
