...
$scope.todayDateTime = new Date().toISOString().slice(0,16);
	...
	$scope.savefeedback = function () {
		...
		$http.post($rootScope.baseurl_main + '/save_ma_clinicaloutcome_carotid_stenting.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
