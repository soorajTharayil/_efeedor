  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of new oncology patients who had treatment initiated following multidisciplinary meeting tumor board."
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of new oncology patients who had treatment initiated following multidisciplinary meeting tumor board less than Number of new oncology cases all disciplines."
        );
        return;
      }
