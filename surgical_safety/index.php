                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:16px;margin-bottom:13px;">
                        <div class="form-group transparent-placeholder" style="display: flex; flex-direction: column; position: relative;">
                          ...
                          <div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
                            <input class="form-control" ng-model="feedback.initial_assessment_hr1" oninput="restrictYearLength(this)" type="datetime-local" id="formula_para1_hr" autocomplete="off" style="padding-top: 2px;margin-left: -14px;padding-left: 6px;border: 1px solid #ced4da; margin-top:9px;width: calc(100% - 0px);" />
