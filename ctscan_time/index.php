...
<head>
  ...
  <script src="app_ctscan_time.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step0 == true">
                  ...
                  <div ng-if="calculatedResultTime" style="margin-top: 15px;text-align:left;"><br>
                    <div style="margin-left:15px;">
                      <strong>Waiting time for CT scan: <span style="color: blue; font-size:16px;">{{calculatedResultTime}}</span></strong><br><br>
