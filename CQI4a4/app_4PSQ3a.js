  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Total quantity rejected less than Total quantity received before Goods Receipt Note "
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "number of stock outs of emergency drugs less than Number of drugs listed as emergency drugs in hospital formulary"
        );
        return false;
      }
