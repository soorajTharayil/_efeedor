...
$scope.user_id = ehandor.userid;
	...
	$scope.savefeedback = function () {
		...
		$scope.feedback.identification_details_text = formatDateToLocalString($scope.feedback.identification_details_text);
		...
		$http.post($rootScope.baseurl_main + '/save_ma_extravasation_audit.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
