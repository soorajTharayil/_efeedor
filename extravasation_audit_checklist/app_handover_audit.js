...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window) {
    ...
    $scope.savefeedback = function () {
      ...
      $scope.feedback.identification_details_text = formatDateToLocalString(
        $scope.feedback.identification_details_text
      );
      $scope.feedback.initial_assessment_hr3 = formatDateToLocalString(
      ...
      $http
        .post(
          $rootScope.baseurl_main +
            "/save_ma_extravasation_audit.php?patient_id=" +
            $rootScope.patientid +
            "&administratorId=" +
            $rootScope.adminId,
          $scope.feedback
