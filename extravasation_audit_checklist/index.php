              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px;">
                    <div class="form-group"
                      style="margin-top: 30px; margin-bottom: 18px; margin-left:-10px; text-align:left;">
                      <label for="formula_para1_hr7" style="font-size: 16px; margin-bottom: 4px;">
                        {{lang.identification_details}} <sup style="color:red"></sup>
                      </label>

                      <input class="form-control" ng-model="feedback.identification_details_text" type="datetime-local"
                        id="formula_para1_hr7" ng-required="true" autocomplete="off" ng-attr-max="{{todayDateTime}}"
                    ...
                    <div style="margin-top: 4px; text-align: left; margin-left:-6px;">
                      ...
                      <!-- Text Input only -->
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.vital_signs"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <!-- Text Input only -->
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.surgery_text"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.intake_text"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.output_text"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.allergies_text"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.medication_text"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 8px;">
                        <input type="text" class="form-control" ng-model="feedback.diagnostic_text"
                          placeholder="Enter your input" maxlength="50" autocomplete="off" />
                      </span>
                    </div>
                    <h6 style="font-size: 18px;text-align: left; margin-left:-6px;margin-top:13px;"><b>Signs and
                        symptoms noted</b></h6>
                    <!-- Lab Results -->
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.lab_results" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.lab_results" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.lab_results" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pending_investigation" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pending_investigation" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.pending_investigation" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                      <input type="text" class="form-cont" ng-model="feedback.pending_investigation_text"
                        placeholder="Remarks" style="margin-top: 5px; width: 100%;" />
                    </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.medicine_order" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.medicine_order" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.medicine_order" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.facility_communicated" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.facility_communicated" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.facility_communicated" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <h6 style="font-size: 18px; text-align: left; margin-left:-6px; margin-top:13px;"><b>Immediate
                        actions taken</b></h6>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.health_education" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.health_education" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.health_education" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.risk_assessment" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.risk_assessment" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.risk_assessment" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.urethral" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.urethral" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.urethral" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.urine_sample" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.urine_sample" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.urine_sample" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.bystander" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.bystander" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.bystander" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.instruments" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.instruments" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.instruments" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.sterile" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.sterile" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.sterile" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.antibiotics" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.antibiotics" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.antibiotics" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.surgical_site" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.surgical_site" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.surgical_site" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                    ...
                    <div style="margin-top: 12px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="display: flex; gap: 20px; align-items: center; font-size: 18px;">
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.wound" value="yes" /> <span
                            style="margin-left:5px;">Yes</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.wound" value="no" /> <span
                            style="margin-left:5px;">No</span>
                        </label>
                        <label style="display: flex; align-items: center;">
                          <input type="radio" ng-model="feedback.wound" value="N/A" /> <span
                            style="margin-left:5px;">N/A</span>
                        </label>
                      </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12"
                    style="padding-right: 0px; padding-left: 12px; margin-left: 5px; margin-top: 13px;">
                    <p style="font-size: 16px; text-align:left; margin-bottom: 6px; margin-left: -2px;">
                  ...
                  <!-- submit button -->
                  <input type="button" name="previous" class="previous action-button-previous"
                    style=" font-size:small;margin-left:12px;margin-top:35px;" ng-click="prev1()"
                    value="{{lang.previous}}" />
