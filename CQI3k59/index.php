                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Percentage of cases where in Initial assessment done in physiotherapy with in 24 hours (OPD)-(Physical therapy and Rehabilitation Department - Medical records): <span style="color: blue !important;">{{calculatedResult}}%</span></strong><br><br>
