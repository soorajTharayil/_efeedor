  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of employees provided with pre-exposure prophylaxis "
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter Number of employees due to be provided with pre-exposure prophylaxis"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of employees provided with pre-exposure prophylaxis less than Number of employees due to be provided with pre-exposure prophylaxis "
        );
        return;
      }
