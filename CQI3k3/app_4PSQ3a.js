  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of surgical site infections among patients undergone inguinal herniorrhaphy with a mesh in a given period  "
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter number of inguinal herniorrhaphies performed in that period"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Please enter number of surgical site infections among patients undergone inguinal herniorrhaphy with a mesh in a given period be less than number of inguinal herniorrhaphies performed in that period"
        );
        return;
      }
