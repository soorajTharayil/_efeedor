                    ...
                    <div class="row">
                        ...
                        <div class="form-group" style="margin-top: -17px;">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" ng-model="feedback.ward" ng-change="change_asset()" style="margin-top: 6px;padding-left:0px;">
                              <option value="" disabled selected>Select Asset Group/ Category</option>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group" style="margin-top: -17px;">
                          ...
                          <span class="addon" style="font-size: 16px;">Asset Brand</span>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group" style="margin-top: -17px;">
                          ...
                          <span class="addon" style="font-size: 16px;">Asset Model No.</span>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group" style="margin-top: -17px;">
                          ...
                          <span class="addon" style="font-size: 16px;">Asset Serial No.</span>

                          <span class="has-float-label">

                            <input class="form-control" placeholder="{{lang.input}}" maxlength="30" type="text" id="contactnumber" ng-required="true" ng-model="feedback.serial" autocomplete="off" style="padding-top:0px;" />
                        ...
                        <div class="form-group" style="margin-left: 0px; margin-top:7px;">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" ng-model="feedback.component" style="width: 100%; margin-top: 6px;">
                              ...
                              <option ng-repeat="x in component_b" value="{{x}}" required>{{x}}</option>
                            </select>
                        ...
                        <div class="form-group" style="margin-top: 12px;">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" id="assigned" ng-required="true" ng-model="feedback.depart" autocomplete="off" ng-change="updateAssetStatus()" style="padding-top:0px;margin-top: 5px;padding-left:0px;width:100%">
                              <option value="" disabled selected>Select Asset Department</option>
                        ...
                        <div class="form-group" style="margin-top: 0px;">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" id="assigned" ng-required="true" ng-model="feedback.assigned" autocomplete="off" ng-change="updateAssetStatus()" style="padding-top:0px;margin-top: 5px;padding-left:0px;width:100%">
                              <option value="" disabled selected>Select Asset User</option>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group" style="margin-left: 0px; margin-top:-17px;">
                          ...
                          <span class="has-float-label">
                            <select class="form-control" ng-model="feedback.locationsite" ng-change="change_ward()" style="width: 100%; margin-top: 6px;padding-left:0px;">
                              <option value="" disabled selected>{{lang.floor}}</option>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" ng-if="isDepreciationCalculated" style="margin-top: 16px;">
                        <p>Current value of the Asset is: {{assetCurrentValue | currency:"":0}}</p>
                      </div>

                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left: 0px; margin-top: 8px">
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            ...
                            <input class="form-control" placeholder="{{lang.totalprice_placeholder}}" maxlength="30" type="number" id="totalprice" ng-required="true" ng-model="feedback.totalprice" autocomplete="off" style="padding-top:0px; width:100%" readonly>
