  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateErrorRate = function () {
      ...
      if (isNaN(reportingErrors) || reportingErrors < 0) {
        alert(
          "Please enter Number of Urinary Catheter associated UTIs in a month."
        );
        return;
      }
      ...
      if (reportingErrors > testsPerformed) {
        alert(
          " Number of Urinary Catheter associated UTIs in a month less than Number of urinary catheter days in the month ."
        );
        return;
      }
