  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of medication charts with error prone abbreviations "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "The number of medication charts with error prone abbreviations less than the number of medication charts reviewed."
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "The no.of number of medication charts with error prone abbreviations less than the no.of number of medication charts reviewed"
        );
        return false;
      }
