                          ...
                          <!-- Surgery -->
                            <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                              ...
                              <span class="has-float-label" style="margin-top: 5px;">
                                <input type="text" class="form-cont" ng-model="feedback.vital_signs_text" placeholder="Remarks"
                            ...
                            <!-- Allergies -->
                                ...
                                <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                            <h6 style="font-size: 18px;margin-left:-6px;margin-top:16px;"><b>Part B ( filled after 30 days)</b></h6>
                                  ...
                                  <span class="has-float-label" style="margin-top: 5px;">
                                    <input type="text" class="form-cont" ng-model="feedback.facility_communicated_remarks" placeholder="Remarks"
                                      style="margin-left:-2px; margin-top:5px;" />
                                  </span>
                                </div>
