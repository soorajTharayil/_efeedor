  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateErrorRate = function () {
      ...
      if (reportingErrors > testsPerformed) {
        alert(
          "Please enter number of parenteral exposures be less than total number of in-patient days for the month"
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "Please enter number of parenteral exposures less than total number of in-patient days for the month"
        );
        return false;
      }
