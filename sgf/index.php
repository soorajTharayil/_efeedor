							...
							<form id="msform">
								...
								<fieldset ng-show="step2 == true">
									...
									<div class="" style="width: 94%; margin: 0px auto;">
										<div class="row">
											<div ng-repeat="q in questioset" class="col-12" ng-show="q.category != 'Other'">
								...
								<fieldset ng-show="step3 == true">
									<div class="text-left">
										...
										<div class="text-left" style="width: 94%; margin: 0px auto;" ng-show="selectedQuestionObject.question.length != 0">
											...
											<h4 style="font-size: 18px; margin-bottom: 22px;" ng-show="typel == 'lang2'"><br><b>{{lang.telluswrong}} : {{categoryk}}</b></h4>
											<h4 style="font-size: 18px; margin-bottom: 22px;" ng-show="typel == 'lang3'"><br><b>{{lang.telluswrong}} : {{categorym}}</b></h4>
								...
								<fieldset ng-show="step4 == true">
									<div class="form-card" style="margin-top: 10px;">
										...
										<!-- <button type="button" class="btn btn-outline-dark" data-toggle="modal" data-target="#tagPatientModal" style="margin-left: 12px;">
											Tag Patient to the grievance
											<i class="fa fa-plus" aria-hidden="true"></i>

										</button>
										<br> -->
										<div class="form-group" style="margin-left: 13px; margin-right:13px;margin-top:13px;">
								...
								<fieldset ng-show="step5 == true">
									<div class="form-card">
										...
										<div class="text-left details-section" style="background: white;">
											<label for="comment"><b style="font-size: 19px;">{{lang.review}}</b></label>
											<br>
											<table class="details-content" style="border-spacing: 10px; border-collapse: collapse; width: 100%; margin-bottom: 0px; border: 1px solid #dddddd;">
												<tr>
													<td colspan="2" class="details-label" style="padding: 10px;"><b>{{lang.details}}</b></td>
												</tr>
												...
												<tr ng-show="image == true">
													...
													<td style="border: 1px solid #dddddd; padding: 10px;"> <img ng-src="{{feedback.image}}" alt="Encoded Image" ng-show="feedback.image" />
													</td>
												</tr>
												<!-- <tr>
												...
												<tr>
													<td colspan="2" class="details-label" style="padding: 10px;"><b>{{lang.occurred}}</b></td>
												</tr>
												<tr>
												...
												<tr>
													<td colspan="2" class="details-label" style="padding: 10px;"><b>{{lang.reported}}</b></td>
												</tr>
												<tr>
												...
												<!-- <tr ng-show="tagpatient == true">
													<td colspan="2" class="details-label" style="padding: 10px;"><b>Patient details</b></td>
												</tr>

												<tr ng-show="tagpatient == true">
													<td class="details-label" style="border: 1px solid #dddddd; padding: 10px;">Patient Name</td>
													<td style="border: 1px solid #dddddd; padding: 10px;">{{feedback.pname}}</td>
												</tr>
												<tr ng-show="tagpatient == true">
													<td class="details-label" style="border: 1px solid #dddddd; padding: 10px;">Patient ID</td>
													<td style="border: 1px solid #dddddd; padding: 10px;">{{feedback.ppatientid}}</td>
												</tr>
												<tr ng-show="tagpatient == true">
													<td class="details-label" style="border: 1px solid #dddddd; padding: 10px;">Patient Type</td>
													<td style="border: 1px solid #dddddd; padding: 10px;">{{feedback.patient_type}}</td>
												</tr>
												<tr ng-show="tagpatient == true">
													<td class="details-label" style="border: 1px solid #dddddd; padding: 10px;">Primary consultant</td>
													<td style="border: 1px solid #dddddd; padding: 10px;">{{feedback.pconsultant}}</td>
												</tr> -->
											</table>
											<br><br>
...
<div class="modal fade" id="tagPatientModal" tabindex="-1" role="dialog" aria-labelledby="tagPatientModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="tagPatientModalLabel">Enter patient details</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="form-group">
					<span class="addon" style="    font-size: 16px;">Patient Name</span>
					<span class="has-float-label">
						<input class="form-control" placeholder="Enter Name" maxlength="25" name="name" type="text" id="emailid" ng-model="feedback.pname" onblur="this.value = this.value.toUpperCase();" autocomplete="off" style=" padding-top:0px;" />
						<label for="emailid"></label>
					</span>
				</div>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="form-group">
					<span class="addon" style="    font-size: 16px;">Patient ID</span>
					<span class="has-float-label">
						<input class="form-control" placeholder="Enter ID" type="text" maxlength="10" id="contactnumber" ng-required="true" ng-model="feedback.ppatientid" autocomplete="off" placeholder="Numerical digits only" style="padding-top:0px;" />
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="form-group">
						<span class="has-float-label">
							<select class="form-control" ng-model="feedback.patient_type" style=" width: 94%; margin: 0px auto;">
			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="form-group">
					<span class="addon" style="    font-size: 16px;">Primary consultant</span>
					<span class="has-float-label">
						<input class="form-control" placeholder="Enter Name" maxlength="25" name="name" type="text" id="emailid" ng-model="feedback.pconsultant" onblur="this.value = this.value.toUpperCase();" autocomplete="off" style=" padding-top:0px;" />
						<label for="emailid"></label>
					</span>
				</div>
			</div>
