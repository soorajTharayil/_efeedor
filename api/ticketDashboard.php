...
if (isset($data["module"]) && $data["module"] == "IP") {
		...
		$url = "https://demo.efeedor.com/TicketManagementApi/ticketdashboard/{$userId}/IP";
    ...
    $url = "https://demo.efeedor.com/TicketManagementApi/ticketdashboard/{$userId}/OP";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
    ...
    $url = "https://demo.efeedor.com/TicketManagementApi/ticketdashboard/{$userId}/ISR";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
   ...
   $url = "https://demo.efeedor.com/TicketManagementApi/ticketdashboard/{$userId}/PCF";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
    ...
    $url = "https://demo.efeedor.com/TicketManagementApi/ticketdashboard/{$userId}/INCIDENT";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
