...
$url = "https://demo.efeedor.com/view/user_activity_permission/" . $userId;
...
if (isset($data['module']) && isset($data['section']) && $data["module"] == "IP") {
	...
	$url = "https://demo.efeedor.com/TicketManagementApi/allTicketDashboard/{$userId}/IP";
    ...
    $module = $data['module'];
    $section = $data['section'];    $status = $data['status'];
	...
	$url = "https://demo.efeedor.com/TicketManagementApi/allTicketDashboard/{$userId}/ISR";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
	...
	$url = "https://demo.efeedor.com/TicketManagementApi/allTicketDashboard/{$userId}/OP";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
	...
	$url = "https://demo.efeedor.com/TicketManagementApi/allTicketDashboard/{$userId}/PCF";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
	...
	$url = "https://demo.efeedor.com/TicketManagementApi/allTicketDashboard/{$userId}/INCIDENT";
		$url .= "?tdate={$fdate}&fdate={$tdate}";
