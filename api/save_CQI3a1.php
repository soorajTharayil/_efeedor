...
if (count($data) > 1) {
   ...
   $query = 'INSERT INTO `bf_feedback_CQI3a1` (`name`,`email`,`patientid`,`mobile`,`time_taken_initial_assessment`, `number_of_admission`, `average_time_taken_initial_assessment`, `bench_mark_time`, `data_analysis`,`corrective_action`,`preventive_action`, `dataset`,`datet`,`datetime`) 
