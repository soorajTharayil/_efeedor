...
<head>
  ...
  <script src="app_20PSQ3c.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Avg. turn around time for issue of blood and blood components: <span ng-style="{ color: getTextColor() }">{{calculatedResult}}</span></strong><br><br>
