...
$scope.user_id = ehandor.userid;
	...
	$scope.calculateMedicationErrorRate = function () {
		...
		if (isNaN(medicationErrors) || medicationErrors < 0) {
			alert("Please enter total number of medical services accepted or provided ");
			return;
		}

		if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
			alert("Please enter total number of medical services requested ");
			return;
		}

		if (medicationErrors > opportunitiesForErrors) {
			alert("Please enter  total number of medical services accepted or provided  be less than total number of medical services requested ");
			return;
		}
