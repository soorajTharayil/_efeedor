              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 30px; margin-left:5px;">
                    <div class="form-group" style="text-align: left;">
                      <h6 style="font-size: 18px;margin-left:-6px;margin-top:15px;"><b>Nutritional Initial assessment</b></h6>
                    ...
                    <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <span class="has-float-label" style="margin-top: 5px;">
                       ...
                       <!--<h6 style="font-size: 18px;margin-left:-6px;margin-top:16px;"><b>Nursing Initial assessment - OPD</b></h6>-->
                      <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                ...
                <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                      ...
                      <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                        ...
                        <h6 style="font-size: 18px;margin-left:-6px;margin-top:16px;"><b>Diet Progress note</b></h6>
                      <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
