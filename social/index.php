...
<head>
	...
	<script src="app_social.js?<?php echo time(); ?>"></script>
</head>
<!-- head part end -->
					...
					<div class="row">
						<div class="col-md-12 mx-0">
							...
							<form id="msform">
								...
								<fieldset ng-show="step1 == true">
									...
									<div class="form-card">
										...
										<div class="row">
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													<span class="" style="font-size:16px;">{{lang.social_media_type}} <sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<select class="form-control" ng-model="feedback.ward" ng-change="change_ward()" ng-required="true" ng-show="typel == 'english'">
															<option value="">{{lang.social_media_type}}</option>
															<option ng-repeat="x in wardlist.ward" ng-show="x.title != 'ALL'" value="{{x.title}}">
																{{x.title}}
															</option>
														</select>
								...
								<!-- INTERIM Card page start  -->
								<fieldset ng-show="step2 == true">
									<div class="form-card">
										<h3 class="sectiondivision" style="font-weight:bold;" ng-show="feedback.section == 'SOCIAL'">{{lang.pagetitle}}</h3>
										...
										<table class="details-content" style="border-spacing: 10px; border-collapse: collapse; width: 100%; margin-bottom: 0px; border: 1px solid #dddddd;">
											...
											<tr >
												...
												<td  style="border: 1px solid #dddddd; padding: 10px;">
													<span style="margin-left: 0px;" class="lang-content" ng-show="typel == 'english'">{{selectedQuestionObject.category}}</span>
													<span style="margin-left: 0px;" class="lang-content" ng-show="typel == 'lang2'">{{selectedQuestionObject.categoryk}}</span>
													<span style="margin-left: 0px;" class="lang-content" ng-show="typel == 'lang3'">{{selectedQuestionObject.categorym}}</span>
												</td>
											</tr>
											<!-- <tr >
									...
									<div class="form-card">
										...
										<div class="row justify-content-center">
											...
											<div class="col-12 text-center">
												...
												<br>
												<button id="refreshBtn" class="btn btn-danger " style="padding: 15px; border-radius: 45px; font-size: 16px; box-shadow: 0px 1px 1px rgba(0,0,0,0.5); background-color:#DB6B97; border:none;">
													{{lang.refresh}}
												</button>
											</div>
										</div>
