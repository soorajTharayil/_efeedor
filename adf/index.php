...
<head>
  ...
  <script src="app_adf.js?<?php echo time(); ?>"></script>
              ...
              <form id="msform">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            ...
                            <input class="form-control" placeholder="{{lang.reg_mobile_message_placeholder}}" oninput="restrictToNumerals(event)" name="contactnumber" type="tel" maxlength="10" id="contactnumber" ng-model="feedback.contactnumber" autocomplete="on" pattern="[0-9]{10}" style=" padding-top:0px;" step="1" />
                ...
                <fieldset ng-show="step3 == true">
                  ...
                  <div class="form-card">
                    ...
                    <h3 class="sectiondivision" style="text-align: center;margin-top:0px; font-size:18px; padding-top:36px;"><b>
                    ...
                    <h3 class="sectiondivision" style="text-align: center;margin-top:0px; padding-top:0px;">
                    ...
                    <p style="font-size:18px;margin-top:3%;margin-bottom:5%;"> {{lang.recognizeateam}}</p>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-6">
                        ...
                        <div class="form-group input-group">
                          ...
                          <span class="has-float-label">
                            ...
                            <textarea class="form-control" type="text" id="staffname" ng-model="feedback.staffname" onblur="this.value = this.value.toUpperCase();" style=" height: 42px; font-size: 18px;" /></textarea>
                ...
                <fieldset ng-show="step4 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row justify-content-center" ng-show="positivefeedback == true && feedback.recommend1Score > 3">
                    ...
                    <div class="row justify-content-center" ng-show="positivefeedback == false || feedback.recommend1Score < 3">
