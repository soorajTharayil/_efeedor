...
<head>
  ...
  <script src="app_7PSQ3a.js?<?php echo time(); ?>"></script>
            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <h4 style="font-size:18px; margin-left:1px;"><strong>{{lang.kpi_info}} {{selectedMonths}} {{selectedYears}}</strong></h4>
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateUnplannedReturnToOTRate()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Percentage of unplanned return to OT is: <span style="color: blue; font-size:16px;">{{calculatedResult}}%</span></strong><br><br>
