  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter No of empirical antibiotics prescribed for the high risk infections as per policy"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter total No of high risk infections prescribed with antibiotics"
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "empirical antibiotics prescribed for the high risk infections as per policy less than total No of high risk infections prescribed with antibiotics ."
        );
        return;
      }
