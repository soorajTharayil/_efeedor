...
<head>
  ...
  <script src="app_12PSQ3a.js?<?php echo time(); ?>"></script>
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculatePressureUlcersKPI()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult !== undefined" style="margin-top: 15px;text-align:left;"><br>
                    ...
                    <div style="margin-left:15px;">
                      <strong>Incidence of hospital associated pressure ulcers after admission is: <span style="color: blue; font-size:16px;">{{calculatedResult}} per 1000 patient days</span></strong><br><br>
