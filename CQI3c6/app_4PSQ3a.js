  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter number of patients receiving high risk medications  developing adverse drug event "
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "The number of patients receiving high risk medications developing adverse drug event less than the total Number of patients receiving high risk medication."
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        alert(
          "The number of patients receiving high risk medications less than the total Number of patients receiving high risk medication"
        );
        return false;
      }
