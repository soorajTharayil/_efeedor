...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    document
      .getElementById("formula_para1_hr2")
      .addEventListener("input", $scope.onValuesEdited);
    document
      .getElementById("formula_para1_min2")
      .addEventListener("input", $scope.onValuesEdited);
    document
      .getElementById("formula_para1_sec2")
      .addEventListener("input", $scope.onValuesEdited);
