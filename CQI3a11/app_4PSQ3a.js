  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (isNaN(medicationErrors) || medicationErrors < 0) {
        alert(
          "Please enter Number of patients discharged with a diagnosis of CHF with reduced EF and prescribed a beta blocker at discharge"
        );
        return;
      }
      ...
      if (isNaN(opportunitiesForErrors) || opportunitiesForErrors <= 0) {
        alert(
          "Please enter Number of patients discharged with a diagnosis of CHF."
        );
        return;
      }
      ...
      if (medicationErrors > opportunitiesForErrors) {
        alert(
          "Number of patients discharged with a diagnosis of CHF with reduced EF and prescribed a beta blocker at discharge be less than number of patients discharged with a diagnosis of CHF"
        );
        return;
      }
