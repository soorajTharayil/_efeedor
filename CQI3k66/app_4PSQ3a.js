  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateMedicationErrorRate = function () {
      ...
      if (medicationErrors < 0) {
        alert(
          "Please enter a non-negative value for number of women having cesarean section for first time"
        );
        return;
      }
      ...
      if (opportunitiesForErrors < 0) {
        alert(
          "Please enter a non-negative value for total number of live birth other than cesarean"
        );
        return;
      }
    ...
    $scope.savefeedback = function () {
      ...
      if (
        ...
        $scope.feedback.initial_assessment_hr == null
      ) {
        alert(
          "Please enter number of Patient safety events or patterns of events"
        );
        return false;
      }
