...
<head>
  ...
  <script src="app_2PSQ3a.js?<?php echo time(); ?>"></script>
            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px; margin-top: -20px;">
                        <div class="form-group transparent-placeholder">
                          <span class="addon" style="font-size: 16px; margin-bottom: 15px;">
                            <b>{{lang.formula_para1}}</b><sup style="color:red">*</sup>
                          </span>
                          <span class="has-float-label">
                            <input class="form-control" oninput="restrictToNumerals(event)" placeholder="{{lang.formula_para1_placeholder}}" ng-model="feedback.initial_assessment_hr" type="number" id="formula_para1" ng-required="true" autocomplete="off" style="padding-top: 2px; padding-left: 6px; border: 1px solid grey; margin-top: 9px;" />
                            <label for="formula_para1"></label>
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:5px;">
                        <div class="form-group transparent-placeholder">
                          <span class="addon" style="font-size: 16px; margin-bottom: 15px;">
                            <b>{{lang.formula_para2}}</b><sup style="color:red">*</sup>
                          </span>
                          <span class="has-float-label">
                            <input class="form-control" oninput="restrictToNumerals(event)" ng-model="feedback.total_admission" placeholder="{{lang.formula_para2_placeholder}}" type="number" id="formula_para2" ng-required="true" autocomplete="off" style="padding-top: 2px; padding-left: 6px; border: 1px solid grey; margin-top: 9px;" />
                            <label for="formula_para2"></label>
                          </span>
                        </div>
                      </div>
                      ...
                      <button type="button" class="btn btn-primary" ng-click="calculateErrorRate()" style="margin-left:20px;">
                        Compute KPI
                      </button>
                  ...
                  <div ng-if="calculatedResult !== undefined && calculatedResult !== ''" style="margin-top: 15px;text-align:left;"><br>

                    <div style="margin-left:15px;">
                      <strong>Number of reporting errors per 1000 investigations (Radiology): <span style="color: blue; font-size:16px;">{{calculatedResult}}</span></strong><br><br>
