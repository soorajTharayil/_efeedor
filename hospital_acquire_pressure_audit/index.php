            ...
            <div class="col-md-12 mx-0">
              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top: 0px;">
                    <div class="form-group">
                      ...
                      <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                        ...
                        <input class="form-control" type="number" ng-model="feedback.intake"
                          placeholder="Enter your input" maxlength="30" autocomplete="off"
                      ...
                      <div style="margin-top: 8px; text-align: left; margin-left:-6px;">
                        ...
                        <input class="form-control" type="number" ng-model="feedback.output_text"
                          placeholder="Enter your input" maxlength="30" autocomplete="off"
                          style="width: 100%; border-radius: 4px; padding: 6px 8px;" />
                      </div>
