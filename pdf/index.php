                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          <span class="" style="font-size:16px;">{{lang.wardtitle}} </span>
                          <span class="has-float-label">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          <span class="addon" style="    font-size: 16px;">{{lang.bedno}}</span>
                          <span class="has-float-label">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" >
                        ...
                        <div class="form-group">
                          ...
                          <span class="has-float-label">
                            ...
                            <input class="form-control" type="tel" oninput="restrictToNumerals(event)" maxlength="10" id="contactnumber" ng-model="feedback.contactnumber" style="padding-top:0px;" autocomplete="off" placeholder="{{lang.mobile_placeholder}}"  />
